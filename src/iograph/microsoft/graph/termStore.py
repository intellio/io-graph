...
class RelationType(RootModel[Literal['pin', 'reuse', 'unknownFutureValue']]):
    root: Literal['pin', 'reuse', 'unknownFutureValue'] = Field(
        ..., title='relationType'
    )


class TermGroupScope(
    RootModel[Literal['global', 'system', 'siteCollection', 'unknownFutureValue']]
):
    root: Literal['global', 'system', 'siteCollection', 'unknownFutureValue'] = Field(
...
class Group(Entity):
    ...
    scope: TermGroupScope | None = Field(
        None,
