...
class PrinterDefaults(BaseModel):
    ...
    finishings: List[PrintFinishing] | None = Field(
        None,
...
class PrinterCapabilities(BaseModel):
    ...
    color_modes: List[PrintColorMode] | None = Field(
        None,
    ...
    qualities: List[PrintQuality] | None = Field(
    ...
    scalings: List[PrintScaling] | None = Field(
