...
class ConnectionOperation(Entity):
    ...
    status: Annotated[
        ConnectionOperationStatus | Dict[str, Any] | None,
        Field(
...
class Identity(Entity):
    type: Annotated[
        IdentityType | Dict[str, Any] | None,
        Field(
...
class ActivitySettings(BaseModel):
    url_to_item_resolvers: Annotated[
        List[UrlToItemResolverBase] | None,
        Field(
...
class ExternalItemContent(BaseModel):
    type: ExternalItemContentType | None = None
    value: Annotated[
        str | None, Field(description='The content for the externalItem. Required.')
    ] = None
    field_odata_type: str
...
class ItemIdResolver(UrlToItemResolverBase):
    ...
    url_match_info: Annotated[
        UrlMatchInfo | Dict[str, Any] | None,
...
class PropertyRule(BaseModel):
    operation: RuleOperation | None = None
    property: Annotated[
        str | None,
...
class UrlToItemResolverBaseCollectionResponse(BaseCollectionPaginationCountResponse):
    value: List[UrlToItemResolverBase] | None = None


class PropertyRuleCollectionResponse(BaseCollectionPaginationCountResponse):
    value: List[PropertyRule] | None = None
...
class ExternalActivity(Entity):
    ...
    type: ExternalActivityType | None = None
...
class ExternalItem(Entity):
    ...
    content: Annotated[
        ExternalItemContent | Dict[str, Any] | None,
        Field(
...
class ExternalConnection(Entity):
    ...
    connector_id: Annotated[
        str | None, Field(description='The Teams app ID. Optional.')
    ] = None
    description: Annotated[
        str | None,
        Field(
    ...
    search_settings: Annotated[
        SearchSettings | Dict[str, Any] | None,
        Field(
    ...
    state: Annotated[
        ConnectionState | Dict[str, Any] | None,
        Field(
    ...
    groups: List[ExternalGroup] | None = None
    items: List[ExternalItem] | None = None
    operations: List[ConnectionOperation] | None = None
    schema_: Schema | Dict[str, Any] | None = None
    field_odata_type: str


class ExternalConnectionCollectionResponse(BaseCollectionPaginationCountResponse):
    value: List[ExternalConnection] | None = None


class External(BaseModel):
    connections: List[ExternalConnection] | None = None
    field_odata_type: str
