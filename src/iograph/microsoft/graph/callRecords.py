...
class AdministrativeUnitInfo(BaseModel):
    id: Annotated[
        str | None, Field(description='Unique identifier for the administrative unit.')
    ] = None
...
class DirectRoutingLogRow(BaseModel):
    ...
    call_type: Annotated[str | None, Field(description='Call type and direction.')] = (
        None
    )
    ...
    successful_call: Annotated[
        bool | None, Field(description='Success or attempt.')
    ] = None
    ...
    user_display_name: Annotated[
        str | None, Field(description='Display name of the user.')
    ] = None
    user_id: Annotated[
        str | None,
        Field(
...
class ParticipantBase(Entity):
    administrative_unit_infos: Annotated[
        List[AdministrativeUnitInfo] | None,
        Field(
            description='List of administrativeUnitInfo objects for the call participant.'
        ),
    ] = None
    identity: Annotated[
        CommunicationsIdentitySet | Dict[str, Any] | None,
...
class MediaStream(BaseModel):
    ...
    packet_utilization: Annotated[
        float | None, Field(description='Packet count for the stream.')
    ] = None
    ...
    stream_id: Annotated[
        str | None, Field(description='Unique identifier for the stream.')
    ] = None
    video_codec: Annotated[
        VideoCodec | Dict[str, Any] | None,
        Field(
...
class NetworkInfo(BaseModel):
    ...
    connection_type: NetworkConnectionType | None = None
    ...
    ip_address: Annotated[
        str | None, Field(description='IP address of the media endpoint.')
    ] = None
    ...
    network_transport_protocol: NetworkTransportProtocol | None = None
    port: Annotated[
        float | None,
        Field(
    ...
    wifi_radio_type: WifiRadioType | None = None
...
class PstnCallLogRow(BaseModel):
    call_duration_source: Annotated[
        PstnCallDurationSource | Dict[str, Any] | None,
        Field(
    ...
    callee_number: Annotated[
        str | None, Field(description='Number dialed in E.164 format.')
    ] = None
    caller_number: Annotated[
        str | None,
        Field(
    ...
    call_id: Annotated[
        str | None, Field(description='Call identifier. Not guaranteed to be unique.')
    ] = None
    call_type: Annotated[
        str | None,
        Field(
    ...
    conference_id: Annotated[
        str | None, Field(description='ID of the audio conference.')
    ] = None
    connection_charge: Annotated[
        Decimal | None, Field(description='Connection fee price.')
    ] = None
    currency: Annotated[
        str | None,
        Field(
    ...
    destination_name: Annotated[
        str | None, Field(description='Country or region dialed.')
    ] = None
    duration: Annotated[
        float | None,
        Field(
    ...
    license_capability: Annotated[
        str | None, Field(description='The license used for the call.')
    ] = None
    operator: Annotated[
        str | None,
        Field(
...
class UserFeedback(BaseModel):
    rating: UserFeedbackRating | None = None
    text: Annotated[
        str | None,
        Field(
    ...
    tokens: Annotated[
        FeedbackTokenSet | Dict[str, Any] | None,
        Field(
...
class ParticipantEndpoint(Endpoint):
    ...
    cpu_name: Annotated[
        str | None, Field(description='CPU name used by the media endpoint.')
    ] = None
    ...
    feedback: Annotated[
        UserFeedback | Dict[str, Any] | None,
        Field(
...
class Segment(Entity):
    ...
    failure_info: Annotated[
        FailureInfo | Dict[str, Any] | None,
        Field(
            description='Failure information associated with the segment if it failed.'
        ),
    ] = None
    media: Annotated[
        List[Media] | None, Field(description='Media associated with this segment.')
    ] = None
    start_date_time: Annotated[
        datetime | None,
        Field(
...
class Session(Entity):
    ...
    is_test: Annotated[
        bool | None, Field(description='Specifies whether the session is a test.')
    ] = None
...
class CallRecordCollectionResponse(BaseCollectionPaginationCountResponse):
    value: List[CallRecord] | None = None
