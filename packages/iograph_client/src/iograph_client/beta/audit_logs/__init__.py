...
if TYPE_CHECKING:
	...
	from .directory_provisioning import DirectoryProvisioningRequest
...
class AuditLogsRequest(BaseRequestBuilder):
	...
	@property
	def custom_security_attribute_audits(self,
	) -> CustomSecurityAttributeAuditsRequest:
		from .custom_security_attribute_audits import CustomSecurityAttributeAuditsRequest
		return CustomSecurityAttributeAuditsRequest(self.request_adapter, self.path_parameters)
