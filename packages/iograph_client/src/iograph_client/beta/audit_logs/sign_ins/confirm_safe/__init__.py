...
from iograph_models.beta.confirm_safe_post_request import Confirm_safePostRequest


class ConfirmSafeRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/auditLogs/signIns/confirmSafe", path_parameters)

	async def post(
		self,
		body: Confirm_safePostRequest,
	...
	def with_url(self, raw_url: str) -> ConfirmSafeRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: ConfirmSafeRequest
		"""
		if raw_url is None:
