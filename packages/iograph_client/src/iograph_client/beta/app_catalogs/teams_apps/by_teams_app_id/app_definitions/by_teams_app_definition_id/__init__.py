...
if TYPE_CHECKING:
	from .outline_icon import OutlineIconRequest
	from .dashboard_cards import DashboardCardsRequest
	from .color_icon import ColorIconRequest
...
the created resource has a distributionMethod property value of organization. The requiresReview property allows any user to submit an app for review by an administrator. Admins can approve or reject these apps via this API or the Microsoft Teams admin center.
	...
	def color_icon(self,
		...
		from .color_icon import ColorIconRequest
		return ColorIconRequest(self.request_adapter, path_parameters)
	...
	def dashboard_cards(self,
		...
		from .dashboard_cards import DashboardCardsRequest
		return DashboardCardsRequest(self.request_adapter, path_parameters)

	def outline_icon(self,
		teamsApp_id: str,
		teamsAppDefinition_id: str,
	) -> OutlineIconRequest:
		if teamsApp_id is None:
		...
		from .outline_icon import OutlineIconRequest
		return OutlineIconRequest(self.request_adapter, path_parameters)
