...
from iograph_models.beta.teams_app_definition_collection_response import TeamsAppDefinitionCollectionResponse
from iograph_models.beta.teams_app_definition import TeamsAppDefinition


class AppDefinitionsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/appCatalogs/teamsApps/{teamsApp%2Did}/appDefinitions", path_parameters)
	...
	def with_url(self, raw_url: str) -> AppDefinitionsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: AppDefinitionsRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return AppDefinitionsRequest(self.request_adapter, self.path_parameters)

	def by_teams_app_definition_id(self,
		teamsApp_id: str,
		teamsAppDefinition_id: str,
	) -> ByTeamsAppDefinitionIdRequest:
