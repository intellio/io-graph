...
if TYPE_CHECKING:
	...
	from .by_filtering_profile_id import ByFilteringProfileIdRequest
	from ....request_adapter import HttpxRequestAdapter
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.beta.networkaccess_filtering_profile_collection_response import NetworkaccessFilteringProfileCollectionResponse
from iograph_models.beta.networkaccess_filtering_profile import NetworkaccessFilteringProfile


class FilteringProfilesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/networkAccess/filteringProfiles", path_parameters)

	async def get(
		self,
		request_configuration: Optional[RequestConfiguration[GetQueryParams]] = None,
	) -> NetworkaccessFilteringProfileCollectionResponse:
		"""
		...
		return await self.request_adapter.send_async(request_info, NetworkaccessFilteringProfileCollectionResponse, error_mapping)
	...
	def with_url(self, raw_url: str) -> FilteringProfilesRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: FilteringProfilesRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return FilteringProfilesRequest(self.request_adapter, self.path_parameters)

	def by_filtering_profile_id(self,
		filteringProfile_id: str,
	) -> ByFilteringProfileIdRequest:
		...
		from .by_filtering_profile_id import ByFilteringProfileIdRequest
		return ByFilteringProfileIdRequest(self.request_adapter, path_parameters)
