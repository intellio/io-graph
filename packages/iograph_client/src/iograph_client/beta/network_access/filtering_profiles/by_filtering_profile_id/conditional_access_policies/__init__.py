...
from iograph_models.beta.networkaccess_conditional_access_policy_collection_response import NetworkaccessConditionalAccessPolicyCollectionResponse


class ConditionalAccessPoliciesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/networkAccess/filteringProfiles/{filteringProfile%2Did}/conditionalAccessPolicies", path_parameters)

	async def get(
		self,
		request_configuration: Optional[RequestConfiguration[GetQueryParams]] = None,
	) -> NetworkaccessConditionalAccessPolicyCollectionResponse:
		"""
		...
		return await self.request_adapter.send_async(request_info, NetworkaccessConditionalAccessPolicyCollectionResponse, error_mapping)
	...
	def with_url(self, raw_url: str) -> ConditionalAccessPoliciesRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: ConditionalAccessPoliciesRequest
		"""
		if raw_url is None:
