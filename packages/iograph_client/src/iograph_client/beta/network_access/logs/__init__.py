...
from iograph_models.beta.networkaccess_logs import NetworkaccessLogs
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class LogsRequest(BaseRequestBuilder):
	...
	async def get(
		...
		return await self.request_adapter.send_async(request_info, NetworkaccessLogs, error_mapping)

	async def patch(
		self,
		body: NetworkaccessLogs,
	...
	def with_url(self, raw_url: str) -> LogsRequest:
		"""
