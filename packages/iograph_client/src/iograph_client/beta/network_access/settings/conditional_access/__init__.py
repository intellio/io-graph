...
from iograph_models.beta.networkaccess_conditional_access_settings import NetworkaccessConditionalAccessSettings
...
class ConditionalAccessRequest(BaseRequestBuilder):
	...
	async def get(
	...
	) -> NetworkaccessConditionalAccessSettings:
		"""
		...
		return await self.request_adapter.send_async(request_info, NetworkaccessConditionalAccessSettings, error_mapping)

	async def patch(
		self,
		body: NetworkaccessConditionalAccessSettings,
