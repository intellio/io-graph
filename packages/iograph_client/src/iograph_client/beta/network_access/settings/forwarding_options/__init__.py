...
from iograph_models.beta.networkaccess_forwarding_options import NetworkaccessForwardingOptions
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class ForwardingOptionsRequest(BaseRequestBuilder):
	...
	async def get(
	...
	) -> NetworkaccessForwardingOptions:
		"""
		...
		return await self.request_adapter.send_async(request_info, NetworkaccessForwardingOptions, error_mapping)

	async def patch(
		self,
		body: NetworkaccessForwardingOptions,
	...
	def with_url(self, raw_url: str) -> ForwardingOptionsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: ForwardingOptionsRequest
		"""
		if raw_url is None:
