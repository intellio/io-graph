...
from iograph_models.beta.networkaccess_enriched_audit_logs import NetworkaccessEnrichedAuditLogs
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class EnrichedAuditLogsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/networkAccess/settings/enrichedAuditLogs", path_parameters)

	async def get(
		self,
		request_configuration: Optional[RequestConfiguration[GetQueryParams]] = None,
	) -> NetworkaccessEnrichedAuditLogs:
		"""
		...
		return await self.request_adapter.send_async(request_info, NetworkaccessEnrichedAuditLogs, error_mapping)

	async def patch(
		self,
		body: NetworkaccessEnrichedAuditLogs,
	...
	def with_url(self, raw_url: str) -> EnrichedAuditLogsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: EnrichedAuditLogsRequest
		"""
		if raw_url is None:
