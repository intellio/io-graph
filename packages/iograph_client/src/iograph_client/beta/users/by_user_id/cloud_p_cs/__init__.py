...
class CloudPCsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/users/{user%2Did}/cloudPCs", path_parameters)
	...
	def bulk_resize(self,
		...
		from .bulk_resize import BulkResizeRequest
		return BulkResizeRequest(self.request_adapter, path_parameters)
	...
	def validate_bulk_resize(self,
		...
		from .validate_bulk_resize import ValidateBulkResizeRequest
		return ValidateBulkResizeRequest(self.request_adapter, path_parameters)
