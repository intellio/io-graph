...
from iograph_models.beta.activity_history_item_collection_response import ActivityHistoryItemCollectionResponse
from iograph_models.beta.activity_history_item import ActivityHistoryItem


class HistoryItemsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/users/{user%2Did}/activities/{userActivity%2Did}/historyItems", path_parameters)
	...
	def with_url(self, raw_url: str) -> HistoryItemsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: HistoryItemsRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return HistoryItemsRequest(self.request_adapter, self.path_parameters)

	def by_activity_history_item_id(self,
		user_id: str,
		userActivity_id: str,
		activityHistoryItem_id: str,
	) -> ByActivityHistoryItemIdRequest:
		if user_id is None:
