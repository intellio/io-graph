...
from iograph_models.beta.user_scope_teams_app_installation import UserScopeTeamsAppInstallation
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.beta.user_scope_teams_app_installation_collection_response import UserScopeTeamsAppInstallationCollectionResponse


class InstalledAppsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/users/{user%2Did}/teamwork/installedApps", path_parameters)
	...
	def by_user_scope_teams_app_installation_id(self,
		user_id: str,
		userScopeTeamsAppInstallation_id: str,
	) -> ByUserScopeTeamsAppInstallationIdRequest:
		if user_id is None:
