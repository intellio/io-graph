...
from iograph_models.beta.get_managed_app_policies_response import GetManagedAppPoliciesResponse
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class GetManagedAppPoliciesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/users/{user%2Did}/getManagedAppPolicies()", path_parameters)
