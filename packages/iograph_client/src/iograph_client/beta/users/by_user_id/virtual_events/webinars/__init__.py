...
from iograph_models.beta.virtual_event_webinar_collection_response import VirtualEventWebinarCollectionResponse


class WebinarsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/users/{user%2Did}/virtualEvents/webinars", path_parameters)
	...
	async def get(
		...
		"""
		tags = ['users.userVirtualEventsRoot']
