...
from iograph_models.beta.app_role_assignment_collection_response import AppRoleAssignmentCollectionResponse


class GraphAppRoleAssignmentRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/users/{user%2Did}/devices/{device%2Did}/registeredOwners/graph.appRoleAssignment", path_parameters)
