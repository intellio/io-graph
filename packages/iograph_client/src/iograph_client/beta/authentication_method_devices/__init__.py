...
class AuthenticationMethodDevicesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/authenticationMethodDevices", path_parameters)

	async def get(
		self,
		request_configuration: Optional[RequestConfiguration[GetQueryParams]] = None,
	) -> AuthenticationMethodDeviceCollectionResponse:
		"""
	...
	def with_url(self, raw_url: str) -> AuthenticationMethodDevicesRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: AuthenticationMethodDevicesRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return AuthenticationMethodDevicesRequest(self.request_adapter, self.path_parameters)

	def by_authentication_method_device_id(self,
		authenticationMethodDevice_id: str,
	) -> ByAuthenticationMethodDeviceIdRequest:
		...
		from .by_authentication_method_device_id import ByAuthenticationMethodDeviceIdRequest
		return ByAuthenticationMethodDeviceIdRequest(self.request_adapter, path_parameters)
