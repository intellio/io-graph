...
class ExactMatchDataStoresRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/dataClassification/exactMatchDataStores", path_parameters)
	...
	def with_url(self, raw_url: str) -> ExactMatchDataStoresRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: ExactMatchDataStoresRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return ExactMatchDataStoresRequest(self.request_adapter, self.path_parameters)

	def by_exact_match_data_store_id(self,
		exactMatchDataStore_id: str,
	) -> ByExactMatchDataStoreIdRequest:
		...
		from .by_exact_match_data_store_id import ByExactMatchDataStoreIdRequest
		return ByExactMatchDataStoreIdRequest(self.request_adapter, path_parameters)
