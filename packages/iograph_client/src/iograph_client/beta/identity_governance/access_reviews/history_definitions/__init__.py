...
from iograph_models.beta.access_review_history_definition import AccessReviewHistoryDefinition
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.beta.access_review_history_definition_collection_response import AccessReviewHistoryDefinitionCollectionResponse


class HistoryDefinitionsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/identityGovernance/accessReviews/historyDefinitions", path_parameters)
	...
	def with_url(self, raw_url: str) -> HistoryDefinitionsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: HistoryDefinitionsRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return HistoryDefinitionsRequest(self.request_adapter, self.path_parameters)
