...
if TYPE_CHECKING:
	...
	from .by_finding_id import ByFindingIdRequest
	from ......request_adapter import HttpxRequestAdapter
from iograph_models.beta.finding import Finding
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.beta.finding_collection_response import FindingCollectionResponse


class FindingsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/identityGovernance/permissionsAnalytics/azure/findings", path_parameters)
	...
	def by_finding_id(self,
		...
		path_parameters["finding%2Did"] =  finding_id

		from .by_finding_id import ByFindingIdRequest
		return ByFindingIdRequest(self.request_adapter, path_parameters)
