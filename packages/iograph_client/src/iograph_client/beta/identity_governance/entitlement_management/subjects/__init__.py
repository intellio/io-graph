...
if TYPE_CHECKING:
	...
	from .by_access_package_subject_id import ByAccessPackageSubjectIdRequest
	from .....request_adapter import HttpxRequestAdapter
from iograph_models.beta.access_package_subject import AccessPackageSubject
from iograph_models.beta.access_package_subject_collection_response import AccessPackageSubjectCollectionResponse
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class SubjectsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/identityGovernance/entitlementManagement/subjects", path_parameters)
	...
	def with_url(self, raw_url: str) -> SubjectsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: SubjectsRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return SubjectsRequest(self.request_adapter, self.path_parameters)

	def by_access_package_subject_id(self,
		accessPackageSubject_id: str,
	) -> ByAccessPackageSubjectIdRequest:
		...
		from .by_access_package_subject_id import ByAccessPackageSubjectIdRequest
		return ByAccessPackageSubjectIdRequest(self.request_adapter, path_parameters)
