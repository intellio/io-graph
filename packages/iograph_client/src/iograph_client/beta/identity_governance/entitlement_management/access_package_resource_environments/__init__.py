...
from iograph_models.beta.access_package_resource_environment_collection_response import AccessPackageResourceEnvironmentCollectionResponse
from iograph_models.beta.access_package_resource_environment import AccessPackageResourceEnvironment
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class AccessPackageResourceEnvironmentsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/identityGovernance/entitlementManagement/accessPackageResourceEnvironments", path_parameters)
	...
	def with_url(self, raw_url: str) -> AccessPackageResourceEnvironmentsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: AccessPackageResourceEnvironmentsRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return AccessPackageResourceEnvironmentsRequest(self.request_adapter, self.path_parameters)

	def by_access_package_resource_environment_id(self,
		accessPackageResourceEnvironment_id: str,
	) -> ByAccessPackageResourceEnvironmentIdRequest:
		...
		from .by_access_package_resource_environment_id import ByAccessPackageResourceEnvironmentIdRequest
		return ByAccessPackageResourceEnvironmentIdRequest(self.request_adapter, path_parameters)
