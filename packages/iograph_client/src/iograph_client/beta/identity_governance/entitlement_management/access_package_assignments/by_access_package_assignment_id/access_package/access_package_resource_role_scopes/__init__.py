...
if TYPE_CHECKING:
	...
	from .by_access_package_resource_role_scope_id import ByAccessPackageResourceRoleScopeIdRequest
...
from iograph_models.beta.access_package_resource_role_scope_collection_response import AccessPackageResourceRoleScopeCollectionResponse


class AccessPackageResourceRoleScopesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/identityGovernance/entitlementManagement/accessPackageAssignments/{accessPackageAssignment%2Did}/accessPackage/accessPackageResourceRoleScopes", path_parameters)
	...
	def with_url(self, raw_url: str) -> AccessPackageResourceRoleScopesRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: AccessPackageResourceRoleScopesRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return AccessPackageResourceRoleScopesRequest(self.request_adapter, self.path_parameters)

	def by_access_package_resource_role_scope_id(self,
		accessPackageAssignment_id: str,
		accessPackageResourceRoleScope_id: str,
	) -> ByAccessPackageResourceRoleScopeIdRequest:
		...
		from .by_access_package_resource_role_scope_id import ByAccessPackageResourceRoleScopeIdRequest
		return ByAccessPackageResourceRoleScopeIdRequest(self.request_adapter, path_parameters)
