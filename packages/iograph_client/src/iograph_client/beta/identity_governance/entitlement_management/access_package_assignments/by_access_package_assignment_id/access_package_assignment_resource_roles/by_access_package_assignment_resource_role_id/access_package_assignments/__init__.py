...
if TYPE_CHECKING:
	...
	from .by_access_package_assignment_id1 import ByAccessPackageAssignmentId1Request
...
class AccessPackageAssignmentsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/identityGovernance/entitlementManagement/accessPackageAssignments/{accessPackageAssignment%2Did}/accessPackageAssignmentResourceRoles/{accessPackageAssignmentResourceRole%2Did}/accessPackageAssignments", path_parameters)
	...
	def by_access_package_assignment_id1(self,
		accessPackageAssignment_id: str,
		accessPackageAssignmentResourceRole_id: str,
		accessPackageAssignment_id1: str,
	) -> ByAccessPackageAssignmentId1Request:
		...
		if accessPackageAssignment_id1 is None:
			raise TypeError("accessPackageAssignment_id1 cannot be null.")
		...
		path_parameters["accessPackageAssignment%2Did1"] =  accessPackageAssignment_id1

		from .by_access_package_assignment_id1 import ByAccessPackageAssignmentId1Request
		return ByAccessPackageAssignmentId1Request(self.request_adapter, path_parameters)
