...
class ByAccessPackageAssignmentIdRequest(BaseRequestBuilder):
	...
	def access_package_assignment_policy(self,
		accessPackageAssignment_id: str,
	) -> AccessPackageAssignmentPolicyRequest:
		if accessPackageAssignment_id is None:
			raise TypeError("accessPackageAssignment_id cannot be null.")
		...
		from .access_package_assignment_policy import AccessPackageAssignmentPolicyRequest
		return AccessPackageAssignmentPolicyRequest(self.request_adapter, path_parameters)
	...
	def access_package_assignment_requests(self,
		...
		from .access_package_assignment_requests import AccessPackageAssignmentRequestsRequest
		return AccessPackageAssignmentRequestsRequest(self.request_adapter, path_parameters)
	...
	def access_package_assignment_resource_roles(self,
		...
		from .access_package_assignment_resource_roles import AccessPackageAssignmentResourceRolesRequest
		return AccessPackageAssignmentResourceRolesRequest(self.request_adapter, path_parameters)
