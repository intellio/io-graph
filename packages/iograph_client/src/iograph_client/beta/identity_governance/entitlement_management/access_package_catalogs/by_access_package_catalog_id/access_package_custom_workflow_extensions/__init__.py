...
from iograph_models.beta.custom_callout_extension_collection_response import CustomCalloutExtensionCollectionResponse
from iograph_models.beta.custom_callout_extension import CustomCalloutExtension
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class AccessPackageCustomWorkflowExtensionsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/identityGovernance/entitlementManagement/accessPackageCatalogs/{accessPackageCatalog%2Did}/accessPackageCustomWorkflowExtensions", path_parameters)
	...
	def with_url(self, raw_url: str) -> AccessPackageCustomWorkflowExtensionsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: AccessPackageCustomWorkflowExtensionsRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return AccessPackageCustomWorkflowExtensionsRequest(self.request_adapter, self.path_parameters)
