...
if TYPE_CHECKING:
	...
	from .by_custom_access_package_workflow_extension_id import ByCustomAccessPackageWorkflowExtensionIdRequest
...
from iograph_models.beta.custom_access_package_workflow_extension_collection_response import CustomAccessPackageWorkflowExtensionCollectionResponse


class CustomAccessPackageWorkflowExtensionsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/identityGovernance/entitlementManagement/accessPackageCatalogs/{accessPackageCatalog%2Did}/customAccessPackageWorkflowExtensions", path_parameters)
	...
	def with_url(self, raw_url: str) -> CustomAccessPackageWorkflowExtensionsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: CustomAccessPackageWorkflowExtensionsRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return CustomAccessPackageWorkflowExtensionsRequest(self.request_adapter, self.path_parameters)

	def by_custom_access_package_workflow_extension_id(self,
		accessPackageCatalog_id: str,
		customAccessPackageWorkflowExtension_id: str,
	) -> ByCustomAccessPackageWorkflowExtensionIdRequest:
		if accessPackageCatalog_id is None:
			raise TypeError("accessPackageCatalog_id cannot be null.")
		if customAccessPackageWorkflowExtension_id is None:
			raise TypeError("customAccessPackageWorkflowExtension_id cannot be null.")

		path_parameters = get_path_parameters(self.path_parameters)
		path_parameters["accessPackageCatalog%2Did"] =  accessPackageCatalog_id
		path_parameters["customAccessPackageWorkflowExtension%2Did"] =  customAccessPackageWorkflowExtension_id

		from .by_custom_access_package_workflow_extension_id import ByCustomAccessPackageWorkflowExtensionIdRequest
		return ByCustomAccessPackageWorkflowExtensionIdRequest(self.request_adapter, path_parameters)
