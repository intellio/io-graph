...
from iograph_models.beta.privileged_access_group_eligibility_schedule_instance_collection_response import PrivilegedAccessGroupEligibilityScheduleInstanceCollectionResponse
