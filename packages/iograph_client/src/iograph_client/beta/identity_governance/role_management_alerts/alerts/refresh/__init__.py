...
from iograph_models.beta.refresh_post_request import RefreshPostRequest


class RefreshRequest(BaseRequestBuilder):
	...
	def with_url(self, raw_url: str) -> RefreshRequest:
		"""
