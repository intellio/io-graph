...
from iograph_models.beta.mark_chat_unread_for_user_post_request import Mark_chat_unread_for_userPostRequest
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class MarkChatUnreadForUserRequest(BaseRequestBuilder):
	...
	def with_url(self, raw_url: str) -> MarkChatUnreadForUserRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: MarkChatUnreadForUserRequest
		"""
		if raw_url is None:
