...
from iograph_models.beta.unhide_for_user_post_request import Unhide_for_userPostRequest
...
class UnhideForUserRequest(BaseRequestBuilder):
	...
	async def post(
		self,
		body: Unhide_for_userPostRequest,
	...
	def with_url(self, raw_url: str) -> UnhideForUserRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: UnhideForUserRequest
		"""
		if raw_url is None:
