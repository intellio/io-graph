...
from iograph_models.beta.workbook_comment_reply import WorkbookCommentReply
from iograph_models.beta.workbook_comment_reply_collection_response import WorkbookCommentReplyCollectionResponse
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class RepliesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/tasks/{workbookDocumentTask%2Did}/comment/replies", path_parameters)
	...
	def by_workbook_comment_reply_id(self,
		...
		from .by_workbook_comment_reply_id import ByWorkbookCommentReplyIdRequest
		return ByWorkbookCommentReplyIdRequest(self.request_adapter, path_parameters)
