...
from iograph_models.beta.drive_item_version import DriveItemVersion
from iograph_models.beta.drive_item_version_collection_response import DriveItemVersionCollectionResponse
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class VersionsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/versions", path_parameters)
	...
	def by_drive_item_version_id(self,
		drive_id: str,
		driveItem_id: str,
		driveItemVersion_id: str,
	) -> ByDriveItemVersionIdRequest:
		if drive_id is None:
		...
		from .by_drive_item_version_id import ByDriveItemVersionIdRequest
		return ByDriveItemVersionIdRequest(self.request_adapter, path_parameters)
