...
from iograph_models.beta.workbook_chart_point import WorkbookChartPoint
from iograph_models.beta.workbook_chart_point_collection_response import WorkbookChartPointCollectionResponse


class PointsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/charts/{workbookChart%2Did}/series/itemAt(index={index})/points", path_parameters)
