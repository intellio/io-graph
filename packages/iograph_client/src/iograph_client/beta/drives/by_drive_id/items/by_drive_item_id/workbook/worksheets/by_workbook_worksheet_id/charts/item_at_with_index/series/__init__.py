...
from iograph_models.beta.workbook_chart_series import WorkbookChartSeries
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.beta.workbook_chart_series_collection_response import WorkbookChartSeriesCollectionResponse


class SeriesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/charts/itemAt(index={index})/series", path_parameters)
	...
	def with_url(self, raw_url: str) -> SeriesRequest:
		"""
