...
from iograph_models.beta.thumbnail_set_collection_response import ThumbnailSetCollectionResponse
from iograph_models.beta.thumbnail_set import ThumbnailSet


class ThumbnailsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/thumbnails", path_parameters)
	...
	def with_url(self, raw_url: str) -> ThumbnailsRequest:
		"""
	...
	def by_thumbnail_set_id(self,
		drive_id: str,
		driveItem_id: str,
		thumbnailSet_id: str,
	) -> ByThumbnailSetIdRequest:
		if drive_id is None:
			raise TypeError("drive_id cannot be null.")
		if driveItem_id is None:
			raise TypeError("driveItem_id cannot be null.")
		if thumbnailSet_id is None:
			raise TypeError("thumbnailSet_id cannot be null.")

		path_parameters = get_path_parameters(self.path_parameters)
		path_parameters["drive%2Did"] =  drive_id
		path_parameters["driveItem%2Did"] =  driveItem_id
		path_parameters["thumbnailSet%2Did"] =  thumbnailSet_id
