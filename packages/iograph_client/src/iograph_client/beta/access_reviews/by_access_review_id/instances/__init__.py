...
if TYPE_CHECKING:
	...
	from .by_access_review_id1 import ByAccessReviewId1Request
...
class InstancesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/accessReviews/{accessReview%2Did}/instances", path_parameters)
	...
	def by_access_review_id1(self,
		accessReview_id: str,
		accessReview_id1: str,
	) -> ByAccessReviewId1Request:
		...
		from .by_access_review_id1 import ByAccessReviewId1Request
		return ByAccessReviewId1Request(self.request_adapter, path_parameters)
