...
from iograph_models.beta.booking_business_collection_response import BookingBusinessCollectionResponse
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class BookingBusinessesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/bookingBusinesses", path_parameters)
	...
	async def get(
		...
		"""
		tags = ['bookingBusinesses.bookingBusiness']
