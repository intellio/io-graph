...
from iograph_models.beta.get_staff_availability_post_response import Get_staff_availabilityPostResponse
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.beta.get_staff_availability_post_request import Get_staff_availabilityPostRequest
...
class GetStaffAvailabilityRequest(BaseRequestBuilder):
	...
	async def post(
		...
		"""
		tags = ['bookingBusinesses.bookingBusiness.Actions']
