...
from iograph_models.beta.booking_custom_question_collection_response import BookingCustomQuestionCollectionResponse
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class CustomQuestionsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/bookingBusinesses/{bookingBusiness%2Did}/customQuestions", path_parameters)
