...
if TYPE_CHECKING:
	...
	from .by_windows_defender_application_control_supplemental_policy_id import ByWindowsDefenderApplicationControlSupplementalPolicyIdRequest
...
from iograph_models.beta.windows_defender_application_control_supplemental_policy_collection_response import WindowsDefenderApplicationControlSupplementalPolicyCollectionResponse


class WdacSupplementalPoliciesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/deviceAppManagement/wdacSupplementalPolicies", path_parameters)
	...
	def with_url(self, raw_url: str) -> WdacSupplementalPoliciesRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: WdacSupplementalPoliciesRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return WdacSupplementalPoliciesRequest(self.request_adapter, self.path_parameters)

	def by_windows_defender_application_control_supplemental_policy_id(self,
		windowsDefenderApplicationControlSupplementalPolicy_id: str,
	) -> ByWindowsDefenderApplicationControlSupplementalPolicyIdRequest:
		...
		from .by_windows_defender_application_control_supplemental_policy_id import ByWindowsDefenderApplicationControlSupplementalPolicyIdRequest
		return ByWindowsDefenderApplicationControlSupplementalPolicyIdRequest(self.request_adapter, path_parameters)
