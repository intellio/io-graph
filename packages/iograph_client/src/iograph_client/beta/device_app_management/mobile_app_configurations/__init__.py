...
from iograph_models.beta.managed_device_mobile_app_configuration_collection_response import ManagedDeviceMobileAppConfigurationCollectionResponse


class MobileAppConfigurationsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/deviceAppManagement/mobileAppConfigurations", path_parameters)
	...
	def with_url(self, raw_url: str) -> MobileAppConfigurationsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: MobileAppConfigurationsRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return MobileAppConfigurationsRequest(self.request_adapter, self.path_parameters)

	def by_managed_device_mobile_app_configuration_id(self,
		managedDeviceMobileAppConfiguration_id: str,
	) -> ByManagedDeviceMobileAppConfigurationIdRequest:
		...
		from .by_managed_device_mobile_app_configuration_id import ByManagedDeviceMobileAppConfigurationIdRequest
		return ByManagedDeviceMobileAppConfigurationIdRequest(self.request_adapter, path_parameters)
