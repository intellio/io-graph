...
from iograph_models.beta.android_managed_app_protection import AndroidManagedAppProtection
from iograph_models.beta.android_managed_app_protection_collection_response import AndroidManagedAppProtectionCollectionResponse
