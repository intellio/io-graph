...
if TYPE_CHECKING:
	...
	from .update_relationships import UpdateRelationshipsRequest
...
class ByMobileAppIdRequest(BaseRequestBuilder):
	...
	def graph_android_for_work_app(self,
		...
		from .graph_android_for_work_app import GraphAndroidForWorkAppRequest
		return GraphAndroidForWorkAppRequest(self.request_adapter, path_parameters)
	...
	def graph_android_managed_store_app(self,
		...
		from .graph_android_managed_store_app import GraphAndroidManagedStoreAppRequest
		return GraphAndroidManagedStoreAppRequest(self.request_adapter, path_parameters)
	...
	def graph_mac_o_s_pkg_app(self,
		...
		from .graph_mac_o_s_pkg_app import GraphMacOSPkgAppRequest
		return GraphMacOSPkgAppRequest(self.request_adapter, path_parameters)
	...
	def update_relationships(self,
		...
		from .update_relationships import UpdateRelationshipsRequest
		return UpdateRelationshipsRequest(self.request_adapter, path_parameters)
	...
	def graph_windows_store_app(self,
		...
		from .graph_windows_store_app import GraphWindowsStoreAppRequest
		return GraphWindowsStoreAppRequest(self.request_adapter, path_parameters)
	...
	def graph_win_get_app(self,
		...
		from .graph_win_get_app import GraphWinGetAppRequest
		return GraphWinGetAppRequest(self.request_adapter, path_parameters)
