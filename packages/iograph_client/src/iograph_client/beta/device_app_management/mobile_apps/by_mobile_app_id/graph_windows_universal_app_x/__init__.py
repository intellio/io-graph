...
from iograph_models.beta.windows_universal_app_x import WindowsUniversalAppX


class GraphWindowsUniversalAppXRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.windowsUniversalAppX", path_parameters)
	...
	def with_url(self, raw_url: str) -> GraphWindowsUniversalAppXRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: GraphWindowsUniversalAppXRequest
		"""
		if raw_url is None:
	...
	def committed_contained_apps(self,
		...
		from .committed_contained_apps import CommittedContainedAppsRequest
		return CommittedContainedAppsRequest(self.request_adapter, path_parameters)
