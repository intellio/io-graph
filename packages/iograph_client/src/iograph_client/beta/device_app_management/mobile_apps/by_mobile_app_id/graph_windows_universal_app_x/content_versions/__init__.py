...
from iograph_models.beta.mobile_app_content_collection_response import MobileAppContentCollectionResponse
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.beta.mobile_app_content import MobileAppContent


class ContentVersionsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.windowsUniversalAppX/contentVersions", path_parameters)
	...
	def with_url(self, raw_url: str) -> ContentVersionsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: ContentVersionsRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return ContentVersionsRequest(self.request_adapter, self.path_parameters)

	def by_mobile_app_content_id(self,
		mobileApp_id: str,
		mobileAppContent_id: str,
	) -> ByMobileAppContentIdRequest:
