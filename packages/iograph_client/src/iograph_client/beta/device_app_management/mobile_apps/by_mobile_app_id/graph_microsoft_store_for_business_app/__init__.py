...
from iograph_models.beta.microsoft_store_for_business_app import MicrosoftStoreForBusinessApp


class GraphMicrosoftStoreForBusinessAppRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/deviceAppManagement/mobileApps/{mobileApp%2Did}/graph.microsoftStoreForBusinessApp", path_parameters)
