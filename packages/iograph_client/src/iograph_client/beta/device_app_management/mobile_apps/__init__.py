...
if TYPE_CHECKING:
	from .graph_win_get_app import GraphWinGetAppRequest
	...
	from .graph_windows_store_app import GraphWindowsStoreAppRequest
	...
	from .validate_xml import ValidateXmlRequest
	...
	from .graph_mac_o_s_pkg_app import GraphMacOSPkgAppRequest
	...
	from .convert_from_mobile_app_catalog_package_with_mobileappcatalogpackageid import ConvertFromMobileAppCatalogPackageWithMobileAppCatalogPackageIdRequest
	from .graph_android_store_app import GraphAndroidStoreAppRequest
	from .graph_android_managed_store_app import GraphAndroidManagedStoreAppRequest
	from .graph_android_lob_app import GraphAndroidLobAppRequest
	from .graph_android_for_work_app import GraphAndroidForWorkAppRequest
...
class MobileAppsRequest(BaseRequestBuilder):
	...
	@property
	def graph_android_for_work_app(self,
	) -> GraphAndroidForWorkAppRequest:
		from .graph_android_for_work_app import GraphAndroidForWorkAppRequest
	...
	@property
	def graph_android_managed_store_app(self,
	) -> GraphAndroidManagedStoreAppRequest:
		from .graph_android_managed_store_app import GraphAndroidManagedStoreAppRequest
		return GraphAndroidManagedStoreAppRequest(self.request_adapter, self.path_parameters)
	...
	def convert_from_mobile_app_catalog_package_with_mobileappcatalogpackageid(self,
		mobileAppCatalogPackageId: str,
	) -> ConvertFromMobileAppCatalogPackageWithMobileAppCatalogPackageIdRequest:
		if mobileAppCatalogPackageId is None:
			raise TypeError("mobileAppCatalogPackageId cannot be null.")

		path_parameters = get_path_parameters(self.path_parameters)
		path_parameters["mobileAppCatalogPackageId"] =  mobileAppCatalogPackageId

		from .convert_from_mobile_app_catalog_package_with_mobileappcatalogpackageid import ConvertFromMobileAppCatalogPackageWithMobileAppCatalogPackageIdRequest
		return ConvertFromMobileAppCatalogPackageWithMobileAppCatalogPackageIdRequest(self.request_adapter, path_parameters)
	...
	@property
	def graph_mac_o_s_pkg_app(self,
	) -> GraphMacOSPkgAppRequest:
		from .graph_mac_o_s_pkg_app import GraphMacOSPkgAppRequest
		return GraphMacOSPkgAppRequest(self.request_adapter, self.path_parameters)
	...
	def validate_xml(self,
		...
		from .validate_xml import ValidateXmlRequest
		return ValidateXmlRequest(self.request_adapter, self.path_parameters)
	...
	@property
	def graph_windows_store_app(self,
	) -> GraphWindowsStoreAppRequest:
		from .graph_windows_store_app import GraphWindowsStoreAppRequest
		return GraphWindowsStoreAppRequest(self.request_adapter, self.path_parameters)
	...
	@property
	def graph_win_get_app(self,
	) -> GraphWinGetAppRequest:
		from .graph_win_get_app import GraphWinGetAppRequest
		return GraphWinGetAppRequest(self.request_adapter, self.path_parameters)
