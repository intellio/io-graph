...
if TYPE_CHECKING:
	...
	from .by_windows_managed_app_protection_id import ByWindowsManagedAppProtectionIdRequest
	from ....request_adapter import HttpxRequestAdapter
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.beta.windows_managed_app_protection_collection_response import WindowsManagedAppProtectionCollectionResponse
from iograph_models.beta.windows_managed_app_protection import WindowsManagedAppProtection


class WindowsManagedAppProtectionsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/deviceAppManagement/windowsManagedAppProtections", path_parameters)
	...
	def with_url(self, raw_url: str) -> WindowsManagedAppProtectionsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: WindowsManagedAppProtectionsRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return WindowsManagedAppProtectionsRequest(self.request_adapter, self.path_parameters)

	def by_windows_managed_app_protection_id(self,
		windowsManagedAppProtection_id: str,
	) -> ByWindowsManagedAppProtectionIdRequest:
		...
		from .by_windows_managed_app_protection_id import ByWindowsManagedAppProtectionIdRequest
		return ByWindowsManagedAppProtectionIdRequest(self.request_adapter, path_parameters)
