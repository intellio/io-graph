...
from iograph_models.beta.managed_mobile_app import ManagedMobileApp
from iograph_models.beta.managed_mobile_app_collection_response import ManagedMobileAppCollectionResponse


class AppsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/deviceAppManagement/defaultManagedAppProtections/{defaultManagedAppProtection%2Did}/apps", path_parameters)
