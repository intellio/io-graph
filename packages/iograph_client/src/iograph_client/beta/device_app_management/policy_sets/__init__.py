...
if TYPE_CHECKING:
	from .get_policy_sets import GetPolicySetsRequest
...
class PolicySetsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/deviceAppManagement/policySets", path_parameters)
	...
	def with_url(self, raw_url: str) -> PolicySetsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: PolicySetsRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return PolicySetsRequest(self.request_adapter, self.path_parameters)

	def by_policy_set_id(self,
		policySet_id: str,
	) -> ByPolicySetIdRequest:
		...
		from .by_policy_set_id import ByPolicySetIdRequest
		return ByPolicySetIdRequest(self.request_adapter, path_parameters)
