...
if TYPE_CHECKING:
	...
	from .by_ios_lob_app_provisioning_configuration_id import ByIosLobAppProvisioningConfigurationIdRequest
...
from iograph_models.beta.ios_lob_app_provisioning_configuration_collection_response import IosLobAppProvisioningConfigurationCollectionResponse


class IosLobAppProvisioningConfigurationsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/deviceAppManagement/iosLobAppProvisioningConfigurations", path_parameters)
	...
	def with_url(self, raw_url: str) -> IosLobAppProvisioningConfigurationsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: IosLobAppProvisioningConfigurationsRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return IosLobAppProvisioningConfigurationsRequest(self.request_adapter, self.path_parameters)

	def by_ios_lob_app_provisioning_configuration_id(self,
		iosLobAppProvisioningConfiguration_id: str,
	) -> ByIosLobAppProvisioningConfigurationIdRequest:
		...
		from .by_ios_lob_app_provisioning_configuration_id import ByIosLobAppProvisioningConfigurationIdRequest
		return ByIosLobAppProvisioningConfigurationIdRequest(self.request_adapter, path_parameters)
