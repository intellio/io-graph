...
from iograph_models.beta.managed_device_mobile_app_configuration_device_status import ManagedDeviceMobileAppConfigurationDeviceStatus
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.beta.managed_device_mobile_app_configuration_device_status_collection_response import ManagedDeviceMobileAppConfigurationDeviceStatusCollectionResponse


class DeviceStatusesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/deviceAppManagement/iosLobAppProvisioningConfigurations/{iosLobAppProvisioningConfiguration%2Did}/deviceStatuses", path_parameters)
	...
	async def post(
		self,
		body: ManagedDeviceMobileAppConfigurationDeviceStatus,
	...
	def by_managed_device_mobile_app_configuration_device_status_id(self,
		iosLobAppProvisioningConfiguration_id: str,
		managedDeviceMobileAppConfigurationDeviceStatus_id: str,
	) -> ByManagedDeviceMobileAppConfigurationDeviceStatusIdRequest:
		if iosLobAppProvisioningConfiguration_id is None:
			raise TypeError("iosLobAppProvisioningConfiguration_id cannot be null.")
		if managedDeviceMobileAppConfigurationDeviceStatus_id is None:
			raise TypeError("managedDeviceMobileAppConfigurationDeviceStatus_id cannot be null.")

		path_parameters = get_path_parameters(self.path_parameters)
		path_parameters["iosLobAppProvisioningConfiguration%2Did"] =  iosLobAppProvisioningConfiguration_id
		path_parameters["managedDeviceMobileAppConfigurationDeviceStatus%2Did"] =  managedDeviceMobileAppConfigurationDeviceStatus_id
