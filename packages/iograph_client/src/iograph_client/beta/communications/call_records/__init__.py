...
if TYPE_CHECKING:
	from .call_records_get_sms_log_with_fromdatetime_todatetime import CallRecordsGetSmsLogWithFromDateTimeToDateTimeRequest
	from .call_records_get_pstn_online_meeting_dialout_report_with_fromdatetime_todatetime import CallRecordsGetPstnOnlineMeetingDialoutReportWithFromDateTimeToDateTimeRequest
	...
	from .call_records_get_pstn_blocked_users_log_with_fromdatetime_todatetime import CallRecordsGetPstnBlockedUsersLogWithFromDateTimeToDateTimeRequest
...
class CallRecordsRequest(BaseRequestBuilder):
	...
	def call_records_get_pstn_blocked_users_log_with_fromdatetime_todatetime(self,
		fromDateTime: datetime,
		toDateTime: datetime,
	) -> CallRecordsGetPstnBlockedUsersLogWithFromDateTimeToDateTimeRequest:
		if fromDateTime is None:
			raise TypeError("fromDateTime cannot be null.")
		if toDateTime is None:
			raise TypeError("toDateTime cannot be null.")
		...
		from .call_records_get_pstn_blocked_users_log_with_fromdatetime_todatetime import CallRecordsGetPstnBlockedUsersLogWithFromDateTimeToDateTimeRequest
		return CallRecordsGetPstnBlockedUsersLogWithFromDateTimeToDateTimeRequest(self.request_adapter, path_parameters)
	...
	def call_records_get_pstn_online_meeting_dialout_report_with_fromdatetime_todatetime(self,
		fromDateTime: datetime,
		toDateTime: datetime,
	) -> CallRecordsGetPstnOnlineMeetingDialoutReportWithFromDateTimeToDateTimeRequest:
		if fromDateTime is None:
			raise TypeError("fromDateTime cannot be null.")
		if toDateTime is None:
			raise TypeError("toDateTime cannot be null.")
		...
		from .call_records_get_pstn_online_meeting_dialout_report_with_fromdatetime_todatetime import CallRecordsGetPstnOnlineMeetingDialoutReportWithFromDateTimeToDateTimeRequest
		return CallRecordsGetPstnOnlineMeetingDialoutReportWithFromDateTimeToDateTimeRequest(self.request_adapter, path_parameters)

	def call_records_get_sms_log_with_fromdatetime_todatetime(self,
		fromDateTime: datetime,
		toDateTime: datetime,
	) -> CallRecordsGetSmsLogWithFromDateTimeToDateTimeRequest:
		if fromDateTime is None:
			raise TypeError("fromDateTime cannot be null.")
		if toDateTime is None:
			raise TypeError("toDateTime cannot be null.")
		...
		from .call_records_get_sms_log_with_fromdatetime_todatetime import CallRecordsGetSmsLogWithFromDateTimeToDateTimeRequest
		return CallRecordsGetSmsLogWithFromDateTimeToDateTimeRequest(self.request_adapter, path_parameters)
