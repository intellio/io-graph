...
from iograph_models.beta.call_records_session import CallRecordsSession
from iograph_models.beta.call_records_session_collection_response import CallRecordsSessionCollectionResponse
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class SessionsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/communications/callRecords/{callRecord%2Did}/sessions", path_parameters)
	...
	async def get(
		...
		return await self.request_adapter.send_async(request_info, CallRecordsSessionCollectionResponse, error_mapping)
