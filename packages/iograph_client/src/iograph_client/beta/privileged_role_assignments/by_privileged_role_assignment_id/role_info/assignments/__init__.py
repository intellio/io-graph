...
class AssignmentsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/privilegedRoleAssignments/{privilegedRoleAssignment%2Did}/roleInfo/assignments", path_parameters)
	...
	def by_privileged_role_assignment_id1(self,
		privilegedRoleAssignment_id: str,
		privilegedRoleAssignment_id1: str,
	) -> ByPrivilegedRoleAssignmentId1Request:
		if privilegedRoleAssignment_id is None:
			raise TypeError("privilegedRoleAssignment_id cannot be null.")
		if privilegedRoleAssignment_id1 is None:
			raise TypeError("privilegedRoleAssignment_id1 cannot be null.")

		path_parameters = get_path_parameters(self.path_parameters)
		path_parameters["privilegedRoleAssignment%2Did"] =  privilegedRoleAssignment_id
		path_parameters["privilegedRoleAssignment%2Did1"] =  privilegedRoleAssignment_id1

		from .by_privileged_role_assignment_id1 import ByPrivilegedRoleAssignmentId1Request
		return ByPrivilegedRoleAssignmentId1Request(self.request_adapter, path_parameters)
