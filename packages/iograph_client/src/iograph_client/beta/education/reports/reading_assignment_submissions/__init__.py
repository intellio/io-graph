...
class ReadingAssignmentSubmissionsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/education/reports/readingAssignmentSubmissions", path_parameters)
	...
	async def post(
		self,
		body: ReadingAssignmentSubmission,
	...
	def with_url(self, raw_url: str) -> ReadingAssignmentSubmissionsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: ReadingAssignmentSubmissionsRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return ReadingAssignmentSubmissionsRequest(self.request_adapter, self.path_parameters)

	def by_reading_assignment_submission_id(self,
		readingAssignmentSubmission_id: str,
	) -> ByReadingAssignmentSubmissionIdRequest:
		if readingAssignmentSubmission_id is None:
			raise TypeError("readingAssignmentSubmission_id cannot be null.")

		path_parameters = get_path_parameters(self.path_parameters)
		path_parameters["readingAssignmentSubmission%2Did"] =  readingAssignmentSubmission_id

		from .by_reading_assignment_submission_id import ByReadingAssignmentSubmissionIdRequest
		return ByReadingAssignmentSubmissionIdRequest(self.request_adapter, path_parameters)
