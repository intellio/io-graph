...
if TYPE_CHECKING:
	from .grading_schemes import GradingSchemesRequest
...
class AssignmentSettingsRequest(BaseRequestBuilder):
	...
	def default_grading_scheme(self,
		educationClass_id: str,
	) -> DefaultGradingSchemeRequest:
		...
		from .default_grading_scheme import DefaultGradingSchemeRequest
		return DefaultGradingSchemeRequest(self.request_adapter, path_parameters)
	...
	def grading_schemes(self,
		educationClass_id: str,
	) -> GradingSchemesRequest:
		if educationClass_id is None:
			raise TypeError("educationClass_id cannot be null.")
		...
		from .grading_schemes import GradingSchemesRequest
		return GradingSchemesRequest(self.request_adapter, path_parameters)
