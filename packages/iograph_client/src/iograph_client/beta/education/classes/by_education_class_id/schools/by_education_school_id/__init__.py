...
from iograph_models.beta.education_school import EducationSchool
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class ByEducationSchoolIdRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/education/classes/{educationClass%2Did}/schools/{educationSchool%2Did}", path_parameters)
