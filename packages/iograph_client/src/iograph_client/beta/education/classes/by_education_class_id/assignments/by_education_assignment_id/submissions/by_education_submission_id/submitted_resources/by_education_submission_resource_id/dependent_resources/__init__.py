...
if TYPE_CHECKING:
	...
	from .by_education_submission_resource_id1 import ByEducationSubmissionResourceId1Request
	from ............request_adapter import HttpxRequestAdapter
from iograph_models.beta.education_submission_resource_collection_response import EducationSubmissionResourceCollectionResponse
...
class DependentResourcesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/education/classes/{educationClass%2Did}/assignments/{educationAssignment%2Did}/submissions/{educationSubmission%2Did}/submittedResources/{educationSubmissionResource%2Did}/dependentResources", path_parameters)
	...
	def by_education_submission_resource_id1(self,
		educationClass_id: str,
		educationAssignment_id: str,
		educationSubmission_id: str,
		educationSubmissionResource_id: str,
		educationSubmissionResource_id1: str,
	) -> ByEducationSubmissionResourceId1Request:
		...
		if educationSubmissionResource_id1 is None:
			raise TypeError("educationSubmissionResource_id1 cannot be null.")
		...
		path_parameters["educationSubmissionResource%2Did1"] =  educationSubmissionResource_id1

		from .by_education_submission_resource_id1 import ByEducationSubmissionResourceId1Request
		return ByEducationSubmissionResourceId1Request(self.request_adapter, path_parameters)
