...
if TYPE_CHECKING:
	...
	from .by_privileged_access_id import ByPrivilegedAccessIdRequest
	from ...request_adapter import HttpxRequestAdapter
from iograph_models.beta.privileged_access import PrivilegedAccess
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.beta.privileged_access_collection_response import PrivilegedAccessCollectionResponse


class PrivilegedAccessRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/privilegedAccess", path_parameters)
	...
	def with_url(self, raw_url: str) -> PrivilegedAccessRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: PrivilegedAccessRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return PrivilegedAccessRequest(self.request_adapter, self.path_parameters)

	def by_privileged_access_id(self,
		privilegedAccess_id: str,
	) -> ByPrivilegedAccessIdRequest:
		...
		from .by_privileged_access_id import ByPrivilegedAccessIdRequest
		return ByPrivilegedAccessIdRequest(self.request_adapter, path_parameters)
