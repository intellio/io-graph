...
from iograph_models.beta.printer_share import PrinterShare
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.beta.printer_share_collection_response import PrinterShareCollectionResponse


class PrinterSharesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/print/printerShares", path_parameters)
	...
	def with_url(self, raw_url: str) -> PrinterSharesRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: PrinterSharesRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return PrinterSharesRequest(self.request_adapter, self.path_parameters)
