...
class PrinterRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/print/printerShares/{printerShare%2Did}/printer", path_parameters)
	...
	def with_url(self, raw_url: str) -> PrinterRequest:
		"""
