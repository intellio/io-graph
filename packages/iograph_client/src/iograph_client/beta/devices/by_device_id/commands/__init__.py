...
class CommandsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/devices/{device%2Did}/commands", path_parameters)
	...
	def by_command_id(self,
		...
		from .by_command_id import ByCommandIdRequest
		return ByCommandIdRequest(self.request_adapter, path_parameters)
