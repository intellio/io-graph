...
from iograph_models.beta.home_realm_discovery_policy_collection_response import HomeRealmDiscoveryPolicyCollectionResponse
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class HomeRealmDiscoveryPoliciesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/applications/{application%2Did}/homeRealmDiscoveryPolicies", path_parameters)
	...
	async def get(
		...
		"""
		tags = ['applications.homeRealmDiscoveryPolicy']
