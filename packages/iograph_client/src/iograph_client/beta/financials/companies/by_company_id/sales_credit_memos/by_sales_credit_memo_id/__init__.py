...
from iograph_models.beta.sales_credit_memo import SalesCreditMemo
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class BySalesCreditMemoIdRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/financials/companies/{company%2Did}/salesCreditMemos/{salesCreditMemo%2Did}", path_parameters)
	...
	def with_url(self, raw_url: str) -> BySalesCreditMemoIdRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: BySalesCreditMemoIdRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return BySalesCreditMemoIdRequest(self.request_adapter, self.path_parameters)
