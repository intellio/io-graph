...
if TYPE_CHECKING:
	...
	from .by_journal_id import ByJournalIdRequest
	from ......request_adapter import HttpxRequestAdapter
from iograph_models.beta.journal import Journal
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.beta.journal_collection_response import JournalCollectionResponse


class JournalsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/financials/companies/{company%2Did}/journals", path_parameters)
	...
	def with_url(self, raw_url: str) -> JournalsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: JournalsRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return JournalsRequest(self.request_adapter, self.path_parameters)

	def by_journal_id(self,
		company_id: UUID,
		journal_id: UUID,
	) -> ByJournalIdRequest:
		...
		from .by_journal_id import ByJournalIdRequest
		return ByJournalIdRequest(self.request_adapter, path_parameters)
