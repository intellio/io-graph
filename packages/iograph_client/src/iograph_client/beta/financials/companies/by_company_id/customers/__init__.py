...
if TYPE_CHECKING:
	...
	from .by_customer_id import ByCustomerIdRequest
	from ......request_adapter import HttpxRequestAdapter
from iograph_models.beta.customer import Customer
from iograph_models.beta.customer_collection_response import CustomerCollectionResponse
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class CustomersRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/financials/companies/{company%2Did}/customers", path_parameters)
	...
	def by_customer_id(self,
		...
		from .by_customer_id import ByCustomerIdRequest
		return ByCustomerIdRequest(self.request_adapter, path_parameters)
