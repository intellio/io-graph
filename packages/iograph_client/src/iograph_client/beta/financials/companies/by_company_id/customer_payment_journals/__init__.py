...
class CustomerPaymentJournalsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/financials/companies/{company%2Did}/customerPaymentJournals", path_parameters)
	...
	def with_url(self, raw_url: str) -> CustomerPaymentJournalsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: CustomerPaymentJournalsRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return CustomerPaymentJournalsRequest(self.request_adapter, self.path_parameters)

	def by_customer_payment_journal_id(self,
		company_id: UUID,
		customerPaymentJournal_id: UUID,
	) -> ByCustomerPaymentJournalIdRequest:
		...
		from .by_customer_payment_journal_id import ByCustomerPaymentJournalIdRequest
		return ByCustomerPaymentJournalIdRequest(self.request_adapter, path_parameters)
