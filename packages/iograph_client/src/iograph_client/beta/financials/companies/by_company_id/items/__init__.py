...
if TYPE_CHECKING:
	...
	from .by_item_id import ByItemIdRequest
	from ......request_adapter import HttpxRequestAdapter
from iograph_models.beta.item_collection_response import ItemCollectionResponse
...
class ItemsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/financials/companies/{company%2Did}/items", path_parameters)
	...
	def by_item_id(self,
		...
		path_parameters["item%2Did"] =  item_id

		from .by_item_id import ByItemIdRequest
		return ByItemIdRequest(self.request_adapter, path_parameters)
