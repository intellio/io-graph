...
if TYPE_CHECKING:
	...
	from .shared_email_domain_invitations import SharedEmailDomainInvitationsRequest
	...
	from .promote_to_initial import PromoteToInitialRequest
...
class ByDomainIdRequest(BaseRequestBuilder):
	...
	def promote_to_initial(self,
		domain_id: str,
	) -> PromoteToInitialRequest:
		if domain_id is None:
			raise TypeError("domain_id cannot be null.")
		...
		from .promote_to_initial import PromoteToInitialRequest
		return PromoteToInitialRequest(self.request_adapter, path_parameters)
	...
	def shared_email_domain_invitations(self,
		domain_id: str,
	) -> SharedEmailDomainInvitationsRequest:
		if domain_id is None:
			raise TypeError("domain_id cannot be null.")
		...
		from .shared_email_domain_invitations import SharedEmailDomainInvitationsRequest
		return SharedEmailDomainInvitationsRequest(self.request_adapter, path_parameters)
