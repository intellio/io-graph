...
from iograph_models.beta.term_store_relation_collection_response import TermStoreRelationCollectionResponse


class RelationsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/termStore/groups/{group%2Did}/sets/{set%2Did}/children/{term%2Did}/children/{term%2Did1}/relations", path_parameters)
	...
	async def get(
		...
		"""
		Get relations from termStore
		To indicate which terms are related to the current term as either pinned or reused.
		"""
		tags = ['termStore.group']
