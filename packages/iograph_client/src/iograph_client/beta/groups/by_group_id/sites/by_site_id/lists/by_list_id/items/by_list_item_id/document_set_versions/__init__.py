...
from iograph_models.beta.document_set_version import DocumentSetVersion
from iograph_models.beta.document_set_version_collection_response import DocumentSetVersionCollectionResponse
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class DocumentSetVersionsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/lists/{list%2Did}/items/{listItem%2Did}/documentSetVersions", path_parameters)
