...
class LabelsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/informationProtection/policy/labels", path_parameters)
	...
	def evaluate_application(self,
		...
		from .evaluate_application import EvaluateApplicationRequest
		return EvaluateApplicationRequest(self.request_adapter, path_parameters)
	...
	def evaluate_classification_results(self,
		...
		from .evaluate_classification_results import EvaluateClassificationResultsRequest
		return EvaluateClassificationResultsRequest(self.request_adapter, path_parameters)
	...
	def evaluate_removal(self,
		...
		from .evaluate_removal import EvaluateRemovalRequest
		return EvaluateRemovalRequest(self.request_adapter, path_parameters)
	...
	def extract_label(self,
		...
		from .extract_label import ExtractLabelRequest
		return ExtractLabelRequest(self.request_adapter, path_parameters)
