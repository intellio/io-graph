...
from iograph_models.beta.term_store_set import TermStoreSet
from iograph_models.beta.term_store_set_collection_response import TermStoreSetCollectionResponse
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class SetsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStore/sets/{set%2Did}/parentGroup/sets", path_parameters)
