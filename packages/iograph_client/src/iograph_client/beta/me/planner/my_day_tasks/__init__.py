...
class MyDayTasksRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/me/planner/myDayTasks", path_parameters)
	...
	async def get(
		...
		Find more info here: https://learn.microsoft.com/graph/api/planneruser-list-mydaytasks?view=graph-rest-beta
		"""
		tags = ['me.plannerUser']
	...
	def with_url(self, raw_url: str) -> MyDayTasksRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: MyDayTasksRequest
		"""
		if raw_url is None:
