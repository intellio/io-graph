...
class CalendarsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/me/calendars", path_parameters)
	...
	async def get(
		...
		Find more info here: https://learn.microsoft.com/graph/api/user-list-calendars?view=graph-rest-beta
		"""
		tags = ['me.calendar']
	...
	async def post(
		...
		Find more info here: https://learn.microsoft.com/graph/api/user-post-calendars?view=graph-rest-beta
		"""
		tags = ['me.calendar']
