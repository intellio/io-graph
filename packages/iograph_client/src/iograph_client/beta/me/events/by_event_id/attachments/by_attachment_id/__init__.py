...
class ByAttachmentIdRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/me/events/{event%2Did}/attachments/{attachment%2Did}", path_parameters)
	...
	async def get(
		...
		Find more info here: https://learn.microsoft.com/graph/api/attachment-get?view=graph-rest-beta
		"""
		tags = ['me.event']
	...
	async def delete(
		...
		Find more info here: https://learn.microsoft.com/graph/api/attachment-delete?view=graph-rest-beta
		"""
		tags = ['me.event']
