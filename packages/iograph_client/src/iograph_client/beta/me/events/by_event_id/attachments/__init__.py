...
class AttachmentsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/me/events/{event%2Did}/attachments", path_parameters)
	...
	async def get(
		...
		Find more info here: https://learn.microsoft.com/graph/api/event-list-attachments?view=graph-rest-beta
		"""
		tags = ['me.event']
	...
	async def post(
		...
		Find more info here: https://learn.microsoft.com/graph/api/event-post-attachments?view=graph-rest-beta
		"""
		tags = ['me.event']
