...
class InstancesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/me/events/{event%2Did}/instances", path_parameters)
...
occurrences and exceptions of the event in the specified time range.
		Find more info here: https://learn.microsoft.com/graph/api/event-list-instances?view=graph-rest-beta
		"""
		tags = ['me.event']
