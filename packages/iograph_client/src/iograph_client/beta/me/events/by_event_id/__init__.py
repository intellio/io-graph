...
class ByEventIdRequest(BaseRequestBuilder):
	...
	async def get(
		...
		Find more info here: https://learn.microsoft.com/graph/api/event-get?view=graph-rest-beta
		"""
		tags = ['me.event']
	...
	async def patch(
		...
		Find more info here: https://learn.microsoft.com/graph/api/event-update?view=graph-rest-beta
		"""
		tags = ['me.event']
	...
	async def delete(
		...
		Find more info here: https://learn.microsoft.com/graph/api/event-delete?view=graph-rest-beta
		"""
		tags = ['me.event']
