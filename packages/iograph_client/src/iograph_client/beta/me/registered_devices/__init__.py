...
class RegisteredDevicesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/me/registeredDevices", path_parameters)
	...
	async def get(
		...
		Find more info here: https://learn.microsoft.com/graph/api/user-list-registereddevices?view=graph-rest-beta
		"""
