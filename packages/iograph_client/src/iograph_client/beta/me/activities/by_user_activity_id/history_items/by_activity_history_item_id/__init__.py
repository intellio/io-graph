...
class ByActivityHistoryItemIdRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/me/activities/{userActivity%2Did}/historyItems/{activityHistoryItem%2Did}", path_parameters)
	...
	async def patch(
		...
		Find more info here: https://learn.microsoft.com/graph/api/projectrome-delete-historyitem?view=graph-rest-beta
		"""
		tags = ['me.userActivity']
	...
	def with_url(self, raw_url: str) -> ByActivityHistoryItemIdRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: ByActivityHistoryItemIdRequest
		"""
		if raw_url is None:
