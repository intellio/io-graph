...
from iograph_models.beta.attachment_base import AttachmentBase
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class ByAttachmentBaseIdRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/me/todo/lists/{todoTaskList%2Did}/tasks/{todoTask%2Did}/attachments/{attachmentBase%2Did}", path_parameters)
	...
	async def get(
		...
		Find more info here: https://learn.microsoft.com/graph/api/taskfileattachment-get?view=graph-rest-beta
		"""
		tags = ['me.todo']
	...
	async def delete(
		...
		Find more info here: https://learn.microsoft.com/graph/api/taskfileattachment-delete?view=graph-rest-beta
		"""
		tags = ['me.todo']
