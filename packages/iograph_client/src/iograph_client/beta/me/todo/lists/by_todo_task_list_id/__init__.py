...
class ByTodoTaskListIdRequest(BaseRequestBuilder):
	...
	async def get(
		...
		Find more info here: https://learn.microsoft.com/graph/api/todotasklist-get?view=graph-rest-beta
		"""
		tags = ['me.todo']
	...
	async def patch(
		...
		Find more info here: https://learn.microsoft.com/graph/api/todotasklist-update?view=graph-rest-beta
		"""
		tags = ['me.todo']
	...
	async def delete(
		...
		Find more info here: https://learn.microsoft.com/graph/api/todotasklist-delete?view=graph-rest-beta
		"""
		tags = ['me.todo']
