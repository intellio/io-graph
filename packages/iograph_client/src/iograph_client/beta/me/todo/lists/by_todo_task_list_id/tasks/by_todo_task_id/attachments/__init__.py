...
from iograph_models.beta.attachment_base_collection_response import AttachmentBaseCollectionResponse
...
class AttachmentsRequest(BaseRequestBuilder):
	...
	async def get(
		...
		Find more info here: https://learn.microsoft.com/graph/api/todotask-list-attachments?view=graph-rest-beta
		"""
		tags = ['me.todo']
	...
	async def post(
		...
		Find more info here: https://learn.microsoft.com/graph/api/todotask-post-attachments?view=graph-rest-beta
		"""
		tags = ['me.todo']
