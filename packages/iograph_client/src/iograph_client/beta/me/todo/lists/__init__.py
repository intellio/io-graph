...
from iograph_models.beta.todo_task_list_collection_response import TodoTaskListCollectionResponse


class ListsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/me/todo/lists", path_parameters)
	...
	async def get(
		...
		Find more info here: https://learn.microsoft.com/graph/api/todo-list-lists?view=graph-rest-beta
		"""
		tags = ['me.todo']
	...
	async def post(
		...
		Find more info here: https://learn.microsoft.com/graph/api/todo-post-lists?view=graph-rest-beta
		"""
		tags = ['me.todo']
