...
class TasksRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/me/todo/lists/{todoTaskList%2Did}/tasks", path_parameters)
	...
	async def get(
		...
		Find more info here: https://learn.microsoft.com/graph/api/todotasklist-list-tasks?view=graph-rest-beta
		"""
		tags = ['me.todo']
	...
	async def post(
		...
		Find more info here: https://learn.microsoft.com/graph/api/todotasklist-post-tasks?view=graph-rest-beta
		"""
		tags = ['me.todo']
