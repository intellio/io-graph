...
from iograph_models.beta.linked_resource_collection_response import LinkedResourceCollectionResponse
...
class LinkedResourcesRequest(BaseRequestBuilder):
	...
	async def get(
		...
		Find more info here: https://learn.microsoft.com/graph/api/todotask-list-linkedresources?view=graph-rest-beta
		"""
		tags = ['me.todo']
	...
	async def post(
		...
		Find more info here: https://learn.microsoft.com/graph/api/todotask-post-linkedresources?view=graph-rest-beta
		"""
		tags = ['me.todo']
