...
if TYPE_CHECKING:
	...
	from .mark_as_not_junk import MarkAsNotJunkRequest
	from .mark_as_junk import MarkAsJunkRequest
	...
	from .mentions import MentionsRequest
...
navigation property to get the associated event in an attendee's calendar.
		Find more info here: https://learn.microsoft.com/graph/api/eventmessage-get?view=graph-rest-beta
		"""
		tags = ['me.message']
	...
	async def patch(
		...
		Find more info here: https://learn.microsoft.com/graph/api/eventmessage-update?view=graph-rest-beta
		"""
		tags = ['me.message']
	...
	async def delete(
		...
		Find more info here: https://learn.microsoft.com/graph/api/message-delete?view=graph-rest-beta
		"""
		tags = ['me.message']
	...
	def mentions(self,
		...
		from .mentions import MentionsRequest
		return MentionsRequest(self.request_adapter, path_parameters)
	...
	def mark_as_junk(self,
		...
		from .mark_as_junk import MarkAsJunkRequest
		return MarkAsJunkRequest(self.request_adapter, path_parameters)

	def mark_as_not_junk(self,
		message_id: str,
	) -> MarkAsNotJunkRequest:
		if message_id is None:
			raise TypeError("message_id cannot be null.")
		...
		from .mark_as_not_junk import MarkAsNotJunkRequest
		return MarkAsNotJunkRequest(self.request_adapter, path_parameters)
	...
	def unsubscribe(self,
		...
		from .unsubscribe import UnsubscribeRequest
		return UnsubscribeRequest(self.request_adapter, path_parameters)
