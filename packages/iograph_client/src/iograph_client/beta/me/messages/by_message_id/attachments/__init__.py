...
class AttachmentsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/me/messages/{message%2Did}/attachments", path_parameters)
	...
	async def get(
		...
		Find more info here: https://learn.microsoft.com/graph/api/eventmessage-list-attachments?view=graph-rest-beta
		"""
		tags = ['me.message']
...
message that is being drafted, or created and sent on the fly.
		Find more info here: https://learn.microsoft.com/graph/api/message-post-attachments?view=graph-rest-beta
		"""
		tags = ['me.message']
