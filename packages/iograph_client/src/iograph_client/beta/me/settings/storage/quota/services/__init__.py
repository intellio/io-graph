...
from iograph_models.beta.service_storage_quota_breakdown_collection_response import ServiceStorageQuotaBreakdownCollectionResponse
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class ServicesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/me/settings/storage/quota/services", path_parameters)
	...
	async def get(
		...
		Find more info here: https://learn.microsoft.com/graph/api/unifiedstoragequota-list-services?view=graph-rest-beta
		"""
