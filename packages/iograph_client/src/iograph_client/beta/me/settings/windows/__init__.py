...
from iograph_models.beta.windows_setting_collection_response import WindowsSettingCollectionResponse
from iograph_models.beta.windows_setting import WindowsSetting
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class WindowsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/me/settings/windows", path_parameters)
	...
	async def get(
		...
		Find more info here: https://learn.microsoft.com/graph/api/usersettings-list-windows?view=graph-rest-beta
		"""
