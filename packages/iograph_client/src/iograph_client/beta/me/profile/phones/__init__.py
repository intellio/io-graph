...
class PhonesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/me/profile/phones", path_parameters)
	...
	async def get(
		...
		Find more info here: https://learn.microsoft.com/graph/api/profile-list-phones?view=graph-rest-beta
		"""
		tags = ['me.profile']
	...
	async def post(
		...
		Find more info here: https://learn.microsoft.com/graph/api/profile-post-phones?view=graph-rest-beta
		"""
		tags = ['me.profile']
	...
	def with_url(self, raw_url: str) -> PhonesRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: PhonesRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return PhonesRequest(self.request_adapter, self.path_parameters)

	def by_item_phone_id(self,
		itemPhone_id: str,
	) -> ByItemPhoneIdRequest:
		if itemPhone_id is None:
			raise TypeError("itemPhone_id cannot be null.")

		path_parameters = get_path_parameters(self.path_parameters)
		path_parameters["itemPhone%2Did"] =  itemPhone_id

		from .by_item_phone_id import ByItemPhoneIdRequest
		return ByItemPhoneIdRequest(self.request_adapter, path_parameters)
