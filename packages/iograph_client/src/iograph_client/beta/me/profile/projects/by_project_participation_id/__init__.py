...
class ByProjectParticipationIdRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/me/profile/projects/{projectParticipation%2Did}", path_parameters)
	...
	async def get(
		...
		Find more info here: https://learn.microsoft.com/graph/api/projectparticipation-get?view=graph-rest-beta
		"""
		tags = ['me.profile']
	...
	async def patch(
		...
		Find more info here: https://learn.microsoft.com/graph/api/projectparticipation-update?view=graph-rest-beta
		"""
		tags = ['me.profile']
	...
	async def delete(
		...
		Find more info here: https://learn.microsoft.com/graph/api/projectparticipation-delete?view=graph-rest-beta
		"""
		tags = ['me.profile']
