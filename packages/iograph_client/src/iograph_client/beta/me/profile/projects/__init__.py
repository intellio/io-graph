...
class ProjectsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/me/profile/projects", path_parameters)
	...
	async def get(
		...
		Find more info here: https://learn.microsoft.com/graph/api/profile-list-projects?view=graph-rest-beta
		"""
		tags = ['me.profile']
	...
	async def post(
		...
		Find more info here: https://learn.microsoft.com/graph/api/profile-post-projects?view=graph-rest-beta
		"""
		tags = ['me.profile']
