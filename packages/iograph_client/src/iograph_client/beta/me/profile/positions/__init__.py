...
class PositionsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/me/profile/positions", path_parameters)
	...
	async def get(
		...
		Find more info here: https://learn.microsoft.com/graph/api/profile-list-positions?view=graph-rest-beta
		"""
		tags = ['me.profile']
	...
	async def post(
		...
		Find more info here: https://learn.microsoft.com/graph/api/profile-post-positions?view=graph-rest-beta
		"""
		tags = ['me.profile']
	...
	def with_url(self, raw_url: str) -> PositionsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: PositionsRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return PositionsRequest(self.request_adapter, self.path_parameters)

	def by_work_position_id(self,
		workPosition_id: str,
	) -> ByWorkPositionIdRequest:
		if workPosition_id is None:
			raise TypeError("workPosition_id cannot be null.")

		path_parameters = get_path_parameters(self.path_parameters)
		path_parameters["workPosition%2Did"] =  workPosition_id

		from .by_work_position_id import ByWorkPositionIdRequest
		return ByWorkPositionIdRequest(self.request_adapter, path_parameters)
