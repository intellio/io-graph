...
class InformationProtectionRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/me/security/informationProtection", path_parameters)

	async def get(
		self,
		request_configuration: Optional[RequestConfiguration[GetQueryParams]] = None,
	) -> SecurityInformationProtection:
		"""
		...
		return await self.request_adapter.send_async(request_info, SecurityInformationProtection, error_mapping)

	async def patch(
		self,
		body: SecurityInformationProtection,
	...
	@property
	def label_policy_settings(self,
	) -> LabelPolicySettingsRequest:
		from .label_policy_settings import LabelPolicySettingsRequest
