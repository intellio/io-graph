...
class RegistrationRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/me/onlineMeetings/{onlineMeeting%2Did}/registration", path_parameters)
	...
	async def get(
		...
		Find more info here: https://learn.microsoft.com/graph/api/externalmeetingregistration-get?view=graph-rest-beta
		"""
	...
	async def patch(
		...
		Find more info here: https://learn.microsoft.com/graph/api/meetingregistration-update?view=graph-rest-beta
		"""
		tags = ['me.onlineMeeting']
	...
	async def delete(
		...
		Find more info here: https://learn.microsoft.com/graph/api/externalmeetingregistration-delete?view=graph-rest-beta
		"""
		tags = ['me.onlineMeeting']
