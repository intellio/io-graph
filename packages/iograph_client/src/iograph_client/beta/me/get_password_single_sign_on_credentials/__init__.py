...
from iograph_models.beta.get_password_single_sign_on_credentials_response import GetPasswordSingleSignOnCredentialsResponse
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class GetPasswordSingleSignOnCredentialsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/me/getPasswordSingleSignOnCredentials", path_parameters)
	...
	async def post(
		...
		return await self.request_adapter.send_async(request_info, GetPasswordSingleSignOnCredentialsResponse, error_mapping)
