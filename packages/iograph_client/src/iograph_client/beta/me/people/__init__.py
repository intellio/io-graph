...
if TYPE_CHECKING:
	...
	from .by_person_id import ByPersonIdRequest
	from ....request_adapter import HttpxRequestAdapter
from iograph_models.beta.person_collection_response import PersonCollectionResponse
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class PeopleRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/me/people", path_parameters)
	...
	async def get(
		...
		Find more info here: https://learn.microsoft.com/graph/api/user-list-people?view=graph-rest-beta
		"""
		tags = ['me.person']
	...
	def by_person_id(self,
		...
		path_parameters["person%2Did"] =  person_id

		from .by_person_id import ByPersonIdRequest
		return ByPersonIdRequest(self.request_adapter, path_parameters)
