...
class ByCalendarGroupIdRequest(BaseRequestBuilder):
	...
	async def get(
		...
		Find more info here: https://learn.microsoft.com/graph/api/calendargroup-get?view=graph-rest-beta
		"""
	...
	async def patch(
		...
		Find more info here: https://learn.microsoft.com/graph/api/calendargroup-update?view=graph-rest-beta
		"""
		tags = ['me.calendarGroup']
	...
	async def delete(
		...
		Find more info here: https://learn.microsoft.com/graph/api/calendargroup-delete?view=graph-rest-beta
		"""
		tags = ['me.calendarGroup']
