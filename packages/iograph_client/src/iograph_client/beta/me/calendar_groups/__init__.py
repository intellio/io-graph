...
from iograph_models.beta.calendar_group import CalendarGroup
from iograph_models.beta.calendar_group_collection_response import CalendarGroupCollectionResponse
...
class CalendarGroupsRequest(BaseRequestBuilder):
	...
	async def get(
		...
		Find more info here: https://learn.microsoft.com/graph/api/user-list-calendargroups?view=graph-rest-beta
		"""
	...
	async def post(
		...
		Find more info here: https://learn.microsoft.com/graph/api/user-post-calendargroups?view=graph-rest-beta
		"""
		tags = ['me.calendarGroup']
