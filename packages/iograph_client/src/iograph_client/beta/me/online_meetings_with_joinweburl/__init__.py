...
class OnlineMeetingsWithJoinWebUrlRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/me/onlineMeetings(joinWebUrl='{joinWebUrl}')", path_parameters)
	...
	async def patch(
		...
		Find more info here: https://learn.microsoft.com/graph/api/onlinemeeting-update?view=graph-rest-beta
		"""
		tags = ['me.onlineMeeting']
	...
	async def delete(
		...
		Find more info here: https://learn.microsoft.com/graph/api/onlinemeeting-delete?view=graph-rest-beta
		"""
		tags = ['me.onlineMeeting']
