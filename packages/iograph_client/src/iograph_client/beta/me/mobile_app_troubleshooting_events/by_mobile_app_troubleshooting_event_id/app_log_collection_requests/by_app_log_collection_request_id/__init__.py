...
class ByAppLogCollectionRequestIdRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/me/mobileAppTroubleshootingEvents/{mobileAppTroubleshootingEvent%2Did}/appLogCollectionRequests/{appLogCollectionRequest%2Did}", path_parameters)
	...
	async def get(
		...
		"""
		Get appLogCollectionRequests from me
	...
	def with_url(self, raw_url: str) -> ByAppLogCollectionRequestIdRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: ByAppLogCollectionRequestIdRequest
		"""
		if raw_url is None:
