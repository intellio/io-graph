...
from iograph_models.beta.software_oath_authentication_method import SoftwareOathAuthenticationMethod


class BySoftwareOathAuthenticationMethodIdRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/me/authentication/softwareOathMethods/{softwareOathAuthenticationMethod%2Did}", path_parameters)
	...
	async def get(
		...
		Find more info here: https://learn.microsoft.com/graph/api/softwareoathauthenticationmethod-get?view=graph-rest-beta
		"""
