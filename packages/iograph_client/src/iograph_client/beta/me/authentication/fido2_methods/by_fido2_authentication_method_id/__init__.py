...
from iograph_models.beta.fido2_authentication_method import Fido2AuthenticationMethod


class ByFido2AuthenticationMethodIdRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/me/authentication/fido2Methods/{fido2AuthenticationMethod%2Did}", path_parameters)
	...
	async def get(
		...
		Find more info here: https://learn.microsoft.com/graph/api/fido2authenticationmethod-get?view=graph-rest-beta
		"""
