...
from iograph_models.beta.windows_hello_for_business_authentication_method_collection_response import WindowsHelloForBusinessAuthenticationMethodCollectionResponse
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class WindowsHelloForBusinessMethodsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/me/authentication/windowsHelloForBusinessMethods", path_parameters)
