...
class TasksRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/me/outlook/tasks", path_parameters)
...
different than UTC. See an example for getting a single task. You can apply the header similarly to get multiple tasks.
		Find more info here: https://learn.microsoft.com/graph/api/outlookuser-list-tasks?view=graph-rest-beta
		"""
		tags = ['me.outlookUser']
...
You can use the Prefer: outlook.timezone header to have all the date-related properties in the response represented in a time zone 
different than UTC.
		Find more info here: https://learn.microsoft.com/graph/api/outlookuser-post-tasks?view=graph-rest-beta
		"""
		tags = ['me.outlookUser']
