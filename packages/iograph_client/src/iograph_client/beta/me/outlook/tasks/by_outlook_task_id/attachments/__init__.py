...
class AttachmentsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/me/outlook/tasks/{outlookTask%2Did}/attachments", path_parameters)
	...
	async def post(
		...
		Find more info here: https://learn.microsoft.com/graph/api/outlooktask-post-attachments?view=graph-rest-beta
		"""
		tags = ['me.outlookUser']
