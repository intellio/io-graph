...
from iograph_models.beta.outlook_category_collection_response import OutlookCategoryCollectionResponse
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.beta.outlook_category import OutlookCategory
...
class MasterCategoriesRequest(BaseRequestBuilder):
	...
	async def get(
		...
		Find more info here: https://learn.microsoft.com/graph/api/outlookuser-list-mastercategories?view=graph-rest-beta
		"""
		tags = ['me.outlookUser']
	...
	async def post(
		...
		Find more info here: https://learn.microsoft.com/graph/api/outlookuser-post-mastercategories?view=graph-rest-beta
		"""
		tags = ['me.outlookUser']
