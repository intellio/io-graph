...
class ByOutlookCategoryIdRequest(BaseRequestBuilder):
	...
	async def get(
		...
		Find more info here: https://learn.microsoft.com/graph/api/outlookcategory-get?view=graph-rest-beta
		"""
		tags = ['me.outlookUser']
	...
	async def patch(
		...
		Find more info here: https://learn.microsoft.com/graph/api/outlookcategory-update?view=graph-rest-beta
		"""
		tags = ['me.outlookUser']
	...
	async def delete(
		...
		Find more info here: https://learn.microsoft.com/graph/api/outlookcategory-delete?view=graph-rest-beta
		"""
		tags = ['me.outlookUser']
