...
class ByOnenotePageIdRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/me/onenote/pages/{onenotePage%2Did}", path_parameters)
	...
	async def delete(
		...
		Find more info here: https://learn.microsoft.com/graph/api/page-delete?view=graph-rest-beta
		"""
		tags = ['me.onenote']
