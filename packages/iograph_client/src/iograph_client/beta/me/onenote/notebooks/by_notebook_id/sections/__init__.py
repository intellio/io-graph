...
class SectionsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/me/onenote/notebooks/{notebook%2Did}/sections", path_parameters)
	...
	async def get(
		...
		Find more info here: https://learn.microsoft.com/graph/api/notebook-list-sections?view=graph-rest-beta
		"""
		tags = ['me.onenote']
	...
	async def post(
		...
		Find more info here: https://learn.microsoft.com/graph/api/notebook-post-sections?view=graph-rest-beta
		"""
		tags = ['me.onenote']
