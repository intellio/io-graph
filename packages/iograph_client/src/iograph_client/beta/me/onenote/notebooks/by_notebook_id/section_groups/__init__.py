...
class SectionGroupsRequest(BaseRequestBuilder):
	...
	async def get(
		...
		Find more info here: https://learn.microsoft.com/graph/api/notebook-list-sectiongroups?view=graph-rest-beta
		"""
		tags = ['me.onenote']
	...
	async def post(
		...
		Find more info here: https://learn.microsoft.com/graph/api/notebook-post-sectiongroups?view=graph-rest-beta
		"""
		tags = ['me.onenote']
