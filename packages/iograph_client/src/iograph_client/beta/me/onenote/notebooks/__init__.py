...
class NotebooksRequest(BaseRequestBuilder):
	...
	async def get(
		...
		Find more info here: https://learn.microsoft.com/graph/api/onenote-list-notebooks?view=graph-rest-beta
		"""
		tags = ['me.onenote']
	...
	async def post(
		...
		Find more info here: https://learn.microsoft.com/graph/api/onenote-post-notebooks?view=graph-rest-beta
		"""
		tags = ['me.onenote']
