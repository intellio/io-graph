...
class ContactFoldersRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/me/contactFolders", path_parameters)
	...
	async def get(
		...
		Find more info here: https://learn.microsoft.com/graph/api/user-list-contactfolders?view=graph-rest-beta
		"""
	...
	async def post(
		...
		Find more info here: https://learn.microsoft.com/graph/api/user-post-contactfolders?view=graph-rest-beta
		"""
		tags = ['me.contactFolder']
