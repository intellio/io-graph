...
class ContactsRequest(BaseRequestBuilder):
	...
	async def get(
		...
		Find more info here: https://learn.microsoft.com/graph/api/contactfolder-list-contacts?view=graph-rest-beta
		"""
	...
	async def post(
		...
		Find more info here: https://learn.microsoft.com/graph/api/contactfolder-post-contacts?view=graph-rest-beta
		"""
		tags = ['me.contactFolder']
