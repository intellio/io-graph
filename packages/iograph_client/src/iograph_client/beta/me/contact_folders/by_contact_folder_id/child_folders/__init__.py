...
from iograph_models.beta.contact_folder_collection_response import ContactFolderCollectionResponse
...
class ChildFoldersRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/me/contactFolders/{contactFolder%2Did}/childFolders", path_parameters)
	...
	async def get(
		...
		Find more info here: https://learn.microsoft.com/graph/api/contactfolder-list-childfolders?view=graph-rest-beta
		"""
	...
	async def post(
		...
		Find more info here: https://learn.microsoft.com/graph/api/contactfolder-post-childfolders?view=graph-rest-beta
		"""
		tags = ['me.contactFolder']
