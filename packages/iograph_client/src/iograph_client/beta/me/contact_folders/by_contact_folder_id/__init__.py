...
class ByContactFolderIdRequest(BaseRequestBuilder):
	...
	async def get(
		...
		Find more info here: https://learn.microsoft.com/graph/api/contactfolder-get?view=graph-rest-beta
		"""
	...
	async def patch(
		...
		Find more info here: https://learn.microsoft.com/graph/api/contactfolder-update?view=graph-rest-beta
		"""
		tags = ['me.contactFolder']
	...
	async def delete(
		...
		Find more info here: https://learn.microsoft.com/graph/api/contactfolder-delete?view=graph-rest-beta
		"""
		tags = ['me.contactFolder']
