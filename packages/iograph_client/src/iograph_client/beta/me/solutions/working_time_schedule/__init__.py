...
from iograph_models.beta.working_time_schedule import WorkingTimeSchedule
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class WorkingTimeScheduleRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/me/solutions/workingTimeSchedule", path_parameters)
