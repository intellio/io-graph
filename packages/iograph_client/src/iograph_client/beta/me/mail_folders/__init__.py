...
class MailFoldersRequest(BaseRequestBuilder):
	...
	async def get(
		...
		Find more info here: https://learn.microsoft.com/graph/api/user-list-mailfolders?view=graph-rest-beta
		"""
		tags = ['me.mailFolder']
	...
	async def post(
		...
		Find more info here: https://learn.microsoft.com/graph/api/user-post-mailfolders?view=graph-rest-beta
		"""
		tags = ['me.mailFolder']
