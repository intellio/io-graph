...
class MessagesRequest(BaseRequestBuilder):
	...
	async def get(
		...
		Find more info here: https://learn.microsoft.com/graph/api/mailfolder-list-messages?view=graph-rest-beta
		"""
		tags = ['me.mailFolder']
	...
	async def post(
		...
		Find more info here: https://learn.microsoft.com/graph/api/mailfolder-post-messages?view=graph-rest-beta
		"""
		tags = ['me.mailFolder']
