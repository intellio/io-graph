...
folder collection and navigate to another folder. By default, this operation does not return hidden folders. Use a query parameter includeHiddenFolders to include them in the response.
		Find more info here: https://learn.microsoft.com/graph/api/mailfolder-list-childfolders?view=graph-rest-beta
		"""
		tags = ['me.mailFolder']
	...
	async def post(
		...
		Find more info here: https://learn.microsoft.com/graph/api/mailsearchfolder-post?view=graph-rest-beta
		"""
		tags = ['me.mailFolder']
