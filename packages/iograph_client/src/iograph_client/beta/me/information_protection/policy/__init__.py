...
from iograph_models.beta.information_protection_policy import InformationProtectionPolicy
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class PolicyRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/me/informationProtection/policy", path_parameters)
	...
	async def patch(
		self,
		body: InformationProtectionPolicy,
