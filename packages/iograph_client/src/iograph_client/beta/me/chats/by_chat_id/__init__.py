...
if TYPE_CHECKING:
	...
	from .remove_all_access_for_user import RemoveAllAccessForUserRequest
...
class ByChatIdRequest(BaseRequestBuilder):
	...
	def remove_all_access_for_user(self,
		chat_id: str,
	) -> RemoveAllAccessForUserRequest:
		if chat_id is None:
			raise TypeError("chat_id cannot be null.")
		...
		from .remove_all_access_for_user import RemoveAllAccessForUserRequest
		return RemoveAllAccessForUserRequest(self.request_adapter, path_parameters)
