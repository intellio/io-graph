...
class ByContactIdRequest(BaseRequestBuilder):
	...
	async def get(
		...
		Find more info here: https://learn.microsoft.com/graph/api/contact-get?view=graph-rest-beta
		"""
		tags = ['me.contact']
	...
	async def patch(
		...
		Find more info here: https://learn.microsoft.com/graph/api/contact-update?view=graph-rest-beta
		"""
		tags = ['me.contact']
	...
	async def delete(
		...
		Delete contact
		Delete contact.
		Find more info here: https://learn.microsoft.com/graph/api/contact-delete?view=graph-rest-beta
		"""
		tags = ['me.contact']
