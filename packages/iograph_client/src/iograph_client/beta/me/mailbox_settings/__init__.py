...
class MailboxSettingsRequest(BaseRequestBuilder):
	...
	async def get(
		...
		Find more info here: https://learn.microsoft.com/graph/api/user-get-mailboxsettings?view=graph-rest-beta
		"""
	...
	async def patch(
		...
		Find more info here: https://learn.microsoft.com/graph/api/user-update-mailboxsettings?view=graph-rest-beta
		"""
		tags = ['me.mailboxSettings']
