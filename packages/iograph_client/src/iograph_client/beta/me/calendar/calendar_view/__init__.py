...
class CalendarViewRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/me/calendar/calendarView", path_parameters)
...
from a user's default calendar (../me/calendarView) or some other calendar of the user's.
		Find more info here: https://learn.microsoft.com/graph/api/calendar-list-calendarview?view=graph-rest-beta
		"""
		tags = ['me.calendar']
