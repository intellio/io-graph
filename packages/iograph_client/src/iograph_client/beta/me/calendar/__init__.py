...
or the default calendar of a Microsoft 365 group. There are two scenarios where an app can get another user's calendar:
		Find more info here: https://learn.microsoft.com/graph/api/calendar-get?view=graph-rest-beta
		"""
		tags = ['me.calendar']
...
or the default calendar of a Microsoft 365 group.
		Find more info here: https://learn.microsoft.com/graph/api/calendar-update?view=graph-rest-beta
		"""
		tags = ['me.calendar']
