...
from iograph_models.beta.microsoft_application_data_access_settings import MicrosoftApplicationDataAccessSettings


class MicrosoftApplicationDataAccessRequest(BaseRequestBuilder):
	...
	async def patch(
		self,
		body: MicrosoftApplicationDataAccessSettings,
	...
	def with_url(self, raw_url: str) -> MicrosoftApplicationDataAccessRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: MicrosoftApplicationDataAccessRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return MicrosoftApplicationDataAccessRequest(self.request_adapter, self.path_parameters)
