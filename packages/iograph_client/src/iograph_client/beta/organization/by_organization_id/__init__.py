...
if TYPE_CHECKING:
	...
	from .partner_information import PartnerInformationRequest
...
from iograph_models.beta.organization import Organization
...
class ByOrganizationIdRequest(BaseRequestBuilder):
	...
	def partner_information(self,
		...
		from .partner_information import PartnerInformationRequest
		return PartnerInformationRequest(self.request_adapter, path_parameters)
