...
class MessageTracesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/messageTraces", path_parameters)
	...
	async def get(
		...
		"""
		tags = ['messageTraces.messageTrace']
	...
	def with_url(self, raw_url: str) -> MessageTracesRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: MessageTracesRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return MessageTracesRequest(self.request_adapter, self.path_parameters)

	def by_message_trace_id(self,
		messageTrace_id: str,
	) -> ByMessageTraceIdRequest:
		...
		from .by_message_trace_id import ByMessageTraceIdRequest
		return ByMessageTraceIdRequest(self.request_adapter, path_parameters)
