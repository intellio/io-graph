...
from iograph_models.beta.unified_role_eligibility_schedule_instance_collection_response import UnifiedRoleEligibilityScheduleInstanceCollectionResponse
from iograph_models.beta.unified_role_eligibility_schedule_instance import UnifiedRoleEligibilityScheduleInstance
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class RoleEligibilityScheduleInstancesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/roleManagement/enterpriseApps/{rbacApplication%2Did}/roleEligibilityScheduleInstances", path_parameters)
