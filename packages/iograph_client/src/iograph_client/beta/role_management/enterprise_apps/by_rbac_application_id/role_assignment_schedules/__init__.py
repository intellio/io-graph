...
from iograph_models.beta.unified_role_assignment_schedule import UnifiedRoleAssignmentSchedule
from iograph_models.beta.unified_role_assignment_schedule_collection_response import UnifiedRoleAssignmentScheduleCollectionResponse
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class RoleAssignmentSchedulesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/roleManagement/enterpriseApps/{rbacApplication%2Did}/roleAssignmentSchedules", path_parameters)
	...
	def with_url(self, raw_url: str) -> RoleAssignmentSchedulesRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: RoleAssignmentSchedulesRequest
		"""
		if raw_url is None:
