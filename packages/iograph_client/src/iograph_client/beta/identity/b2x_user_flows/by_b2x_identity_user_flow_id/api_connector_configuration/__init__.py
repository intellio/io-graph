...
if TYPE_CHECKING:
	from .pre_token_issuance import PreTokenIssuanceRequest
...
from iograph_models.beta.user_flow_api_connector_configuration import UserFlowApiConnectorConfiguration
...
class ApiConnectorConfigurationRequest(BaseRequestBuilder):
	...
	def pre_token_issuance(self,
		b2xIdentityUserFlow_id: str,
	) -> PreTokenIssuanceRequest:
		if b2xIdentityUserFlow_id is None:
			raise TypeError("b2xIdentityUserFlow_id cannot be null.")
		...
		from .pre_token_issuance import PreTokenIssuanceRequest
		return PreTokenIssuanceRequest(self.request_adapter, path_parameters)
