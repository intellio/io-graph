...
if TYPE_CHECKING:
	from .user_flows import UserFlowsRequest
	from .user_flow_attributes import UserFlowAttributesRequest
	from .product_changes import ProductChangesRequest
	...
	from .continuous_access_evaluation_policy import ContinuousAccessEvaluationPolicyRequest
	from .conditional_access import ConditionalAccessRequest
	from .b2x_user_flows import B2xUserFlowsRequest
	from .b2c_user_flows import B2cUserFlowsRequest
...
from iograph_models.beta.identity_container import IdentityContainer
...
class IdentityRequest(BaseRequestBuilder):
	...
	@property
	def continuous_access_evaluation_policy(self,
	) -> ContinuousAccessEvaluationPolicyRequest:
		from .continuous_access_evaluation_policy import ContinuousAccessEvaluationPolicyRequest
		return ContinuousAccessEvaluationPolicyRequest(self.request_adapter, self.path_parameters)
