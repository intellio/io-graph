...
class CustodiansRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/custodians", path_parameters)
	...
	def by_custodian_id(self,
		case_id: str,
		custodian_id: str,
	) -> ByCustodianIdRequest:
		if case_id is None:
		...
		from .by_custodian_id import ByCustodianIdRequest
		return ByCustodianIdRequest(self.request_adapter, path_parameters)
