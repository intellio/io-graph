...
if TYPE_CHECKING:
	...
	from .by_tag_id1 import ByTagId1Request
...
class ChildTagsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/tags/{tag%2Did}/childTags", path_parameters)
	...
	def by_tag_id1(self,
		...
		path_parameters["tag%2Did1"] =  tag_id1

		from .by_tag_id1 import ByTagId1Request
		return ByTagId1Request(self.request_adapter, path_parameters)
