...
from iograph_models.beta.ediscovery_export_post_request import Ediscovery_exportPostRequest
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class EdiscoveryExportRequest(BaseRequestBuilder):
	...
	async def post(
		self,
		body: Ediscovery_exportPostRequest,
	...
	def with_url(self, raw_url: str) -> EdiscoveryExportRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: EdiscoveryExportRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return EdiscoveryExportRequest(self.request_adapter, self.path_parameters)
