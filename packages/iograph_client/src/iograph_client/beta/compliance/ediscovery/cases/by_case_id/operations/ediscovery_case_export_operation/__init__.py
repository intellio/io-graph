...
from iograph_models.beta.ediscovery_case_export_operation_collection_response import EdiscoveryCaseExportOperationCollectionResponse


class EdiscoveryCaseExportOperationRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/operations/microsoft.graph.ediscovery.caseExportOperation", path_parameters)

	async def get(
		self,
		request_configuration: Optional[RequestConfiguration[GetQueryParams]] = None,
	) -> EdiscoveryCaseExportOperationCollectionResponse:
		"""
		...
		return await self.request_adapter.send_async(request_info, EdiscoveryCaseExportOperationCollectionResponse, error_mapping)
