...
from iograph_models.beta.ediscovery_estimate_statistics_operation import EdiscoveryEstimateStatisticsOperation
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class LastEstimateStatisticsOperationRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/compliance/ediscovery/cases/{case%2Did}/sourceCollections/{sourceCollection%2Did}/lastEstimateStatisticsOperation", path_parameters)

	async def get(
		self,
		request_configuration: Optional[RequestConfiguration[GetQueryParams]] = None,
	) -> EdiscoveryEstimateStatisticsOperation:
		"""
		...
		return await self.request_adapter.send_async(request_info, EdiscoveryEstimateStatisticsOperation, error_mapping)
