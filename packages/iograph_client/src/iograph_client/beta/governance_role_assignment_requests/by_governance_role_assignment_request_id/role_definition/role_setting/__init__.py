...
class RoleSettingRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/governanceRoleAssignmentRequests/{governanceRoleAssignmentRequest%2Did}/roleDefinition/roleSetting", path_parameters)
	...
	async def get(
		...
		"""
		Get roleSetting from governanceRoleAssignmentRequests
		The associated role setting for the role definition.
		"""
		tags = ['governanceRoleAssignmentRequests.governanceRoleDefinition']
