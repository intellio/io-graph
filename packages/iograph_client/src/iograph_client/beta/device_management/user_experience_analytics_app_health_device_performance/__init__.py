...
from iograph_models.beta.user_experience_analytics_app_health_device_performance_collection_response import UserExperienceAnalyticsAppHealthDevicePerformanceCollectionResponse
