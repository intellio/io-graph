...
from iograph_models.beta.device_compliance_policy_state_collection_response import DeviceCompliancePolicyStateCollectionResponse
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class DeviceCompliancePolicyStatesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/deviceCompliancePolicyStates", path_parameters)
