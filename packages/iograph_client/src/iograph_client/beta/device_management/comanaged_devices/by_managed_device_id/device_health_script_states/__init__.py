...
class DeviceHealthScriptStatesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/deviceManagement/comanagedDevices/{managedDevice%2Did}/deviceHealthScriptStates", path_parameters)
	...
	async def get(
		...
		"""
		Get deviceHealthScriptStates from deviceManagement
	...
	async def post(
		self,
		body: DeviceHealthScriptPolicyState,
	...
	def with_url(self, raw_url: str) -> DeviceHealthScriptStatesRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: DeviceHealthScriptStatesRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return DeviceHealthScriptStatesRequest(self.request_adapter, self.path_parameters)

	def id='{id}',policy_id='{policy_id}',device_id='{device_id}'(self,
		managedDevice_id: str,
		id: str,
		policyId: str,
		deviceId: str,
	) -> Id='{id}',policyId='{policyId}',deviceId='{deviceId}'Request:
		...
		from .id='{id}',policy_id='{policy_id}',device_id='{device_id}' import Id='{id}',policyId='{policyId}',deviceId='{deviceId}'Request
		return Id='{id}',policyId='{policyId}',deviceId='{deviceId}'Request(self.request_adapter, path_parameters)
