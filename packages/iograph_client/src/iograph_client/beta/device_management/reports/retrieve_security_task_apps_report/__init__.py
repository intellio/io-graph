...
class RetrieveSecurityTaskAppsReportRequest(BaseRequestBuilder):
	...
	async def post(
		self,
		body: Retrieve_security_task_apps_reportPostRequest,
	...
	def with_url(self, raw_url: str) -> RetrieveSecurityTaskAppsReportRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: RetrieveSecurityTaskAppsReportRequest
		"""
		if raw_url is None:
