...
class CartToClassAssociationsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/deviceManagement/cartToClassAssociations", path_parameters)
	...
	def with_url(self, raw_url: str) -> CartToClassAssociationsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: CartToClassAssociationsRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return CartToClassAssociationsRequest(self.request_adapter, self.path_parameters)

	def by_cart_to_class_association_id(self,
		cartToClassAssociation_id: str,
	) -> ByCartToClassAssociationIdRequest:
		if cartToClassAssociation_id is None:
			raise TypeError("cartToClassAssociation_id cannot be null.")

		path_parameters = get_path_parameters(self.path_parameters)
		path_parameters["cartToClassAssociation%2Did"] =  cartToClassAssociation_id

		from .by_cart_to_class_association_id import ByCartToClassAssociationIdRequest
		return ByCartToClassAssociationIdRequest(self.request_adapter, path_parameters)
