...
from iograph_models.beta.revoke_post_request import RevokePostRequest
...
class RevokeRequest(BaseRequestBuilder):
	...
	def with_url(self, raw_url: str) -> RevokeRequest:
		"""
		...
		return RevokeRequest(self.request_adapter, self.path_parameters)
