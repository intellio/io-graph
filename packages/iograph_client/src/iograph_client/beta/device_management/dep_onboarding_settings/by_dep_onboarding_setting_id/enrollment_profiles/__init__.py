...
class EnrollmentProfilesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/deviceManagement/depOnboardingSettings/{depOnboardingSetting%2Did}/enrollmentProfiles", path_parameters)
	...
	def with_url(self, raw_url: str) -> EnrollmentProfilesRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: EnrollmentProfilesRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return EnrollmentProfilesRequest(self.request_adapter, self.path_parameters)

	def by_enrollment_profile_id(self,
		depOnboardingSetting_id: str,
		enrollmentProfile_id: str,
	) -> ByEnrollmentProfileIdRequest:
		...
		from .by_enrollment_profile_id import ByEnrollmentProfileIdRequest
		return ByEnrollmentProfileIdRequest(self.request_adapter, path_parameters)
