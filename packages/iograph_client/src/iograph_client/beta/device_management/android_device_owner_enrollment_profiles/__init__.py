...
if TYPE_CHECKING:
	...
	from .by_android_device_owner_enrollment_profile_id import ByAndroidDeviceOwnerEnrollmentProfileIdRequest
...
from iograph_models.beta.android_device_owner_enrollment_profile_collection_response import AndroidDeviceOwnerEnrollmentProfileCollectionResponse


class AndroidDeviceOwnerEnrollmentProfilesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/deviceManagement/androidDeviceOwnerEnrollmentProfiles", path_parameters)
	...
	def with_url(self, raw_url: str) -> AndroidDeviceOwnerEnrollmentProfilesRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: AndroidDeviceOwnerEnrollmentProfilesRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return AndroidDeviceOwnerEnrollmentProfilesRequest(self.request_adapter, self.path_parameters)

	def by_android_device_owner_enrollment_profile_id(self,
		androidDeviceOwnerEnrollmentProfile_id: str,
	) -> ByAndroidDeviceOwnerEnrollmentProfileIdRequest:
		...
		from .by_android_device_owner_enrollment_profile_id import ByAndroidDeviceOwnerEnrollmentProfileIdRequest
		return ByAndroidDeviceOwnerEnrollmentProfileIdRequest(self.request_adapter, path_parameters)
