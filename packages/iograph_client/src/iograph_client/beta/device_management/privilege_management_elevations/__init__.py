...
class PrivilegeManagementElevationsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/deviceManagement/privilegeManagementElevations", path_parameters)
	...
	async def get(
		...
		"""
		Get privilegeManagementElevations from deviceManagement
		The endpoint privilege management elevation event entity contains elevation details.
		"""
		tags = ['deviceManagement.privilegeManagementElevation']
	...
	async def post(
		self,
		body: PrivilegeManagementElevation,
	...
	def with_url(self, raw_url: str) -> PrivilegeManagementElevationsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: PrivilegeManagementElevationsRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return PrivilegeManagementElevationsRequest(self.request_adapter, self.path_parameters)

	def by_privilege_management_elevation_id(self,
		privilegeManagementElevation_id: str,
	) -> ByPrivilegeManagementElevationIdRequest:
		if privilegeManagementElevation_id is None:
			raise TypeError("privilegeManagementElevation_id cannot be null.")

		path_parameters = get_path_parameters(self.path_parameters)
		path_parameters["privilegeManagementElevation%2Did"] =  privilegeManagementElevation_id

		from .by_privilege_management_elevation_id import ByPrivilegeManagementElevationIdRequest
		return ByPrivilegeManagementElevationIdRequest(self.request_adapter, path_parameters)
