...
class ExchangeOnPremisesPolicyRequest(BaseRequestBuilder):
	...
	async def get(
		...
		"""
		Get exchangeOnPremisesPolicy from deviceManagement
	...
	def with_url(self, raw_url: str) -> ExchangeOnPremisesPolicyRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: ExchangeOnPremisesPolicyRequest
		"""
		if raw_url is None:
