...
class ByUserExperienceAnalyticsBatteryHealthModelPerformanceIdRequest(BaseRequestBuilder):
	...
	def with_url(self, raw_url: str) -> ByUserExperienceAnalyticsBatteryHealthModelPerformanceIdRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: ByUserExperienceAnalyticsBatteryHealthModelPerformanceIdRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return ByUserExperienceAnalyticsBatteryHealthModelPerformanceIdRequest(self.request_adapter, self.path_parameters)
