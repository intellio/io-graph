...
class GetAssignmentFiltersStatusDetailsRequest(BaseRequestBuilder):
	...
	async def post(
		self,
		body: Get_assignment_filters_status_detailsPostRequest,
	...
	def with_url(self, raw_url: str) -> GetAssignmentFiltersStatusDetailsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: GetAssignmentFiltersStatusDetailsRequest
		"""
		if raw_url is None:
