...
if TYPE_CHECKING:
	from .generate_apple_push_notification_certificate_signing_request import GenerateApplePushNotificationCertificateSigningRequestRequest
...
from iograph_models.beta.apple_push_notification_certificate import ApplePushNotificationCertificate
...
class ApplePushNotificationCertificateRequest(BaseRequestBuilder):
	...
	async def patch(
		self,
		body: ApplePushNotificationCertificate,
	...
	def with_url(self, raw_url: str) -> ApplePushNotificationCertificateRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: ApplePushNotificationCertificateRequest
		"""
		if raw_url is None:
	...
	@property
	def generate_apple_push_notification_certificate_signing_request(self,
	) -> GenerateApplePushNotificationCertificateSigningRequestRequest:
		from .generate_apple_push_notification_certificate_signing_request import GenerateApplePushNotificationCertificateSigningRequestRequest
