...
class SearchExistingIdentitiesRequest(BaseRequestBuilder):
	...
	async def post(
		self,
		body: Search_existing_identitiesPostRequest,
		request_configuration: Optional[RequestConfiguration[BaseModel]] = None,
	) -> Search_existing_identitiesPostResponse:
		"""
		...
		return await self.request_adapter.send_async(request_info, Search_existing_identitiesPostResponse, error_mapping)


	def with_url(self, raw_url: str) -> SearchExistingIdentitiesRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: SearchExistingIdentitiesRequest
		"""
		if raw_url is None:
