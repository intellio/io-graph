...
from iograph_models.beta.user_experience_analytics_device_startup_history_collection_response import UserExperienceAnalyticsDeviceStartupHistoryCollectionResponse
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.beta.user_experience_analytics_device_startup_history import UserExperienceAnalyticsDeviceStartupHistory


class UserExperienceAnalyticsDeviceStartupHistoryRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/deviceManagement/userExperienceAnalyticsDeviceStartupHistory", path_parameters)
	...
	def with_url(self, raw_url: str) -> UserExperienceAnalyticsDeviceStartupHistoryRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: UserExperienceAnalyticsDeviceStartupHistoryRequest
		"""
		if raw_url is None:
