...
if TYPE_CHECKING:
	...
	from .by_remote_assistance_partner_id import ByRemoteAssistancePartnerIdRequest
	from ....request_adapter import HttpxRequestAdapter
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.beta.remote_assistance_partner import RemoteAssistancePartner
from iograph_models.beta.remote_assistance_partner_collection_response import RemoteAssistancePartnerCollectionResponse


class RemoteAssistancePartnersRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/deviceManagement/remoteAssistancePartners", path_parameters)
	...
	def with_url(self, raw_url: str) -> RemoteAssistancePartnersRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: RemoteAssistancePartnersRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return RemoteAssistancePartnersRequest(self.request_adapter, self.path_parameters)

	def by_remote_assistance_partner_id(self,
		remoteAssistancePartner_id: str,
	) -> ByRemoteAssistancePartnerIdRequest:
		...
		from .by_remote_assistance_partner_id import ByRemoteAssistancePartnerIdRequest
		return ByRemoteAssistancePartnerIdRequest(self.request_adapter, path_parameters)
