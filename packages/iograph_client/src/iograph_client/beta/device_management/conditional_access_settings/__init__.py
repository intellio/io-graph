...
from iograph_models.beta.on_premises_conditional_access_settings import OnPremisesConditionalAccessSettings
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class ConditionalAccessSettingsRequest(BaseRequestBuilder):
	...
	def with_url(self, raw_url: str) -> ConditionalAccessSettingsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: ConditionalAccessSettingsRequest
		"""
		if raw_url is None:
