...
class DataSharingConsentsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/deviceManagement/dataSharingConsents", path_parameters)
	...
	def with_url(self, raw_url: str) -> DataSharingConsentsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: DataSharingConsentsRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return DataSharingConsentsRequest(self.request_adapter, self.path_parameters)

	def by_data_sharing_consent_id(self,
		dataSharingConsent_id: str,
	) -> ByDataSharingConsentIdRequest:
		...
		from .by_data_sharing_consent_id import ByDataSharingConsentIdRequest
		return ByDataSharingConsentIdRequest(self.request_adapter, path_parameters)
