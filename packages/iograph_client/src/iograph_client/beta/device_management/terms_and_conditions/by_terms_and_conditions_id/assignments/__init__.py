...
from iograph_models.beta.terms_and_conditions_assignment import TermsAndConditionsAssignment
from iograph_models.beta.terms_and_conditions_assignment_collection_response import TermsAndConditionsAssignmentCollectionResponse
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class AssignmentsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/deviceManagement/termsAndConditions/{termsAndConditions%2Did}/assignments", path_parameters)
	...
	async def post(
		self,
		body: TermsAndConditionsAssignment,
	...
	def by_terms_and_conditions_assignment_id(self,
		termsAndConditions_id: str,
		termsAndConditionsAssignment_id: str,
	) -> ByTermsAndConditionsAssignmentIdRequest:
		if termsAndConditions_id is None:
			raise TypeError("termsAndConditions_id cannot be null.")
		if termsAndConditionsAssignment_id is None:
			raise TypeError("termsAndConditionsAssignment_id cannot be null.")

		path_parameters = get_path_parameters(self.path_parameters)
		path_parameters["termsAndConditions%2Did"] =  termsAndConditions_id
		path_parameters["termsAndConditionsAssignment%2Did"] =  termsAndConditionsAssignment_id
