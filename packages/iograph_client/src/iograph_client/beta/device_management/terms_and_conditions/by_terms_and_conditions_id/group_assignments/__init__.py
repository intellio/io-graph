...
class GroupAssignmentsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/deviceManagement/termsAndConditions/{termsAndConditions%2Did}/groupAssignments", path_parameters)
	...
	def by_terms_and_conditions_group_assignment_id(self,
		termsAndConditions_id: str,
		termsAndConditionsGroupAssignment_id: str,
	) -> ByTermsAndConditionsGroupAssignmentIdRequest:
		...
		from .by_terms_and_conditions_group_assignment_id import ByTermsAndConditionsGroupAssignmentIdRequest
		return ByTermsAndConditionsGroupAssignmentIdRequest(self.request_adapter, path_parameters)
