...
class AssignmentsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/deviceManagement/windowsDriverUpdateProfiles/{windowsDriverUpdateProfile%2Did}/assignments", path_parameters)
	...
	async def post(
		self,
		body: WindowsDriverUpdateProfileAssignment,
	...
	def by_windows_driver_update_profile_assignment_id(self,
		windowsDriverUpdateProfile_id: str,
		windowsDriverUpdateProfileAssignment_id: str,
	) -> ByWindowsDriverUpdateProfileAssignmentIdRequest:
		if windowsDriverUpdateProfile_id is None:
			raise TypeError("windowsDriverUpdateProfile_id cannot be null.")
		if windowsDriverUpdateProfileAssignment_id is None:
			raise TypeError("windowsDriverUpdateProfileAssignment_id cannot be null.")

		path_parameters = get_path_parameters(self.path_parameters)
		path_parameters["windowsDriverUpdateProfile%2Did"] =  windowsDriverUpdateProfile_id
		path_parameters["windowsDriverUpdateProfileAssignment%2Did"] =  windowsDriverUpdateProfileAssignment_id

		from .by_windows_driver_update_profile_assignment_id import ByWindowsDriverUpdateProfileAssignmentIdRequest
		return ByWindowsDriverUpdateProfileAssignmentIdRequest(self.request_adapter, path_parameters)
