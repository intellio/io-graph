...
if TYPE_CHECKING:
	...
	from .by_microsoft_tunnel_site_id import ByMicrosoftTunnelSiteIdRequest
	from ....request_adapter import HttpxRequestAdapter
from iograph_models.beta.microsoft_tunnel_site_collection_response import MicrosoftTunnelSiteCollectionResponse
from iograph_models.beta.microsoft_tunnel_site import MicrosoftTunnelSite
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class MicrosoftTunnelSitesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/deviceManagement/microsoftTunnelSites", path_parameters)
	...
	def with_url(self, raw_url: str) -> MicrosoftTunnelSitesRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: MicrosoftTunnelSitesRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return MicrosoftTunnelSitesRequest(self.request_adapter, self.path_parameters)

	def by_microsoft_tunnel_site_id(self,
		microsoftTunnelSite_id: str,
	) -> ByMicrosoftTunnelSiteIdRequest:
		...
		from .by_microsoft_tunnel_site_id import ByMicrosoftTunnelSiteIdRequest
		return ByMicrosoftTunnelSiteIdRequest(self.request_adapter, path_parameters)
