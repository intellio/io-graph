...
class AssignmentsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/deviceManagement/intents/{deviceManagementIntent%2Did}/assignments", path_parameters)
	...
	async def post(
		self,
		body: DeviceManagementIntentAssignment,
	...
	def by_device_management_intent_assignment_id(self,
		deviceManagementIntent_id: str,
		deviceManagementIntentAssignment_id: str,
	) -> ByDeviceManagementIntentAssignmentIdRequest:
		if deviceManagementIntent_id is None:
			raise TypeError("deviceManagementIntent_id cannot be null.")
		if deviceManagementIntentAssignment_id is None:
			raise TypeError("deviceManagementIntentAssignment_id cannot be null.")

		path_parameters = get_path_parameters(self.path_parameters)
		path_parameters["deviceManagementIntent%2Did"] =  deviceManagementIntent_id
		path_parameters["deviceManagementIntentAssignment%2Did"] =  deviceManagementIntentAssignment_id

		from .by_device_management_intent_assignment_id import ByDeviceManagementIntentAssignmentIdRequest
		return ByDeviceManagementIntentAssignmentIdRequest(self.request_adapter, path_parameters)
