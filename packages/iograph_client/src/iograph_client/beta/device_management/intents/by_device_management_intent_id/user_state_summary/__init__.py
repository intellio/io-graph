...
from iograph_models.beta.device_management_intent_user_state_summary import DeviceManagementIntentUserStateSummary
...
class UserStateSummaryRequest(BaseRequestBuilder):
	...
	async def patch(
		self,
		body: DeviceManagementIntentUserStateSummary,
