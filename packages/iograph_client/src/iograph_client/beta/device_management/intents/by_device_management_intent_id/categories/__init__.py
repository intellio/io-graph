...
if TYPE_CHECKING:
	...
	from .by_device_management_intent_setting_category_id import ByDeviceManagementIntentSettingCategoryIdRequest
...
from iograph_models.beta.device_management_intent_setting_category_collection_response import DeviceManagementIntentSettingCategoryCollectionResponse


class CategoriesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/deviceManagement/intents/{deviceManagementIntent%2Did}/categories", path_parameters)
	...
	def by_device_management_intent_setting_category_id(self,
		deviceManagementIntent_id: str,
		deviceManagementIntentSettingCategory_id: str,
	) -> ByDeviceManagementIntentSettingCategoryIdRequest:
		...
		from .by_device_management_intent_setting_category_id import ByDeviceManagementIntentSettingCategoryIdRequest
		return ByDeviceManagementIntentSettingCategoryIdRequest(self.request_adapter, path_parameters)
