...
if TYPE_CHECKING:
	...
	from .by_device_management_intent_id import ByDeviceManagementIntentIdRequest
	from ....request_adapter import HttpxRequestAdapter
from iograph_models.beta.device_management_intent import DeviceManagementIntent
from iograph_models.beta.device_management_intent_collection_response import DeviceManagementIntentCollectionResponse
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class IntentsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/deviceManagement/intents", path_parameters)
	...
	def with_url(self, raw_url: str) -> IntentsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: IntentsRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return IntentsRequest(self.request_adapter, self.path_parameters)

	def by_device_management_intent_id(self,
		deviceManagementIntent_id: str,
	) -> ByDeviceManagementIntentIdRequest:
		...
		from .by_device_management_intent_id import ByDeviceManagementIntentIdRequest
		return ByDeviceManagementIntentIdRequest(self.request_adapter, path_parameters)
