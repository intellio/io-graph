...
class ByDeviceManagementExchangeOnPremisesPolicyIdRequest(BaseRequestBuilder):
	...
	def with_url(self, raw_url: str) -> ByDeviceManagementExchangeOnPremisesPolicyIdRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: ByDeviceManagementExchangeOnPremisesPolicyIdRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return ByDeviceManagementExchangeOnPremisesPolicyIdRequest(self.request_adapter, self.path_parameters)
	...
	def conditional_access_settings(self,
		...
		from .conditional_access_settings import ConditionalAccessSettingsRequest
		return ConditionalAccessSettingsRequest(self.request_adapter, path_parameters)
