...
class DeviceConfigurationRestrictedAppsViolationsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/deviceManagement/deviceConfigurationRestrictedAppsViolations", path_parameters)
	...
	async def get(
		...
		"""
		tags = ['deviceManagement.restrictedAppsViolation']
	...
	def with_url(self, raw_url: str) -> DeviceConfigurationRestrictedAppsViolationsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: DeviceConfigurationRestrictedAppsViolationsRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return DeviceConfigurationRestrictedAppsViolationsRequest(self.request_adapter, self.path_parameters)

	def by_restricted_apps_violation_id(self,
		restrictedAppsViolation_id: str,
	) -> ByRestrictedAppsViolationIdRequest:
		if restrictedAppsViolation_id is None:
			raise TypeError("restrictedAppsViolation_id cannot be null.")

		path_parameters = get_path_parameters(self.path_parameters)
		path_parameters["restrictedAppsViolation%2Did"] =  restrictedAppsViolation_id

		from .by_restricted_apps_violation_id import ByRestrictedAppsViolationIdRequest
		return ByRestrictedAppsViolationIdRequest(self.request_adapter, path_parameters)
