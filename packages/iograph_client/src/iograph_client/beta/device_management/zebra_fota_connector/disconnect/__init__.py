...
from iograph_models.beta.disconnect_post_response import DisconnectPostResponse
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class DisconnectRequest(BaseRequestBuilder):
	...
	def with_url(self, raw_url: str) -> DisconnectRequest:
		"""
