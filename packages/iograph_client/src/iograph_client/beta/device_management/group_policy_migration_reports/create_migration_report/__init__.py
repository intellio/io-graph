...
class CreateMigrationReportRequest(BaseRequestBuilder):
	...
	async def post(
		self,
		body: Create_migration_reportPostRequest,
		request_configuration: Optional[RequestConfiguration[BaseModel]] = None,
	) -> Create_migration_reportPostResponse:
		"""
		...
		return await self.request_adapter.send_async(request_info, Create_migration_reportPostResponse, error_mapping)


	def with_url(self, raw_url: str) -> CreateMigrationReportRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: CreateMigrationReportRequest
		"""
		if raw_url is None:
