...
class UserExperienceAnalyticsAnomalyRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/deviceManagement/userExperienceAnalyticsAnomaly", path_parameters)
	...
	async def get(
		...
		"""
		Get userExperienceAnalyticsAnomaly from deviceManagement
		The user experience analytics anomaly entity contains anomaly details.
		"""
		tags = ['deviceManagement.userExperienceAnalyticsAnomaly']
	...
	async def post(
		self,
		body: UserExperienceAnalyticsAnomaly,
	...
	def with_url(self, raw_url: str) -> UserExperienceAnalyticsAnomalyRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: UserExperienceAnalyticsAnomalyRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return UserExperienceAnalyticsAnomalyRequest(self.request_adapter, self.path_parameters)

	def by_user_experience_analytics_anomaly_id(self,
		userExperienceAnalyticsAnomaly_id: str,
	) -> ByUserExperienceAnalyticsAnomalyIdRequest:
		if userExperienceAnalyticsAnomaly_id is None:
			raise TypeError("userExperienceAnalyticsAnomaly_id cannot be null.")

		path_parameters = get_path_parameters(self.path_parameters)
		path_parameters["userExperienceAnalyticsAnomaly%2Did"] =  userExperienceAnalyticsAnomaly_id

		from .by_user_experience_analytics_anomaly_id import ByUserExperienceAnalyticsAnomalyIdRequest
		return ByUserExperienceAnalyticsAnomalyIdRequest(self.request_adapter, path_parameters)
