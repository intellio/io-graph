...
if TYPE_CHECKING:
	...
	from .by_device_configuration_group_assignment_id import ByDeviceConfigurationGroupAssignmentIdRequest
	from ......request_adapter import HttpxRequestAdapter
from iograph_models.beta.device_configuration_group_assignment_collection_response import DeviceConfigurationGroupAssignmentCollectionResponse
...
class GroupAssignmentsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/deviceManagement/deviceConfigurations/{deviceConfiguration%2Did}/groupAssignments", path_parameters)
	...
	def by_device_configuration_group_assignment_id(self,
		deviceConfiguration_id: str,
		deviceConfigurationGroupAssignment_id: str,
	) -> ByDeviceConfigurationGroupAssignmentIdRequest:
		...
		from .by_device_configuration_group_assignment_id import ByDeviceConfigurationGroupAssignmentIdRequest
		return ByDeviceConfigurationGroupAssignmentIdRequest(self.request_adapter, path_parameters)
