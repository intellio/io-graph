...
class GetTargetedUsersAndDevicesRequest(BaseRequestBuilder):
	...
	async def post(
		self,
		body: Get_targeted_users_and_devicesPostRequest,
		request_configuration: Optional[RequestConfiguration[BaseModel]] = None,
	) -> Get_targeted_users_and_devicesPostResponse:
		"""
		...
		return await self.request_adapter.send_async(request_info, Get_targeted_users_and_devicesPostResponse, error_mapping)


	def with_url(self, raw_url: str) -> GetTargetedUsersAndDevicesRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: GetTargetedUsersAndDevicesRequest
		"""
		if raw_url is None:
