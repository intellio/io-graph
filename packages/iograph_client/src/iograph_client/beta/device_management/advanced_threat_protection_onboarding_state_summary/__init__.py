...
class AdvancedThreatProtectionOnboardingStateSummaryRequest(BaseRequestBuilder):
	...
	async def patch(
		self,
		body: AdvancedThreatProtectionOnboardingStateSummary,
	...
	def with_url(self, raw_url: str) -> AdvancedThreatProtectionOnboardingStateSummaryRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: AdvancedThreatProtectionOnboardingStateSummaryRequest
		"""
		if raw_url is None:
	...
	@property
	def advanced_threat_protection_onboarding_device_setting_states(self,
	) -> AdvancedThreatProtectionOnboardingDeviceSettingStatesRequest:
		from .advanced_threat_protection_onboarding_device_setting_states import AdvancedThreatProtectionOnboardingDeviceSettingStatesRequest
