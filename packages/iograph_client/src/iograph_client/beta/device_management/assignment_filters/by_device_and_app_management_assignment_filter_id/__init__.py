...
class ByDeviceAndAppManagementAssignmentFilterIdRequest(BaseRequestBuilder):
	...
	def with_url(self, raw_url: str) -> ByDeviceAndAppManagementAssignmentFilterIdRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: ByDeviceAndAppManagementAssignmentFilterIdRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return ByDeviceAndAppManagementAssignmentFilterIdRequest(self.request_adapter, self.path_parameters)

	def get_supported_properties(self,
		deviceAndAppManagementAssignmentFilter_id: str,
	) -> GetSupportedPropertiesRequest:
		...
		from .get_supported_properties import GetSupportedPropertiesRequest
		return GetSupportedPropertiesRequest(self.request_adapter, path_parameters)
