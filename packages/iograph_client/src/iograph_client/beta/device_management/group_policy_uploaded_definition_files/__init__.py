...
if TYPE_CHECKING:
	...
	from .by_group_policy_uploaded_definition_file_id import ByGroupPolicyUploadedDefinitionFileIdRequest
	from ....request_adapter import HttpxRequestAdapter
from iograph_models.beta.group_policy_uploaded_definition_file_collection_response import GroupPolicyUploadedDefinitionFileCollectionResponse
from iograph_models.beta.group_policy_uploaded_definition_file import GroupPolicyUploadedDefinitionFile
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class GroupPolicyUploadedDefinitionFilesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/deviceManagement/groupPolicyUploadedDefinitionFiles", path_parameters)
	...
	def with_url(self, raw_url: str) -> GroupPolicyUploadedDefinitionFilesRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: GroupPolicyUploadedDefinitionFilesRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return GroupPolicyUploadedDefinitionFilesRequest(self.request_adapter, self.path_parameters)

	def by_group_policy_uploaded_definition_file_id(self,
		groupPolicyUploadedDefinitionFile_id: str,
	) -> ByGroupPolicyUploadedDefinitionFileIdRequest:
		...
		from .by_group_policy_uploaded_definition_file_id import ByGroupPolicyUploadedDefinitionFileIdRequest
		return ByGroupPolicyUploadedDefinitionFileIdRequest(self.request_adapter, path_parameters)
