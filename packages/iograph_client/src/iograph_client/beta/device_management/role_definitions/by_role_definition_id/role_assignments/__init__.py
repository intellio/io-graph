...
from iograph_models.beta.role_assignment import RoleAssignment
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.beta.role_assignment_collection_response import RoleAssignmentCollectionResponse


class RoleAssignmentsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/deviceManagement/roleDefinitions/{roleDefinition%2Did}/roleAssignments", path_parameters)
	...
	def by_role_assignment_id(self,
		roleDefinition_id: str,
		roleAssignment_id: str,
	) -> ByRoleAssignmentIdRequest:
		...
		from .by_role_assignment_id import ByRoleAssignmentIdRequest
		return ByRoleAssignmentIdRequest(self.request_adapter, path_parameters)
