...
if TYPE_CHECKING:
	...
	from .by_device_management_compliance_scheduled_action_for_rule_id import ByDeviceManagementComplianceScheduledActionForRuleIdRequest
...
from iograph_models.beta.device_management_compliance_scheduled_action_for_rule_collection_response import DeviceManagementComplianceScheduledActionForRuleCollectionResponse


class ScheduledActionsForRuleRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/deviceManagement/compliancePolicies/{deviceManagementCompliancePolicy%2Did}/scheduledActionsForRule", path_parameters)
	...
	def by_device_management_compliance_scheduled_action_for_rule_id(self,
		deviceManagementCompliancePolicy_id: str,
		deviceManagementComplianceScheduledActionForRule_id: str,
	) -> ByDeviceManagementComplianceScheduledActionForRuleIdRequest:
		...
		from .by_device_management_compliance_scheduled_action_for_rule_id import ByDeviceManagementComplianceScheduledActionForRuleIdRequest
		return ByDeviceManagementComplianceScheduledActionForRuleIdRequest(self.request_adapter, path_parameters)
