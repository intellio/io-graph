...
class RevokeLeafCertificateRequest(BaseRequestBuilder):
	...
	async def post(
		self,
		body: Revoke_leaf_certificatePostRequest,
	...
	def with_url(self, raw_url: str) -> RevokeLeafCertificateRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: RevokeLeafCertificateRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return RevokeLeafCertificateRequest(self.request_adapter, self.path_parameters)
