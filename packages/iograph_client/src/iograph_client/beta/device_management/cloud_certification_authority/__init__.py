...
class CloudCertificationAuthorityRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/deviceManagement/cloudCertificationAuthority", path_parameters)

	async def get(
		self,
		request_configuration: Optional[RequestConfiguration[GetQueryParams]] = None,
	) -> CloudCertificationAuthorityCollectionResponse:
		"""
	...
	def with_url(self, raw_url: str) -> CloudCertificationAuthorityRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: CloudCertificationAuthorityRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return CloudCertificationAuthorityRequest(self.request_adapter, self.path_parameters)

	def by_cloud_certification_authority_id(self,
		cloudCertificationAuthority_id: str,
	) -> ByCloudCertificationAuthorityIdRequest:
		...
		from .by_cloud_certification_authority_id import ByCloudCertificationAuthorityIdRequest
		return ByCloudCertificationAuthorityIdRequest(self.request_adapter, path_parameters)
