...
class DeviceCustomAttributeShellScriptsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/deviceManagement/deviceCustomAttributeShellScripts", path_parameters)
	...
	def with_url(self, raw_url: str) -> DeviceCustomAttributeShellScriptsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: DeviceCustomAttributeShellScriptsRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return DeviceCustomAttributeShellScriptsRequest(self.request_adapter, self.path_parameters)

	def by_device_custom_attribute_shell_script_id(self,
		deviceCustomAttributeShellScript_id: str,
	) -> ByDeviceCustomAttributeShellScriptIdRequest:
		...
		from .by_device_custom_attribute_shell_script_id import ByDeviceCustomAttributeShellScriptIdRequest
		return ByDeviceCustomAttributeShellScriptIdRequest(self.request_adapter, path_parameters)
