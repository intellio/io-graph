...
if TYPE_CHECKING:
	...
	from .by_device_management_script_device_state_id import ByDeviceManagementScriptDeviceStateIdRequest
	from ........request_adapter import HttpxRequestAdapter
from iograph_models.beta.device_management_script_device_state_collection_response import DeviceManagementScriptDeviceStateCollectionResponse
...
class DeviceRunStatesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/deviceManagement/deviceCustomAttributeShellScripts/{deviceCustomAttributeShellScript%2Did}/userRunStates/{deviceManagementScriptUserState%2Did}/deviceRunStates", path_parameters)
	...
	def by_device_management_script_device_state_id(self,
		...
		from .by_device_management_script_device_state_id import ByDeviceManagementScriptDeviceStateIdRequest
		return ByDeviceManagementScriptDeviceStateIdRequest(self.request_adapter, path_parameters)
