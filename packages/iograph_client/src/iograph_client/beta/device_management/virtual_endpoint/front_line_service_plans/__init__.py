...
class FrontLineServicePlansRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/deviceManagement/virtualEndpoint/frontLineServicePlans", path_parameters)
	...
	async def post(
		self,
		body: CloudPcFrontLineServicePlan,
	...
	def with_url(self, raw_url: str) -> FrontLineServicePlansRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: FrontLineServicePlansRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return FrontLineServicePlansRequest(self.request_adapter, self.path_parameters)

	def by_cloud_pc_front_line_service_plan_id(self,
		cloudPcFrontLineServicePlan_id: str,
	) -> ByCloudPcFrontLineServicePlanIdRequest:
		if cloudPcFrontLineServicePlan_id is None:
			raise TypeError("cloudPcFrontLineServicePlan_id cannot be null.")

		path_parameters = get_path_parameters(self.path_parameters)
		path_parameters["cloudPcFrontLineServicePlan%2Did"] =  cloudPcFrontLineServicePlan_id

		from .by_cloud_pc_front_line_service_plan_id import ByCloudPcFrontLineServicePlanIdRequest
		return ByCloudPcFrontLineServicePlanIdRequest(self.request_adapter, path_parameters)
