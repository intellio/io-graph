...
if TYPE_CHECKING:
	from .schedule_policy_apply_task import SchedulePolicyApplyTaskRequest
	from .retrieve_policy_apply_schedule import RetrievePolicyApplyScheduleRequest
	from .retrieve_policy_apply_action_result import RetrievePolicyApplyActionResultRequest
...
class ByCloudPcProvisioningPolicyIdRequest(BaseRequestBuilder):
	...
	def retrieve_policy_apply_action_result(self,
		cloudPcProvisioningPolicy_id: str,
	) -> RetrievePolicyApplyActionResultRequest:
		if cloudPcProvisioningPolicy_id is None:
			raise TypeError("cloudPcProvisioningPolicy_id cannot be null.")
		...
		from .retrieve_policy_apply_action_result import RetrievePolicyApplyActionResultRequest
		return RetrievePolicyApplyActionResultRequest(self.request_adapter, path_parameters)

	def retrieve_policy_apply_schedule(self,
		cloudPcProvisioningPolicy_id: str,
	) -> RetrievePolicyApplyScheduleRequest:
		if cloudPcProvisioningPolicy_id is None:
			raise TypeError("cloudPcProvisioningPolicy_id cannot be null.")
		...
		from .retrieve_policy_apply_schedule import RetrievePolicyApplyScheduleRequest
		return RetrievePolicyApplyScheduleRequest(self.request_adapter, path_parameters)

	def schedule_policy_apply_task(self,
		cloudPcProvisioningPolicy_id: str,
	) -> SchedulePolicyApplyTaskRequest:
		if cloudPcProvisioningPolicy_id is None:
			raise TypeError("cloudPcProvisioningPolicy_id cannot be null.")
		...
		from .schedule_policy_apply_task import SchedulePolicyApplyTaskRequest
		return SchedulePolicyApplyTaskRequest(self.request_adapter, path_parameters)
