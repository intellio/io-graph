...
from iograph_models.beta.cloud_pc_organization_settings import CloudPcOrganizationSettings


class OrganizationSettingsRequest(BaseRequestBuilder):
	...
	async def patch(
		self,
		body: CloudPcOrganizationSettings,
	...
	def with_url(self, raw_url: str) -> OrganizationSettingsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: OrganizationSettingsRequest
		"""
		if raw_url is None:
