...
class SupportedRegionsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/deviceManagement/virtualEndpoint/supportedRegions", path_parameters)
	...
	def with_url(self, raw_url: str) -> SupportedRegionsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: SupportedRegionsRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return SupportedRegionsRequest(self.request_adapter, self.path_parameters)

	def by_cloud_pc_supported_region_id(self,
		cloudPcSupportedRegion_id: str,
	) -> ByCloudPcSupportedRegionIdRequest:
		if cloudPcSupportedRegion_id is None:
			raise TypeError("cloudPcSupportedRegion_id cannot be null.")

		path_parameters = get_path_parameters(self.path_parameters)
		path_parameters["cloudPcSupportedRegion%2Did"] =  cloudPcSupportedRegion_id

		from .by_cloud_pc_supported_region_id import ByCloudPcSupportedRegionIdRequest
		return ByCloudPcSupportedRegionIdRequest(self.request_adapter, path_parameters)
