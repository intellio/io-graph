...
from iograph_models.beta.get_frontline_report_post_request import Get_frontline_reportPostRequest


class GetFrontlineReportRequest(BaseRequestBuilder):
	...
	async def post(
		self,
		body: Get_frontline_reportPostRequest,
	...
	def with_url(self, raw_url: str) -> GetFrontlineReportRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: GetFrontlineReportRequest
		"""
		if raw_url is None:
