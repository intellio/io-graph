...
from iograph_models.beta.get_daily_aggregated_remote_connection_reports_post_request import Get_daily_aggregated_remote_connection_reportsPostRequest


class GetDailyAggregatedRemoteConnectionReportsRequest(BaseRequestBuilder):
	...
	async def post(
		self,
		body: Get_daily_aggregated_remote_connection_reportsPostRequest,
	...
	def with_url(self, raw_url: str) -> GetDailyAggregatedRemoteConnectionReportsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: GetDailyAggregatedRemoteConnectionReportsRequest
		"""
		if raw_url is None:
