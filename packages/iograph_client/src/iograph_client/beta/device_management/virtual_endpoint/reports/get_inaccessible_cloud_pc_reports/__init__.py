...
from iograph_models.beta.get_inaccessible_cloud_pc_reports_post_request import Get_inaccessible_cloud_pc_reportsPostRequest


class GetInaccessibleCloudPcReportsRequest(BaseRequestBuilder):
	...
	async def post(
		self,
		body: Get_inaccessible_cloud_pc_reportsPostRequest,
	...
	def with_url(self, raw_url: str) -> GetInaccessibleCloudPcReportsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: GetInaccessibleCloudPcReportsRequest
		"""
		if raw_url is None:
