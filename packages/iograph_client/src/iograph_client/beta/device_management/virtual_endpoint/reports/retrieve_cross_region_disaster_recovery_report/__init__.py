...
from iograph_models.beta.retrieve_cross_region_disaster_recovery_report_post_request import Retrieve_cross_region_disaster_recovery_reportPostRequest
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class RetrieveCrossRegionDisasterRecoveryReportRequest(BaseRequestBuilder):
	...
	async def post(
		self,
		body: Retrieve_cross_region_disaster_recovery_reportPostRequest,
	...
	def with_url(self, raw_url: str) -> RetrieveCrossRegionDisasterRecoveryReportRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: RetrieveCrossRegionDisasterRecoveryReportRequest
		"""
		if raw_url is None:
