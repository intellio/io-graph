...
from iograph_models.beta.get_remote_connection_historical_reports_post_request import Get_remote_connection_historical_reportsPostRequest


class GetRemoteConnectionHistoricalReportsRequest(BaseRequestBuilder):
	...
	async def post(
		self,
		body: Get_remote_connection_historical_reportsPostRequest,
	...
	def with_url(self, raw_url: str) -> GetRemoteConnectionHistoricalReportsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: GetRemoteConnectionHistoricalReportsRequest
		"""
		if raw_url is None:
