...
from iograph_models.beta.cloud_pc_cross_cloud_government_organization_mapping import CloudPcCrossCloudGovernmentOrganizationMapping


class CrossCloudGovernmentOrganizationMappingRequest(BaseRequestBuilder):
	...
	def with_url(self, raw_url: str) -> CrossCloudGovernmentOrganizationMappingRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: CrossCloudGovernmentOrganizationMappingRequest
		"""
		if raw_url is None:
