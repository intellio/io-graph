...
from iograph_models.beta.domain_dns_record_collection_response import DomainDnsRecordCollectionResponse
from iograph_models.beta.domain_dns_record import DomainDnsRecord


class DomainDnsRecordsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/domainDnsRecords", path_parameters)
	...
	async def get(
		...
		"""
		tags = ['domainDnsRecords.domainDnsRecord']
	...
	def with_url(self, raw_url: str) -> DomainDnsRecordsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: DomainDnsRecordsRequest
		"""
		if raw_url is None:
