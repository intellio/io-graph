...
if TYPE_CHECKING:
	from .record_decisions import RecordDecisionsRequest
	from ......request_adapter import HttpxRequestAdapter
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.beta.business_flow import BusinessFlow


class ByBusinessFlowIdRequest(BaseRequestBuilder):
	...
	def with_url(self, raw_url: str) -> ByBusinessFlowIdRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: ByBusinessFlowIdRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return ByBusinessFlowIdRequest(self.request_adapter, self.path_parameters)

	def record_decisions(self,
		approvalWorkflowProvider_id: str,
		businessFlow_id: str,
	) -> RecordDecisionsRequest:
		...
		from .record_decisions import RecordDecisionsRequest
		return RecordDecisionsRequest(self.request_adapter, path_parameters)
