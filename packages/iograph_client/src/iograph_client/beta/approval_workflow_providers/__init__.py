...
class ApprovalWorkflowProvidersRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/approvalWorkflowProviders", path_parameters)
	...
	def with_url(self, raw_url: str) -> ApprovalWorkflowProvidersRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: ApprovalWorkflowProvidersRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return ApprovalWorkflowProvidersRequest(self.request_adapter, self.path_parameters)

	def by_approval_workflow_provider_id(self,
		approvalWorkflowProvider_id: str,
	) -> ByApprovalWorkflowProviderIdRequest:
		...
		from .by_approval_workflow_provider_id import ByApprovalWorkflowProviderIdRequest
		return ByApprovalWorkflowProviderIdRequest(self.request_adapter, path_parameters)
