...
class ActivitiesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/external/industryData/runs/{industryDataRun%2Did}/activities", path_parameters)

	async def get(
		self,
		request_configuration: Optional[RequestConfiguration[GetQueryParams]] = None,
	) -> IndustryDataIndustryDataRunActivityCollectionResponse:
		"""
		...
		return await self.request_adapter.send_async(request_info, IndustryDataIndustryDataRunActivityCollectionResponse, error_mapping)
	...
	def by_industry_data_run_activity_id(self,
		industryDataRun_id: str,
		industryDataRunActivity_id: str,
	) -> ByIndustryDataRunActivityIdRequest:
		...
		from .by_industry_data_run_activity_id import ByIndustryDataRunActivityIdRequest
		return ByIndustryDataRunActivityIdRequest(self.request_adapter, path_parameters)
