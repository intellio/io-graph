...
if TYPE_CHECKING:
	...
	from .by_provisioning_flow_id import ByProvisioningFlowIdRequest
	from .......request_adapter import HttpxRequestAdapter
from iograph_models.beta.industry_data_provisioning_flow import IndustryDataProvisioningFlow
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.beta.industry_data_provisioning_flow_collection_response import IndustryDataProvisioningFlowCollectionResponse


class ProvisioningFlowsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/external/industryData/outboundProvisioningFlowSets/{outboundProvisioningFlowSet%2Did}/provisioningFlows", path_parameters)

	async def get(
		self,
		request_configuration: Optional[RequestConfiguration[GetQueryParams]] = None,
	) -> IndustryDataProvisioningFlowCollectionResponse:
		"""
		...
		return await self.request_adapter.send_async(request_info, IndustryDataProvisioningFlowCollectionResponse, error_mapping)
	...
	def with_url(self, raw_url: str) -> ProvisioningFlowsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: ProvisioningFlowsRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return ProvisioningFlowsRequest(self.request_adapter, self.path_parameters)

	def by_provisioning_flow_id(self,
		outboundProvisioningFlowSet_id: str,
		provisioningFlow_id: str,
	) -> ByProvisioningFlowIdRequest:
		...
		from .by_provisioning_flow_id import ByProvisioningFlowIdRequest
		return ByProvisioningFlowIdRequest(self.request_adapter, path_parameters)
