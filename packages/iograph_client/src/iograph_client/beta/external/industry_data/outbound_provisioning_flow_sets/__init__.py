...
if TYPE_CHECKING:
	...
	from .by_outbound_provisioning_flow_set_id import ByOutboundProvisioningFlowSetIdRequest
	from .....request_adapter import HttpxRequestAdapter
from iograph_models.beta.industry_data_outbound_provisioning_flow_set_collection_response import IndustryDataOutboundProvisioningFlowSetCollectionResponse
...
class OutboundProvisioningFlowSetsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/external/industryData/outboundProvisioningFlowSets", path_parameters)

	async def get(
		self,
		request_configuration: Optional[RequestConfiguration[GetQueryParams]] = None,
	) -> IndustryDataOutboundProvisioningFlowSetCollectionResponse:
		"""
		...
		return await self.request_adapter.send_async(request_info, IndustryDataOutboundProvisioningFlowSetCollectionResponse, error_mapping)
	...
	def with_url(self, raw_url: str) -> OutboundProvisioningFlowSetsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: OutboundProvisioningFlowSetsRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return OutboundProvisioningFlowSetsRequest(self.request_adapter, self.path_parameters)

	def by_outbound_provisioning_flow_set_id(self,
		outboundProvisioningFlowSet_id: str,
	) -> ByOutboundProvisioningFlowSetIdRequest:
		...
		from .by_outbound_provisioning_flow_set_id import ByOutboundProvisioningFlowSetIdRequest
		return ByOutboundProvisioningFlowSetIdRequest(self.request_adapter, path_parameters)
