...
class DataConnectorsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/external/industryData/dataConnectors", path_parameters)

	async def get(
		self,
		request_configuration: Optional[RequestConfiguration[GetQueryParams]] = None,
	) -> IndustryDataIndustryDataConnectorCollectionResponse:
		"""
		...
		return await self.request_adapter.send_async(request_info, IndustryDataIndustryDataConnectorCollectionResponse, error_mapping)
	...
	def with_url(self, raw_url: str) -> DataConnectorsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: DataConnectorsRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return DataConnectorsRequest(self.request_adapter, self.path_parameters)

	def by_industry_data_connector_id(self,
		industryDataConnector_id: str,
	) -> ByIndustryDataConnectorIdRequest:
		...
		from .by_industry_data_connector_id import ByIndustryDataConnectorIdRequest
		return ByIndustryDataConnectorIdRequest(self.request_adapter, path_parameters)
