...
class ByInboundFlowIdRequest(BaseRequestBuilder):
	...
	def with_url(self, raw_url: str) -> ByInboundFlowIdRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: ByInboundFlowIdRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return ByInboundFlowIdRequest(self.request_adapter, self.path_parameters)
	...
	def data_connector(self,
		...
		from .data_connector import DataConnectorRequest
		return DataConnectorRequest(self.request_adapter, path_parameters)
