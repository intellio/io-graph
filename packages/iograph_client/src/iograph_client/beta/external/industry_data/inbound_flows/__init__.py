...
class InboundFlowsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/external/industryData/inboundFlows", path_parameters)

	async def get(
		self,
		request_configuration: Optional[RequestConfiguration[GetQueryParams]] = None,
	) -> IndustryDataInboundFlowCollectionResponse:
		"""
		List inboundFlows
		...
		return await self.request_adapter.send_async(request_info, IndustryDataInboundFlowCollectionResponse, error_mapping)

	async def post(
		self,
		body: IndustryDataInboundFlow,
		...
		return await self.request_adapter.send_async(request_info, IndustryDataInboundFlow, error_mapping)
	...
	def with_url(self, raw_url: str) -> InboundFlowsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: InboundFlowsRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return InboundFlowsRequest(self.request_adapter, self.path_parameters)

	def by_inbound_flow_id(self,
		inboundFlow_id: str,
	) -> ByInboundFlowIdRequest:
		if inboundFlow_id is None:
			raise TypeError("inboundFlow_id cannot be null.")

		path_parameters = get_path_parameters(self.path_parameters)
		path_parameters["inboundFlow%2Did"] =  inboundFlow_id

		from .by_inbound_flow_id import ByInboundFlowIdRequest
		return ByInboundFlowIdRequest(self.request_adapter, path_parameters)
