...
class ByAuthorizationSystemIdRequest(BaseRequestBuilder):
	...
	def with_url(self, raw_url: str) -> ByAuthorizationSystemIdRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: ByAuthorizationSystemIdRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return ByAuthorizationSystemIdRequest(self.request_adapter, self.path_parameters)

	def data_collection_info(self,
		authorizationSystem_id: str,
	) -> DataCollectionInfoRequest:
		...
		from .data_collection_info import DataCollectionInfoRequest
		return DataCollectionInfoRequest(self.request_adapter, path_parameters)
