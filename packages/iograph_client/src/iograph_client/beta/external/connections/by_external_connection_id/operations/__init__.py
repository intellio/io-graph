...
from iograph_models.beta.external_connectors_connection_operation import ExternalConnectorsConnectionOperation
from iograph_models.beta.external_connectors_connection_operation_collection_response import ExternalConnectorsConnectionOperationCollectionResponse


class OperationsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/external/connections/{externalConnection%2Did}/operations", path_parameters)
