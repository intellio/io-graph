...
if TYPE_CHECKING:
	...
	from .by_published_resource_id import ByPublishedResourceIdRequest
	from .......request_adapter import HttpxRequestAdapter
from iograph_models.beta.published_resource import PublishedResource
from iograph_models.beta.published_resource_collection_response import PublishedResourceCollectionResponse
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class PublishedResourcesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/onPremisesPublishingProfiles/{onPremisesPublishingProfile%2Did}/agentGroups/{onPremisesAgentGroup%2Did}/publishedResources", path_parameters)
	...
	def with_url(self, raw_url: str) -> PublishedResourcesRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: PublishedResourcesRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return PublishedResourcesRequest(self.request_adapter, self.path_parameters)

	def by_published_resource_id(self,
		onPremisesPublishingProfile_id: str,
		onPremisesAgentGroup_id: str,
		publishedResource_id: str,
	) -> ByPublishedResourceIdRequest:
		...
		from .by_published_resource_id import ByPublishedResourceIdRequest
		return ByPublishedResourceIdRequest(self.request_adapter, path_parameters)
