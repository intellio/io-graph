...
class OnPremisesPublishingProfilesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/onPremisesPublishingProfiles", path_parameters)
	...
	def with_url(self, raw_url: str) -> OnPremisesPublishingProfilesRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: OnPremisesPublishingProfilesRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return OnPremisesPublishingProfilesRequest(self.request_adapter, self.path_parameters)

	def by_on_premises_publishing_profile_id(self,
		onPremisesPublishingProfile_id: str,
	) -> ByOnPremisesPublishingProfileIdRequest:
		...
		from .by_on_premises_publishing_profile_id import ByOnPremisesPublishingProfileIdRequest
		return ByOnPremisesPublishingProfileIdRequest(self.request_adapter, path_parameters)
