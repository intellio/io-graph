...
from iograph_models.beta.planner_plan_configuration import PlannerPlanConfiguration
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class PlanConfigurationRequest(BaseRequestBuilder):
	...
	def with_url(self, raw_url: str) -> PlanConfigurationRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: PlanConfigurationRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return PlanConfigurationRequest(self.request_adapter, self.path_parameters)
