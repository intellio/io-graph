...
if TYPE_CHECKING:
	...
	from .business_scenarios_with_uniquename import BusinessScenariosWithUniqueNameRequest
	from .business_scenarios import BusinessScenariosRequest
...
from iograph_models.beta.solutions_root import SolutionsRoot
...
class SolutionsRequest(BaseRequestBuilder):
	...
	) -> BusinessScenariosRequest:
		from .business_scenarios import BusinessScenariosRequest
		return BusinessScenariosRequest(self.request_adapter, self.path_parameters)

	def business_scenarios_with_uniquename(self,
		uniqueName: str,
	) -> BusinessScenariosWithUniqueNameRequest:
		...
		from .business_scenarios_with_uniquename import BusinessScenariosWithUniqueNameRequest
		return BusinessScenariosWithUniqueNameRequest(self.request_adapter, path_parameters)
