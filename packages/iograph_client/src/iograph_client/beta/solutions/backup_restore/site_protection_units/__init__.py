...
from iograph_models.beta.site_protection_unit_collection_response import SiteProtectionUnitCollectionResponse
from iograph_models.beta.site_protection_unit import SiteProtectionUnit
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class SiteProtectionUnitsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/solutions/backupRestore/siteProtectionUnits", path_parameters)
	...
	def with_url(self, raw_url: str) -> SiteProtectionUnitsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: SiteProtectionUnitsRequest
		"""
		if raw_url is None:
