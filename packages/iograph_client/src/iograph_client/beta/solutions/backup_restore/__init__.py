...
if TYPE_CHECKING:
	from .site_protection_units_bulk_addition_jobs import SiteProtectionUnitsBulkAdditionJobsRequest
	...
	from .mailbox_protection_units_bulk_addition_jobs import MailboxProtectionUnitsBulkAdditionJobsRequest
...
class BackupRestoreRequest(BaseRequestBuilder):
	...
	def with_url(self, raw_url: str) -> BackupRestoreRequest:
		"""
	...
	@property
	def mailbox_protection_units_bulk_addition_jobs(self,
	) -> MailboxProtectionUnitsBulkAdditionJobsRequest:
		from .mailbox_protection_units_bulk_addition_jobs import MailboxProtectionUnitsBulkAdditionJobsRequest
	...
	@property
	def site_protection_units_bulk_addition_jobs(self,
	) -> SiteProtectionUnitsBulkAdditionJobsRequest:
		from .site_protection_units_bulk_addition_jobs import SiteProtectionUnitsBulkAdditionJobsRequest
