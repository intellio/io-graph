...
from iograph_models.beta.site_protection_rule import SiteProtectionRule
from iograph_models.beta.site_protection_rule_collection_response import SiteProtectionRuleCollectionResponse
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class SiteInclusionRulesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/solutions/backupRestore/siteInclusionRules", path_parameters)
