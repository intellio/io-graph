...
class ByOneDriveForBusinessRestoreSessionIdRequest(BaseRequestBuilder):
	...
	def drive_restore_artifacts_bulk_addition_requests(self,
		oneDriveForBusinessRestoreSession_id: str,
	) -> DriveRestoreArtifactsBulkAdditionRequestsRequest:
		if oneDriveForBusinessRestoreSession_id is None:
			raise TypeError("oneDriveForBusinessRestoreSession_id cannot be null.")
		...
		from .drive_restore_artifacts_bulk_addition_requests import DriveRestoreArtifactsBulkAdditionRequestsRequest
		return DriveRestoreArtifactsBulkAdditionRequestsRequest(self.request_adapter, path_parameters)
