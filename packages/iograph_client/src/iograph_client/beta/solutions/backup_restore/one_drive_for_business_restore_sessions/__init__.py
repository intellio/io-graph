...
from iograph_models.beta.one_drive_for_business_restore_session_collection_response import OneDriveForBusinessRestoreSessionCollectionResponse
...
class OneDriveForBusinessRestoreSessionsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/solutions/backupRestore/oneDriveForBusinessRestoreSessions", path_parameters)
	...
	def with_url(self, raw_url: str) -> OneDriveForBusinessRestoreSessionsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: OneDriveForBusinessRestoreSessionsRequest
		"""
		if raw_url is None:
