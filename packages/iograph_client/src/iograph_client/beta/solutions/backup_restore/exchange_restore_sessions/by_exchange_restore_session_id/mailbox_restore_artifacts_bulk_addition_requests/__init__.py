...
if TYPE_CHECKING:
	...
	from .by_mailbox_restore_artifacts_bulk_addition_request_id import ByMailboxRestoreArtifactsBulkAdditionRequestIdRequest
	from .......request_adapter import HttpxRequestAdapter
from iograph_models.beta.mailbox_restore_artifacts_bulk_addition_request_collection_response import MailboxRestoreArtifactsBulkAdditionRequestCollectionResponse
...
class MailboxRestoreArtifactsBulkAdditionRequestsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/solutions/backupRestore/exchangeRestoreSessions/{exchangeRestoreSession%2Did}/mailboxRestoreArtifactsBulkAdditionRequests", path_parameters)
	...
	def with_url(self, raw_url: str) -> MailboxRestoreArtifactsBulkAdditionRequestsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: MailboxRestoreArtifactsBulkAdditionRequestsRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return MailboxRestoreArtifactsBulkAdditionRequestsRequest(self.request_adapter, self.path_parameters)

	def by_mailbox_restore_artifacts_bulk_addition_request_id(self,
		exchangeRestoreSession_id: str,
		mailboxRestoreArtifactsBulkAdditionRequest_id: str,
	) -> ByMailboxRestoreArtifactsBulkAdditionRequestIdRequest:
		if exchangeRestoreSession_id is None:
			raise TypeError("exchangeRestoreSession_id cannot be null.")
		if mailboxRestoreArtifactsBulkAdditionRequest_id is None:
			raise TypeError("mailboxRestoreArtifactsBulkAdditionRequest_id cannot be null.")

		path_parameters = get_path_parameters(self.path_parameters)
		path_parameters["exchangeRestoreSession%2Did"] =  exchangeRestoreSession_id
		path_parameters["mailboxRestoreArtifactsBulkAdditionRequest%2Did"] =  mailboxRestoreArtifactsBulkAdditionRequest_id

		from .by_mailbox_restore_artifacts_bulk_addition_request_id import ByMailboxRestoreArtifactsBulkAdditionRequestIdRequest
		return ByMailboxRestoreArtifactsBulkAdditionRequestIdRequest(self.request_adapter, path_parameters)
