...
if TYPE_CHECKING:
	from .mailbox_restore_artifacts_bulk_addition_requests import MailboxRestoreArtifactsBulkAdditionRequestsRequest
...
class ByExchangeRestoreSessionIdRequest(BaseRequestBuilder):
	...
	def mailbox_restore_artifacts_bulk_addition_requests(self,
		exchangeRestoreSession_id: str,
	) -> MailboxRestoreArtifactsBulkAdditionRequestsRequest:
		if exchangeRestoreSession_id is None:
			raise TypeError("exchangeRestoreSession_id cannot be null.")
		...
		from .mailbox_restore_artifacts_bulk_addition_requests import MailboxRestoreArtifactsBulkAdditionRequestsRequest
		return MailboxRestoreArtifactsBulkAdditionRequestsRequest(self.request_adapter, path_parameters)
