...
class OperationsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/solutions/approval/operations", path_parameters)
	...
	def by_approval_operation_id(self,
		approvalOperation_id: str,
	) -> ByApprovalOperationIdRequest:
		if approvalOperation_id is None:
			raise TypeError("approvalOperation_id cannot be null.")

		path_parameters = get_path_parameters(self.path_parameters)
		path_parameters["approvalOperation%2Did"] =  approvalOperation_id

		from .by_approval_operation_id import ByApprovalOperationIdRequest
		return ByApprovalOperationIdRequest(self.request_adapter, path_parameters)
