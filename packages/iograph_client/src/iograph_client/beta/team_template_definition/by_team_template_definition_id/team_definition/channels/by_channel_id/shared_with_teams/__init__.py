...
from iograph_models.beta.shared_with_channel_team_info_collection_response import SharedWithChannelTeamInfoCollectionResponse
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class SharedWithTeamsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/channels/{channel%2Did}/sharedWithTeams", path_parameters)
	...
	async def get(
		...
		"""
		Get sharedWithTeams from teamTemplateDefinition
