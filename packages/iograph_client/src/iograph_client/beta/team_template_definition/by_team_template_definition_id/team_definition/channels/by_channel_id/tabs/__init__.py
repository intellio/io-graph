...
from iograph_models.beta.teams_tab_collection_response import TeamsTabCollectionResponse
from iograph_models.beta.teams_tab import TeamsTab


class TabsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/channels/{channel%2Did}/tabs", path_parameters)
	...
	async def get(
		...
		"""
		Get tabs from teamTemplateDefinition
