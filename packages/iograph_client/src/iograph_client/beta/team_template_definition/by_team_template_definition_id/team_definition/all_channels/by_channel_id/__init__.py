...
class ByChannelIdRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/teamTemplateDefinition/{teamTemplateDefinition%2Did}/teamDefinition/allChannels/{channel%2Did}", path_parameters)
	...
	async def get(
		...
		"""
		Get allChannels from teamTemplateDefinition
