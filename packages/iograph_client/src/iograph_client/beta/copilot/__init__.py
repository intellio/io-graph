...
from iograph_models.beta.copilot_root import CopilotRoot


class CopilotRequest(BaseRequestBuilder):
	...
	async def get(
		...
		return await self.request_adapter.send_async(request_info, CopilotRoot, error_mapping)
	...
	def with_url(self, raw_url: str) -> CopilotRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: CopilotRequest
		"""
		if raw_url is None:
