...
class UsersRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/copilot/users", path_parameters)
	...
	def by_ai_user_id(self,
		...
		from .by_ai_user_id import ByAiUserIdRequest
		return ByAiUserIdRequest(self.request_adapter, path_parameters)
