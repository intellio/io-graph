...
class DeltaRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/directorySettingTemplates/delta()", path_parameters)
	...
	async def get(
		...
		"""
		tags = ['directorySettingTemplates.directorySettingTemplate.Functions']
