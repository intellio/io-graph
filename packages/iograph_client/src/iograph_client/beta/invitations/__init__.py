...
if TYPE_CHECKING:
	from .invited_user_sponsors import InvitedUserSponsorsRequest
	from .invited_user import InvitedUserRequest
	from .count import CountRequest
	from ...request_adapter import HttpxRequestAdapter
from iograph_models.beta.invitation_collection_response import InvitationCollectionResponse
from iograph_models.beta.invitation import Invitation
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class InvitationsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/invitations", path_parameters)
	...
	def with_url(self, raw_url: str) -> InvitationsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: InvitationsRequest
		"""
		if raw_url is None:
	...
	def invited_user(self,
		...
		from .invited_user import InvitedUserRequest
		return InvitedUserRequest(self.request_adapter, self.path_parameters)

	@property
	def invited_user_sponsors(self,
	) -> InvitedUserSponsorsRequest:
		from .invited_user_sponsors import InvitedUserSponsorsRequest
		return InvitedUserSponsorsRequest(self.request_adapter, self.path_parameters)
