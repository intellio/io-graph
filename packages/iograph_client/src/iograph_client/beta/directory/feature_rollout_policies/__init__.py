...
from iograph_models.beta.feature_rollout_policy import FeatureRolloutPolicy
from iograph_models.beta.feature_rollout_policy_collection_response import FeatureRolloutPolicyCollectionResponse


class FeatureRolloutPoliciesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/directory/featureRolloutPolicies", path_parameters)
	...
	def with_url(self, raw_url: str) -> FeatureRolloutPoliciesRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: FeatureRolloutPoliciesRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return FeatureRolloutPoliciesRequest(self.request_adapter, self.path_parameters)

	def by_feature_rollout_policy_id(self,
		featureRolloutPolicy_id: str,
	) -> ByFeatureRolloutPolicyIdRequest:
		...
		from .by_feature_rollout_policy_id import ByFeatureRolloutPolicyIdRequest
		return ByFeatureRolloutPolicyIdRequest(self.request_adapter, path_parameters)
