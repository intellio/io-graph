...
from iograph_models.beta.company_subscription import CompanySubscription
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class SubscriptionsWithCommerceSubscriptionIdRequest(BaseRequestBuilder):
	...
	def with_url(self, raw_url: str) -> SubscriptionsWithCommerceSubscriptionIdRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: SubscriptionsWithCommerceSubscriptionIdRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return SubscriptionsWithCommerceSubscriptionIdRequest(self.request_adapter, self.path_parameters)
