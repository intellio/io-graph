...
class TenantsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/directory/outboundSharedUserProfiles/{outboundSharedUserProfile%2DuserId}/tenants", path_parameters)
	...
	def by_tenant_reference_tenant_id(self,
		outboundSharedUserProfile_userId: str,
		tenantReference_tenantId: str,
	) -> ByTenantReferenceTenantIdRequest:
		...
		from .by_tenant_reference_tenant_id import ByTenantReferenceTenantIdRequest
		return ByTenantReferenceTenantIdRequest(self.request_adapter, path_parameters)
