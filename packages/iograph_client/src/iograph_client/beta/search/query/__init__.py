...
from iograph_models.beta.query_post_request import QueryPostRequest
from iograph_models.beta.query_post_response import QueryPostResponse
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class QueryRequest(BaseRequestBuilder):
	...
	def with_url(self, raw_url: str) -> QueryRequest:
		"""
