...
from iograph_models.beta.authentication_methods_policy import AuthenticationMethodsPolicy
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class AuthenticationMethodsPolicyRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/authenticationMethodsPolicy", path_parameters)
	...
	async def get(
		...
		"""
		tags = ['authenticationMethodsPolicy.authenticationMethodsPolicy']
