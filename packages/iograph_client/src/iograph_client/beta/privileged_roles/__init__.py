...
if TYPE_CHECKING:
	...
	from .by_privileged_role_id import ByPrivilegedRoleIdRequest
	from ...request_adapter import HttpxRequestAdapter
from iograph_models.beta.privileged_role_collection_response import PrivilegedRoleCollectionResponse
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.beta.privileged_role import PrivilegedRole


class PrivilegedRolesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/privilegedRoles", path_parameters)
	...
	def with_url(self, raw_url: str) -> PrivilegedRolesRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: PrivilegedRolesRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return PrivilegedRolesRequest(self.request_adapter, self.path_parameters)

	def by_privileged_role_id(self,
		privilegedRole_id: str,
	) -> ByPrivilegedRoleIdRequest:
		...
		from .by_privileged_role_id import ByPrivilegedRoleIdRequest
		return ByPrivilegedRoleIdRequest(self.request_adapter, path_parameters)
