...
from iograph_models.beta.cross_tenant_access_policy_configuration_default import CrossTenantAccessPolicyConfigurationDefault


class DefaultRequest(BaseRequestBuilder):
	...
	def with_url(self, raw_url: str) -> DefaultRequest:
		"""
