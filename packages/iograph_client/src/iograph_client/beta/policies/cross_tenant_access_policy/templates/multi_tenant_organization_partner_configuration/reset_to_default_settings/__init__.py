...
class ResetToDefaultSettingsRequest(BaseRequestBuilder):
	...
	async def post(
		...
		"""
		Invoke action resetToDefaultSettings
	...
	def with_url(self, raw_url: str) -> ResetToDefaultSettingsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: ResetToDefaultSettingsRequest
		"""
		if raw_url is None:
