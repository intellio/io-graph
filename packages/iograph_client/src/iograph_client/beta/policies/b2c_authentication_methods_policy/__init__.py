...
from iograph_models.beta.b2c_authentication_methods_policy import B2cAuthenticationMethodsPolicy
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class B2cAuthenticationMethodsPolicyRequest(BaseRequestBuilder):
	...
	async def get(
		...
		"""
		tags = ['policies.b2cAuthenticationMethodsPolicy']
	...
	async def patch(
		self,
		body: B2cAuthenticationMethodsPolicy,
	...
	def with_url(self, raw_url: str) -> B2cAuthenticationMethodsPolicyRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: B2cAuthenticationMethodsPolicyRequest
		"""
		if raw_url is None:
