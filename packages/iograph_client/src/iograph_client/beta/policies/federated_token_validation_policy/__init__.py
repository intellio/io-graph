...
from iograph_models.beta.federated_token_validation_policy import FederatedTokenValidationPolicy
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class FederatedTokenValidationPolicyRequest(BaseRequestBuilder):
	...
	async def get(
		...
		"""
		tags = ['policies.federatedTokenValidationPolicy']
	...
	async def patch(
		self,
		body: FederatedTokenValidationPolicy,
	...
	def with_url(self, raw_url: str) -> FederatedTokenValidationPolicyRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: FederatedTokenValidationPolicyRequest
		"""
		if raw_url is None:
