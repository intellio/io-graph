...
if TYPE_CHECKING:
	...
	from .by_service_principal_creation_policy_id import ByServicePrincipalCreationPolicyIdRequest
...
from iograph_models.beta.service_principal_creation_policy_collection_response import ServicePrincipalCreationPolicyCollectionResponse


class ServicePrincipalCreationPoliciesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/policies/servicePrincipalCreationPolicies", path_parameters)
	...
	def with_url(self, raw_url: str) -> ServicePrincipalCreationPoliciesRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: ServicePrincipalCreationPoliciesRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return ServicePrincipalCreationPoliciesRequest(self.request_adapter, self.path_parameters)

	def by_service_principal_creation_policy_id(self,
		servicePrincipalCreationPolicy_id: str,
	) -> ByServicePrincipalCreationPolicyIdRequest:
		...
		from .by_service_principal_creation_policy_id import ByServicePrincipalCreationPolicyIdRequest
		return ByServicePrincipalCreationPolicyIdRequest(self.request_adapter, path_parameters)
