...
from iograph_models.beta.authentication_strength_policy import AuthenticationStrengthPolicy
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.beta.authentication_strength_policy_collection_response import AuthenticationStrengthPolicyCollectionResponse


class AuthenticationStrengthPoliciesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/policies/authenticationStrengthPolicies", path_parameters)
	...
	def with_url(self, raw_url: str) -> AuthenticationStrengthPoliciesRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: AuthenticationStrengthPoliciesRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return AuthenticationStrengthPoliciesRequest(self.request_adapter, self.path_parameters)

	def by_authentication_strength_policy_id(self,
		authenticationStrengthPolicy_id: str,
	) -> ByAuthenticationStrengthPolicyIdRequest:
		...
		from .by_authentication_strength_policy_id import ByAuthenticationStrengthPolicyIdRequest
		return ByAuthenticationStrengthPolicyIdRequest(self.request_adapter, path_parameters)
