...
from iograph_models.beta.external_identities_policy import ExternalIdentitiesPolicy
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class ExternalIdentitiesPolicyRequest(BaseRequestBuilder):
	...
	async def get(
		...
		"""
		tags = ['policies.externalIdentitiesPolicy']
	...
	def with_url(self, raw_url: str) -> ExternalIdentitiesPolicyRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: ExternalIdentitiesPolicyRequest
		"""
		if raw_url is None:
