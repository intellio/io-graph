...
from iograph_models.beta.permission_grant_condition_set_collection_response import PermissionGrantConditionSetCollectionResponse
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.beta.permission_grant_condition_set import PermissionGrantConditionSet


class IncludesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/policies/permissionGrantPolicies/{permissionGrantPolicy%2Did}/includes", path_parameters)
	...
	def with_url(self, raw_url: str) -> IncludesRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: IncludesRequest
		"""
		if raw_url is None:
