...
if TYPE_CHECKING:
	from .my_requests import MyRequestsRequest
...
class PrivilegedApprovalRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/privilegedApproval", path_parameters)
	...
	async def get(
		...
		"""
		tags = ['privilegedApproval.privilegedApproval']
	...
	def with_url(self, raw_url: str) -> PrivilegedApprovalRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: PrivilegedApprovalRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return PrivilegedApprovalRequest(self.request_adapter, self.path_parameters)

	def by_privileged_approval_id(self,
		privilegedApproval_id: str,
	) -> ByPrivilegedApprovalIdRequest:
		if privilegedApproval_id is None:
			raise TypeError("privilegedApproval_id cannot be null.")

		path_parameters = get_path_parameters(self.path_parameters)
		path_parameters["privilegedApproval%2Did"] =  privilegedApproval_id

		from .by_privileged_approval_id import ByPrivilegedApprovalIdRequest
		return ByPrivilegedApprovalIdRequest(self.request_adapter, path_parameters)
	...
	def my_requests(self,
		...
		from .my_requests import MyRequestsRequest
		return MyRequestsRequest(self.request_adapter, self.path_parameters)
