...
from iograph_models.beta.get_by_ids_post_request import Get_by_idsPostRequest
from iograph_models.beta.get_by_ids_post_response import Get_by_idsPostResponse
