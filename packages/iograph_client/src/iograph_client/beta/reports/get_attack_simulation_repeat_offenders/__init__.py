...
from iograph_models.beta.get_attack_simulation_repeat_offenders_get_response import Get_attack_simulation_repeat_offendersGetResponse


class GetAttackSimulationRepeatOffendersRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/reports/getAttackSimulationRepeatOffenders()", path_parameters)
