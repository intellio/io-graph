...
class CredentialUserRegistrationDetailsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/reports/credentialUserRegistrationDetails", path_parameters)
	...
	async def get(
		...
		"""
		tags = ['reports.credentialUserRegistrationDetails']
	...
	async def post(
		self,
		body: CredentialUserRegistrationDetails,
	...
	def with_url(self, raw_url: str) -> CredentialUserRegistrationDetailsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: CredentialUserRegistrationDetailsRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return CredentialUserRegistrationDetailsRequest(self.request_adapter, self.path_parameters)

	def by_credential_user_registration_details_id(self,
		credentialUserRegistrationDetails_id: str,
	) -> ByCredentialUserRegistrationDetailsIdRequest:
		if credentialUserRegistrationDetails_id is None:
			raise TypeError("credentialUserRegistrationDetails_id cannot be null.")

		path_parameters = get_path_parameters(self.path_parameters)
		path_parameters["credentialUserRegistrationDetails%2Did"] =  credentialUserRegistrationDetails_id

		from .by_credential_user_registration_details_id import ByCredentialUserRegistrationDetailsIdRequest
		return ByCredentialUserRegistrationDetailsIdRequest(self.request_adapter, path_parameters)
