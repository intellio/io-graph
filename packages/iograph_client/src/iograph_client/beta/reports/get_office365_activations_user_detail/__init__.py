...
class GetOffice365ActivationsUserDetailRequest(BaseRequestBuilder):
	...
	def with_url(self, raw_url: str) -> GetOffice365ActivationsUserDetailRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: GetOffice365ActivationsUserDetailRequest
		"""
		if raw_url is None:
