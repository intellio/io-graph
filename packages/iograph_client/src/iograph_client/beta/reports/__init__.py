...
if TYPE_CHECKING:
	from .user_insights import UserInsightsRequest
	from .user_credential_usage_details import UserCredentialUsageDetailsRequest
	from .sla import SlaRequest
	from .service_principal_sign_in_activities import ServicePrincipalSignInActivitiesRequest
	from .service_activity import ServiceActivityRequest
	from .security import SecurityRequest
	from .partners import PartnersRequest
	from .monthly_print_usage_summaries_by_user import MonthlyPrintUsageSummariesByUserRequest
	from .monthly_print_usage_summaries_by_printer import MonthlyPrintUsageSummariesByPrinterRequest
	...
	from .managed_device_enrollment_failure_trends import ManagedDeviceEnrollmentFailureTrendsRequest
	...
	from .managed_device_enrollment_abandonment_summary_with_skip_top_filter_skiptoken import ManagedDeviceEnrollmentAbandonmentSummaryWithSkipTopFilterSkipTokenRequest
	from .managed_device_enrollment_abandonment_details_with_skip_top_filter_skiptoken import ManagedDeviceEnrollmentAbandonmentDetailsWithSkipTopFilterSkipTokenRequest
	...
	from .get_teams_user_activity_total_user_counts_with_period import GetTeamsUserActivityTotalUserCountsWithPeriodRequest
	from .get_teams_user_activity_total_distribution_counts_with_period import GetTeamsUserActivityTotalDistributionCountsWithPeriodRequest
	from .get_teams_user_activity_total_counts_with_period import GetTeamsUserActivityTotalCountsWithPeriodRequest
	from .get_teams_user_activity_distribution_user_counts_with_period import GetTeamsUserActivityDistributionUserCountsWithPeriodRequest
	from .get_teams_user_activity_distribution_total_user_counts_with_period import GetTeamsUserActivityDistributionTotalUserCountsWithPeriodRequest
	...
	from .get_teams_device_usage_total_user_counts_with_period import GetTeamsDeviceUsageTotalUserCountsWithPeriodRequest
	...
	from .get_teams_device_usage_distribution_total_user_counts_with_period import GetTeamsDeviceUsageDistributionTotalUserCountsWithPeriodRequest
	...
	from .get_microsoft365_copilot_user_count_trend_with_period import GetMicrosoft365CopilotUserCountTrendWithPeriodRequest
	from .get_microsoft365_copilot_user_count_summary_with_period import GetMicrosoft365CopilotUserCountSummaryWithPeriodRequest
	from .get_microsoft365_copilot_usage_user_detail_with_period import GetMicrosoft365CopilotUsageUserDetailWithPeriodRequest
	...
	from .get_forms_user_activity_user_detail_with_period import GetFormsUserActivityUserDetailWithPeriodRequest
	from .get_forms_user_activity_user_detail_with_date import GetFormsUserActivityUserDetailWithDateRequest
	from .get_forms_user_activity_user_counts_with_period import GetFormsUserActivityUserCountsWithPeriodRequest
	from .get_forms_user_activity_counts_with_period import GetFormsUserActivityCountsWithPeriodRequest
	...
	from .get_credential_user_registration_count import GetCredentialUserRegistrationCountRequest
	from .get_credential_usage_summary_with_period import GetCredentialUsageSummaryWithPeriodRequest
	from .get_browser_user_detail_with_period import GetBrowserUserDetailWithPeriodRequest
	from .get_browser_user_counts_with_period import GetBrowserUserCountsWithPeriodRequest
	from .get_browser_distribution_user_counts_with_period import GetBrowserDistributionUserCountsWithPeriodRequest
	from .get_azure_a_d_application_sign_in_summary_with_period import GetAzureADApplicationSignInSummaryWithPeriodRequest
	...
	from .health_monitoring import HealthMonitoringRequest
	from .daily_print_usage_summaries_by_user import DailyPrintUsageSummariesByUserRequest
	from .daily_print_usage_summaries_by_printer import DailyPrintUsageSummariesByPrinterRequest
	...
	from .daily_print_usage import DailyPrintUsageRequest
	from .credential_user_registration_details import CredentialUserRegistrationDetailsRequest
...
class ReportsRequest(BaseRequestBuilder):
	...
	@property
	def app_credential_sign_in_activities(self,
	) -> AppCredentialSignInActivitiesRequest:
		from .app_credential_sign_in_activities import AppCredentialSignInActivitiesRequest
		return AppCredentialSignInActivitiesRequest(self.request_adapter, self.path_parameters)

	@property
	def application_sign_in_detailed_summary(self,
	) -> ApplicationSignInDetailedSummaryRequest:
		from .application_sign_in_detailed_summary import ApplicationSignInDetailedSummaryRequest
		return ApplicationSignInDetailedSummaryRequest(self.request_adapter, self.path_parameters)
	...
	@property
	def credential_user_registration_details(self,
	) -> CredentialUserRegistrationDetailsRequest:
		from .credential_user_registration_details import CredentialUserRegistrationDetailsRequest
		return CredentialUserRegistrationDetailsRequest(self.request_adapter, self.path_parameters)

	@property
	def daily_print_usage(self,
	) -> DailyPrintUsageRequest:
		from .daily_print_usage import DailyPrintUsageRequest
	...
	@property
	def daily_print_usage_summaries_by_printer(self,
	) -> DailyPrintUsageSummariesByPrinterRequest:
		from .daily_print_usage_summaries_by_printer import DailyPrintUsageSummariesByPrinterRequest
		return DailyPrintUsageSummariesByPrinterRequest(self.request_adapter, self.path_parameters)

	@property
	def daily_print_usage_summaries_by_user(self,
	) -> DailyPrintUsageSummariesByUserRequest:
		from .daily_print_usage_summaries_by_user import DailyPrintUsageSummariesByUserRequest
		return DailyPrintUsageSummariesByUserRequest(self.request_adapter, self.path_parameters)
	...
	def get_azure_a_d_application_sign_in_summary_with_period(self,
		period: str,
	) -> GetAzureADApplicationSignInSummaryWithPeriodRequest:
		if period is None:
		...
		from .get_azure_a_d_application_sign_in_summary_with_period import GetAzureADApplicationSignInSummaryWithPeriodRequest
		return GetAzureADApplicationSignInSummaryWithPeriodRequest(self.request_adapter, path_parameters)

	def get_browser_distribution_user_counts_with_period(self,
		period: str,
	) -> GetBrowserDistributionUserCountsWithPeriodRequest:
		if period is None:
			raise TypeError("period cannot be null.")
		...
		from .get_browser_distribution_user_counts_with_period import GetBrowserDistributionUserCountsWithPeriodRequest
		return GetBrowserDistributionUserCountsWithPeriodRequest(self.request_adapter, path_parameters)

	def get_browser_user_counts_with_period(self,
		period: str,
	) -> GetBrowserUserCountsWithPeriodRequest:
		if period is None:
			raise TypeError("period cannot be null.")
		...
		from .get_browser_user_counts_with_period import GetBrowserUserCountsWithPeriodRequest
		return GetBrowserUserCountsWithPeriodRequest(self.request_adapter, path_parameters)

	def get_browser_user_detail_with_period(self,
		period: str,
	) -> GetBrowserUserDetailWithPeriodRequest:
		if period is None:
			raise TypeError("period cannot be null.")
		...
		from .get_browser_user_detail_with_period import GetBrowserUserDetailWithPeriodRequest
		return GetBrowserUserDetailWithPeriodRequest(self.request_adapter, path_parameters)

	def get_credential_usage_summary_with_period(self,
		period: str,
	) -> GetCredentialUsageSummaryWithPeriodRequest:
		if period is None:
			raise TypeError("period cannot be null.")
		...
		from .get_credential_usage_summary_with_period import GetCredentialUsageSummaryWithPeriodRequest
		return GetCredentialUsageSummaryWithPeriodRequest(self.request_adapter, path_parameters)

	@property
	def get_credential_user_registration_count(self,
	) -> GetCredentialUserRegistrationCountRequest:
		from .get_credential_user_registration_count import GetCredentialUserRegistrationCountRequest
		return GetCredentialUserRegistrationCountRequest(self.request_adapter, self.path_parameters)
	...
	def get_forms_user_activity_counts_with_period(self,
		period: str,
	) -> GetFormsUserActivityCountsWithPeriodRequest:
		if period is None:
			raise TypeError("period cannot be null.")
		...
		from .get_forms_user_activity_counts_with_period import GetFormsUserActivityCountsWithPeriodRequest
		return GetFormsUserActivityCountsWithPeriodRequest(self.request_adapter, path_parameters)

	def get_forms_user_activity_user_counts_with_period(self,
		period: str,
	) -> GetFormsUserActivityUserCountsWithPeriodRequest:
		if period is None:
			raise TypeError("period cannot be null.")
		...
		from .get_forms_user_activity_user_counts_with_period import GetFormsUserActivityUserCountsWithPeriodRequest
		return GetFormsUserActivityUserCountsWithPeriodRequest(self.request_adapter, path_parameters)

	def get_forms_user_activity_user_detail_with_date(self,
		date: str,
	) -> GetFormsUserActivityUserDetailWithDateRequest:
		if date is None:
			raise TypeError("date cannot be null.")
		...
		from .get_forms_user_activity_user_detail_with_date import GetFormsUserActivityUserDetailWithDateRequest
		return GetFormsUserActivityUserDetailWithDateRequest(self.request_adapter, path_parameters)

	def get_forms_user_activity_user_detail_with_period(self,
		period: str,
	) -> GetFormsUserActivityUserDetailWithPeriodRequest:
		if period is None:
			raise TypeError("period cannot be null.")
		...
		from .get_forms_user_activity_user_detail_with_period import GetFormsUserActivityUserDetailWithPeriodRequest
		return GetFormsUserActivityUserDetailWithPeriodRequest(self.request_adapter, path_parameters)
	...
	def get_microsoft365_copilot_usage_user_detail_with_period(self,
		period: str,
	) -> GetMicrosoft365CopilotUsageUserDetailWithPeriodRequest:
		if period is None:
			raise TypeError("period cannot be null.")
		...
		from .get_microsoft365_copilot_usage_user_detail_with_period import GetMicrosoft365CopilotUsageUserDetailWithPeriodRequest
		return GetMicrosoft365CopilotUsageUserDetailWithPeriodRequest(self.request_adapter, path_parameters)

	def get_microsoft365_copilot_user_count_summary_with_period(self,
		period: str,
	) -> GetMicrosoft365CopilotUserCountSummaryWithPeriodRequest:
		if period is None:
			raise TypeError("period cannot be null.")
		...
		from .get_microsoft365_copilot_user_count_summary_with_period import GetMicrosoft365CopilotUserCountSummaryWithPeriodRequest
		return GetMicrosoft365CopilotUserCountSummaryWithPeriodRequest(self.request_adapter, path_parameters)

	def get_microsoft365_copilot_user_count_trend_with_period(self,
		period: str,
	) -> GetMicrosoft365CopilotUserCountTrendWithPeriodRequest:
		if period is None:
			raise TypeError("period cannot be null.")
		...
		from .get_microsoft365_copilot_user_count_trend_with_period import GetMicrosoft365CopilotUserCountTrendWithPeriodRequest
		return GetMicrosoft365CopilotUserCountTrendWithPeriodRequest(self.request_adapter, path_parameters)
	...
	def get_teams_device_usage_distribution_total_user_counts_with_period(self,
		period: str,
	) -> GetTeamsDeviceUsageDistributionTotalUserCountsWithPeriodRequest:
		if period is None:
			raise TypeError("period cannot be null.")
		...
		from .get_teams_device_usage_distribution_total_user_counts_with_period import GetTeamsDeviceUsageDistributionTotalUserCountsWithPeriodRequest
		return GetTeamsDeviceUsageDistributionTotalUserCountsWithPeriodRequest(self.request_adapter, path_parameters)
	...
	def get_teams_device_usage_total_user_counts_with_period(self,
		period: str,
	) -> GetTeamsDeviceUsageTotalUserCountsWithPeriodRequest:
		if period is None:
			raise TypeError("period cannot be null.")
		...
		from .get_teams_device_usage_total_user_counts_with_period import GetTeamsDeviceUsageTotalUserCountsWithPeriodRequest
		return GetTeamsDeviceUsageTotalUserCountsWithPeriodRequest(self.request_adapter, path_parameters)
	...
	def get_teams_user_activity_distribution_total_user_counts_with_period(self,
		period: str,
	) -> GetTeamsUserActivityDistributionTotalUserCountsWithPeriodRequest:
		if period is None:
			raise TypeError("period cannot be null.")
		...
		from .get_teams_user_activity_distribution_total_user_counts_with_period import GetTeamsUserActivityDistributionTotalUserCountsWithPeriodRequest
		return GetTeamsUserActivityDistributionTotalUserCountsWithPeriodRequest(self.request_adapter, path_parameters)

	def get_teams_user_activity_distribution_user_counts_with_period(self,
		period: str,
	) -> GetTeamsUserActivityDistributionUserCountsWithPeriodRequest:
		if period is None:
			raise TypeError("period cannot be null.")
		...
		from .get_teams_user_activity_distribution_user_counts_with_period import GetTeamsUserActivityDistributionUserCountsWithPeriodRequest
		return GetTeamsUserActivityDistributionUserCountsWithPeriodRequest(self.request_adapter, path_parameters)

	def get_teams_user_activity_total_counts_with_period(self,
		period: str,
	) -> GetTeamsUserActivityTotalCountsWithPeriodRequest:
		if period is None:
			raise TypeError("period cannot be null.")
		...
		from .get_teams_user_activity_total_counts_with_period import GetTeamsUserActivityTotalCountsWithPeriodRequest
		return GetTeamsUserActivityTotalCountsWithPeriodRequest(self.request_adapter, path_parameters)

	def get_teams_user_activity_total_distribution_counts_with_period(self,
		period: str,
	) -> GetTeamsUserActivityTotalDistributionCountsWithPeriodRequest:
		if period is None:
			raise TypeError("period cannot be null.")
		...
		from .get_teams_user_activity_total_distribution_counts_with_period import GetTeamsUserActivityTotalDistributionCountsWithPeriodRequest
		return GetTeamsUserActivityTotalDistributionCountsWithPeriodRequest(self.request_adapter, path_parameters)

	def get_teams_user_activity_total_user_counts_with_period(self,
		period: str,
	) -> GetTeamsUserActivityTotalUserCountsWithPeriodRequest:
		if period is None:
			raise TypeError("period cannot be null.")
		...
		from .get_teams_user_activity_total_user_counts_with_period import GetTeamsUserActivityTotalUserCountsWithPeriodRequest
		return GetTeamsUserActivityTotalUserCountsWithPeriodRequest(self.request_adapter, path_parameters)
	...
	def managed_device_enrollment_abandonment_details_with_skip_top_filter_skiptoken(self,
		skip: int,
		top: int,
		filter: str,
		skipToken: str,
	) -> ManagedDeviceEnrollmentAbandonmentDetailsWithSkipTopFilterSkipTokenRequest:
		if skip is None:
		...
		from .managed_device_enrollment_abandonment_details_with_skip_top_filter_skiptoken import ManagedDeviceEnrollmentAbandonmentDetailsWithSkipTopFilterSkipTokenRequest
		return ManagedDeviceEnrollmentAbandonmentDetailsWithSkipTopFilterSkipTokenRequest(self.request_adapter, path_parameters)

	def managed_device_enrollment_abandonment_summary_with_skip_top_filter_skiptoken(self,
		skip: int,
		top: int,
		filter: str,
		skipToken: str,
	) -> ManagedDeviceEnrollmentAbandonmentSummaryWithSkipTopFilterSkipTokenRequest:
		if skip is None:
			raise TypeError("skip cannot be null.")
		if top is None:
			raise TypeError("top cannot be null.")
		...
		from .managed_device_enrollment_abandonment_summary_with_skip_top_filter_skiptoken import ManagedDeviceEnrollmentAbandonmentSummaryWithSkipTopFilterSkipTokenRequest
		return ManagedDeviceEnrollmentAbandonmentSummaryWithSkipTopFilterSkipTokenRequest(self.request_adapter, path_parameters)
	...
	@property
	def managed_device_enrollment_failure_trends(self,
	) -> ManagedDeviceEnrollmentFailureTrendsRequest:
		from .managed_device_enrollment_failure_trends import ManagedDeviceEnrollmentFailureTrendsRequest
		return ManagedDeviceEnrollmentFailureTrendsRequest(self.request_adapter, self.path_parameters)
	...
	@property
	def monthly_print_usage_summaries_by_printer(self,
	) -> MonthlyPrintUsageSummariesByPrinterRequest:
		from .monthly_print_usage_summaries_by_printer import MonthlyPrintUsageSummariesByPrinterRequest
		return MonthlyPrintUsageSummariesByPrinterRequest(self.request_adapter, self.path_parameters)

	@property
	def monthly_print_usage_summaries_by_user(self,
	) -> MonthlyPrintUsageSummariesByUserRequest:
		from .monthly_print_usage_summaries_by_user import MonthlyPrintUsageSummariesByUserRequest
		return MonthlyPrintUsageSummariesByUserRequest(self.request_adapter, self.path_parameters)
	...
	def service_activity(self,
		...
		from .service_activity import ServiceActivityRequest
		return ServiceActivityRequest(self.request_adapter, self.path_parameters)

	@property
	def service_principal_sign_in_activities(self,
	) -> ServicePrincipalSignInActivitiesRequest:
		from .service_principal_sign_in_activities import ServicePrincipalSignInActivitiesRequest
	...
	@property
	def user_credential_usage_details(self,
	) -> UserCredentialUsageDetailsRequest:
		from .user_credential_usage_details import UserCredentialUsageDetailsRequest
		return UserCredentialUsageDetailsRequest(self.request_adapter, self.path_parameters)

	@property
	def user_insights(self,
	) -> UserInsightsRequest:
		from .user_insights import UserInsightsRequest
		return UserInsightsRequest(self.request_adapter, self.path_parameters)
