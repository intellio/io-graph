...
from iograph_models.beta.azure_a_d_authentication import AzureADAuthentication


class AzureADAuthenticationRequest(BaseRequestBuilder):
	...
	def with_url(self, raw_url: str) -> AzureADAuthenticationRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: AzureADAuthenticationRequest
		"""
		if raw_url is None:
