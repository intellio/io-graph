...
if TYPE_CHECKING:
	...
	from .by_user_sign_up_metric_id import ByUserSignUpMetricIdRequest
	from ......request_adapter import HttpxRequestAdapter
from iograph_models.beta.user_sign_up_metric_collection_response import UserSignUpMetricCollectionResponse
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class SignUpsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/reports/userInsights/monthly/signUps", path_parameters)
	...
	def by_user_sign_up_metric_id(self,
		userSignUpMetric_id: str,
	) -> ByUserSignUpMetricIdRequest:
		if userSignUpMetric_id is None:
			raise TypeError("userSignUpMetric_id cannot be null.")

		path_parameters = get_path_parameters(self.path_parameters)
		path_parameters["userSignUpMetric%2Did"] =  userSignUpMetric_id

		from .by_user_sign_up_metric_id import ByUserSignUpMetricIdRequest
		return ByUserSignUpMetricIdRequest(self.request_adapter, path_parameters)
