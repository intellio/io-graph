...
from iograph_models.beta.time_off_reason import TimeOffReason
from iograph_models.beta.time_off_reason_collection_response import TimeOffReasonCollectionResponse
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class TimeOffReasonsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/schedule/timeOffReasons", path_parameters)
	...
	async def get(
		...
		"""
		Get timeOffReasons from teamwork
