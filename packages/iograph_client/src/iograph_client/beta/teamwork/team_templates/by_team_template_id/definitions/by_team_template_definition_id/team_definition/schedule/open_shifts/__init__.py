...
from iograph_models.beta.open_shift_collection_response import OpenShiftCollectionResponse
from iograph_models.beta.open_shift import OpenShift
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class OpenShiftsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/teamwork/teamTemplates/{teamTemplate%2Did}/definitions/{teamTemplateDefinition%2Did}/teamDefinition/schedule/openShifts", path_parameters)
