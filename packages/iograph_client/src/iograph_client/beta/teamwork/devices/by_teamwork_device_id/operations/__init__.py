...
class OperationsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/teamwork/devices/{teamworkDevice%2Did}/operations", path_parameters)
	...
	def by_teamwork_device_operation_id(self,
		teamworkDevice_id: str,
		teamworkDeviceOperation_id: str,
	) -> ByTeamworkDeviceOperationIdRequest:
		if teamworkDevice_id is None:
			raise TypeError("teamworkDevice_id cannot be null.")
		if teamworkDeviceOperation_id is None:
			raise TypeError("teamworkDeviceOperation_id cannot be null.")

		path_parameters = get_path_parameters(self.path_parameters)
		path_parameters["teamworkDevice%2Did"] =  teamworkDevice_id
		path_parameters["teamworkDeviceOperation%2Did"] =  teamworkDeviceOperation_id

		from .by_teamwork_device_operation_id import ByTeamworkDeviceOperationIdRequest
		return ByTeamworkDeviceOperationIdRequest(self.request_adapter, path_parameters)
