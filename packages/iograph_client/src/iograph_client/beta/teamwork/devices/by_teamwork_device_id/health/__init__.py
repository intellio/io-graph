...
from iograph_models.beta.teamwork_device_health import TeamworkDeviceHealth
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class HealthRequest(BaseRequestBuilder):
	...
	def with_url(self, raw_url: str) -> HealthRequest:
		"""
		...
		return HealthRequest(self.request_adapter, self.path_parameters)
