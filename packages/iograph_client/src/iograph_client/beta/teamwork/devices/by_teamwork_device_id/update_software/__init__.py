...
from iograph_models.beta.update_software_post_request import Update_softwarePostRequest


class UpdateSoftwareRequest(BaseRequestBuilder):
	...
	async def post(
		self,
		body: Update_softwarePostRequest,
	...
	def with_url(self, raw_url: str) -> UpdateSoftwareRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: UpdateSoftwareRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return UpdateSoftwareRequest(self.request_adapter, self.path_parameters)
