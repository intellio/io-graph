...
from iograph_models.beta.workforce_integration import WorkforceIntegration
from iograph_models.beta.workforce_integration_collection_response import WorkforceIntegrationCollectionResponse
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class WorkforceIntegrationsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/teamwork/workforceIntegrations", path_parameters)
	...
	def with_url(self, raw_url: str) -> WorkforceIntegrationsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: WorkforceIntegrationsRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return WorkforceIntegrationsRequest(self.request_adapter, self.path_parameters)

	def by_workforce_integration_id(self,
		workforceIntegration_id: str,
	) -> ByWorkforceIntegrationIdRequest:
		if workforceIntegration_id is None:
			raise TypeError("workforceIntegration_id cannot be null.")

		path_parameters = get_path_parameters(self.path_parameters)
		path_parameters["workforceIntegration%2Did"] =  workforceIntegration_id

		from .by_workforce_integration_id import ByWorkforceIntegrationIdRequest
		return ByWorkforceIntegrationIdRequest(self.request_adapter, path_parameters)
