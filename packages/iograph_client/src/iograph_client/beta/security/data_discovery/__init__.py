...
class DataDiscoveryRequest(BaseRequestBuilder):
	...
	async def get(
		...
		return await self.request_adapter.send_async(request_info, SecurityDataDiscoveryRoot, error_mapping)

	async def patch(
		self,
		body: SecurityDataDiscoveryRoot,
	...
	def with_url(self, raw_url: str) -> DataDiscoveryRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: DataDiscoveryRequest
		"""
		if raw_url is None:
	...
	@property
	def cloud_app_discovery(self,
	) -> CloudAppDiscoveryRequest:
		from .cloud_app_discovery import CloudAppDiscoveryRequest
