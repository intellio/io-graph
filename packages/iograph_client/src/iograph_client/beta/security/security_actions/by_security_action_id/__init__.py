...
if TYPE_CHECKING:
	from .cancel_security_action import CancelSecurityActionRequest
	from .....request_adapter import HttpxRequestAdapter
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.beta.security_action import SecurityAction


class BySecurityActionIdRequest(BaseRequestBuilder):
	...
	def with_url(self, raw_url: str) -> BySecurityActionIdRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: BySecurityActionIdRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return BySecurityActionIdRequest(self.request_adapter, self.path_parameters)

	def cancel_security_action(self,
		securityAction_id: str,
	) -> CancelSecurityActionRequest:
		...
		from .cancel_security_action import CancelSecurityActionRequest
		return CancelSecurityActionRequest(self.request_adapter, path_parameters)
