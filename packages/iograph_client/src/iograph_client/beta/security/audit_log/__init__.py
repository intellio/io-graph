...
class AuditLogRequest(BaseRequestBuilder):
	...
	async def get(
		...
		return await self.request_adapter.send_async(request_info, SecurityAuditCoreRoot, error_mapping)

	async def patch(
		self,
		body: SecurityAuditCoreRoot,
	...
	def with_url(self, raw_url: str) -> AuditLogRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: AuditLogRequest
		"""
		if raw_url is None:
