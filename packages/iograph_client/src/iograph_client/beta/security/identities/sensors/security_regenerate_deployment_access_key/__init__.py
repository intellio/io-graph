...
from iograph_models.beta.security_deployment_access_key_type import SecurityDeploymentAccessKeyType


class SecurityRegenerateDeploymentAccessKeyRequest(BaseRequestBuilder):
	...
	def with_url(self, raw_url: str) -> SecurityRegenerateDeploymentAccessKeyRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: SecurityRegenerateDeploymentAccessKeyRequest
		"""
		if raw_url is None:
