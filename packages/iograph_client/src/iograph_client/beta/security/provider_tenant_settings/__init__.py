...
class ProviderTenantSettingsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/security/providerTenantSettings", path_parameters)
	...
	async def get(
		...
		"""
		tags = ['security.providerTenantSetting']
	...
	def with_url(self, raw_url: str) -> ProviderTenantSettingsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: ProviderTenantSettingsRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return ProviderTenantSettingsRequest(self.request_adapter, self.path_parameters)

	def by_provider_tenant_setting_id(self,
		providerTenantSetting_id: str,
	) -> ByProviderTenantSettingIdRequest:
		if providerTenantSetting_id is None:
			raise TypeError("providerTenantSetting_id cannot be null.")

		path_parameters = get_path_parameters(self.path_parameters)
		path_parameters["providerTenantSetting%2Did"] =  providerTenantSetting_id

		from .by_provider_tenant_setting_id import ByProviderTenantSettingIdRequest
		return ByProviderTenantSettingIdRequest(self.request_adapter, path_parameters)
