...
from iograph_models.beta.security_host_ssl_certificate_collection_response import SecurityHostSslCertificateCollectionResponse


class SslCertificatesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/security/threatIntelligence/hosts/{host%2Did}/sslCertificates", path_parameters)
