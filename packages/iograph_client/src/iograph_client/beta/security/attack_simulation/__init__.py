...
if TYPE_CHECKING:
	...
	from .training_campaigns import TrainingCampaignsRequest
...
from iograph_models.beta.attack_simulation_root import AttackSimulationRoot
