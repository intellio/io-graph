...
from iograph_models.beta.payload_collection_response import PayloadCollectionResponse
...
class PayloadsRequest(BaseRequestBuilder):
	...
	def by_payload_id(self,
		...
		path_parameters["payload%2Did"] =  payload_id

		from .by_payload_id import ByPayloadIdRequest
		return ByPayloadIdRequest(self.request_adapter, path_parameters)
