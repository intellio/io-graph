...
class TrainingCampaignsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/security/attackSimulation/trainingCampaigns", path_parameters)

	async def get(
		self,
		request_configuration: Optional[RequestConfiguration[GetQueryParams]] = None,
	) -> TrainingCampaignCollectionResponse:
		"""
	...
	def with_url(self, raw_url: str) -> TrainingCampaignsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: TrainingCampaignsRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return TrainingCampaignsRequest(self.request_adapter, self.path_parameters)

	def by_training_campaign_id(self,
		trainingCampaign_id: str,
	) -> ByTrainingCampaignIdRequest:
		if trainingCampaign_id is None:
			raise TypeError("trainingCampaign_id cannot be null.")

		path_parameters = get_path_parameters(self.path_parameters)
		path_parameters["trainingCampaign%2Did"] =  trainingCampaign_id

		from .by_training_campaign_id import ByTrainingCampaignIdRequest
		return ByTrainingCampaignIdRequest(self.request_adapter, path_parameters)
