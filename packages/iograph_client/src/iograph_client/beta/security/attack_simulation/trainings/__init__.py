...
if TYPE_CHECKING:
	...
	from .by_training_id import ByTrainingIdRequest
	from .....request_adapter import HttpxRequestAdapter
from iograph_models.beta.training_collection_response import TrainingCollectionResponse
from iograph_models.beta.training import Training
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class TrainingsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/security/attackSimulation/trainings", path_parameters)
	...
	def by_training_id(self,
		...
		from .by_training_id import ByTrainingIdRequest
		return ByTrainingIdRequest(self.request_adapter, path_parameters)
