...
if TYPE_CHECKING:
	...
	from .by_ediscovery_hold_policy_id import ByEdiscoveryHoldPolicyIdRequest
	from .......request_adapter import HttpxRequestAdapter
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.beta.security_ediscovery_hold_policy_collection_response import SecurityEdiscoveryHoldPolicyCollectionResponse
...
class LegalHoldsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/legalHolds", path_parameters)

	async def get(
		self,
		request_configuration: Optional[RequestConfiguration[GetQueryParams]] = None,
	) -> SecurityEdiscoveryHoldPolicyCollectionResponse:
		"""
		...
		return await self.request_adapter.send_async(request_info, SecurityEdiscoveryHoldPolicyCollectionResponse, error_mapping)
	...
	def by_ediscovery_hold_policy_id(self,
		ediscoveryCase_id: str,
		ediscoveryHoldPolicy_id: str,
	) -> ByEdiscoveryHoldPolicyIdRequest:
		...
		from .by_ediscovery_hold_policy_id import ByEdiscoveryHoldPolicyIdRequest
		return ByEdiscoveryHoldPolicyIdRequest(self.request_adapter, path_parameters)
