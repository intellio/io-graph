...
from iograph_models.beta.security_purge_data_post_request import Security_purge_dataPostRequest
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class SecurityPurgeDataRequest(BaseRequestBuilder):
...
- eDiscovery (Premium) workflow for content in Microsoft Teams 
	...
	def with_url(self, raw_url: str) -> SecurityPurgeDataRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: SecurityPurgeDataRequest
		"""
		if raw_url is None:
