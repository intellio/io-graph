...
if TYPE_CHECKING:
	from .update_alerts import UpdateAlertsRequest
	from .count import CountRequest
	from .by_alert_id import ByAlertIdRequest
	from ....request_adapter import HttpxRequestAdapter
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.beta.alert import Alert
from iograph_models.beta.alert_collection_response import AlertCollectionResponse


class AlertsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/security/alerts", path_parameters)
