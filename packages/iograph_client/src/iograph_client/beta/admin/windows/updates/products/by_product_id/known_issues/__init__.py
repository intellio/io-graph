...
class KnownIssuesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/admin/windows/updates/products/{product%2Did}/knownIssues", path_parameters)

	async def get(
		self,
		request_configuration: Optional[RequestConfiguration[GetQueryParams]] = None,
	) -> WindowsUpdatesKnownIssueCollectionResponse:
		"""
		...
		return await self.request_adapter.send_async(request_info, WindowsUpdatesKnownIssueCollectionResponse, error_mapping)
	...
	def with_url(self, raw_url: str) -> KnownIssuesRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: KnownIssuesRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return KnownIssuesRequest(self.request_adapter, self.path_parameters)

	def by_known_issue_id(self,
		product_id: str,
		knownIssue_id: str,
	) -> ByKnownIssueIdRequest:
		...
		from .by_known_issue_id import ByKnownIssueIdRequest
		return ByKnownIssueIdRequest(self.request_adapter, path_parameters)
