...
from iograph_models.beta.windows_updates_remove_members_post_request import Windows_updates_remove_membersPostRequest


class WindowsUpdatesRemoveMembersRequest(BaseRequestBuilder):
	...
	async def post(
		self,
		body: Windows_updates_remove_membersPostRequest,
	...
	def with_url(self, raw_url: str) -> WindowsUpdatesRemoveMembersRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: WindowsUpdatesRemoveMembersRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return WindowsUpdatesRemoveMembersRequest(self.request_adapter, self.path_parameters)
