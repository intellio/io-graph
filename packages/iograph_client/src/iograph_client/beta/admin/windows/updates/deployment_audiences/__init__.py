...
class DeploymentAudiencesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/admin/windows/updates/deploymentAudiences", path_parameters)

	async def get(
		self,
		request_configuration: Optional[RequestConfiguration[GetQueryParams]] = None,
	) -> WindowsUpdatesDeploymentAudienceCollectionResponse:
		"""
		...
		return await self.request_adapter.send_async(request_info, WindowsUpdatesDeploymentAudienceCollectionResponse, error_mapping)
	...
	def with_url(self, raw_url: str) -> DeploymentAudiencesRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: DeploymentAudiencesRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return DeploymentAudiencesRequest(self.request_adapter, self.path_parameters)

	def by_deployment_audience_id(self,
		deploymentAudience_id: str,
	) -> ByDeploymentAudienceIdRequest:
		...
		from .by_deployment_audience_id import ByDeploymentAudienceIdRequest
		return ByDeploymentAudienceIdRequest(self.request_adapter, path_parameters)
