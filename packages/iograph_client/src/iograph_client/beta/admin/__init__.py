...
if TYPE_CHECKING:
	...
	from .forms import FormsRequest
	from .exchange import ExchangeRequest
	from .entra import EntraRequest
	from .edge import EdgeRequest
	from .dynamics import DynamicsRequest
	from .apps_and_services import AppsAndServicesRequest
	from ...request_adapter import HttpxRequestAdapter
from iograph_models.beta.admin import Admin
...
class AdminRequest(BaseRequestBuilder):
	...
	@property
	def apps_and_services(self,
	) -> AppsAndServicesRequest:
		from .apps_and_services import AppsAndServicesRequest
		return AppsAndServicesRequest(self.request_adapter, self.path_parameters)

	@property
	def dynamics(self,
	) -> DynamicsRequest:
		from .dynamics import DynamicsRequest
		return DynamicsRequest(self.request_adapter, self.path_parameters)
	...
	def entra(self,
		...
		from .entra import EntraRequest
		return EntraRequest(self.request_adapter, self.path_parameters)
	...
	def forms(self,
		...
		from .forms import FormsRequest
		return FormsRequest(self.request_adapter, self.path_parameters)
