...
from iograph_models.beta.admin_apps_and_services import AdminAppsAndServices
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class AppsAndServicesRequest(BaseRequestBuilder):
	...
	async def get(
		...
		"""
		tags = ['admin.adminAppsAndServices']
	...
	def with_url(self, raw_url: str) -> AppsAndServicesRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: AppsAndServicesRequest
		"""
		if raw_url is None:
