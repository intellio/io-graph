...
from iograph_models.beta.name_pronunciation_settings import NamePronunciationSettings
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class NamePronunciationRequest(BaseRequestBuilder):
	...
	async def patch(
		self,
		body: NamePronunciationSettings,
	...
	def with_url(self, raw_url: str) -> NamePronunciationRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: NamePronunciationRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return NamePronunciationRequest(self.request_adapter, self.path_parameters)
