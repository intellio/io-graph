...
from iograph_models.beta.directory_role_collection_response import DirectoryRoleCollectionResponse
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class GraphDirectoryRoleRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/transitiveMemberOf/graph.directoryRole", path_parameters)
	...
	def with_url(self, raw_url: str) -> GraphDirectoryRoleRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: GraphDirectoryRoleRequest
		"""
		if raw_url is None:
