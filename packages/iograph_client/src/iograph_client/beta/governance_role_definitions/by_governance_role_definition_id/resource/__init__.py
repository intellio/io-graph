...
class ResourceRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/governanceRoleDefinitions/{governanceRoleDefinition%2Did}/resource", path_parameters)
	...
	async def get(
		...
		"""
		Get resource from governanceRoleDefinitions
		Read-only. The associated resource for the role definition.
		"""
		tags = ['governanceRoleDefinitions.governanceResource']
