...
class RoleSettingRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/governanceRoleDefinitions/{governanceRoleDefinition%2Did}/roleSetting", path_parameters)
	...
	async def get(
		...
		"""
		Get roleSetting from governanceRoleDefinitions
		The associated role setting for the role definition.
		"""
		tags = ['governanceRoleDefinitions.governanceRoleSetting']
