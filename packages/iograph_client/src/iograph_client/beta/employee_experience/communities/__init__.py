...
if TYPE_CHECKING:
	...
	from .by_community_id import ByCommunityIdRequest
	from ....request_adapter import HttpxRequestAdapter
from iograph_models.beta.community_collection_response import CommunityCollectionResponse
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.beta.community import Community


class CommunitiesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/employeeExperience/communities", path_parameters)
	...
	def with_url(self, raw_url: str) -> CommunitiesRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: CommunitiesRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return CommunitiesRequest(self.request_adapter, self.path_parameters)

	def by_community_id(self,
		community_id: str,
	) -> ByCommunityIdRequest:
		...
		from .by_community_id import ByCommunityIdRequest
		return ByCommunityIdRequest(self.request_adapter, path_parameters)
