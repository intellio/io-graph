...
from iograph_models.beta.multi_tenant_organization_member import MultiTenantOrganizationMember
from iograph_models.beta.multi_tenant_organization_member_collection_response import MultiTenantOrganizationMemberCollectionResponse
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError


class TenantsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/tenantRelationships/multiTenantOrganization/tenants", path_parameters)
	...
	async def post(
		self,
		body: MultiTenantOrganizationMember,
	...
	def with_url(self, raw_url: str) -> TenantsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: TenantsRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return TenantsRequest(self.request_adapter, self.path_parameters)

	def by_multi_tenant_organization_member_id(self,
		multiTenantOrganizationMember_id: str,
	) -> ByMultiTenantOrganizationMemberIdRequest:
		if multiTenantOrganizationMember_id is None:
			raise TypeError("multiTenantOrganizationMember_id cannot be null.")

		path_parameters = get_path_parameters(self.path_parameters)
		path_parameters["multiTenantOrganizationMember%2Did"] =  multiTenantOrganizationMember_id

		from .by_multi_tenant_organization_member_id import ByMultiTenantOrganizationMemberIdRequest
		return ByMultiTenantOrganizationMemberIdRequest(self.request_adapter, path_parameters)
