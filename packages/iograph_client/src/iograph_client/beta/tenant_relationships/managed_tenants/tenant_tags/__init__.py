...
if TYPE_CHECKING:
	...
	from .by_tenant_tag_id import ByTenantTagIdRequest
	from .....request_adapter import HttpxRequestAdapter
from iograph_models.beta.managed_tenants_tenant_tag import ManagedTenantsTenantTag
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.beta.managed_tenants_tenant_tag_collection_response import ManagedTenantsTenantTagCollectionResponse


class TenantTagsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/tenantRelationships/managedTenants/tenantTags", path_parameters)

	async def get(
		self,
		request_configuration: Optional[RequestConfiguration[GetQueryParams]] = None,
	) -> ManagedTenantsTenantTagCollectionResponse:
		"""
		List tenantTags
		...
		return await self.request_adapter.send_async(request_info, ManagedTenantsTenantTagCollectionResponse, error_mapping)
	...
	def with_url(self, raw_url: str) -> TenantTagsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: TenantTagsRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return TenantTagsRequest(self.request_adapter, self.path_parameters)

	def by_tenant_tag_id(self,
		tenantTag_id: str,
	) -> ByTenantTagIdRequest:
		...
		from .by_tenant_tag_id import ByTenantTagIdRequest
		return ByTenantTagIdRequest(self.request_adapter, path_parameters)
