...
class ByManagementTemplateIdRequest(BaseRequestBuilder):
	...
	async def patch(
		self,
		body: ManagedTenantsManagementTemplate,
	...
	def management_template_collections(self,
		...
		from .management_template_collections import ManagementTemplateCollectionsRequest
		return ManagementTemplateCollectionsRequest(self.request_adapter, path_parameters)
	...
	def management_template_steps(self,
		...
		from .management_template_steps import ManagementTemplateStepsRequest
		return ManagementTemplateStepsRequest(self.request_adapter, path_parameters)
