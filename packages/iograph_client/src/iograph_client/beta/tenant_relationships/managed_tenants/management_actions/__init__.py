...
class ManagementActionsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/tenantRelationships/managedTenants/managementActions", path_parameters)

	async def get(
		self,
		request_configuration: Optional[RequestConfiguration[GetQueryParams]] = None,
	) -> ManagedTenantsManagementActionCollectionResponse:
		"""
		...
		return await self.request_adapter.send_async(request_info, ManagedTenantsManagementActionCollectionResponse, error_mapping)
	...
	def with_url(self, raw_url: str) -> ManagementActionsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: ManagementActionsRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return ManagementActionsRequest(self.request_adapter, self.path_parameters)

	def by_management_action_id(self,
		managementAction_id: str,
	) -> ByManagementActionIdRequest:
		...
		from .by_management_action_id import ByManagementActionIdRequest
		return ByManagementActionIdRequest(self.request_adapter, path_parameters)
