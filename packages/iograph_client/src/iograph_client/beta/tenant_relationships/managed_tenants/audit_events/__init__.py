...
class AuditEventsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/tenantRelationships/managedTenants/auditEvents", path_parameters)

	async def get(
		self,
		request_configuration: Optional[RequestConfiguration[GetQueryParams]] = None,
	) -> ManagedTenantsAuditEventCollectionResponse:
		"""
		List auditEvents
		...
		return await self.request_adapter.send_async(request_info, ManagedTenantsAuditEventCollectionResponse, error_mapping)

	async def post(
		self,
		body: ManagedTenantsAuditEvent,
		request_configuration: Optional[RequestConfiguration[BaseModel]] = None,
	) -> ManagedTenantsAuditEvent:
		"""
		...
		return await self.request_adapter.send_async(request_info, ManagedTenantsAuditEvent, error_mapping)
