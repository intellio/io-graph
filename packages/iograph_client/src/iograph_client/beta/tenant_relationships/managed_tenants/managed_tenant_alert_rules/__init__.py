...
class ManagedTenantAlertRulesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/tenantRelationships/managedTenants/managedTenantAlertRules", path_parameters)

	async def get(
		self,
		request_configuration: Optional[RequestConfiguration[GetQueryParams]] = None,
	) -> ManagedTenantsManagedTenantAlertRuleCollectionResponse:
		"""
		...
		return await self.request_adapter.send_async(request_info, ManagedTenantsManagedTenantAlertRuleCollectionResponse, error_mapping)
	...
	def with_url(self, raw_url: str) -> ManagedTenantAlertRulesRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: ManagedTenantAlertRulesRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return ManagedTenantAlertRulesRequest(self.request_adapter, self.path_parameters)

	def by_managed_tenant_alert_rule_id(self,
		managedTenantAlertRule_id: str,
	) -> ByManagedTenantAlertRuleIdRequest:
		...
		from .by_managed_tenant_alert_rule_id import ByManagedTenantAlertRuleIdRequest
		return ByManagedTenantAlertRuleIdRequest(self.request_adapter, path_parameters)
