...
class ByTenantIdRequest(BaseRequestBuilder):
	...
	def with_url(self, raw_url: str) -> ByTenantIdRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: ByTenantIdRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return ByTenantIdRequest(self.request_adapter, self.path_parameters)

	def managed_tenants_offboard_tenant(self,
		tenant_id: str,
	) -> ManagedTenantsOffboardTenantRequest:
		...
		from .managed_tenants_offboard_tenant import ManagedTenantsOffboardTenantRequest
		return ManagedTenantsOffboardTenantRequest(self.request_adapter, path_parameters)

	def managed_tenants_reset_tenant_onboarding_status(self,
		tenant_id: str,
	) -> ManagedTenantsResetTenantOnboardingStatusRequest:
		if tenant_id is None:
			raise TypeError("tenant_id cannot be null.")
		...
		from .managed_tenants_reset_tenant_onboarding_status import ManagedTenantsResetTenantOnboardingStatusRequest
		return ManagedTenantsResetTenantOnboardingStatusRequest(self.request_adapter, path_parameters)
