...
from iograph_models.beta.delegated_admin_customer import DelegatedAdminCustomer
from iograph_models.beta.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.beta.delegated_admin_customer_collection_response import DelegatedAdminCustomerCollectionResponse


class DelegatedAdminCustomersRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/tenantRelationships/delegatedAdminCustomers", path_parameters)
	...
	def with_url(self, raw_url: str) -> DelegatedAdminCustomersRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: DelegatedAdminCustomersRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return DelegatedAdminCustomersRequest(self.request_adapter, self.path_parameters)

	def by_delegated_admin_customer_id(self,
		delegatedAdminCustomer_id: str,
	) -> ByDelegatedAdminCustomerIdRequest:
		...
		from .by_delegated_admin_customer_id import ByDelegatedAdminCustomerIdRequest
		return ByDelegatedAdminCustomerIdRequest(self.request_adapter, path_parameters)
