...
from kiota_abstractions._version import VERSION
...
class RequestInformation:
    ...
    def configure(self, request_configuration: Optional[RequestConfiguration]) -> None:
        ...
        if request_configuration:
            ...
            if request_configuration.query_parameters:
                self.query_parameters = (
                    request_configuration.query_parameters.model_dump(
                        mode="json",
                        by_alias=True,
                        exclude_unset=True,
    ...
    def set_content(
        self, content: BaseModel | str, content_type: Optional[str] = None
    ) -> None:
        ...
        if isinstance(content, BaseModel):
            self.content = content.model_dump_json(
                by_alias=True, 
                exclude_unset=True, 
                exclude_none=True,
                exclude_defaults=True,
            ...
            raise ValueError("Content must be a BaseModel or a string")
