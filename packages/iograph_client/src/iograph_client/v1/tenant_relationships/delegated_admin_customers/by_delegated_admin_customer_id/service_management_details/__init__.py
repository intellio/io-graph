...
from iograph_models.v1.delegated_admin_service_management_detail_collection_response import DelegatedAdminServiceManagementDetailCollectionResponse
from iograph_models.v1.delegated_admin_service_management_detail import DelegatedAdminServiceManagementDetail
from iograph_models.v1.o_data_errors__o_data_error import ODataErrorsODataError


class ServiceManagementDetailsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/tenantRelationships/delegatedAdminCustomers/{delegatedAdminCustomer%2Did}/serviceManagementDetails", path_parameters)
	...
	def with_url(self, raw_url: str) -> ServiceManagementDetailsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: ServiceManagementDetailsRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return ServiceManagementDetailsRequest(self.request_adapter, self.path_parameters)
