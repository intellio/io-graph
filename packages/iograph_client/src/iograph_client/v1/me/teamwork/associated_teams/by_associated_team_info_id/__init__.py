...
from iograph_models.v1.associated_team_info import AssociatedTeamInfo
from iograph_models.v1.o_data_errors__o_data_error import ODataErrorsODataError


class ByAssociatedTeamInfoIdRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/me/teamwork/associatedTeams/{associatedTeamInfo%2Did}", path_parameters)
	...
	def with_url(self, raw_url: str) -> ByAssociatedTeamInfoIdRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: ByAssociatedTeamInfoIdRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return ByAssociatedTeamInfoIdRequest(self.request_adapter, self.path_parameters)
