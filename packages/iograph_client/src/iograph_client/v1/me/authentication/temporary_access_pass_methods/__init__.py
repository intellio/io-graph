...
from iograph_models.v1.temporary_access_pass_authentication_method_collection_response import TemporaryAccessPassAuthenticationMethodCollectionResponse
from iograph_models.v1.o_data_errors__o_data_error import ODataErrorsODataError


class TemporaryAccessPassMethodsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/me/authentication/temporaryAccessPassMethods", path_parameters)
