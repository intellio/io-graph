...
from iograph_models.v1.identity_provider import IdentityProvider
from iograph_models.v1.identity_provider_collection_response import IdentityProviderCollectionResponse


class IdentityProvidersRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/identityProviders", path_parameters)
	...
	async def get(
		...
		"""
		tags = ['identityProviders.identityProvider']
