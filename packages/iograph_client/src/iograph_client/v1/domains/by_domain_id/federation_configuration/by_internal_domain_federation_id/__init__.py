...
from iograph_models.v1.internal_domain_federation import InternalDomainFederation


class ByInternalDomainFederationIdRequest(BaseRequestBuilder):
	...
	def with_url(self, raw_url: str) -> ByInternalDomainFederationIdRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: ByInternalDomainFederationIdRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return ByInternalDomainFederationIdRequest(self.request_adapter, self.path_parameters)
