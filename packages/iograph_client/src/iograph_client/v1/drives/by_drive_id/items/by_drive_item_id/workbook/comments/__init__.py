...
from iograph_models.v1.workbook_comment_collection_response import WorkbookCommentCollectionResponse
from iograph_models.v1.workbook_comment import WorkbookComment


class CommentsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/comments", path_parameters)
	...
	def by_workbook_comment_id(self,
		drive_id: str,
		driveItem_id: str,
		workbookComment_id: str,
	) -> ByWorkbookCommentIdRequest:
		if drive_id is None:
		...
		from .by_workbook_comment_id import ByWorkbookCommentIdRequest
		return ByWorkbookCommentIdRequest(self.request_adapter, path_parameters)
