...
from iograph_models.v1.workbook_table_collection_response import WorkbookTableCollectionResponse
from iograph_models.v1.workbook_table import WorkbookTable
from iograph_models.v1.o_data_errors__o_data_error import ODataErrorsODataError


class TablesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/tables", path_parameters)
