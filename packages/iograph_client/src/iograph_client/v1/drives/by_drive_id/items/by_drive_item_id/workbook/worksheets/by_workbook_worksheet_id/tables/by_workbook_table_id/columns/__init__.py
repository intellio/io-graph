...
from iograph_models.v1.workbook_table_column_collection_response import WorkbookTableColumnCollectionResponse
from iograph_models.v1.workbook_table_column import WorkbookTableColumn


class ColumnsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/tables/{workbookTable%2Did}/columns", path_parameters)
	...
	def by_workbook_table_column_id(self,
		...
		from .by_workbook_table_column_id import ByWorkbookTableColumnIdRequest
		return ByWorkbookTableColumnIdRequest(self.request_adapter, path_parameters)
