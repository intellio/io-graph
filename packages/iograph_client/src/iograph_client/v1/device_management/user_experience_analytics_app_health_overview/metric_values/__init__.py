...
from iograph_models.v1.user_experience_analytics_metric_collection_response import UserExperienceAnalyticsMetricCollectionResponse
...
class MetricValuesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/deviceManagement/userExperienceAnalyticsAppHealthOverview/metricValues", path_parameters)
