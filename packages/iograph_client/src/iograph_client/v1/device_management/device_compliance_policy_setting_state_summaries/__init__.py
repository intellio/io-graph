...
from iograph_models.v1.device_compliance_policy_setting_state_summary import DeviceCompliancePolicySettingStateSummary
from iograph_models.v1.device_compliance_policy_setting_state_summary_collection_response import DeviceCompliancePolicySettingStateSummaryCollectionResponse


class DeviceCompliancePolicySettingStateSummariesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/deviceManagement/deviceCompliancePolicySettingStateSummaries", path_parameters)
