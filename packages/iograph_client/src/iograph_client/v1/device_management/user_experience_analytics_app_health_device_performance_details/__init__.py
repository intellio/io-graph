...
from iograph_models.v1.user_experience_analytics_app_health_device_performance_details_collection_response import UserExperienceAnalyticsAppHealthDevicePerformanceDetailsCollectionResponse
