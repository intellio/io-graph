...
if TYPE_CHECKING:
	...
	from .by_resource_operation_id import ByResourceOperationIdRequest
	from ....request_adapter import HttpxRequestAdapter
from iograph_models.v1.resource_operation import ResourceOperation
from iograph_models.v1.resource_operation_collection_response import ResourceOperationCollectionResponse
from iograph_models.v1.o_data_errors__o_data_error import ODataErrorsODataError


class ResourceOperationsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/deviceManagement/resourceOperations", path_parameters)
	...
	def with_url(self, raw_url: str) -> ResourceOperationsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: ResourceOperationsRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return ResourceOperationsRequest(self.request_adapter, self.path_parameters)

	def by_resource_operation_id(self,
		resourceOperation_id: str,
	) -> ByResourceOperationIdRequest:
		...
		from .by_resource_operation_id import ByResourceOperationIdRequest
		return ByResourceOperationIdRequest(self.request_adapter, path_parameters)
