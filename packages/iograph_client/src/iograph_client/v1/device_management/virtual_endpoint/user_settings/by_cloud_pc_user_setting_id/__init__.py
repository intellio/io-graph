...
from iograph_models.v1.cloud_pc_user_setting import CloudPcUserSetting
from iograph_models.v1.o_data_errors__o_data_error import ODataErrorsODataError


class ByCloudPcUserSettingIdRequest(BaseRequestBuilder):
	...
	def with_url(self, raw_url: str) -> ByCloudPcUserSettingIdRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: ByCloudPcUserSettingIdRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return ByCloudPcUserSettingIdRequest(self.request_adapter, self.path_parameters)
