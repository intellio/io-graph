...
from iograph_models.v1.user_experience_analytics_device_performance_collection_response import UserExperienceAnalyticsDevicePerformanceCollectionResponse
