...
from iograph_models.v1.managed_device_mobile_app_configuration_assignment_collection_response import ManagedDeviceMobileAppConfigurationAssignmentCollectionResponse
