...
from iograph_models.v1.managed_e_book_collection_response import ManagedEBookCollectionResponse
from iograph_models.v1.managed_e_book import ManagedEBook
