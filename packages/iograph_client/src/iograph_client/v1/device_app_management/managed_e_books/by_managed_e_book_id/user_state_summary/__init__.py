...
from iograph_models.v1.user_install_state_summary import UserInstallStateSummary
from iograph_models.v1.user_install_state_summary_collection_response import UserInstallStateSummaryCollectionResponse


class UserStateSummaryRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/deviceAppManagement/managedEBooks/{managedEBook%2Did}/userStateSummary", path_parameters)
	...
	def with_url(self, raw_url: str) -> UserStateSummaryRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: UserStateSummaryRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return UserStateSummaryRequest(self.request_adapter, self.path_parameters)

	def by_user_install_state_summary_id(self,
		managedEBook_id: str,
		userInstallStateSummary_id: str,
	) -> ByUserInstallStateSummaryIdRequest:
		...
		from .by_user_install_state_summary_id import ByUserInstallStateSummaryIdRequest
		return ByUserInstallStateSummaryIdRequest(self.request_adapter, path_parameters)
