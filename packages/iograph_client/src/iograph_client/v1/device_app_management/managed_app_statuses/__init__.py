...
from iograph_models.v1.managed_app_status_collection_response import ManagedAppStatusCollectionResponse
from iograph_models.v1.managed_app_status import ManagedAppStatus


class ManagedAppStatusesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/deviceAppManagement/managedAppStatuses", path_parameters)
	...
	def with_url(self, raw_url: str) -> ManagedAppStatusesRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: ManagedAppStatusesRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return ManagedAppStatusesRequest(self.request_adapter, self.path_parameters)

	def by_managed_app_status_id(self,
		managedAppStatus_id: str,
	) -> ByManagedAppStatusIdRequest:
		if managedAppStatus_id is None:
			raise TypeError("managedAppStatus_id cannot be null.")

		path_parameters = get_path_parameters(self.path_parameters)
		path_parameters["managedAppStatus%2Did"] =  managedAppStatus_id

		from .by_managed_app_status_id import ByManagedAppStatusIdRequest
		return ByManagedAppStatusIdRequest(self.request_adapter, path_parameters)
