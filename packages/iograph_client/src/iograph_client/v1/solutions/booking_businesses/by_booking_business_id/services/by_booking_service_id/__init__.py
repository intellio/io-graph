...
from iograph_models.v1.booking_service import BookingService
from iograph_models.v1.o_data_errors__o_data_error import ODataErrorsODataError


class ByBookingServiceIdRequest(BaseRequestBuilder):
...
- Scheduling policy parameters, such as minimum notice to book or cancel, and whether customers can select specific staff members for an appointment.
	...
	def with_url(self, raw_url: str) -> ByBookingServiceIdRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: ByBookingServiceIdRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return ByBookingServiceIdRequest(self.request_adapter, self.path_parameters)
