...
from iograph_models.v1.protection_policy_base_collection_response import ProtectionPolicyBaseCollectionResponse
from iograph_models.v1.protection_policy_base import ProtectionPolicyBase
from iograph_models.v1.o_data_errors__o_data_error import ODataErrorsODataError


class ProtectionPoliciesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/solutions/backupRestore/protectionPolicies", path_parameters)
	...
	def with_url(self, raw_url: str) -> ProtectionPoliciesRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: ProtectionPoliciesRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return ProtectionPoliciesRequest(self.request_adapter, self.path_parameters)

	def by_protection_policy_base_id(self,
		protectionPolicyBase_id: str,
	) -> ByProtectionPolicyBaseIdRequest:
		...
		from .by_protection_policy_base_id import ByProtectionPolicyBaseIdRequest
		return ByProtectionPolicyBaseIdRequest(self.request_adapter, path_parameters)
