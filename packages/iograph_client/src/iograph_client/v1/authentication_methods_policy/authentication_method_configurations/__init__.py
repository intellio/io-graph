...
from iograph_models.v1.authentication_method_configuration_collection_response import AuthenticationMethodConfigurationCollectionResponse


class AuthenticationMethodConfigurationsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/authenticationMethodsPolicy/authenticationMethodConfigurations", path_parameters)
