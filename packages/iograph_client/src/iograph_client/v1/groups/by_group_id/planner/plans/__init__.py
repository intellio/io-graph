...
from iograph_models.v1.planner_plan_collection_response import PlannerPlanCollectionResponse
from iograph_models.v1.planner_plan import PlannerPlan
from iograph_models.v1.o_data_errors__o_data_error import ODataErrorsODataError


class PlansRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/groups/{group%2Did}/planner/plans", path_parameters)
