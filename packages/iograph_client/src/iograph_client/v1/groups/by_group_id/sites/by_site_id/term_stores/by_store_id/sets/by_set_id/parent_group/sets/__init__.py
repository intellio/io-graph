...
from iograph_models.v1.term_store_set_collection_response import TermStoreSetCollectionResponse
from iograph_models.v1.term_store_set import TermStoreSet


class SetsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/groups/{group%2Did}/sites/{site%2Did}/termStores/{store%2Did}/sets/{set%2Did}/parentGroup/sets", path_parameters)
