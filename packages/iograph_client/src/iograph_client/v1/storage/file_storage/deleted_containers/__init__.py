...
from iograph_models.v1.file_storage_container import FileStorageContainer
from iograph_models.v1.file_storage_container_collection_response import FileStorageContainerCollectionResponse
from iograph_models.v1.o_data_errors__o_data_error import ODataErrorsODataError


class DeletedContainersRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/storage/fileStorage/deletedContainers", path_parameters)
	...
	def with_url(self, raw_url: str) -> DeletedContainersRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: DeletedContainersRequest
		"""
		if raw_url is None:
