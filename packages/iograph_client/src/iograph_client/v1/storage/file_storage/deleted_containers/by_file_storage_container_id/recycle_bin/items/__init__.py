...
from iograph_models.v1.recycle_bin_item_collection_response import RecycleBinItemCollectionResponse
from iograph_models.v1.recycle_bin_item import RecycleBinItem
from iograph_models.v1.o_data_errors__o_data_error import ODataErrorsODataError


class ItemsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/storage/fileStorage/deletedContainers/{fileStorageContainer%2Did}/recycleBin/items", path_parameters)
