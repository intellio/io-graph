...
from iograph_models.v1.device_collection_response import DeviceCollectionResponse
from iograph_models.v1.o_data_errors__o_data_error import ODataErrorsODataError


class GraphDeviceRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/directoryRoles/{directoryRole%2Did}/members/graph.device", path_parameters)
	...
	async def get(
		...
		"""
		tags = ['directoryRoles.directoryObject']
	...
	def with_url(self, raw_url: str) -> GraphDeviceRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: GraphDeviceRequest
		"""
		if raw_url is None:
