...
from iograph_models.v1.external_connectors_external_connection_collection_response import ExternalConnectorsExternalConnectionCollectionResponse
from iograph_models.v1.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.v1.external_connectors_external_connection import ExternalConnectorsExternalConnection


class ConnectionsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/external/connections", path_parameters)
	...
	async def get(
		...
		return await self.request_adapter.send_async(request_info, ExternalConnectorsExternalConnectionCollectionResponse, error_mapping)
	...
	def with_url(self, raw_url: str) -> ConnectionsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: ConnectionsRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return ConnectionsRequest(self.request_adapter, self.path_parameters)

	def by_external_connection_id(self,
		externalConnection_id: str,
	) -> ByExternalConnectionIdRequest:
		...
		from .by_external_connection_id import ByExternalConnectionIdRequest
		return ByExternalConnectionIdRequest(self.request_adapter, path_parameters)
