...
if TYPE_CHECKING:
	...
	from .by_group_setting_template_id import ByGroupSettingTemplateIdRequest
	from ...request_adapter import HttpxRequestAdapter
from iograph_models.v1.group_setting_template_collection_response import GroupSettingTemplateCollectionResponse
from iograph_models.v1.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.v1.group_setting_template import GroupSettingTemplate


class GroupSettingTemplatesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/groupSettingTemplates", path_parameters)
	...
	def with_url(self, raw_url: str) -> GroupSettingTemplatesRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: GroupSettingTemplatesRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return GroupSettingTemplatesRequest(self.request_adapter, self.path_parameters)

	def by_group_setting_template_id(self,
		groupSettingTemplate_id: str,
	) -> ByGroupSettingTemplateIdRequest:
		...
		from .by_group_setting_template_id import ByGroupSettingTemplateIdRequest
		return ByGroupSettingTemplateIdRequest(self.request_adapter, path_parameters)
