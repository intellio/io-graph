...
from iograph_models.v1.get_by_ids_post_response import Get_by_idsPostResponse
from iograph_models.v1.get_by_ids_post_request import Get_by_idsPostRequest
