...
from iograph_models.v1.federated_identity_credential import FederatedIdentityCredential
from iograph_models.v1.o_data_errors__o_data_error import ODataErrorsODataError


class FederatedIdentityCredentialsWithNameRequest(BaseRequestBuilder):
	...
	def with_url(self, raw_url: str) -> FederatedIdentityCredentialsWithNameRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: FederatedIdentityCredentialsWithNameRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return FederatedIdentityCredentialsWithNameRequest(self.request_adapter, self.path_parameters)
