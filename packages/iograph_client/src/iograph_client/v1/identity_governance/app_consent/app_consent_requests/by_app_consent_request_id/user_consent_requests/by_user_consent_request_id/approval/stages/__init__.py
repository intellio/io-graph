...
from iograph_models.v1.approval_stage_collection_response import ApprovalStageCollectionResponse
from iograph_models.v1.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.v1.approval_stage import ApprovalStage


class StagesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/identityGovernance/appConsent/appConsentRequests/{appConsentRequest%2Did}/userConsentRequests/{userConsentRequest%2Did}/approval/stages", path_parameters)
	...
	def by_approval_stage_id(self,
		appConsentRequest_id: str,
		userConsentRequest_id: str,
		approvalStage_id: str,
	) -> ByApprovalStageIdRequest:
		...
		if approvalStage_id is None:
			raise TypeError("approvalStage_id cannot be null.")
		...
		path_parameters["approvalStage%2Did"] =  approvalStage_id
