...
from iograph_models.v1.privileged_access_group_assignment_schedule_instance_collection_response import PrivilegedAccessGroupAssignmentScheduleInstanceCollectionResponse
from iograph_models.v1.privileged_access_group_assignment_schedule_instance import PrivilegedAccessGroupAssignmentScheduleInstance
from iograph_models.v1.o_data_errors__o_data_error import ODataErrorsODataError


class AssignmentScheduleInstancesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/identityGovernance/privilegedAccess/group/assignmentScheduleInstances", path_parameters)
	...
	def with_url(self, raw_url: str) -> AssignmentScheduleInstancesRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: AssignmentScheduleInstancesRequest
		"""
		if raw_url is None:
