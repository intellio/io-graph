...
from iograph_models.v1.approval_collection_response import ApprovalCollectionResponse
from iograph_models.v1.o_data_errors__o_data_error import ODataErrorsODataError


class AccessPackageAssignmentApprovalsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/identityGovernance/entitlementManagement/accessPackageAssignmentApprovals", path_parameters)
...
In PIM for groups, providing the identifier of the assignment schedule request.
	...
	def with_url(self, raw_url: str) -> AccessPackageAssignmentApprovalsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: AccessPackageAssignmentApprovalsRequest
		"""
		if raw_url is None:
