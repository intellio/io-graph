...
from iograph_models.v1.unified_role_assignment_schedule_request_collection_response import UnifiedRoleAssignmentScheduleRequestCollectionResponse
from iograph_models.v1.unified_role_assignment_schedule_request import UnifiedRoleAssignmentScheduleRequest


class RoleAssignmentScheduleRequestsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/roleManagement/entitlementManagement/roleAssignmentScheduleRequests", path_parameters)
