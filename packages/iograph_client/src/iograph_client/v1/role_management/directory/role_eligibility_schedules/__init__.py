...
from iograph_models.v1.unified_role_eligibility_schedule import UnifiedRoleEligibilitySchedule
from iograph_models.v1.unified_role_eligibility_schedule_collection_response import UnifiedRoleEligibilityScheduleCollectionResponse


class RoleEligibilitySchedulesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/roleManagement/directory/roleEligibilitySchedules", path_parameters)
