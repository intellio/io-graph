...
from iograph_models.v1.deleted_team_collection_response import DeletedTeamCollectionResponse
from iograph_models.v1.deleted_team import DeletedTeam


class DeletedTeamsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/teamwork/deletedTeams", path_parameters)
	...
	def with_url(self, raw_url: str) -> DeletedTeamsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: DeletedTeamsRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return DeletedTeamsRequest(self.request_adapter, self.path_parameters)

	def by_deleted_team_id(self,
		deletedTeam_id: str,
	) -> ByDeletedTeamIdRequest:
		...
		from .by_deleted_team_id import ByDeletedTeamIdRequest
		return ByDeletedTeamIdRequest(self.request_adapter, path_parameters)
