...
from iograph_models.v1.user_flow_language_page_collection_response import UserFlowLanguagePageCollectionResponse
...
class OverridesPagesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/identity/b2xUserFlows/{b2xIdentityUserFlow%2Did}/languages/{userFlowLanguageConfiguration%2Did}/overridesPages", path_parameters)
	...
	def with_url(self, raw_url: str) -> OverridesPagesRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: OverridesPagesRequest
		"""
		if raw_url is None:
