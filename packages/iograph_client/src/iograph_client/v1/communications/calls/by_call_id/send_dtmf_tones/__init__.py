...
from iograph_models.v1.send_dtmf_tones_operation import SendDtmfTonesOperation
from iograph_models.v1.send_dtmf_tones_post_request import Send_dtmf_tonesPostRequest
