...
from iograph_models.v1.unified_role_management_policy_rule_collection_response import UnifiedRoleManagementPolicyRuleCollectionResponse
from iograph_models.v1.unified_role_management_policy_rule import UnifiedRoleManagementPolicyRule
from iograph_models.v1.o_data_errors__o_data_error import ODataErrorsODataError


class RulesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/policies/roleManagementPolicies/{unifiedRoleManagementPolicy%2Did}/rules", path_parameters)
	...
	def with_url(self, raw_url: str) -> RulesRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: RulesRequest
		"""
		if raw_url is None:
