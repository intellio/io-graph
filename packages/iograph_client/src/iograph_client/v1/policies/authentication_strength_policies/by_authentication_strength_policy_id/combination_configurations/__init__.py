...
from iograph_models.v1.authentication_combination_configuration_collection_response import AuthenticationCombinationConfigurationCollectionResponse


class CombinationConfigurationsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/policies/authenticationStrengthPolicies/{authenticationStrengthPolicy%2Did}/combinationConfigurations", path_parameters)
