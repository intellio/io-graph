...
from iograph_models.v1.permission_grant_policy_collection_response import PermissionGrantPolicyCollectionResponse
from iograph_models.v1.permission_grant_policy import PermissionGrantPolicy
from iograph_models.v1.o_data_errors__o_data_error import ODataErrorsODataError


class PermissionGrantPoliciesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/policies/permissionGrantPolicies", path_parameters)
	...
	def with_url(self, raw_url: str) -> PermissionGrantPoliciesRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: PermissionGrantPoliciesRequest
		"""
		if raw_url is None:
