...
from iograph_models.v1.education_category import EducationCategory
from iograph_models.v1.education_category_collection_response import EducationCategoryCollectionResponse


class CategoriesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/education/users/{educationUser%2Did}/assignments/{educationAssignment%2Did}/categories", path_parameters)
