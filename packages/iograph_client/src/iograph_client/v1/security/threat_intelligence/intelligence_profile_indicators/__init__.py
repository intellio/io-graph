...
from iograph_models.v1.security_intelligence_profile_indicator import SecurityIntelligenceProfileIndicator
from iograph_models.v1.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.v1.security_intelligence_profile_indicator_collection_response import SecurityIntelligenceProfileIndicatorCollectionResponse


class IntelligenceProfileIndicatorsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/security/threatIntelligence/intelligenceProfileIndicators", path_parameters)
	...
	def with_url(self, raw_url: str) -> IntelligenceProfileIndicatorsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: IntelligenceProfileIndicatorsRequest
		"""
		if raw_url is None:
