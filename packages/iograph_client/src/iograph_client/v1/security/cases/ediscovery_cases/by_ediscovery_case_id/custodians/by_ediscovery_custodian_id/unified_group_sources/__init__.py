...
from iograph_models.v1.security_unified_group_source import SecurityUnifiedGroupSource
from iograph_models.v1.security_unified_group_source_collection_response import SecurityUnifiedGroupSourceCollectionResponse
from iograph_models.v1.o_data_errors__o_data_error import ODataErrorsODataError


class UnifiedGroupSourcesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/custodians/{ediscoveryCustodian%2Did}/unifiedGroupSources", path_parameters)
