...
from iograph_models.v1.security_ediscovery_review_tag_collection_response import SecurityEdiscoveryReviewTagCollectionResponse


class ChildTagsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/tags/{ediscoveryReviewTag%2Did}/childTags", path_parameters)
	...
	def with_url(self, raw_url: str) -> ChildTagsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: ChildTagsRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return ChildTagsRequest(self.request_adapter, self.path_parameters)

	def by_ediscovery_review_tag_id1(self,
		ediscoveryCase_id: str,
		ediscoveryReviewTag_id: str,
		ediscoveryReviewTag_id1: str,
	) -> ByEdiscoveryReviewTagId1Request:
		...
		if ediscoveryReviewTag_id1 is None:
			raise TypeError("ediscoveryReviewTag_id1 cannot be null.")
		...
		path_parameters["ediscoveryReviewTag%2Did1"] =  ediscoveryReviewTag_id1
