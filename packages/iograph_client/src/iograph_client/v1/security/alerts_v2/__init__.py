...
from iograph_models.v1.security_alert_collection_response import SecurityAlertCollectionResponse
from iograph_models.v1.security_alert import SecurityAlert
