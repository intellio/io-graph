...
from iograph_models.v1.teamwork_tag_member import TeamworkTagMember
from iograph_models.v1.teamwork_tag_member_collection_response import TeamworkTagMemberCollectionResponse


class MembersRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/users/{user%2Did}/joinedTeams/{team%2Did}/tags/{teamworkTag%2Did}/members", path_parameters)
