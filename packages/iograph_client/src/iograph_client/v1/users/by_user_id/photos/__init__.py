...
from iograph_models.v1.profile_photo_collection_response import ProfilePhotoCollectionResponse


class PhotosRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/users/{user%2Did}/photos", path_parameters)
