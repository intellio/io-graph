...
from iograph_models.v1.translate_exchange_ids_response import TranslateExchangeIdsResponse
from iograph_models.v1.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.v1.translate_exchange_ids_post_request import Translate_exchange_idsPostRequest
...
class TranslateExchangeIdsRequest(BaseRequestBuilder):
	...
	def with_url(self, raw_url: str) -> TranslateExchangeIdsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: TranslateExchangeIdsRequest
		"""
		if raw_url is None:
