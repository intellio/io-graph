...
from iograph_models.v1.cloud_clipboard_item_collection_response import CloudClipboardItemCollectionResponse
...
class ItemsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/users/{user%2Did}/cloudClipboard/items", path_parameters)
