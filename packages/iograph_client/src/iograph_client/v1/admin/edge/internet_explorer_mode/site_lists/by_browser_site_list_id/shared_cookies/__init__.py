...
from iograph_models.v1.browser_shared_cookie_collection_response import BrowserSharedCookieCollectionResponse
from iograph_models.v1.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.v1.browser_shared_cookie import BrowserSharedCookie


class SharedCookiesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/admin/edge/internetExplorerMode/siteLists/{browserSiteList%2Did}/sharedCookies", path_parameters)
	...
	def with_url(self, raw_url: str) -> SharedCookiesRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: SharedCookiesRequest
		"""
		if raw_url is None:
