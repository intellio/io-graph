...
if TYPE_CHECKING:
	...
	from .by_browser_site_list_id import ByBrowserSiteListIdRequest
	from ......request_adapter import HttpxRequestAdapter
from iograph_models.v1.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.v1.browser_site_list import BrowserSiteList
from iograph_models.v1.browser_site_list_collection_response import BrowserSiteListCollectionResponse


class SiteListsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/admin/edge/internetExplorerMode/siteLists", path_parameters)
	...
	def with_url(self, raw_url: str) -> SiteListsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: SiteListsRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return SiteListsRequest(self.request_adapter, self.path_parameters)

	def by_browser_site_list_id(self,
		browserSiteList_id: str,
	) -> ByBrowserSiteListIdRequest:
		...
		from .by_browser_site_list_id import ByBrowserSiteListIdRequest
		return ByBrowserSiteListIdRequest(self.request_adapter, path_parameters)
