...
from iograph_models.models.set_verified_publisher_post_request import Set_verified_publisherPostRequest
from iograph_models.models.o_data_errors__o_data_error import ODataErrorsODataError


class SetVerifiedPublisherRequest(BaseRequestBuilder):
	...
	async def post(
		self,
		body: Set_verified_publisherPostRequest,
	...
	def with_url(self, raw_url: str) -> SetVerifiedPublisherRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: SetVerifiedPublisherRequest
		"""
		if raw_url is None:
