...
from iograph_models.models.security_disposition_review_stage_collection_response import SecurityDispositionReviewStageCollectionResponse


class DispositionReviewStagesRequest:
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		self.request_adapter = request_adapter
		self.url_template: str = "{+baseurl}/security/labels/retentionLabels/{retentionLabel%2Did}/dispositionReviewStages"
