...
from iograph_models.models.security_retention_label_collection_response import SecurityRetentionLabelCollectionResponse


class RetentionLabelsRequest:
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		self.request_adapter = request_adapter
		self.url_template: str = "{+baseurl}/security/labels/retentionLabels"
