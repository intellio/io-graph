...
if TYPE_CHECKING:
	from .subcategories import SubcategoriesRequest
	from ......request_adapter import HttpxRequestAdapter
from iograph_models.models.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.models.security_category_template import SecurityCategoryTemplate


class ByCategoryTemplateIdRequest(BaseRequestBuilder):
	...
	def with_url(self, raw_url: str) -> ByCategoryTemplateIdRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: ByCategoryTemplateIdRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return ByCategoryTemplateIdRequest(self.request_adapter, self.path_parameters)
	...
	def subcategories(self,
		...
		from .subcategories import SubcategoriesRequest
		return SubcategoriesRequest(self.request_adapter, path_parameters)
