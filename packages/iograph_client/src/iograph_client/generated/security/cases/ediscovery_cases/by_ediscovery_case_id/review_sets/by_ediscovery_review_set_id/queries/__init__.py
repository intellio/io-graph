...
from iograph_models.models.security_ediscovery_review_set_query_collection_response import SecurityEdiscoveryReviewSetQueryCollectionResponse
...
class QueriesRequest:
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		...
		self.url_template: str = "{+baseurl}/security/cases/ediscoveryCases/{ediscoveryCase%2Did}/reviewSets/{ediscoveryReviewSet%2Did}/queries"
