...
from iograph_models.models.security_add_to_review_set_post_request import Security_add_to_review_setPostRequest


class SecurityAddToReviewSetRequest(BaseRequestBuilder):
	...
	async def post(
		self,
		body: Security_add_to_review_setPostRequest,
	...
	def with_url(self, raw_url: str) -> SecurityAddToReviewSetRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: SecurityAddToReviewSetRequest
		"""
		if raw_url is None:
