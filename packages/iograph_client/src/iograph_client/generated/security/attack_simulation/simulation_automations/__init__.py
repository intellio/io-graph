...
from iograph_models.models.simulation_automation import SimulationAutomation
from iograph_models.models.simulation_automation_collection_response import SimulationAutomationCollectionResponse


class SimulationAutomationsRequest:
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		self.request_adapter = request_adapter
		self.url_template: str = "{+baseurl}/security/attackSimulation/simulationAutomations"
