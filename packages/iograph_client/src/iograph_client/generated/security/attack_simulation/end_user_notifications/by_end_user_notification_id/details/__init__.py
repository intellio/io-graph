...
from iograph_models.models.end_user_notification_detail_collection_response import EndUserNotificationDetailCollectionResponse
from iograph_models.models.end_user_notification_detail import EndUserNotificationDetail


class DetailsRequest:
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		self.request_adapter = request_adapter
		self.url_template: str = "{+baseurl}/security/attackSimulation/endUserNotifications/{endUserNotification%2Did}/details"
