...
if TYPE_CHECKING:
	...
	from .by_simulation_id import BySimulationIdRequest
	from .....request_adapter import HttpxRequestAdapter
from iograph_models.models.simulation import Simulation
from iograph_models.models.simulation_collection_response import SimulationCollectionResponse
from iograph_models.models.o_data_errors__o_data_error import ODataErrorsODataError


class SimulationsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/security/attackSimulation/simulations", path_parameters)
	...
	def with_url(self, raw_url: str) -> SimulationsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: SimulationsRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return SimulationsRequest(self.request_adapter, self.path_parameters)

	def by_simulation_id(self,
		simulation_id: str,
	) -> BySimulationIdRequest:
		...
		from .by_simulation_id import BySimulationIdRequest
		return BySimulationIdRequest(self.request_adapter, path_parameters)
