...
from iograph_models.models.security_health_issue import SecurityHealthIssue
from iograph_models.models.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.models.security_health_issue_collection_response import SecurityHealthIssueCollectionResponse


class HealthIssuesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/security/identities/healthIssues", path_parameters)
