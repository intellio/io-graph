...
from iograph_models.models.security_sensor_deployment_package import SecuritySensorDeploymentPackage


class SecurityGetDeploymentPackageUriRequest(BaseRequestBuilder):
	...
	async def get(
		...
		return await self.request_adapter.send_async(request_info, SecuritySensorDeploymentPackage, error_mapping)


	def with_url(self, raw_url: str) -> SecurityGetDeploymentPackageUriRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: SecurityGetDeploymentPackageUriRequest
		"""
		if raw_url is None:
