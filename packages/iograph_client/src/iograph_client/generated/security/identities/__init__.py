...
if TYPE_CHECKING:
	from .sensors import SensorsRequest
	from .health_issues import HealthIssuesRequest
	from ....request_adapter import HttpxRequestAdapter
from iograph_models.models.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.models.security_identity_container import SecurityIdentityContainer


class IdentitiesRequest(BaseRequestBuilder):
	...
	async def get(
		...
		return await self.request_adapter.send_async(request_info, SecurityIdentityContainer, error_mapping)

	async def patch(
		self,
		body: SecurityIdentityContainer,
	...
	def with_url(self, raw_url: str) -> IdentitiesRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: IdentitiesRequest
		"""
		if raw_url is None:
