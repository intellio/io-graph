...
from iograph_models.models.entitlement_management_settings import EntitlementManagementSettings


class SettingsRequest:
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		self.request_adapter = request_adapter
		self.url_template: str = "{+baseurl}/identityGovernance/entitlementManagement/settings"
	...
	async def patch(
		self,
		body: EntitlementManagementSettings,
