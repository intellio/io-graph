...
from iograph_models.models.access_package_resource_environment_collection_response import AccessPackageResourceEnvironmentCollectionResponse
...
class ResourceEnvironmentsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/identityGovernance/entitlementManagement/resourceEnvironments", path_parameters)
	...
	def with_url(self, raw_url: str) -> ResourceEnvironmentsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: ResourceEnvironmentsRequest
		"""
		if raw_url is None:
