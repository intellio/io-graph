...
from iograph_models.models.access_package_resource_role_scope_collection_response import AccessPackageResourceRoleScopeCollectionResponse
from iograph_models.models.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.models.access_package_resource_role_scope import AccessPackageResourceRoleScope


class ResourceRoleScopesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/identityGovernance/entitlementManagement/accessPackages/{accessPackage%2Did}/resourceRoleScopes", path_parameters)
	...
	def with_url(self, raw_url: str) -> ResourceRoleScopesRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: ResourceRoleScopesRequest
		"""
		if raw_url is None:
