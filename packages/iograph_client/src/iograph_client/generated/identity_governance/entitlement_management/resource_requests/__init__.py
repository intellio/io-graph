...
from iograph_models.models.access_package_resource_request_collection_response import AccessPackageResourceRequestCollectionResponse
from iograph_models.models.access_package_resource_request import AccessPackageResourceRequest
from iograph_models.models.o_data_errors__o_data_error import ODataErrorsODataError


class ResourceRequestsRequest:
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		self.request_adapter = request_adapter
		self.url_template: str = "{+baseurl}/identityGovernance/entitlementManagement/resourceRequests"
