...
from iograph_models.models.identity_governance_workflow_version_collection_response import IdentityGovernanceWorkflowVersionCollectionResponse


class VersionsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/identityGovernance/lifecycleWorkflows/deletedItems/workflows/{workflow%2Did}/versions", path_parameters)
	...
	async def get(
		...
		return await self.request_adapter.send_async(request_info, IdentityGovernanceWorkflowVersionCollectionResponse, error_mapping)
	...
	def by_workflow_version_version_number(self,
		workflow_id: str,
		workflowVersion_versionNumber: int,
	) -> ByWorkflowVersionVersionNumberRequest:
		...
		from .by_workflow_version_version_number import ByWorkflowVersionVersionNumberRequest
		return ByWorkflowVersionVersionNumberRequest(self.request_adapter, path_parameters)
