...
from iograph_models.models.identity_governance_workflow_template_collection_response import IdentityGovernanceWorkflowTemplateCollectionResponse


class WorkflowTemplatesRequest:
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		self.request_adapter = request_adapter
		self.url_template: str = "{+baseurl}/identityGovernance/lifecycleWorkflows/workflowTemplates"
