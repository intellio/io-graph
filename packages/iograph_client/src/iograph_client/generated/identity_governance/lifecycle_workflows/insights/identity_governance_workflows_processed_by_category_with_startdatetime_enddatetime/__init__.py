...
from iograph_models.models.identity_governance_workflows_insights_by_category import IdentityGovernanceWorkflowsInsightsByCategory


class IdentityGovernanceWorkflowsProcessedByCategoryWithStartDateTimeEndDateTimeRequest(BaseRequestBuilder):
	...
	async def get(
		...
		return await self.request_adapter.send_async(request_info, IdentityGovernanceWorkflowsInsightsByCategory, error_mapping)


	def with_url(self, raw_url: str) -> IdentityGovernanceWorkflowsProcessedByCategoryWithStartDateTimeEndDateTimeRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: IdentityGovernanceWorkflowsProcessedByCategoryWithStartDateTimeEndDateTimeRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return IdentityGovernanceWorkflowsProcessedByCategoryWithStartDateTimeEndDateTimeRequest(self.request_adapter, self.path_parameters)
