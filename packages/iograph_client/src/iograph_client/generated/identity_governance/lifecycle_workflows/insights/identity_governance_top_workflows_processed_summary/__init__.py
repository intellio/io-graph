...
from iograph_models.models.identity_governance_top_workflows_processed_summary_get_response import Identity_governance_top_workflows_processed_summaryGetResponse


class IdentityGovernanceTopWorkflowsProcessedSummaryRequest(BaseRequestBuilder):
	...
	async def get(
	...
	) -> Identity_governance_top_workflows_processed_summaryGetResponse:
		"""
		...
		return await self.request_adapter.send_async(request_info, Identity_governance_top_workflows_processed_summaryGetResponse, error_mapping)
	...
	def with_url(self, raw_url: str) -> IdentityGovernanceTopWorkflowsProcessedSummaryRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: IdentityGovernanceTopWorkflowsProcessedSummaryRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return IdentityGovernanceTopWorkflowsProcessedSummaryRequest(self.request_adapter, self.path_parameters)
