...
if TYPE_CHECKING:
	...
	from .by_privileged_access_group_assignment_schedule_request_id import ByPrivilegedAccessGroupAssignmentScheduleRequestIdRequest
	from ......request_adapter import HttpxRequestAdapter
from iograph_models.models.privileged_access_group_assignment_schedule_request_collection_response import PrivilegedAccessGroupAssignmentScheduleRequestCollectionResponse
from iograph_models.models.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.models.privileged_access_group_assignment_schedule_request import PrivilegedAccessGroupAssignmentScheduleRequest


class AssignmentScheduleRequestsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/identityGovernance/privilegedAccess/group/assignmentScheduleRequests", path_parameters)
	...
	def with_url(self, raw_url: str) -> AssignmentScheduleRequestsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: AssignmentScheduleRequestsRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return AssignmentScheduleRequestsRequest(self.request_adapter, self.path_parameters)

	def by_privileged_access_group_assignment_schedule_request_id(self,
		privilegedAccessGroupAssignmentScheduleRequest_id: str,
	) -> ByPrivilegedAccessGroupAssignmentScheduleRequestIdRequest:
		...
		from .by_privileged_access_group_assignment_schedule_request_id import ByPrivilegedAccessGroupAssignmentScheduleRequestIdRequest
		return ByPrivilegedAccessGroupAssignmentScheduleRequestIdRequest(self.request_adapter, path_parameters)
