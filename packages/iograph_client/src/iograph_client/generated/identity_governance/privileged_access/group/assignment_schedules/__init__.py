...
from iograph_models.models.privileged_access_group_assignment_schedule_collection_response import PrivilegedAccessGroupAssignmentScheduleCollectionResponse


class AssignmentSchedulesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/identityGovernance/privilegedAccess/group/assignmentSchedules", path_parameters)
	...
	def with_url(self, raw_url: str) -> AssignmentSchedulesRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: AssignmentSchedulesRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return AssignmentSchedulesRequest(self.request_adapter, self.path_parameters)

	def by_privileged_access_group_assignment_schedule_id(self,
		privilegedAccessGroupAssignmentSchedule_id: str,
	) -> ByPrivilegedAccessGroupAssignmentScheduleIdRequest:
		...
		from .by_privileged_access_group_assignment_schedule_id import ByPrivilegedAccessGroupAssignmentScheduleIdRequest
		return ByPrivilegedAccessGroupAssignmentScheduleIdRequest(self.request_adapter, path_parameters)
