...
from iograph_models.models.user_registration_details_collection_response import UserRegistrationDetailsCollectionResponse
from iograph_models.models.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.models.user_registration_details import UserRegistrationDetails


class UserRegistrationDetailsRequest:
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		self.request_adapter = request_adapter
		self.url_template: str = "{+baseurl}/reports/authenticationMethods/userRegistrationDetails"
