...
from iograph_models.models.user_registration_details import UserRegistrationDetails
from iograph_models.models.o_data_errors__o_data_error import ODataErrorsODataError


class ByUserRegistrationDetailsIdRequest(BaseRequestBuilder):
	...
	def with_url(self, raw_url: str) -> ByUserRegistrationDetailsIdRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: ByUserRegistrationDetailsIdRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return ByUserRegistrationDetailsIdRequest(self.request_adapter, self.path_parameters)
