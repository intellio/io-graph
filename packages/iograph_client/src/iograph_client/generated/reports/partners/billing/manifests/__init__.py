...
from iograph_models.models.partners_billing_manifest_collection_response import PartnersBillingManifestCollectionResponse
...
class ManifestsRequest:
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		...
		self.url_template: str = "{+baseurl}/reports/partners/billing/manifests"
