...
from iograph_models.models.partners_billing_billed_usage import PartnersBillingBilledUsage


class BilledRequest:
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		self.request_adapter = request_adapter
		self.url_template: str = "{+baseurl}/reports/partners/billing/usage/billed"
	...
	async def get(
		...
		return await self.request_adapter.send_async(request_info, PartnersBillingBilledUsage, error_mapping)

	async def patch(
		self,
		body: PartnersBillingBilledUsage,
