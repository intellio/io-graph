...
from iograph_models.models.partners_billing_manifest import PartnersBillingManifest


class ByManifestIdRequest(BaseRequestBuilder):
	...
	def with_url(self, raw_url: str) -> ByManifestIdRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: ByManifestIdRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return ByManifestIdRequest(self.request_adapter, self.path_parameters)
