...
from iograph_models.models.partners_billing_export_post_request import Partners_billing_exportPostRequest
from iograph_models.models.partners_billing_operation import PartnersBillingOperation
from iograph_models.models.o_data_errors__o_data_error import ODataErrorsODataError


class PartnersBillingExportRequest:
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		self.request_adapter = request_adapter
		self.url_template: str = "{+baseurl}/reports/partners/billing/reconciliation/billed/microsoft.graph.partners.billing.export"
