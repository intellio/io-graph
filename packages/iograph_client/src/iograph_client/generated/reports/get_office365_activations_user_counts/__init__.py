...
class GetOffice365ActivationsUserCountsRequest(BaseRequestBuilder):
	...
	def with_url(self, raw_url: str) -> GetOffice365ActivationsUserCountsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: GetOffice365ActivationsUserCountsRequest
		"""
		if raw_url is None:
