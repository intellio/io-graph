...
from iograph_models.models.custom_authentication_extension_collection_response import CustomAuthenticationExtensionCollectionResponse
from iograph_models.models.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.models.custom_authentication_extension import CustomAuthenticationExtension


class CustomAuthenticationExtensionsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/identity/customAuthenticationExtensions", path_parameters)
	...
	def with_url(self, raw_url: str) -> CustomAuthenticationExtensionsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: CustomAuthenticationExtensionsRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return CustomAuthenticationExtensionsRequest(self.request_adapter, self.path_parameters)

	def by_custom_authentication_extension_id(self,
		customAuthenticationExtension_id: str,
	) -> ByCustomAuthenticationExtensionIdRequest:
		...
		from .by_custom_authentication_extension_id import ByCustomAuthenticationExtensionIdRequest
		return ByCustomAuthenticationExtensionIdRequest(self.request_adapter, path_parameters)
