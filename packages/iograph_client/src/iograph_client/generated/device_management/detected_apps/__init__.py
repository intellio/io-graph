...
if TYPE_CHECKING:
	...
	from .by_detected_app_id import ByDetectedAppIdRequest
	from ....request_adapter import HttpxRequestAdapter
from iograph_models.models.detected_app_collection_response import DetectedAppCollectionResponse
from iograph_models.models.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.models.detected_app import DetectedApp


class DetectedAppsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/deviceManagement/detectedApps", path_parameters)
	...
	def with_url(self, raw_url: str) -> DetectedAppsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: DetectedAppsRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return DetectedAppsRequest(self.request_adapter, self.path_parameters)

	def by_detected_app_id(self,
		detectedApp_id: str,
	) -> ByDetectedAppIdRequest:
		...
		from .by_detected_app_id import ByDetectedAppIdRequest
		return ByDetectedAppIdRequest(self.request_adapter, path_parameters)
