...
from iograph_models.models.mobile_app_troubleshooting_event import MobileAppTroubleshootingEvent
from iograph_models.models.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.models.mobile_app_troubleshooting_event_collection_response import MobileAppTroubleshootingEventCollectionResponse


class MobileAppTroubleshootingEventsRequest:
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		self.request_adapter = request_adapter
		self.url_template: str = "{+baseurl}/deviceManagement/mobileAppTroubleshootingEvents"
