...
from iograph_models.models.role_assignment_collection_response import RoleAssignmentCollectionResponse


class RoleAssignmentsRequest:
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		self.request_adapter = request_adapter
		self.url_template: str = "{+baseurl}/deviceManagement/roleDefinitions/{roleDefinition%2Did}/roleAssignments"
