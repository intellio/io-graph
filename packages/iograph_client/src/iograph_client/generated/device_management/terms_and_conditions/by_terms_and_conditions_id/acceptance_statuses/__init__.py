...
from iograph_models.models.terms_and_conditions_acceptance_status_collection_response import TermsAndConditionsAcceptanceStatusCollectionResponse


class AcceptanceStatusesRequest:
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		self.request_adapter = request_adapter
		self.url_template: str = "{+baseurl}/deviceManagement/termsAndConditions/{termsAndConditions%2Did}/acceptanceStatuses"
