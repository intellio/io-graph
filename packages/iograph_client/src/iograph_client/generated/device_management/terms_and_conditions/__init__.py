...
from iograph_models.models.terms_and_conditions_collection_response import TermsAndConditionsCollectionResponse
...
class TermsAndConditionsRequest:
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		...
		self.url_template: str = "{+baseurl}/deviceManagement/termsAndConditions"
