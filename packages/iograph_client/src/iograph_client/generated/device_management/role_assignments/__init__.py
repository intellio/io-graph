...
if TYPE_CHECKING:
	...
	from .by_device_and_app_management_role_assignment_id import ByDeviceAndAppManagementRoleAssignmentIdRequest
	from ....request_adapter import HttpxRequestAdapter
from iograph_models.models.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.models.device_and_app_management_role_assignment import DeviceAndAppManagementRoleAssignment
from iograph_models.models.device_and_app_management_role_assignment_collection_response import DeviceAndAppManagementRoleAssignmentCollectionResponse


class RoleAssignmentsRequest:
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		self.request_adapter = request_adapter
		self.url_template: str = "{+baseurl}/deviceManagement/roleAssignments"
	...
	def by_device_and_app_management_role_assignment_id(self,
		deviceAndAppManagementRoleAssignment_id: str,
	) -> ByDeviceAndAppManagementRoleAssignmentIdRequest:
		...
		from .by_device_and_app_management_role_assignment_id import ByDeviceAndAppManagementRoleAssignmentIdRequest
		return ByDeviceAndAppManagementRoleAssignmentIdRequest(self.request_adapter, path_parameters)
