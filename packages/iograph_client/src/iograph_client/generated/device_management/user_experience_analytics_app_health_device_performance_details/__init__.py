...
from iograph_models.models.user_experience_analytics_app_health_device_performance_details_collection_response import UserExperienceAnalyticsAppHealthDevicePerformanceDetailsCollectionResponse


class UserExperienceAnalyticsAppHealthDevicePerformanceDetailsRequest:
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		self.request_adapter = request_adapter
		self.url_template: str = "{+baseurl}/deviceManagement/userExperienceAnalyticsAppHealthDevicePerformanceDetails"
