...
from iograph_models.models.device_compliance_policy_device_state_summary import DeviceCompliancePolicyDeviceStateSummary


class DeviceCompliancePolicyDeviceStateSummaryRequest(BaseRequestBuilder):
	...
	async def get(
		...
		"""
		tags = ['deviceManagement.deviceCompliancePolicyDeviceStateSummary']
	...
	async def patch(
		self,
		body: DeviceCompliancePolicyDeviceStateSummary,
	...
	def with_url(self, raw_url: str) -> DeviceCompliancePolicyDeviceStateSummaryRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: DeviceCompliancePolicyDeviceStateSummaryRequest
		"""
		if raw_url is None:
