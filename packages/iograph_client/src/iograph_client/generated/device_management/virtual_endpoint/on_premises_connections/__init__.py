...
from iograph_models.models.cloud_pc_on_premises_connection_collection_response import CloudPcOnPremisesConnectionCollectionResponse


class OnPremisesConnectionsRequest:
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		self.request_adapter = request_adapter
		self.url_template: str = "{+baseurl}/deviceManagement/virtualEndpoint/onPremisesConnections"
