...
from iograph_models.models.localized_notification_message import LocalizedNotificationMessage
from iograph_models.models.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.models.localized_notification_message_collection_response import LocalizedNotificationMessageCollectionResponse


class LocalizedNotificationMessagesRequest:
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		self.request_adapter = request_adapter
		self.url_template: str = "{+baseurl}/deviceManagement/notificationMessageTemplates/{notificationMessageTemplate%2Did}/localizedNotificationMessages"
