...
from iograph_models.models.notification_message_template import NotificationMessageTemplate
from iograph_models.models.notification_message_template_collection_response import NotificationMessageTemplateCollectionResponse


class NotificationMessageTemplatesRequest:
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		self.request_adapter = request_adapter
		self.url_template: str = "{+baseurl}/deviceManagement/notificationMessageTemplates"
