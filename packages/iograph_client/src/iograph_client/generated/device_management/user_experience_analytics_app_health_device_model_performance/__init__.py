...
from iograph_models.models.user_experience_analytics_app_health_device_model_performance_collection_response import UserExperienceAnalyticsAppHealthDeviceModelPerformanceCollectionResponse


class UserExperienceAnalyticsAppHealthDeviceModelPerformanceRequest:
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		self.request_adapter = request_adapter
		self.url_template: str = "{+baseurl}/deviceManagement/userExperienceAnalyticsAppHealthDeviceModelPerformance"
