...
from iograph_models.models.user_experience_analytics_work_from_anywhere_devices_summary import UserExperienceAnalyticsWorkFromAnywhereDevicesSummary
from iograph_models.models.o_data_errors__o_data_error import ODataErrorsODataError


class UserExperienceAnalyticsSummarizeWorkFromAnywhereDevicesRequest(BaseRequestBuilder):
	...
	def with_url(self, raw_url: str) -> UserExperienceAnalyticsSummarizeWorkFromAnywhereDevicesRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: UserExperienceAnalyticsSummarizeWorkFromAnywhereDevicesRequest
		"""
		if raw_url is None:
