...
from iograph_models.models.download_apple_push_notification_certificate_signing_request_get_response import Download_apple_push_notification_certificate_signing_requestGetResponse
...
class DownloadApplePushNotificationCertificateSigningRequestRequest(BaseRequestBuilder):
	...
	async def get(
	...
	) -> Download_apple_push_notification_certificate_signing_requestGetResponse:
		"""
		...
		return await self.request_adapter.send_async(request_info, Download_apple_push_notification_certificate_signing_requestGetResponse, error_mapping)


	def with_url(self, raw_url: str) -> DownloadApplePushNotificationCertificateSigningRequestRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: DownloadApplePushNotificationCertificateSigningRequestRequest
		"""
		if raw_url is None:
