...
from iograph_models.models.windows_information_protection_app_learning_summary_collection_response import WindowsInformationProtectionAppLearningSummaryCollectionResponse
from iograph_models.models.windows_information_protection_app_learning_summary import WindowsInformationProtectionAppLearningSummary


class WindowsInformationProtectionAppLearningSummariesRequest:
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		self.request_adapter = request_adapter
		self.url_template: str = "{+baseurl}/deviceManagement/windowsInformationProtectionAppLearningSummaries"
