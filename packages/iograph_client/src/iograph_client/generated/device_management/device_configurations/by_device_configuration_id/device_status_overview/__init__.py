...
from iograph_models.models.device_configuration_device_overview import DeviceConfigurationDeviceOverview


class DeviceStatusOverviewRequest:
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		self.request_adapter = request_adapter
		self.url_template: str = "{+baseurl}/deviceManagement/deviceConfigurations/{deviceConfiguration%2Did}/deviceStatusOverview"
	...
	async def patch(
		self,
		body: DeviceConfigurationDeviceOverview,
