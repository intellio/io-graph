...
from iograph_models.models.device_configuration_user_overview import DeviceConfigurationUserOverview
from iograph_models.models.o_data_errors__o_data_error import ODataErrorsODataError


class UserStatusOverviewRequest:
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		self.request_adapter = request_adapter
		self.url_template: str = "{+baseurl}/deviceManagement/deviceConfigurations/{deviceConfiguration%2Did}/userStatusOverview"
	...
	async def patch(
		self,
		body: DeviceConfigurationUserOverview,
