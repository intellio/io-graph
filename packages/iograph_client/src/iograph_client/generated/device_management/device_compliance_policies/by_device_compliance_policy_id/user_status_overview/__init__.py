...
from iograph_models.models.device_compliance_user_overview import DeviceComplianceUserOverview
...
class UserStatusOverviewRequest:
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		...
		self.url_template: str = "{+baseurl}/deviceManagement/deviceCompliancePolicies/{deviceCompliancePolicy%2Did}/userStatusOverview"
	...
	async def patch(
		self,
		body: DeviceComplianceUserOverview,
