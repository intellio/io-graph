...
from iograph_models.models.device_compliance_scheduled_action_for_rule_collection_response import DeviceComplianceScheduledActionForRuleCollectionResponse
from iograph_models.models.device_compliance_scheduled_action_for_rule import DeviceComplianceScheduledActionForRule


class ScheduledActionsForRuleRequest:
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		self.request_adapter = request_adapter
		self.url_template: str = "{+baseurl}/deviceManagement/deviceCompliancePolicies/{deviceCompliancePolicy%2Did}/scheduledActionsForRule"
