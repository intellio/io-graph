...
from iograph_models.models.device_compliance_device_overview import DeviceComplianceDeviceOverview


class DeviceStatusOverviewRequest:
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		self.request_adapter = request_adapter
		self.url_template: str = "{+baseurl}/deviceManagement/deviceCompliancePolicies/{deviceCompliancePolicy%2Did}/deviceStatusOverview"
	...
	async def patch(
		self,
		body: DeviceComplianceDeviceOverview,
