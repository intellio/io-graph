...
from iograph_models.models.user_experience_analytics_work_from_anywhere_metric_collection_response import UserExperienceAnalyticsWorkFromAnywhereMetricCollectionResponse
...
class UserExperienceAnalyticsWorkFromAnywhereMetricsRequest:
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		self.request_adapter = request_adapter
		self.url_template: str = "{+baseurl}/deviceManagement/userExperienceAnalyticsWorkFromAnywhereMetrics"
