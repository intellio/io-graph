...
class ByDeviceManagementPartnerIdRequest(BaseRequestBuilder):
	...
	def with_url(self, raw_url: str) -> ByDeviceManagementPartnerIdRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: ByDeviceManagementPartnerIdRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return ByDeviceManagementPartnerIdRequest(self.request_adapter, self.path_parameters)
	...
	def terminate(self,
		...
		from .terminate import TerminateRequest
		return TerminateRequest(self.request_adapter, path_parameters)
