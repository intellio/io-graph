...
from iograph_models.models.device_compliance_policy_setting_state_summary_collection_response import DeviceCompliancePolicySettingStateSummaryCollectionResponse
...
class DeviceCompliancePolicySettingStateSummariesRequest:
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		self.request_adapter = request_adapter
		self.url_template: str = "{+baseurl}/deviceManagement/deviceCompliancePolicySettingStateSummaries"
