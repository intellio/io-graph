...
from iograph_models.models.device_compliance_setting_state import DeviceComplianceSettingState
from iograph_models.models.device_compliance_setting_state_collection_response import DeviceComplianceSettingStateCollectionResponse


class DeviceComplianceSettingStatesRequest:
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		self.request_adapter = request_adapter
		self.url_template: str = "{+baseurl}/deviceManagement/deviceCompliancePolicySettingStateSummaries/{deviceCompliancePolicySettingStateSummary%2Did}/deviceComplianceSettingStates"
