...
from iograph_models.models.user_experience_analytics_category_collection_response import UserExperienceAnalyticsCategoryCollectionResponse
...
class UserExperienceAnalyticsCategoriesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/deviceManagement/userExperienceAnalyticsCategories", path_parameters)
	...
	def with_url(self, raw_url: str) -> UserExperienceAnalyticsCategoriesRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: UserExperienceAnalyticsCategoriesRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return UserExperienceAnalyticsCategoriesRequest(self.request_adapter, self.path_parameters)

	def by_user_experience_analytics_category_id(self,
		userExperienceAnalyticsCategory_id: str,
	) -> ByUserExperienceAnalyticsCategoryIdRequest:
		...
		from .by_user_experience_analytics_category_id import ByUserExperienceAnalyticsCategoryIdRequest
		return ByUserExperienceAnalyticsCategoryIdRequest(self.request_adapter, path_parameters)
