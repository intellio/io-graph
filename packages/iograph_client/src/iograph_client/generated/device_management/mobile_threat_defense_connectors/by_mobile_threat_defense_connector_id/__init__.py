...
from iograph_models.models.mobile_threat_defense_connector import MobileThreatDefenseConnector
from iograph_models.models.o_data_errors__o_data_error import ODataErrorsODataError


class ByMobileThreatDefenseConnectorIdRequest(BaseRequestBuilder):
	...
	def with_url(self, raw_url: str) -> ByMobileThreatDefenseConnectorIdRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: ByMobileThreatDefenseConnectorIdRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return ByMobileThreatDefenseConnectorIdRequest(self.request_adapter, self.path_parameters)
