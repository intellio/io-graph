...
from iograph_models.models.mobile_threat_defense_connector_collection_response import MobileThreatDefenseConnectorCollectionResponse
from iograph_models.models.mobile_threat_defense_connector import MobileThreatDefenseConnector


class MobileThreatDefenseConnectorsRequest:
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		self.request_adapter = request_adapter
		self.url_template: str = "{+baseurl}/deviceManagement/mobileThreatDefenseConnectors"
