...
from iograph_models.models.get_device_management_intent_per_setting_contributing_profiles_post_request import Get_device_management_intent_per_setting_contributing_profilesPostRequest
from iograph_models.models.o_data_errors__o_data_error import ODataErrorsODataError


class GetDeviceManagementIntentPerSettingContributingProfilesRequest(BaseRequestBuilder):
	...
	async def post(
		self,
		body: Get_device_management_intent_per_setting_contributing_profilesPostRequest,
	...
	def with_url(self, raw_url: str) -> GetDeviceManagementIntentPerSettingContributingProfilesRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: GetDeviceManagementIntentPerSettingContributingProfilesRequest
		"""
		if raw_url is None:
