...
from iograph_models.models.get_noncompliant_devices_and_settings_report_post_request import Get_noncompliant_devices_and_settings_reportPostRequest


class GetNoncompliantDevicesAndSettingsReportRequest(BaseRequestBuilder):
	...
	async def post(
		self,
		body: Get_noncompliant_devices_and_settings_reportPostRequest,
	...
	def with_url(self, raw_url: str) -> GetNoncompliantDevicesAndSettingsReportRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: GetNoncompliantDevicesAndSettingsReportRequest
		"""
		if raw_url is None:
