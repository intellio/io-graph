...
from iograph_models.models.get_setting_non_compliance_report_post_request import Get_setting_non_compliance_reportPostRequest


class GetSettingNonComplianceReportRequest(BaseRequestBuilder):
	...
	async def post(
		self,
		body: Get_setting_non_compliance_reportPostRequest,
	...
	def with_url(self, raw_url: str) -> GetSettingNonComplianceReportRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: GetSettingNonComplianceReportRequest
		"""
		if raw_url is None:
