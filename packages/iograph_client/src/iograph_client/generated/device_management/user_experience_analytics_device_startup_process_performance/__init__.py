...
from iograph_models.models.user_experience_analytics_device_startup_process_performance_collection_response import UserExperienceAnalyticsDeviceStartupProcessPerformanceCollectionResponse


class UserExperienceAnalyticsDeviceStartupProcessPerformanceRequest:
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		self.request_adapter = request_adapter
		self.url_template: str = "{+baseurl}/deviceManagement/userExperienceAnalyticsDeviceStartupProcessPerformance"
