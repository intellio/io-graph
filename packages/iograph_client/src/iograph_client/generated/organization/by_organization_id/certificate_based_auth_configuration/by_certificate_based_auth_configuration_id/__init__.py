...
from iograph_models.models.certificate_based_auth_configuration import CertificateBasedAuthConfiguration
from iograph_models.models.o_data_errors__o_data_error import ODataErrorsODataError


class ByCertificateBasedAuthConfigurationIdRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/organization/{organization%2Did}/certificateBasedAuthConfiguration/{certificateBasedAuthConfiguration%2Did}", path_parameters)
	...
	def with_url(self, raw_url: str) -> ByCertificateBasedAuthConfigurationIdRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: ByCertificateBasedAuthConfigurationIdRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return ByCertificateBasedAuthConfigurationIdRequest(self.request_adapter, self.path_parameters)
