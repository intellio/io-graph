...
from iograph_models.models.organizational_branding_localization_collection_response import OrganizationalBrandingLocalizationCollectionResponse
...
class LocalizationsRequest:
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		...
		self.url_template: str = "{+baseurl}/organization/{organization%2Did}/branding/localizations"
