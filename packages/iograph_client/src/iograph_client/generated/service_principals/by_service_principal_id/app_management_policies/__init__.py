...
from iograph_models.models.app_management_policy_collection_response import AppManagementPolicyCollectionResponse


class AppManagementPoliciesRequest:
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		self.request_adapter = request_adapter
		self.url_template: str = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/appManagementPolicies"
	...
	async def get(
		...
		"""
		tags = ['servicePrincipals.appManagementPolicy']
