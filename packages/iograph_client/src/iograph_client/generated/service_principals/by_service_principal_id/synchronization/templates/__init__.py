...
from iograph_models.models.synchronization_template_collection_response import SynchronizationTemplateCollectionResponse
...
class TemplatesRequest:
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		...
		self.url_template: str = "{+baseurl}/servicePrincipals/{servicePrincipal%2Did}/synchronization/templates"
