...
from iograph_models.models.clock_out_post_request import Clock_outPostRequest


class ClockOutRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/me/joinedTeams/{team%2Did}/schedule/timeCards/{timeCard%2Did}/clockOut", path_parameters)
