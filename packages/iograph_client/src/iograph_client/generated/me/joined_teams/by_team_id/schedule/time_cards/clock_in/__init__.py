...
from iograph_models.models.clock_in_post_request import Clock_inPostRequest


class ClockInRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/me/joinedTeams/{team%2Did}/schedule/timeCards/clockIn", path_parameters)
