...
from iograph_models.models.reprocess_license_assignment_response import ReprocessLicenseAssignmentResponse


class ReprocessLicenseAssignmentRequest(BaseRequestBuilder):
	...
	async def post(
		...
		return await self.request_adapter.send_async(request_info, ReprocessLicenseAssignmentResponse, error_mapping)


	def with_url(self, raw_url: str) -> ReprocessLicenseAssignmentRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: ReprocessLicenseAssignmentRequest
		"""
		if raw_url is None:
