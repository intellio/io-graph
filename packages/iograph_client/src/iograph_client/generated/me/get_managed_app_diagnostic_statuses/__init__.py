...
from iograph_models.models.get_managed_app_diagnostic_statuses_response import GetManagedAppDiagnosticStatusesResponse


class GetManagedAppDiagnosticStatusesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/me/getManagedAppDiagnosticStatuses()", path_parameters)
