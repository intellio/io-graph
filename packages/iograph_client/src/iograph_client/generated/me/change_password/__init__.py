...
from iograph_models.models.change_password_post_request import Change_passwordPostRequest
from iograph_models.models.o_data_errors__o_data_error import ODataErrorsODataError


class ChangePasswordRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/me/changePassword", path_parameters)

	async def post(
		self,
		body: Change_passwordPostRequest,
	...
	def with_url(self, raw_url: str) -> ChangePasswordRequest:
		"""
