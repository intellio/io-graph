...
from iograph_models.models.share_point_protection_policy_collection_response import SharePointProtectionPolicyCollectionResponse
from iograph_models.models.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.models.share_point_protection_policy import SharePointProtectionPolicy


class SharePointProtectionPoliciesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/solutions/backupRestore/sharePointProtectionPolicies", path_parameters)
	...
	def with_url(self, raw_url: str) -> SharePointProtectionPoliciesRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: SharePointProtectionPoliciesRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return SharePointProtectionPoliciesRequest(self.request_adapter, self.path_parameters)

	def by_share_point_protection_policy_id(self,
		sharePointProtectionPolicy_id: str,
	) -> BySharePointProtectionPolicyIdRequest:
		...
		from .by_share_point_protection_policy_id import BySharePointProtectionPolicyIdRequest
		return BySharePointProtectionPolicyIdRequest(self.request_adapter, path_parameters)
