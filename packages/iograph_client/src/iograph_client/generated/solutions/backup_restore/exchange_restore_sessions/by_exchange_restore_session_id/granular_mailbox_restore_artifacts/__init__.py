...
from iograph_models.models.granular_mailbox_restore_artifact_collection_response import GranularMailboxRestoreArtifactCollectionResponse


class GranularMailboxRestoreArtifactsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/solutions/backupRestore/exchangeRestoreSessions/{exchangeRestoreSession%2Did}/granularMailboxRestoreArtifacts", path_parameters)
	...
	def with_url(self, raw_url: str) -> GranularMailboxRestoreArtifactsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: GranularMailboxRestoreArtifactsRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return GranularMailboxRestoreArtifactsRequest(self.request_adapter, self.path_parameters)

	def by_granular_mailbox_restore_artifact_id(self,
		exchangeRestoreSession_id: str,
		granularMailboxRestoreArtifact_id: str,
	) -> ByGranularMailboxRestoreArtifactIdRequest:
		...
		from .by_granular_mailbox_restore_artifact_id import ByGranularMailboxRestoreArtifactIdRequest
		return ByGranularMailboxRestoreArtifactIdRequest(self.request_adapter, path_parameters)
