...
from iograph_models.models.exchange_restore_session_collection_response import ExchangeRestoreSessionCollectionResponse
from iograph_models.models.exchange_restore_session import ExchangeRestoreSession


class ExchangeRestoreSessionsRequest:
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		self.request_adapter = request_adapter
		self.url_template: str = "{+baseurl}/solutions/backupRestore/exchangeRestoreSessions"
