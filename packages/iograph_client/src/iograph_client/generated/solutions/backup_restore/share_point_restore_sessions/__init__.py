...
from iograph_models.models.share_point_restore_session_collection_response import SharePointRestoreSessionCollectionResponse
from iograph_models.models.share_point_restore_session import SharePointRestoreSession


class SharePointRestoreSessionsRequest:
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		self.request_adapter = request_adapter
		self.url_template: str = "{+baseurl}/solutions/backupRestore/sharePointRestoreSessions"
