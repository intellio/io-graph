...
from iograph_models.models.drive_protection_unit_collection_response import DriveProtectionUnitCollectionResponse
from iograph_models.models.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.models.drive_protection_unit import DriveProtectionUnit


class DriveProtectionUnitsRequest:
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		self.request_adapter = request_adapter
		self.url_template: str = "{+baseurl}/solutions/backupRestore/driveProtectionUnits"
