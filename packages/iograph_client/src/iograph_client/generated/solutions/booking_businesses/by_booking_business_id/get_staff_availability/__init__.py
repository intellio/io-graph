...
from iograph_models.models.get_staff_availability_post_response import Get_staff_availabilityPostResponse
from iograph_models.models.get_staff_availability_post_request import Get_staff_availabilityPostRequest


class GetStaffAvailabilityRequest:
