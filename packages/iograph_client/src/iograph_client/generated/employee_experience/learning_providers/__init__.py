...
from iograph_models.models.learning_provider_collection_response import LearningProviderCollectionResponse
from iograph_models.models.learning_provider import LearningProvider


class LearningProvidersRequest:
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		self.request_adapter = request_adapter
		self.url_template: str = "{+baseurl}/employeeExperience/learningProviders"
