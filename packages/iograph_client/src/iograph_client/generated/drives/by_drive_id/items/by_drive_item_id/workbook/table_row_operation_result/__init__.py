...
class TableRowOperationResultRequest(BaseRequestBuilder):
...
3. Use the query URL returned from step 2 as the GET request URL for this function tableRowOperationResult. A successful function call returns the new table rows in a workbookTableRow resource. This function does not do anything if called independently.
	...
	def with_url(self, raw_url: str) -> TableRowOperationResultRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: TableRowOperationResultRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return TableRowOperationResultRequest(self.request_adapter, self.path_parameters)
