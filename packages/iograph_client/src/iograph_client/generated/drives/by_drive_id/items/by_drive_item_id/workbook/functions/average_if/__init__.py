...
from iograph_models.models.average_if_post_request import Average_ifPostRequest
from iograph_models.models.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.models.workbook_function_result import WorkbookFunctionResult


class AverageIfRequest(BaseRequestBuilder):
	...
	def with_url(self, raw_url: str) -> AverageIfRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: AverageIfRequest
		"""
		if raw_url is None:
