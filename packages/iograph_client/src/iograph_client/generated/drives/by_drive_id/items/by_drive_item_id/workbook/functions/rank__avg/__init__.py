...
from iograph_models.models.rank__avg_post_request import Rank__avgPostRequest


class Rank_AvgRequest(BaseRequestBuilder):
	...
	def with_url(self, raw_url: str) -> Rank_AvgRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: Rank_AvgRequest
		"""
		if raw_url is None:
