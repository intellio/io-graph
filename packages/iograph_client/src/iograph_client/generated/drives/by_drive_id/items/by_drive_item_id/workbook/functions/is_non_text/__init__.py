...
from iograph_models.models.is_non_text_post_request import Is_non_textPostRequest


class IsNonTextRequest(BaseRequestBuilder):
	...
	def with_url(self, raw_url: str) -> IsNonTextRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: IsNonTextRequest
		"""
		if raw_url is None:
