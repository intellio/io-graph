...
from iograph_models.models.extract_sensitivity_labels_result import ExtractSensitivityLabelsResult
from iograph_models.models.o_data_errors__o_data_error import ODataErrorsODataError


class ExtractSensitivityLabelsRequest(BaseRequestBuilder):
	...
	def with_url(self, raw_url: str) -> ExtractSensitivityLabelsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: ExtractSensitivityLabelsRequest
		"""
		if raw_url is None:
