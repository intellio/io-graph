...
from iograph_models.models.workbook_chart_axes import WorkbookChartAxes


class AxesRequest:
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		self.request_adapter = request_adapter
		self.url_template: str = "{+baseurl}/drives/{drive%2Did}/items/{driveItem%2Did}/workbook/worksheets/{workbookWorksheet%2Did}/charts/{workbookChart%2Did}/axes"
	...
	def series_axis(self,
		...
		from .series_axis import SeriesAxisRequest
		return SeriesAxisRequest(self.request_adapter, self.path_parameters)

	@property
	def value_axis(self,
	) -> ValueAxisRequest:
		from .value_axis import ValueAxisRequest
		return ValueAxisRequest(self.request_adapter, self.path_parameters)
