...
from iograph_models.models.acosh_post_request import AcoshPostRequest
from iograph_models.models.workbook_function_result import WorkbookFunctionResult


class AcoshRequest(BaseRequestBuilder):
	...
	def with_url(self, raw_url: str) -> AcoshRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: AcoshRequest
		"""
		if raw_url is None:
