...
from iograph_models.models.sum_ifs_post_request import Sum_ifsPostRequest
from iograph_models.models.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.models.workbook_function_result import WorkbookFunctionResult


class SumIfsRequest(BaseRequestBuilder):
	...
	def with_url(self, raw_url: str) -> SumIfsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: SumIfsRequest
		"""
		if raw_url is None:
