...
from iograph_models.models.norm__inv_post_request import Norm__invPostRequest


class Norm_InvRequest(BaseRequestBuilder):
	...
	def with_url(self, raw_url: str) -> Norm_InvRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: Norm_InvRequest
		"""
		if raw_url is None:
