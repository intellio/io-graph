...
if TYPE_CHECKING:
	...
	from .by_threat_assessment_request_id import ByThreatAssessmentRequestIdRequest
	from ....request_adapter import HttpxRequestAdapter
from iograph_models.models.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.models.threat_assessment_request import ThreatAssessmentRequest
from iograph_models.models.threat_assessment_request_collection_response import ThreatAssessmentRequestCollectionResponse


class ThreatAssessmentRequestsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/informationProtection/threatAssessmentRequests", path_parameters)
	...
	def with_url(self, raw_url: str) -> ThreatAssessmentRequestsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: ThreatAssessmentRequestsRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return ThreatAssessmentRequestsRequest(self.request_adapter, self.path_parameters)

	def by_threat_assessment_request_id(self,
		threatAssessmentRequest_id: str,
	) -> ByThreatAssessmentRequestIdRequest:
		...
		from .by_threat_assessment_request_id import ByThreatAssessmentRequestIdRequest
		return ByThreatAssessmentRequestIdRequest(self.request_adapter, path_parameters)
