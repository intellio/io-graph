...
if TYPE_CHECKING:
	...
	from .by_print_service_id import ByPrintServiceIdRequest
	from ....request_adapter import HttpxRequestAdapter
from iograph_models.models.print_service import PrintService
from iograph_models.models.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.models.print_service_collection_response import PrintServiceCollectionResponse


class ServicesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/print/services", path_parameters)
	...
	def by_print_service_id(self,
		printService_id: str,
	) -> ByPrintServiceIdRequest:
		...
		from .by_print_service_id import ByPrintServiceIdRequest
		return ByPrintServiceIdRequest(self.request_adapter, path_parameters)
