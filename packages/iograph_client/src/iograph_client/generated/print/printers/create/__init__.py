...
from iograph_models.models.create_post_request import CreatePostRequest


class CreateRequest(BaseRequestBuilder):
	...
	def with_url(self, raw_url: str) -> CreateRequest:
		"""
