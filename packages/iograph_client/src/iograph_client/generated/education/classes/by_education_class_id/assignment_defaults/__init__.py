...
from iograph_models.models.education_assignment_defaults import EducationAssignmentDefaults
from iograph_models.models.o_data_errors__o_data_error import ODataErrorsODataError


class AssignmentDefaultsRequest(BaseRequestBuilder):
	...
	async def patch(
		self,
		body: EducationAssignmentDefaults,
	...
	def with_url(self, raw_url: str) -> AssignmentDefaultsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: AssignmentDefaultsRequest
		"""
		if raw_url is None:
