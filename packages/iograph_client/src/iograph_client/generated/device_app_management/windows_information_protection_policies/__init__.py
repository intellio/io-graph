...
if TYPE_CHECKING:
	...
	from .by_windows_information_protection_policy_id import ByWindowsInformationProtectionPolicyIdRequest
	from ....request_adapter import HttpxRequestAdapter
from iograph_models.models.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.models.windows_information_protection_policy import WindowsInformationProtectionPolicy
from iograph_models.models.windows_information_protection_policy_collection_response import WindowsInformationProtectionPolicyCollectionResponse


class WindowsInformationProtectionPoliciesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/deviceAppManagement/windowsInformationProtectionPolicies", path_parameters)
	...
	def with_url(self, raw_url: str) -> WindowsInformationProtectionPoliciesRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: WindowsInformationProtectionPoliciesRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return WindowsInformationProtectionPoliciesRequest(self.request_adapter, self.path_parameters)

	def by_windows_information_protection_policy_id(self,
		windowsInformationProtectionPolicy_id: str,
	) -> ByWindowsInformationProtectionPolicyIdRequest:
		...
		from .by_windows_information_protection_policy_id import ByWindowsInformationProtectionPolicyIdRequest
		return ByWindowsInformationProtectionPolicyIdRequest(self.request_adapter, path_parameters)
