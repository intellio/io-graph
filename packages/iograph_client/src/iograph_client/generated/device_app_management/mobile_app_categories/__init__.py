...
from iograph_models.models.mobile_app_category_collection_response import MobileAppCategoryCollectionResponse
from iograph_models.models.mobile_app_category import MobileAppCategory


class MobileAppCategoriesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/deviceAppManagement/mobileAppCategories", path_parameters)
	...
	async def get(
		...
		"""
		tags = ['deviceAppManagement.mobileAppCategory']
	...
	def with_url(self, raw_url: str) -> MobileAppCategoriesRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: MobileAppCategoriesRequest
		"""
		if raw_url is None:
