...
from iograph_models.models.managed_device_mobile_app_configuration_assignment import ManagedDeviceMobileAppConfigurationAssignment


class ByManagedDeviceMobileAppConfigurationAssignmentIdRequest(BaseRequestBuilder):
	...
	def with_url(self, raw_url: str) -> ByManagedDeviceMobileAppConfigurationAssignmentIdRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: ByManagedDeviceMobileAppConfigurationAssignmentIdRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return ByManagedDeviceMobileAppConfigurationAssignmentIdRequest(self.request_adapter, self.path_parameters)
