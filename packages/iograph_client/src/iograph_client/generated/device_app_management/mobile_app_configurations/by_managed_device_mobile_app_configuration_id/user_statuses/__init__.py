...
from iograph_models.models.managed_device_mobile_app_configuration_user_status_collection_response import ManagedDeviceMobileAppConfigurationUserStatusCollectionResponse
from iograph_models.models.managed_device_mobile_app_configuration_user_status import ManagedDeviceMobileAppConfigurationUserStatus


class UserStatusesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/deviceAppManagement/mobileAppConfigurations/{managedDeviceMobileAppConfiguration%2Did}/userStatuses", path_parameters)
