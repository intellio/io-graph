...
from iograph_models.models.windows_mobile_m_s_i_collection_response import WindowsMobileMSICollectionResponse


class GraphWindowsMobileMSIRequest:
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		self.request_adapter = request_adapter
		self.url_template: str = "{+baseurl}/deviceAppManagement/mobileApps/graph.windowsMobileMSI"
