...
from iograph_models.models.unified_role_assignment_collection_response import UnifiedRoleAssignmentCollectionResponse
...
class RoleAssignmentsRequest:
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		...
		self.url_template: str = "{+baseurl}/roleManagement/entitlementManagement/roleAssignments"
