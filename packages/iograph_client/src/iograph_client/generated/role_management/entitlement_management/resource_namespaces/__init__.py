...
from iograph_models.models.unified_rbac_resource_namespace_collection_response import UnifiedRbacResourceNamespaceCollectionResponse
from iograph_models.models.unified_rbac_resource_namespace import UnifiedRbacResourceNamespace


class ResourceNamespacesRequest:
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		self.request_adapter = request_adapter
		self.url_template: str = "{+baseurl}/roleManagement/entitlementManagement/resourceNamespaces"
