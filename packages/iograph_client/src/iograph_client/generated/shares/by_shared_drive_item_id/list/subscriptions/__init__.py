...
from iograph_models.models.subscription_collection_response import SubscriptionCollectionResponse


class SubscriptionsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/shares/{sharedDriveItem%2Did}/list/subscriptions", path_parameters)
