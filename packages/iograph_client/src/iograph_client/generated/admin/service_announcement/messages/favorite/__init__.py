...
from iograph_models.models.favorite_post_response import FavoritePostResponse
from iograph_models.models.favorite_post_request import FavoritePostRequest
from iograph_models.models.o_data_errors__o_data_error import ODataErrorsODataError


class FavoriteRequest(BaseRequestBuilder):
	...
	def with_url(self, raw_url: str) -> FavoriteRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: FavoriteRequest
		"""
		if raw_url is None:
