...
from iograph_models.models.m365_apps_installation_options import M365AppsInstallationOptions
from iograph_models.models.o_data_errors__o_data_error import ODataErrorsODataError


class InstallationOptionsRequest(BaseRequestBuilder):
	...
	async def patch(
		self,
		body: M365AppsInstallationOptions,
	...
	def with_url(self, raw_url: str) -> InstallationOptionsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: InstallationOptionsRequest
		"""
		if raw_url is None:
