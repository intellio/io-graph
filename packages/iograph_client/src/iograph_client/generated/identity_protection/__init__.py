...
from iograph_models.models.identity_protection_root import IdentityProtectionRoot


class IdentityProtectionRequest:
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		self.request_adapter = request_adapter
		self.url_template: str = "{+baseurl}/identityProtection"
