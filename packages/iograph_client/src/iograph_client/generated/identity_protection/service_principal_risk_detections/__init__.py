...
from iograph_models.models.service_principal_risk_detection_collection_response import ServicePrincipalRiskDetectionCollectionResponse
from iograph_models.models.service_principal_risk_detection import ServicePrincipalRiskDetection


class ServicePrincipalRiskDetectionsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/identityProtection/servicePrincipalRiskDetections", path_parameters)
	...
	def with_url(self, raw_url: str) -> ServicePrincipalRiskDetectionsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: ServicePrincipalRiskDetectionsRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return ServicePrincipalRiskDetectionsRequest(self.request_adapter, self.path_parameters)

	def by_service_principal_risk_detection_id(self,
		servicePrincipalRiskDetection_id: str,
	) -> ByServicePrincipalRiskDetectionIdRequest:
		if servicePrincipalRiskDetection_id is None:
			raise TypeError("servicePrincipalRiskDetection_id cannot be null.")

		path_parameters = get_path_parameters(self.path_parameters)
		path_parameters["servicePrincipalRiskDetection%2Did"] =  servicePrincipalRiskDetection_id

		from .by_service_principal_risk_detection_id import ByServicePrincipalRiskDetectionIdRequest
		return ByServicePrincipalRiskDetectionIdRequest(self.request_adapter, path_parameters)
