...
from iograph_models.models.tenant_app_management_policy import TenantAppManagementPolicy


class DefaultAppManagementPolicyRequest:
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		self.request_adapter = request_adapter
		self.url_template: str = "{+baseurl}/policies/defaultAppManagementPolicy"
