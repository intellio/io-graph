...
from iograph_models.models.conditional_access_policy import ConditionalAccessPolicy
from iograph_models.models.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.models.conditional_access_policy_collection_response import ConditionalAccessPolicyCollectionResponse


class ConditionalAccessPoliciesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/policies/conditionalAccessPolicies", path_parameters)
	...
	async def get(
		...
		"""
		tags = ['policies.conditionalAccessPolicy']
