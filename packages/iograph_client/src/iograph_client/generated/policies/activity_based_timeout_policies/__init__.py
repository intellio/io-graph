...
from iograph_models.models.activity_based_timeout_policy_collection_response import ActivityBasedTimeoutPolicyCollectionResponse
from iograph_models.models.activity_based_timeout_policy import ActivityBasedTimeoutPolicy
from iograph_models.models.o_data_errors__o_data_error import ODataErrorsODataError


class ActivityBasedTimeoutPoliciesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/policies/activityBasedTimeoutPolicies", path_parameters)
	...
	async def get(
		...
		"""
		tags = ['policies.activityBasedTimeoutPolicy']
	...
	async def post(
		self,
		body: ActivityBasedTimeoutPolicy,
	...
	def with_url(self, raw_url: str) -> ActivityBasedTimeoutPoliciesRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: ActivityBasedTimeoutPoliciesRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return ActivityBasedTimeoutPoliciesRequest(self.request_adapter, self.path_parameters)

	def by_activity_based_timeout_policy_id(self,
		activityBasedTimeoutPolicy_id: str,
	) -> ByActivityBasedTimeoutPolicyIdRequest:
		...
		from .by_activity_based_timeout_policy_id import ByActivityBasedTimeoutPolicyIdRequest
		return ByActivityBasedTimeoutPolicyIdRequest(self.request_adapter, path_parameters)
