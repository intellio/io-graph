...
if TYPE_CHECKING:
	...
	from .by_unified_role_management_policy_assignment_id import ByUnifiedRoleManagementPolicyAssignmentIdRequest
	from ....request_adapter import HttpxRequestAdapter
from iograph_models.models.unified_role_management_policy_assignment import UnifiedRoleManagementPolicyAssignment
from iograph_models.models.o_data_errors__o_data_error import ODataErrorsODataError
from iograph_models.models.unified_role_management_policy_assignment_collection_response import UnifiedRoleManagementPolicyAssignmentCollectionResponse


class RoleManagementPolicyAssignmentsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/policies/roleManagementPolicyAssignments", path_parameters)
	...
	def with_url(self, raw_url: str) -> RoleManagementPolicyAssignmentsRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: RoleManagementPolicyAssignmentsRequest
		"""
		if raw_url is None:
			raise TypeError("raw_url cannot be None.")
		return RoleManagementPolicyAssignmentsRequest(self.request_adapter, self.path_parameters)

	def by_unified_role_management_policy_assignment_id(self,
		unifiedRoleManagementPolicyAssignment_id: str,
	) -> ByUnifiedRoleManagementPolicyAssignmentIdRequest:
		...
		from .by_unified_role_management_policy_assignment_id import ByUnifiedRoleManagementPolicyAssignmentIdRequest
		return ByUnifiedRoleManagementPolicyAssignmentIdRequest(self.request_adapter, path_parameters)
