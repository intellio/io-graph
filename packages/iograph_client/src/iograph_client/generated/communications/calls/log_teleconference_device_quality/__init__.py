...
from iograph_models.models.log_teleconference_device_quality_post_request import Log_teleconference_device_qualityPostRequest


class LogTeleconferenceDeviceQualityRequest:
