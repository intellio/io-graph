...
from iograph_models.models.call_records_organizer import CallRecordsOrganizer


class Organizer_v2Request(BaseRequestBuilder):
	...
	async def get(
		...
		return await self.request_adapter.send_async(request_info, CallRecordsOrganizer, error_mapping)

	async def patch(
		self,
		body: CallRecordsOrganizer,
	...
	def with_url(self, raw_url: str) -> Organizer_v2Request:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: Organizer_v2Request
		"""
		if raw_url is None:
