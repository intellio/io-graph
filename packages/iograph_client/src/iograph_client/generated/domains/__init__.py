...
if TYPE_CHECKING:
	...
	from .by_domain_id import ByDomainIdRequest
	from ...request_adapter import HttpxRequestAdapter
from iograph_models.models.domain_collection_response import DomainCollectionResponse
from iograph_models.models.domain import Domain
from iograph_models.models.o_data_errors__o_data_error import ODataErrorsODataError


class DomainsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/domains", path_parameters)
	...
	def by_domain_id(self,
		...
		from .by_domain_id import ByDomainIdRequest
		return ByDomainIdRequest(self.request_adapter, path_parameters)
