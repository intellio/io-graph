...
from iograph_models.models.get_activities_by_interval_with_startdatetime_enddatetime_interval_get_response import Get_activities_by_interval_with_startdatetime_enddatetime_intervalGetResponse
