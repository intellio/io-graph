...
from iograph_models.models.copy_notebook_post_request import Copy_notebookPostRequest


class CopyNotebookRequest(BaseRequestBuilder):
	...
	def with_url(self, raw_url: str) -> CopyNotebookRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: CopyNotebookRequest
		"""
		if raw_url is None:
