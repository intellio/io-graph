...
from iograph_models.models.teams_async_operation_collection_response import TeamsAsyncOperationCollectionResponse
...
class OperationsRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/teams/{team%2Did}/operations", path_parameters)
