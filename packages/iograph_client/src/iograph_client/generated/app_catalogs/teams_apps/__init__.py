...
from iograph_models.models.teams_app_collection_response import TeamsAppCollectionResponse


class TeamsAppsRequest:
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		self.request_adapter = request_adapter
		self.url_template: str = "{+baseurl}/appCatalogs/teamsApps"
