...
from iograph_models.models.update_windows_device_account_post_request import Update_windows_device_accountPostRequest


class UpdateWindowsDeviceAccountRequest(BaseRequestBuilder):
	...
	async def post(
		self,
		body: Update_windows_device_accountPostRequest,
	...
	def with_url(self, raw_url: str) -> UpdateWindowsDeviceAccountRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: UpdateWindowsDeviceAccountRequest
		"""
		if raw_url is None:
