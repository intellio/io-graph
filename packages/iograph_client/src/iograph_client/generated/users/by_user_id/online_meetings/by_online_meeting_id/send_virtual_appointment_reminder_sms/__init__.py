...
from iograph_models.models.send_virtual_appointment_reminder_sms_post_request import Send_virtual_appointment_reminder_smsPostRequest
from iograph_models.models.o_data_errors__o_data_error import ODataErrorsODataError


class SendVirtualAppointmentReminderSmsRequest:
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		self.request_adapter = request_adapter
		self.url_template: str = "{+baseurl}/users/{user%2Did}/onlineMeetings/{onlineMeeting%2Did}/sendVirtualAppointmentReminderSms"
