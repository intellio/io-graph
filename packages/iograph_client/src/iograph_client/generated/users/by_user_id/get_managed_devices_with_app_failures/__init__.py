...
from iograph_models.models.get_managed_devices_with_app_failures_response import GetManagedDevicesWithAppFailuresResponse


class GetManagedDevicesWithAppFailuresRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/users/{user%2Did}/getManagedDevicesWithAppFailures()", path_parameters)
	...
	def with_url(self, raw_url: str) -> GetManagedDevicesWithAppFailuresRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: GetManagedDevicesWithAppFailuresRequest
		"""
		if raw_url is None:
