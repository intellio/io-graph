...
from iograph_models.models.user_solution_root import UserSolutionRoot
from iograph_models.models.o_data_errors__o_data_error import ODataErrorsODataError


class SolutionsRequest:
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		self.request_adapter = request_adapter
		self.url_template: str = "{+baseurl}/users/{user%2Did}/solutions"
	...
	@property
	def working_time_schedule(self,
	) -> WorkingTimeScheduleRequest:
		from .working_time_schedule import WorkingTimeScheduleRequest
