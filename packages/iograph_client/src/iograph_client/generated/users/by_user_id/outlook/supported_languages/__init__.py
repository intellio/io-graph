...
from iograph_models.models.supported_languages_get_response import Supported_languagesGetResponse


class SupportedLanguagesRequest(BaseRequestBuilder):
	def __init__(self,request_adapter: HttpxRequestAdapter, path_parameters: Optional[Union[dict[str, Any], str]]) -> None:
		super().__init__(request_adapter, "{+baseurl}/users/{user%2Did}/outlook/supportedLanguages()", path_parameters)

	async def get(
		self,
		request_configuration: Optional[RequestConfiguration[GetQueryParams]] = None,
	) -> Supported_languagesGetResponse:
		"""
...
getting the user's mailbox settings.
		...
		return await self.request_adapter.send_async(request_info, Supported_languagesGetResponse, error_mapping)
	...
	def with_url(self, raw_url: str) -> SupportedLanguagesRequest:
		"""
		Returns a request builder with the provided arbitrary URL. Using this method means any other path or query parameters are ignored.
		param raw_url: The raw URL to use for the request builder.
		Returns: SupportedLanguagesRequest
		"""
		if raw_url is None:
