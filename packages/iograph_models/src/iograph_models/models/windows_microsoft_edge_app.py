...
class WindowsMicrosoftEdgeApp(BaseModel):
	...
	channel: Optional[MicrosoftEdgeChannel] = Field(default=None,alias="channel",)
	displayLanguageLocale: Optional[str] = Field(default=None,alias="displayLanguageLocale",)
