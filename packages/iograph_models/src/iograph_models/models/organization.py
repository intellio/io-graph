...
class Organization(BaseModel):
	...
	mobileDeviceManagementAuthority: Optional[str | MdmAuthority] = Field(alias="mobileDeviceManagementAuthority",default=None,)
	...
	partnerTenantType: Optional[str | PartnerTenantType] = Field(alias="partnerTenantType",default=None,)
