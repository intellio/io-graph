...
class SignIn(BaseModel):
	...
	appliedConditionalAccessPolicies: list[AppliedConditionalAccessPolicy] = Field(alias="appliedConditionalAccessPolicies",)
	...
	riskEventTypes_v2: list[Optional[str]] = Field(alias="riskEventTypes_v2",)
