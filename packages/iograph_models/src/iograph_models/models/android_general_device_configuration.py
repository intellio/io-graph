...
class AndroidGeneralDeviceConfiguration(BaseModel):
	...
	appsHideList: Optional[list[AppListItem]] = Field(default=None,alias="appsHideList",)
	appsInstallAllowList: Optional[list[AppListItem]] = Field(default=None,alias="appsInstallAllowList",)
	appsLaunchBlockList: Optional[list[AppListItem]] = Field(default=None,alias="appsLaunchBlockList",)
	...
	kioskModeApps: Optional[list[AppListItem]] = Field(default=None,alias="kioskModeApps",)
