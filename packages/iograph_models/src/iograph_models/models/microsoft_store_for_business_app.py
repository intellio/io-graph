...
class MicrosoftStoreForBusinessApp(BaseModel):
	...
	licenseType: Optional[MicrosoftStoreForBusinessLicenseType] = Field(default=None,alias="licenseType",)
	packageIdentityName: Optional[str] = Field(default=None,alias="packageIdentityName",)
