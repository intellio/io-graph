...
class DeviceAppManagement(BaseModel):
	...
	managedAppPolicies: SerializeAsAny[Optional[list[ManagedAppPolicy]]] = Field(default=None,alias="managedAppPolicies",)
	...
	managedAppStatuses: SerializeAsAny[Optional[list[ManagedAppStatus]]] = Field(default=None,alias="managedAppStatuses",)
	managedEBooks: SerializeAsAny[Optional[list[ManagedEBook]]] = Field(default=None,alias="managedEBooks",)
	...
	mobileAppConfigurations: SerializeAsAny[Optional[list[ManagedDeviceMobileAppConfiguration]]] = Field(default=None,alias="mobileAppConfigurations",)
	mobileApps: SerializeAsAny[Optional[list[MobileApp]]] = Field(default=None,alias="mobileApps",)
