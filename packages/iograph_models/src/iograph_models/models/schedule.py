...
class Schedule(BaseModel):
	...
	provisionStatus: Optional[str | OperationStatus] = Field(alias="provisionStatus",default=None,)
	provisionStatusCode: Optional[str] = Field(alias="provisionStatusCode",default=None,)
	startDayOfWeek: Optional[str | DayOfWeek] = Field(alias="startDayOfWeek",default=None,)
	...
	offerShiftRequests: SerializeAsAny[Optional[list[OfferShiftRequest]]] = Field(alias="offerShiftRequests",default=None,)
