...
class SecurityAlert(BaseModel):
	...
	classification: Optional[str | SecurityAlertClassification] = Field(alias="classification",default=None,)
	comments: Optional[list[SecurityAlertComment]] = Field(alias="comments",default=None,)
	createdDateTime: Optional[datetime] = Field(alias="createdDateTime",default=None,)
	description: Optional[str] = Field(alias="description",default=None,)
	detectionSource: Optional[str | SecurityDetectionSource] = Field(alias="detectionSource",default=None,)
	detectorId: Optional[str] = Field(alias="detectorId",default=None,)
	determination: Optional[str | SecurityAlertDetermination] = Field(alias="determination",default=None,)
	...
	serviceSource: Optional[str | SecurityServiceSource] = Field(alias="serviceSource",default=None,)
	severity: Optional[str | SecurityAlertSeverity] = Field(alias="severity",default=None,)
	status: Optional[str | SecurityAlertStatus] = Field(alias="status",default=None,)
