...
class BackupRestoreRoot(BaseModel):
	...
	protectionPolicies: Optional[list[ProtectionPolicyBase]] = Field(default=None,alias="protectionPolicies",)
	protectionUnits: Optional[list[ProtectionUnitBase]] = Field(default=None,alias="protectionUnits",)
	restorePoints: Optional[list[RestorePoint]] = Field(default=None,alias="restorePoints",)
	restoreSessions: Optional[list[RestoreSessionBase]] = Field(default=None,alias="restoreSessions",)
