...
class NetworkConnection(BaseModel):
	...
	direction: Optional[str | ConnectionDirection] = Field(alias="direction",default=None,)
	...
	protocol: Optional[str | SecurityNetworkProtocol] = Field(alias="protocol",default=None,)
	...
	status: Optional[str | ConnectionStatus] = Field(alias="status",default=None,)
