...
class LearningContent(BaseModel):
	...
	additionalTags: list[Optional[str]] = Field(alias="additionalTags",)
	contentWebUrl: Optional[str] = Field(default=None,alias="contentWebUrl",)
	contributors: list[Optional[str]] = Field(alias="contributors",)
	...
	skillTags: list[Optional[str]] = Field(alias="skillTags",)
