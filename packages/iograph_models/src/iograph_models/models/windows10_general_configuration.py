...
class Windows10GeneralConfiguration(BaseModel):
	...
	appsAllowTrustedAppsSideloading: Optional[str | StateManagementSetting] = Field(alias="appsAllowTrustedAppsSideloading",default=None,)
	...
	defenderCloudBlockLevel: Optional[str | DefenderCloudBlockLevelType] = Field(alias="defenderCloudBlockLevel",default=None,)
	...
	defenderMonitorFileActivity: Optional[str | DefenderMonitorFileActivity] = Field(alias="defenderMonitorFileActivity",default=None,)
	defenderProcessesToExclude: Optional[list[str]] = Field(alias="defenderProcessesToExclude",default=None,)
	defenderPromptForSampleSubmission: Optional[str | DefenderPromptForSampleSubmission] = Field(alias="defenderPromptForSampleSubmission",default=None,)
	...
	defenderScanType: Optional[str | DefenderScanType] = Field(alias="defenderScanType",default=None,)
	...
	defenderSystemScanSchedule: Optional[str | WeeklySchedule] = Field(alias="defenderSystemScanSchedule",default=None,)
	developerUnlockSetting: Optional[str | StateManagementSetting] = Field(alias="developerUnlockSetting",default=None,)
	...
	diagnosticsDataSubmissionMode: Optional[str | DiagnosticDataSubmissionMode] = Field(alias="diagnosticsDataSubmissionMode",default=None,)
	...
	edgeCookiePolicy: Optional[str | EdgeCookiePolicy] = Field(alias="edgeCookiePolicy",default=None,)
	...
	privacyAdvertisingId: Optional[str | StateManagementSetting] = Field(alias="privacyAdvertisingId",default=None,)
	...
	safeSearchFilter: Optional[str | SafeSearchFilterType] = Field(alias="safeSearchFilter",default=None,)
	...
	startMenuAppListVisibility: Optional[str | WindowsStartMenuAppListVisibilityType] = Field(alias="startMenuAppListVisibility",default=None,)
	...
	startMenuMode: Optional[str | WindowsStartMenuModeType] = Field(alias="startMenuMode",default=None,)
	startMenuPinnedFolderDocuments: Optional[str | VisibilitySetting] = Field(alias="startMenuPinnedFolderDocuments",default=None,)
	startMenuPinnedFolderDownloads: Optional[str | VisibilitySetting] = Field(alias="startMenuPinnedFolderDownloads",default=None,)
	startMenuPinnedFolderFileExplorer: Optional[str | VisibilitySetting] = Field(alias="startMenuPinnedFolderFileExplorer",default=None,)
	startMenuPinnedFolderHomeGroup: Optional[str | VisibilitySetting] = Field(alias="startMenuPinnedFolderHomeGroup",default=None,)
	startMenuPinnedFolderMusic: Optional[str | VisibilitySetting] = Field(alias="startMenuPinnedFolderMusic",default=None,)
	startMenuPinnedFolderNetwork: Optional[str | VisibilitySetting] = Field(alias="startMenuPinnedFolderNetwork",default=None,)
	startMenuPinnedFolderPersonalFolder: Optional[str | VisibilitySetting] = Field(alias="startMenuPinnedFolderPersonalFolder",default=None,)
	startMenuPinnedFolderPictures: Optional[str | VisibilitySetting] = Field(alias="startMenuPinnedFolderPictures",default=None,)
	startMenuPinnedFolderSettings: Optional[str | VisibilitySetting] = Field(alias="startMenuPinnedFolderSettings",default=None,)
	startMenuPinnedFolderVideos: Optional[str | VisibilitySetting] = Field(alias="startMenuPinnedFolderVideos",default=None,)
	...
	windowsSpotlightConfigureOnLockScreen: Optional[str | WindowsSpotlightEnablementSettings] = Field(alias="windowsSpotlightConfigureOnLockScreen",default=None,)
