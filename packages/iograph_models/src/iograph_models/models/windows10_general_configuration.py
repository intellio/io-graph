...
class Windows10GeneralConfiguration(BaseModel):
	...
	bluetoothAllowedServices: list[Optional[str]] = Field(alias="bluetoothAllowedServices",)
	...
	defenderFileExtensionsToExclude: list[Optional[str]] = Field(alias="defenderFileExtensionsToExclude",)
	defenderFilesAndFoldersToExclude: list[Optional[str]] = Field(alias="defenderFilesAndFoldersToExclude",)
	defenderMonitorFileActivity: Optional[DefenderMonitorFileActivity] = Field(default=None,alias="defenderMonitorFileActivity",)
	defenderProcessesToExclude: list[Optional[str]] = Field(alias="defenderProcessesToExclude",)
	...
	edgeHomepageUrls: list[Optional[str]] = Field(alias="edgeHomepageUrls",)
