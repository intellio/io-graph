...
class PrinterLocation(BaseModel):
	...
	organization: list[Optional[str]] = Field(alias="organization",)
	...
	subdivision: list[Optional[str]] = Field(alias="subdivision",)
	subunit: list[Optional[str]] = Field(alias="subunit",)
