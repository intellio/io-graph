...
class UserRegistrationDetails(BaseModel):
	...
	methodsRegistered: list[Optional[str]] = Field(alias="methodsRegistered",)
	systemPreferredAuthenticationMethods: list[Optional[str]] = Field(alias="systemPreferredAuthenticationMethods",)
