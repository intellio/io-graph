...
class TodoTask(BaseModel):
	...
	status: Optional[str | TaskStatus] = Field(alias="status",default=None,)
	title: Optional[str] = Field(alias="title",default=None,)
	attachments: SerializeAsAny[Optional[list[AttachmentBase]]] = Field(alias="attachments",default=None,)
