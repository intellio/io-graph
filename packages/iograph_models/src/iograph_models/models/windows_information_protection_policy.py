...
class WindowsInformationProtectionPolicy(BaseModel):
	...
	pinLowercaseLetters: Optional[str | WindowsInformationProtectionPinCharacterRequirements] = Field(alias="pinLowercaseLetters",default=None,)
	pinMinimumLength: Optional[int] = Field(alias="pinMinimumLength",default=None,)
	pinSpecialCharacters: Optional[str | WindowsInformationProtectionPinCharacterRequirements] = Field(alias="pinSpecialCharacters",default=None,)
	pinUppercaseLetters: Optional[str | WindowsInformationProtectionPinCharacterRequirements] = Field(alias="pinUppercaseLetters",default=None,)
