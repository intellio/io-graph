...
class CloudPcOnPremisesConnection(BaseModel):
	...
	connectionType: Optional[str | CloudPcOnPremisesConnectionType] = Field(alias="connectionType",default=None,)
	displayName: Optional[str] = Field(alias="displayName",default=None,)
	healthCheckStatus: Optional[str | CloudPcOnPremisesConnectionStatus] = Field(alias="healthCheckStatus",default=None,)
