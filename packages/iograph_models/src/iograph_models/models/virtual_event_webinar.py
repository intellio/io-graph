...
class VirtualEventWebinar(BaseModel):
	...
	registrationConfiguration: Optional[VirtualEventWebinarRegistrationConfiguration] = Field(default=None,alias="registrationConfiguration",)
	registrations: Optional[list[VirtualEventRegistration]] = Field(default=None,alias="registrations",)
