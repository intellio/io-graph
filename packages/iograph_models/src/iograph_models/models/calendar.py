...
class Calendar(BaseModel):
	...
	allowedOnlineMeetingProviders: Optional[str | OnlineMeetingProviderType] = Field(alias="allowedOnlineMeetingProviders",default=None,)
	...
	color: Optional[str | CalendarColor] = Field(alias="color",default=None,)
	defaultOnlineMeetingProvider: Optional[str | OnlineMeetingProviderType] = Field(alias="defaultOnlineMeetingProvider",default=None,)
	...
	owner: Optional[EmailAddress] = Field(alias="owner",default=None,)
