...
class AndroidWorkProfileGeneralDeviceConfiguration(BaseModel):
	...
	passwordRequiredType: Optional[str | AndroidWorkProfileRequiredPasswordType] = Field(alias="passwordRequiredType",default=None,)
	...
	workProfileDataSharingType: Optional[str | AndroidWorkProfileCrossProfileDataSharingType] = Field(alias="workProfileDataSharingType",default=None,)
	workProfileDefaultAppPermissionPolicy: Optional[str | AndroidWorkProfileDefaultAppPermissionPolicyType] = Field(alias="workProfileDefaultAppPermissionPolicy",default=None,)
	...
	workProfilePasswordRequiredType: Optional[str | AndroidWorkProfileRequiredPasswordType] = Field(alias="workProfilePasswordRequiredType",default=None,)
