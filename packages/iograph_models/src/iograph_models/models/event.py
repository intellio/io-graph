...
class Event(BaseModel):
	...
	onlineMeetingProvider: Optional[str | OnlineMeetingProviderType] = Field(alias="onlineMeetingProvider",default=None,)
	...
	showAs: Optional[str | FreeBusyStatus] = Field(alias="showAs",default=None,)
