...
class SecurityIpAddress(BaseModel):
	...
	autonomousSystem: Optional[SecurityAutonomousSystem] = Field(default=None,alias="autonomousSystem",)
	countryOrRegion: Optional[str] = Field(default=None,alias="countryOrRegion",)
	hostingProvider: Optional[str] = Field(default=None,alias="hostingProvider",)
	netblock: Optional[str] = Field(default=None,alias="netblock",)
