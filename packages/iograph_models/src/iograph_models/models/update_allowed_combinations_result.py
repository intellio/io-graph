...
class UpdateAllowedCombinationsResult(BaseModel):
	...
	currentCombinations: Optional[list[str | AuthenticationMethodModes]] = Field(alias="currentCombinations",default=None,)
	previousCombinations: Optional[list[str | AuthenticationMethodModes]] = Field(alias="previousCombinations",default=None,)
