...
class SharepointSettings(BaseModel):
	...
	imageTaggingOption: Optional[str | ImageTaggingChoice] = Field(alias="imageTaggingOption",default=None,)
	...
	sharingCapability: Optional[str | SharingCapabilities] = Field(alias="sharingCapability",default=None,)
	sharingDomainRestrictionMode: Optional[str | SharingDomainRestrictionMode] = Field(alias="sharingDomainRestrictionMode",default=None,)
