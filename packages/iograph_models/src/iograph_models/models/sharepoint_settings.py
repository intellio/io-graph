...
class SharepointSettings(BaseModel):
	...
	allowedDomainGuidsForSyncApp: list[Optional[UUID]] = Field(alias="allowedDomainGuidsForSyncApp",)
	availableManagedPathsForSiteCreation: list[str] = Field(alias="availableManagedPathsForSiteCreation",)
	...
	excludedFileExtensionsForSyncApp: list[Optional[str]] = Field(alias="excludedFileExtensionsForSyncApp",)
	...
	sharingAllowedDomainList: list[Optional[str]] = Field(alias="sharingAllowedDomainList",)
	sharingBlockedDomainList: list[Optional[str]] = Field(alias="sharingBlockedDomainList",)
