...
class WindowsUniversalAppX(BaseModel):
	...
	applicableDeviceTypes: Optional[str | WindowsDeviceType] = Field(alias="applicableDeviceTypes",default=None,)
	...
	committedContainedApps: SerializeAsAny[Optional[list[MobileContainedApp]]] = Field(alias="committedContainedApps",default=None,)
