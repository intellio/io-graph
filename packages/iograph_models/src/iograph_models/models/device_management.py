...
class DeviceManagement(BaseModel):
	...
	deviceCompliancePolicies: SerializeAsAny[Optional[list[DeviceCompliancePolicy]]] = Field(default=None,alias="deviceCompliancePolicies",)
	...
	deviceConfigurations: SerializeAsAny[Optional[list[DeviceConfiguration]]] = Field(default=None,alias="deviceConfigurations",)
	deviceEnrollmentConfigurations: SerializeAsAny[Optional[list[DeviceEnrollmentConfiguration]]] = Field(default=None,alias="deviceEnrollmentConfigurations",)
	...
	roleDefinitions: SerializeAsAny[Optional[list[RoleDefinition]]] = Field(default=None,alias="roleDefinitions",)
	...
	troubleshootingEvents: SerializeAsAny[Optional[list[DeviceManagementTroubleshootingEvent]]] = Field(default=None,alias="troubleshootingEvents",)
