...
class WindowsDefenderAdvancedThreatProtectionConfiguration(BaseModel):
	...
	allowSampleSharing: Optional[bool] = Field(default=None,alias="allowSampleSharing",)
	enableExpeditedTelemetryReporting: Optional[bool] = Field(default=None,alias="enableExpeditedTelemetryReporting",)
