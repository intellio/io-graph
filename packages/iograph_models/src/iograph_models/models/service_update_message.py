...
class ServiceUpdateMessage(BaseModel):
	...
	category: Optional[str | ServiceUpdateCategory] = Field(alias="category",default=None,)
	...
	severity: Optional[str | ServiceUpdateSeverity] = Field(alias="severity",default=None,)
