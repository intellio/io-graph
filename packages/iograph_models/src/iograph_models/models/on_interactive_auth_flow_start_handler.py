...
class OnInteractiveAuthFlowStartHandler(BaseModel):
	...
	def convert_discriminator_class(cls, data: Any, handler: ModelWrapValidatorHandler[Self]) -> Self:
		try:
			...
			if mapping_key == "#microsoft.graph.onInteractiveAuthFlowStartExternalUsersSelfServiceSignUp":
				...
				return OnInteractiveAuthFlowStartExternalUsersSelfServiceSignUp.model_validate(data)
