...
class WindowsUpdateForBusinessConfiguration(BaseModel):
	...
	automaticUpdateMode: Optional[str | AutomaticUpdateMode] = Field(alias="automaticUpdateMode",default=None,)
	autoRestartNotificationDismissal: Optional[str | AutoRestartNotificationDismissalMethod] = Field(alias="autoRestartNotificationDismissal",default=None,)
	businessReadyUpdatesOnly: Optional[str | WindowsUpdateType] = Field(alias="businessReadyUpdatesOnly",default=None,)
	...
	deliveryOptimizationMode: Optional[str | WindowsDeliveryOptimizationMode] = Field(alias="deliveryOptimizationMode",default=None,)
	...
	installationSchedule: SerializeAsAny[Optional[WindowsUpdateInstallScheduleType]] = Field(alias="installationSchedule",default=None,)
	...
	prereleaseFeatures: Optional[str | PrereleaseFeatures] = Field(alias="prereleaseFeatures",default=None,)
	...
	updateNotificationLevel: Optional[str | WindowsUpdateNotificationDisplayOption] = Field(alias="updateNotificationLevel",default=None,)
	updateWeeks: Optional[str | WindowsUpdateForBusinessUpdateWeeks] = Field(alias="updateWeeks",default=None,)
	userPauseAccess: Optional[str | Enablement] = Field(alias="userPauseAccess",default=None,)
	userWindowsUpdateScanAccess: Optional[str | Enablement] = Field(alias="userWindowsUpdateScanAccess",default=None,)
