...
class Device(BaseModel):
	...
	alternativeSecurityIds: list[AlternativeSecurityId] = Field(alias="alternativeSecurityIds",)
	...
	physicalIds: list[str] = Field(alias="physicalIds",)
	...
	systemLabels: list[str] = Field(alias="systemLabels",)
	...
	registeredOwners: list[DirectoryObject] = Field(alias="registeredOwners",)
	registeredUsers: list[DirectoryObject] = Field(alias="registeredUsers",)
