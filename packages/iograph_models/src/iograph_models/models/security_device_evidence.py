...
class SecurityDeviceEvidence(BaseModel):
	...
	defenderAvStatus: Optional[str | SecurityDefenderAvStatus] = Field(alias="defenderAvStatus",default=None,)
	...
	healthStatus: Optional[str | SecurityDeviceHealthStatus] = Field(alias="healthStatus",default=None,)
	...
	onboardingStatus: Optional[str | SecurityOnboardingStatus] = Field(alias="onboardingStatus",default=None,)
	...
	riskScore: Optional[str | SecurityDeviceRiskScore] = Field(alias="riskScore",default=None,)
