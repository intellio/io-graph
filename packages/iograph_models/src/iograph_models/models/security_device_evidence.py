...
class SecurityDeviceEvidence(BaseModel):
	...
	ipInterfaces: Optional[list[str]] = Field(default=None,alias="ipInterfaces",)
	...
	loggedOnUsers: Optional[list[SecurityLoggedOnUser]] = Field(default=None,alias="loggedOnUsers",)
