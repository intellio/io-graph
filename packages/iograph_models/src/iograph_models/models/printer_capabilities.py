...
class PrinterCapabilities(BaseModel):
	...
	colorModes: Optional[str | PrintColorMode] = Field(alias="colorModes",default=None,)
	...
	duplexModes: Optional[str | PrintDuplexMode] = Field(alias="duplexModes",default=None,)
	feedOrientations: Optional[str | PrinterFeedOrientation] = Field(alias="feedOrientations",default=None,)
	...
	multipageLayouts: Optional[str | PrintMultipageLayout] = Field(alias="multipageLayouts",default=None,)
	orientations: Optional[str | PrintOrientation] = Field(alias="orientations",default=None,)
	...
	qualities: Optional[str | PrintQuality] = Field(alias="qualities",default=None,)
	rightMargins: Optional[list[int]] = Field(alias="rightMargins",default=None,)
	scalings: Optional[str | PrintScaling] = Field(alias="scalings",default=None,)
