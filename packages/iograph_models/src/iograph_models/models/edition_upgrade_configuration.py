...
class EditionUpgradeConfiguration(BaseModel):
	...
	licenseType: Optional[EditionUpgradeLicenseType] = Field(default=None,alias="licenseType",)
	productKey: Optional[str] = Field(default=None,alias="productKey",)
	targetEdition: Optional[Windows10EditionType] = Field(default=None,alias="targetEdition",)
