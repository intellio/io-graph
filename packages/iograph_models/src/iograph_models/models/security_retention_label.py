...
class SecurityRetentionLabel(BaseModel):
	...
	actionAfterRetentionPeriod: Optional[str | SecurityActionAfterRetentionPeriod] = Field(alias="actionAfterRetentionPeriod",default=None,)
	...
	defaultRecordBehavior: Optional[str | SecurityDefaultRecordBehavior] = Field(alias="defaultRecordBehavior",default=None,)
	...
	retentionTrigger: Optional[str | SecurityRetentionTrigger] = Field(alias="retentionTrigger",default=None,)
