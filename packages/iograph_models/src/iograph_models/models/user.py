...
class User(BaseModel):
	...
	deviceManagementTroubleshootingEvents: Optional[list[DeviceManagementTroubleshootingEvent]] = Field(default=None,alias="deviceManagementTroubleshootingEvents",)
	...
	mailFolders: Optional[list[MailFolder]] = Field(default=None,alias="mailFolders",)
	...
	ownedDevices: Optional[list[DirectoryObject]] = Field(default=None,alias="ownedDevices",)
	...
	registeredDevices: Optional[list[DirectoryObject]] = Field(default=None,alias="registeredDevices",)
	...
	sponsors: Optional[list[DirectoryObject]] = Field(default=None,alias="sponsors",)
