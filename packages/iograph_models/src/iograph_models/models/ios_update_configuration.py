...
class IosUpdateConfiguration(BaseModel):
	...
	scheduledInstallDays: Optional[list[DayOfWeek]] = Field(default=None,alias="scheduledInstallDays",)
	utcTimeOffsetInMinutes: Optional[int] = Field(default=None,alias="utcTimeOffsetInMinutes",)
