...
class AuthenticationStrengthPolicy(BaseModel):
	...
	allowedCombinations: list[AuthenticationMethodModes] = Field(alias="allowedCombinations",)
	...
	combinationConfigurations: list[AuthenticationCombinationConfiguration] = Field(alias="combinationConfigurations",)
