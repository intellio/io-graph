...
class Group(BaseModel):
	...
	acceptedSenders: Optional[list[DirectoryObject]] = Field(default=None,alias="acceptedSenders",)
	...
	membersWithLicenseErrors: Optional[list[DirectoryObject]] = Field(default=None,alias="membersWithLicenseErrors",)
	...
	rejectedSenders: Optional[list[DirectoryObject]] = Field(default=None,alias="rejectedSenders",)
	...
	transitiveMembers: Optional[list[DirectoryObject]] = Field(default=None,alias="transitiveMembers",)
