...
class SecurityRetentionEvent(BaseModel):
	...
	eventPropagationResults: list[SecurityEventPropagationResult] = Field(alias="eventPropagationResults",)
	eventQueries: list[SecurityEventQuery] = Field(alias="eventQueries",)
