...
class InternalDomainFederation(BaseModel):
	...
	federatedIdpMfaBehavior: Optional[str | FederatedIdpMfaBehavior] = Field(alias="federatedIdpMfaBehavior",default=None,)
	...
	promptLoginBehavior: Optional[str | PromptLoginBehavior] = Field(alias="promptLoginBehavior",default=None,)
