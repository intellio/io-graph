...
class OnOtpSendCustomExtension(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.onOtpSendCustomExtension"] = Field(alias="@odata.type", default="#microsoft.graph.onOtpSendCustomExtension")
