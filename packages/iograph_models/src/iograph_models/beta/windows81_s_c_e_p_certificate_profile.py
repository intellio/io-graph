...
class Windows81SCEPCertificateProfile(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.windows81SCEPCertificateProfile"] = Field(alias="@odata.type", default="#microsoft.graph.windows81SCEPCertificateProfile")
	...
	rootCertificate: Optional[Windows81TrustedRootCertificate] = Field(alias="rootCertificate", default=None,)
