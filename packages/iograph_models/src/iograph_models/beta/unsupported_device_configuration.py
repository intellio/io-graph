...
class UnsupportedDeviceConfiguration(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.unsupportedDeviceConfiguration"] = Field(alias="@odata.type", default="#microsoft.graph.unsupportedDeviceConfiguration")
	...
	details: Optional[list[UnsupportedDeviceConfigurationDetail]] = Field(alias="details", default=None,)
	originalEntityTypeName: Optional[str] = Field(alias="originalEntityTypeName", default=None,)
