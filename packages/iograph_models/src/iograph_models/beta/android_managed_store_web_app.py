...
class AndroidManagedStoreWebApp(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.androidManagedStoreWebApp"] = Field(alias="@odata.type", default="#microsoft.graph.androidManagedStoreWebApp")
