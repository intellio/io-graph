...
class IosLobAppProvisioningConfigurationPolicySetItem(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.iosLobAppProvisioningConfigurationPolicySetItem"] = Field(alias="@odata.type", default="#microsoft.graph.iosLobAppProvisioningConfigurationPolicySetItem")
