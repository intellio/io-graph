...
class AzureADWindowsAutopilotDeploymentProfile(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.azureADWindowsAutopilotDeploymentProfile"] = Field(alias="@odata.type", default="#microsoft.graph.azureADWindowsAutopilotDeploymentProfile")
