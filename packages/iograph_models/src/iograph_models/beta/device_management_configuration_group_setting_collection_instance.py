...
class DeviceManagementConfigurationGroupSettingCollectionInstance(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.deviceManagementConfigurationGroupSettingCollectionInstance"] = Field(alias="@odata.type", default="#microsoft.graph.deviceManagementConfigurationGroupSettingCollectionInstance")
