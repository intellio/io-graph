...
class DeviceComanagementAuthorityConfiguration(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.deviceComanagementAuthorityConfiguration"] = Field(alias="@odata.type", default="#microsoft.graph.deviceComanagementAuthorityConfiguration")
