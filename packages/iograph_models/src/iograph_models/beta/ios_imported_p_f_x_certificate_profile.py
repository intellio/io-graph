...
class IosImportedPFXCertificateProfile(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.iosImportedPFXCertificateProfile"] = Field(alias="@odata.type", default="#microsoft.graph.iosImportedPFXCertificateProfile")
