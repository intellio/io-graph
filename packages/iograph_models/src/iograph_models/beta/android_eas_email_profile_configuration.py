...
class AndroidEasEmailProfileConfiguration(BaseModel):
	...
	identityCertificate: SerializeAsAny[Optional[AndroidCertificateProfileBase]] = Field(alias="identityCertificate",default=None,)
	smimeSigningCertificate: SerializeAsAny[Optional[AndroidCertificateProfileBase]] = Field(alias="smimeSigningCertificate",default=None,)
