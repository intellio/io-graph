...
class AccessReviewScopeCollectionResponse(BaseModel):
	...
	value: Optional[list[Annotated[Union[AccessReviewInactiveUsersQueryScope, AccessReviewReviewerScope, PrincipalResourceMembershipsScope],Field(discriminator="odata_type")]]] = Field(alias="value", default=None,)
