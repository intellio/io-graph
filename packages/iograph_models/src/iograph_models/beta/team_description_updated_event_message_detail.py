...
class TeamDescriptionUpdatedEventMessageDetail(BaseModel):
	odata_type: Literal["#microsoft.graph.teamDescriptionUpdatedEventMessageDetail"] = Field(alias="@odata.type", default="#microsoft.graph.teamDescriptionUpdatedEventMessageDetail")
