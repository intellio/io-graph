...
class SecurityOauthApplicationEvidence(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.security.oauthApplicationEvidence"] = Field(alias="@odata.type", default="#microsoft.graph.security.oauthApplicationEvidence")
