...
class PendingExternalUserProfile(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.pendingExternalUserProfile"] = Field(alias="@odata.type", default="#microsoft.graph.pendingExternalUserProfile")
