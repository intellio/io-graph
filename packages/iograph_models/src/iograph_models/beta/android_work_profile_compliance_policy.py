...
class AndroidWorkProfileCompliancePolicy(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.androidWorkProfileCompliancePolicy"] = Field(alias="@odata.type", default="#microsoft.graph.androidWorkProfileCompliancePolicy")
