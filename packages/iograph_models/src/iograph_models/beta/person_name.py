...
class PersonName(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.personName"] = Field(alias="@odata.type", default="#microsoft.graph.personName")
	...
	pronunciation: Optional[PersonNamePronounciation] = Field(alias="pronunciation", default=None,)
