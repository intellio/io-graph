...
class WindowsDefenderApplicationControlSupplementalPolicyAssignment(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.windowsDefenderApplicationControlSupplementalPolicyAssignment"] = Field(alias="@odata.type", default="#microsoft.graph.windowsDefenderApplicationControlSupplementalPolicyAssignment")
