...
class AndroidGeneralDeviceConfiguration(BaseModel):
	...
	appsHideList: SerializeAsAny[Optional[list[AppListItem]]] = Field(alias="appsHideList",default=None,)
	appsInstallAllowList: SerializeAsAny[Optional[list[AppListItem]]] = Field(alias="appsInstallAllowList",default=None,)
	appsLaunchBlockList: SerializeAsAny[Optional[list[AppListItem]]] = Field(alias="appsLaunchBlockList",default=None,)
	...
	compliantAppsList: SerializeAsAny[Optional[list[AppListItem]]] = Field(alias="compliantAppsList",default=None,)
	...
	kioskModeApps: SerializeAsAny[Optional[list[AppListItem]]] = Field(alias="kioskModeApps",default=None,)
