...
class SecurityToolAwsResourceAdministratorFinding(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.securityToolAwsResourceAdministratorFinding"] = Field(alias="@odata.type", default="#microsoft.graph.securityToolAwsResourceAdministratorFinding")
