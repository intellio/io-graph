...
class AndroidWorkProfilePkcsCertificateProfile(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.androidWorkProfilePkcsCertificateProfile"] = Field(alias="@odata.type", default="#microsoft.graph.androidWorkProfilePkcsCertificateProfile")
	...
	rootCertificate: Optional[AndroidWorkProfileTrustedRootCertificate] = Field(alias="rootCertificate", default=None,)
