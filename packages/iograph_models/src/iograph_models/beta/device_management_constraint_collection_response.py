...
class DeviceManagementConstraintCollectionResponse(BaseModel):
	...
	value: Optional[list[Annotated[Union[DeviceManagementEnumConstraint, DeviceManagementIntentSettingSecretConstraint, DeviceManagementSettingAbstractImplementationConstraint, DeviceManagementSettingAppConstraint, DeviceManagementSettingBooleanConstraint, DeviceManagementSettingCollectionConstraint, DeviceManagementSettingEnrollmentTypeConstraint, DeviceManagementSettingFileConstraint, DeviceManagementSettingIntegerConstraint, DeviceManagementSettingProfileConstraint, DeviceManagementSettingRegexConstraint, DeviceManagementSettingRequiredConstraint, DeviceManagementSettingSddlConstraint, DeviceManagementSettingStringLengthConstraint, DeviceManagementSettingXmlConstraint],Field(discriminator="odata_type")]]] = Field(alias="value", default=None,)
