...
class AndroidCompliancePolicy(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.androidCompliancePolicy"] = Field(alias="@odata.type", default="#microsoft.graph.androidCompliancePolicy")
	...
	conditionStatementId: Optional[str] = Field(alias="conditionStatementId", default=None,)
