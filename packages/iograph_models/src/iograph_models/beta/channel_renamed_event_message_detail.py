...
class ChannelRenamedEventMessageDetail(BaseModel):
	odata_type: Literal["#microsoft.graph.channelRenamedEventMessageDetail"] = Field(alias="@odata.type", default="#microsoft.graph.channelRenamedEventMessageDetail")
