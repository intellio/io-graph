...
class ChannelAddedEventMessageDetail(BaseModel):
	odata_type: Literal["#microsoft.graph.channelAddedEventMessageDetail"] = Field(alias="@odata.type", default="#microsoft.graph.channelAddedEventMessageDetail")
