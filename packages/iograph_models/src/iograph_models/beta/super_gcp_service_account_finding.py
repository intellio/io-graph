...
class SuperGcpServiceAccountFinding(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.superGcpServiceAccountFinding"] = Field(alias="@odata.type", default="#microsoft.graph.superGcpServiceAccountFinding")
