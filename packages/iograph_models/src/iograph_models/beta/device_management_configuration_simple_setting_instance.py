...
class DeviceManagementConfigurationSimpleSettingInstance(BaseModel):
	...
	simpleSettingValue: Optional[Union[DeviceManagementConfigurationIntegerSettingValue, DeviceManagementConfigurationSecretSettingValue, DeviceManagementConfigurationStringSettingValue, DeviceManagementConfigurationReferenceSettingValue]] = Field(alias="simpleSettingValue", default=None,discriminator="odata_type", )
