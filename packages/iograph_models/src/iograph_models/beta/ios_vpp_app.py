...
class IosVppApp(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.iosVppApp"] = Field(alias="@odata.type", default="#microsoft.graph.iosVppApp")
	...
	revokeLicenseActionResults: Optional[list[IosVppAppRevokeLicensesActionResult]] = Field(alias="revokeLicenseActionResults", default=None,)
	...
	assignedLicenses: Optional[list[Annotated[Union[IosVppAppAssignedDeviceLicense, IosVppAppAssignedUserLicense],Field(discriminator="odata_type")]]] = Field(alias="assignedLicenses", default=None,)
