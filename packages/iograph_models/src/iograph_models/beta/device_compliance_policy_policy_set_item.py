...
class DeviceCompliancePolicyPolicySetItem(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.deviceCompliancePolicyPolicySetItem"] = Field(alias="@odata.type", default="#microsoft.graph.deviceCompliancePolicyPolicySetItem")
