...
class SecretInformationAccessAwsServerlessFunctionFinding(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.secretInformationAccessAwsServerlessFunctionFinding"] = Field(alias="@odata.type", default="#microsoft.graph.secretInformationAccessAwsServerlessFunctionFinding")
