...
class SecurityEmailContentThreatSubmission(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.security.emailContentThreatSubmission"] = Field(alias="@odata.type", default="#microsoft.graph.security.emailContentThreatSubmission")
