...
class AndroidForWorkScepCertificateProfile(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.androidForWorkScepCertificateProfile"] = Field(alias="@odata.type", default="#microsoft.graph.androidForWorkScepCertificateProfile")
