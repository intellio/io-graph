...
class DeviceManagementConfigurationSimpleSettingCollectionDefinition(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.deviceManagementConfigurationSimpleSettingCollectionDefinition"] = Field(alias="@odata.type", default="#microsoft.graph.deviceManagementConfigurationSimpleSettingCollectionDefinition")
