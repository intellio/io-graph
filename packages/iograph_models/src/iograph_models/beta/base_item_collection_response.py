...
class BaseItemCollectionResponse(BaseModel):
	...
	value: Optional[list[Annotated[Union[NewsLinkPage, PageTemplate, SitePage, VideoNewsLinkPage, Drive, DriveItem, List, ListItem, RecycleBin, RecycleBinItem, SharedDriveItem, Site],Field(discriminator="odata_type")]]] = Field(alias="value", default=None,)
