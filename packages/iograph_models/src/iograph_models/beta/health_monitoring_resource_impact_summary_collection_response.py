...
class HealthMonitoringResourceImpactSummaryCollectionResponse(BaseModel):
	...
	value: Optional[list[Annotated[Union[HealthMonitoringApplicationImpactSummary, HealthMonitoringDeviceImpactSummary, HealthMonitoringGroupImpactSummary, HealthMonitoringServicePrincipalImpactSummary, HealthMonitoringUserImpactSummary],Field(discriminator="odata_type")]]] = Field(alias="value", default=None,)
