...
class OverprovisionedAwsRoleFinding(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.overprovisionedAwsRoleFinding"] = Field(alias="@odata.type", default="#microsoft.graph.overprovisionedAwsRoleFinding")
