...
class WindowsDriverUpdateProfileAssignment(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.windowsDriverUpdateProfileAssignment"] = Field(alias="@odata.type", default="#microsoft.graph.windowsDriverUpdateProfileAssignment")
