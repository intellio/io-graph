...
class Windows81TrustedRootCertificate(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.windows81TrustedRootCertificate"] = Field(alias="@odata.type", default="#microsoft.graph.windows81TrustedRootCertificate")
