...
class PrinterDefaults(BaseModel):
	...
	documentMimeType: Optional[str] = Field(alias="documentMimeType", default=None,)
	dpi: Optional[int] = Field(alias="dpi", default=None,)
	duplexConfiguration: Optional[PrintDuplexConfiguration | str] = Field(alias="duplexConfiguration", default=None,)
	...
	pdfFitToPage: Optional[bool] = Field(alias="pdfFitToPage", default=None,)
	presentationDirection: Optional[PrintPresentationDirection | str] = Field(alias="presentationDirection", default=None,)
	printColorConfiguration: Optional[PrintColorConfiguration | str] = Field(alias="printColorConfiguration", default=None,)
	printQuality: Optional[PrintQuality | str] = Field(alias="printQuality", default=None,)
