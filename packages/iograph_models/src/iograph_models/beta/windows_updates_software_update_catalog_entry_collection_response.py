...
class WindowsUpdatesSoftwareUpdateCatalogEntryCollectionResponse(BaseModel):
	...
	value: Optional[list[Annotated[Union[WindowsUpdatesDriverUpdateCatalogEntry, WindowsUpdatesFeatureUpdateCatalogEntry, WindowsUpdatesQualityUpdateCatalogEntry]],Field(discriminator="odata_type")]]] = Field(alias="value", default=None,)
