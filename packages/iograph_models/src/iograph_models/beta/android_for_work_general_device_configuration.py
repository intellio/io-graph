...
class AndroidForWorkGeneralDeviceConfiguration(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.androidForWorkGeneralDeviceConfiguration"] = Field(alias="@odata.type", default="#microsoft.graph.androidForWorkGeneralDeviceConfiguration")
