...
class WindowsVpnConfigurationCollectionResponse(BaseModel):
	...
	value: Optional[list[Annotated[Union[Windows10VpnConfiguration, WindowsPhone81VpnConfiguration],Field(discriminator="odata_type")]]] = Field(alias="value", default=None,)
