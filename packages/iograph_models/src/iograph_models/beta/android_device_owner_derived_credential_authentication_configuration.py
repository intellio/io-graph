...
class AndroidDeviceOwnerDerivedCredentialAuthenticationConfiguration(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.androidDeviceOwnerDerivedCredentialAuthenticationConfiguration"] = Field(alias="@odata.type", default="#microsoft.graph.androidDeviceOwnerDerivedCredentialAuthenticationConfiguration")
