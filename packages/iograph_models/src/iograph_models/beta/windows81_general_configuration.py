...
class Windows81GeneralConfiguration(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.windows81GeneralConfiguration"] = Field(alias="@odata.type", default="#microsoft.graph.windows81GeneralConfiguration")
	...
	browserInternetSecurityLevel: Optional[InternetSiteSecurityLevel | str] = Field(alias="browserInternetSecurityLevel", default=None,)
	browserIntranetSecurityLevel: Optional[SiteSecurityLevel | str] = Field(alias="browserIntranetSecurityLevel", default=None,)
	...
	browserTrustedSitesSecurityLevel: Optional[SiteSecurityLevel | str] = Field(alias="browserTrustedSitesSecurityLevel", default=None,)
	...
	minimumAutoInstallClassification: Optional[UpdateClassification | str] = Field(alias="minimumAutoInstallClassification", default=None,)
	...
	updatesMinimumAutoInstallClassification: Optional[UpdateClassification | str] = Field(alias="updatesMinimumAutoInstallClassification", default=None,)
	updatesRequireAutomaticUpdates: Optional[bool] = Field(alias="updatesRequireAutomaticUpdates", default=None,)
	userAccountControlSettings: Optional[WindowsUserAccountControlSettings | str] = Field(alias="userAccountControlSettings", default=None,)
