...
class SecurityToolAwsUserAdministratorFinding(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.securityToolAwsUserAdministratorFinding"] = Field(alias="@odata.type", default="#microsoft.graph.securityToolAwsUserAdministratorFinding")
