...
class AndroidDeviceOwnerGeneralDeviceConfiguration(BaseModel):
	...
	azureAdSharedDeviceDataClearApps: SerializeAsAny[Optional[list[AppListItem]]] = Field(alias="azureAdSharedDeviceDataClearApps",default=None,)
	...
	globalProxy: SerializeAsAny[Optional[AndroidDeviceOwnerGlobalProxy]] = Field(alias="globalProxy",default=None,)
	...
	personalProfilePersonalApplications: SerializeAsAny[Optional[list[AppListItem]]] = Field(alias="personalProfilePersonalApplications",default=None,)
