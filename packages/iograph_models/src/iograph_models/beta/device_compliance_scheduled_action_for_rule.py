...
class DeviceComplianceScheduledActionForRule(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.deviceComplianceScheduledActionForRule"] = Field(alias="@odata.type", default="#microsoft.graph.deviceComplianceScheduledActionForRule")
