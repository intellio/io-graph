...
class AospDeviceOwnerScepCertificateProfile(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.aospDeviceOwnerScepCertificateProfile"] = Field(alias="@odata.type", default="#microsoft.graph.aospDeviceOwnerScepCertificateProfile")
