...
class Get_inaccessible_cloud_pc_reportsPostRequest(BaseModel):
	reportName: Optional[CloudPCInaccessibleReportName | str] = Field(alias="reportName",default=None,)
...
from .cloud_p_c_inaccessible_report_name import CloudPCInaccessibleReportName
