...
class InactiveAwsRoleFinding(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.inactiveAwsRoleFinding"] = Field(alias="@odata.type", default="#microsoft.graph.inactiveAwsRoleFinding")
