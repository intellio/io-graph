...
class IosWiFiConfiguration(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.iosWiFiConfiguration"] = Field(alias="@odata.type", default="#microsoft.graph.iosWiFiConfiguration")
