...
class PartnerSecurityResponseTimeSecurityRequirement(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.partner.security.responseTimeSecurityRequirement"] = Field(alias="@odata.type", default="#microsoft.graph.partner.security.responseTimeSecurityRequirement")
