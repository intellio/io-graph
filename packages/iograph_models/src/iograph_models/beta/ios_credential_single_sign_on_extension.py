...
class IosCredentialSingleSignOnExtension(BaseModel):
	odata_type: Literal["#microsoft.graph.iosCredentialSingleSignOnExtension"] = Field(alias="@odata.type", default="#microsoft.graph.iosCredentialSingleSignOnExtension")
