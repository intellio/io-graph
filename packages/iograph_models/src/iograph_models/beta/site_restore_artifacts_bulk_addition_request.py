...
class SiteRestoreArtifactsBulkAdditionRequest(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.siteRestoreArtifactsBulkAdditionRequest"] = Field(alias="@odata.type", default="#microsoft.graph.siteRestoreArtifactsBulkAdditionRequest")
