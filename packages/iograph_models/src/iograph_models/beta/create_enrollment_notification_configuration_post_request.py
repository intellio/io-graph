...
class Create_enrollment_notification_configurationPostRequest(BaseModel):
	deviceEnrollmentNotificationConfigurations: Optional[list[Annotated[Union[DeviceComanagementAuthorityConfiguration, DeviceEnrollmentLimitConfiguration, DeviceEnrollmentNotificationConfiguration, DeviceEnrollmentPlatformRestrictionConfiguration, DeviceEnrollmentPlatformRestrictionsConfiguration, DeviceEnrollmentWindowsHelloForBusinessConfiguration, Windows10EnrollmentCompletionPageConfiguration]],Field(discriminator="odata_type")]]] = Field(alias="deviceEnrollmentNotificationConfigurations", default=None,)
