...
class CloudPcBulkDisasterRecoveryFailback(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.cloudPcBulkDisasterRecoveryFailback"] = Field(alias="@odata.type", default="#microsoft.graph.cloudPcBulkDisasterRecoveryFailback")
