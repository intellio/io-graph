...
class WindowsDefenderAdvancedThreatProtectionConfiguration(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.windowsDefenderAdvancedThreatProtectionConfiguration"] = Field(alias="@odata.type", default="#microsoft.graph.windowsDefenderAdvancedThreatProtectionConfiguration")
	...
	advancedThreatProtectionAutoPopulateOnboardingBlob: Optional[bool] = Field(alias="advancedThreatProtectionAutoPopulateOnboardingBlob", default=None,)
	advancedThreatProtectionOffboardingBlob: Optional[str] = Field(alias="advancedThreatProtectionOffboardingBlob", default=None,)
	advancedThreatProtectionOffboardingFilename: Optional[str] = Field(alias="advancedThreatProtectionOffboardingFilename", default=None,)
	advancedThreatProtectionOnboardingBlob: Optional[str] = Field(alias="advancedThreatProtectionOnboardingBlob", default=None,)
	advancedThreatProtectionOnboardingFilename: Optional[str] = Field(alias="advancedThreatProtectionOnboardingFilename", default=None,)
	allowSampleSharing: Optional[bool] = Field(alias="allowSampleSharing", default=None,)
	enableExpeditedTelemetryReporting: Optional[bool] = Field(alias="enableExpeditedTelemetryReporting", default=None,)
