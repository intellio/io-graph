...
class WindowsAutopilotDeploymentProfileAssignment(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.windowsAutopilotDeploymentProfileAssignment"] = Field(alias="@odata.type", default="#microsoft.graph.windowsAutopilotDeploymentProfileAssignment")
