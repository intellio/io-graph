...
class TargetedManagedAppConfigurationPolicySetItem(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.targetedManagedAppConfigurationPolicySetItem"] = Field(alias="@odata.type", default="#microsoft.graph.targetedManagedAppConfigurationPolicySetItem")
