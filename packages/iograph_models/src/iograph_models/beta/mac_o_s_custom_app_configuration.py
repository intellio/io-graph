...
class MacOSCustomAppConfiguration(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.macOSCustomAppConfiguration"] = Field(alias="@odata.type", default="#microsoft.graph.macOSCustomAppConfiguration")
	...
	configurationXml: Optional[str] = Field(alias="configurationXml", default=None,)
