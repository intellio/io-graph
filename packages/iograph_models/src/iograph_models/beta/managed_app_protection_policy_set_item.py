...
class ManagedAppProtectionPolicySetItem(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.managedAppProtectionPolicySetItem"] = Field(alias="@odata.type", default="#microsoft.graph.managedAppProtectionPolicySetItem")
	...
	targetedAppManagementLevels: Optional[str] = Field(alias="targetedAppManagementLevels", default=None,)
