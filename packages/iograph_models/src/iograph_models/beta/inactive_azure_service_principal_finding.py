...
class InactiveAzureServicePrincipalFinding(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.inactiveAzureServicePrincipalFinding"] = Field(alias="@odata.type", default="#microsoft.graph.inactiveAzureServicePrincipalFinding")
