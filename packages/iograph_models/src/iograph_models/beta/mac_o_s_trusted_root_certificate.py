...
class MacOSTrustedRootCertificate(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.macOSTrustedRootCertificate"] = Field(alias="@odata.type", default="#microsoft.graph.macOSTrustedRootCertificate")
