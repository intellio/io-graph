...
class DeviceConfigurationPolicySetItem(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.deviceConfigurationPolicySetItem"] = Field(alias="@odata.type", default="#microsoft.graph.deviceConfigurationPolicySetItem")
