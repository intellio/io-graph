...
class IndustryDataFileDataConnector(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.industryData.fileDataConnector"] = Field(alias="@odata.type", default="#microsoft.graph.industryData.fileDataConnector")
