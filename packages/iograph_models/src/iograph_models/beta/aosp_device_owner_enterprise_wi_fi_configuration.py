...
class AospDeviceOwnerEnterpriseWiFiConfiguration(BaseModel):
	...
	identityCertificateForClientAuthentication: SerializeAsAny[Optional[AospDeviceOwnerCertificateProfileBase]] = Field(alias="identityCertificateForClientAuthentication",default=None,)
