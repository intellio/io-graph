...
class EdiscoveryEstimateStatisticsOperation(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.ediscovery.estimateStatisticsOperation"] = Field(alias="@odata.type", default="#microsoft.graph.ediscovery.estimateStatisticsOperation")
