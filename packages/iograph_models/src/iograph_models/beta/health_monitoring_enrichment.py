...
class HealthMonitoringEnrichment(BaseModel):
	impacts: Optional[list[Annotated[Union[HealthMonitoringApplicationImpactSummary, HealthMonitoringDeviceImpactSummary, HealthMonitoringGroupImpactSummary, HealthMonitoringServicePrincipalImpactSummary, HealthMonitoringUserImpactSummary],Field(discriminator="odata_type")]]] = Field(alias="impacts", default=None,)
