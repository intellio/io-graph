...
class WindowsPhone81SCEPCertificateProfile(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.windowsPhone81SCEPCertificateProfile"] = Field(alias="@odata.type", default="#microsoft.graph.windowsPhone81SCEPCertificateProfile")
	...
	rootCertificate: Optional[WindowsPhone81TrustedRootCertificate] = Field(alias="rootCertificate", default=None,)
