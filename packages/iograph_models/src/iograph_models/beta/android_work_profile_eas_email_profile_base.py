...
class AndroidWorkProfileEasEmailProfileBase(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.androidWorkProfileEasEmailProfileBase"] = Field(alias="@odata.type", default="#microsoft.graph.androidWorkProfileEasEmailProfileBase")
