...
class WindowsPhone81TrustedRootCertificate(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.windowsPhone81TrustedRootCertificate"] = Field(alias="@odata.type", default="#microsoft.graph.windowsPhone81TrustedRootCertificate")
