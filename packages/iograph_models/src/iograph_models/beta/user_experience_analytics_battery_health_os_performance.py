...
class UserExperienceAnalyticsBatteryHealthOsPerformance(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.userExperienceAnalyticsBatteryHealthOsPerformance"] = Field(alias="@odata.type", default="#microsoft.graph.userExperienceAnalyticsBatteryHealthOsPerformance")
