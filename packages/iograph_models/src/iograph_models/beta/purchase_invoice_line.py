...
class PurchaseInvoiceLine(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.purchaseInvoiceLine"] = Field(alias="@odata.type", default="#microsoft.graph.purchaseInvoiceLine")
	...
	expectedReceiptDate: Optional[str] = Field(alias="expectedReceiptDate", default=None,)
