...
class AccessReviewScheduleDefinition(BaseModel):
	...
	instanceEnumerationScope: Optional[Union[AccessReviewQueryScope, AccessReviewInactiveUsersQueryScope, AccessReviewReviewerScope, PrincipalResourceMembershipsScope]] = Field(alias="instanceEnumerationScope", default=None,discriminator="odata_type", )
	lastModifiedDateTime: Optional[datetime] = Field(alias="lastModifiedDateTime", default=None,)
	reviewers: Optional[list[AccessReviewReviewerScope]] = Field(alias="reviewers", default=None,)
	scope: Optional[Union[AccessReviewQueryScope, AccessReviewInactiveUsersQueryScope, AccessReviewReviewerScope, PrincipalResourceMembershipsScope]] = Field(alias="scope", default=None,discriminator="odata_type", )
