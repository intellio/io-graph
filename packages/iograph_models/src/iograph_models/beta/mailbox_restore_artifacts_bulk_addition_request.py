...
class MailboxRestoreArtifactsBulkAdditionRequest(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.mailboxRestoreArtifactsBulkAdditionRequest"] = Field(alias="@odata.type", default="#microsoft.graph.mailboxRestoreArtifactsBulkAdditionRequest")
