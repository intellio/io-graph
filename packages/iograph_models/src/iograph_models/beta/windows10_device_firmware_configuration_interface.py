...
class Windows10DeviceFirmwareConfigurationInterface(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.windows10DeviceFirmwareConfigurationInterface"] = Field(alias="@odata.type", default="#microsoft.graph.windows10DeviceFirmwareConfigurationInterface")
