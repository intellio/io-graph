...
class IosEduDeviceConfiguration(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.iosEduDeviceConfiguration"] = Field(alias="@odata.type", default="#microsoft.graph.iosEduDeviceConfiguration")
	...
	deviceCertificateSettings: Optional[IosEduCertificateSettings] = Field(alias="deviceCertificateSettings", default=None,)
	studentCertificateSettings: Optional[IosEduCertificateSettings] = Field(alias="studentCertificateSettings", default=None,)
	teacherCertificateSettings: Optional[IosEduCertificateSettings] = Field(alias="teacherCertificateSettings", default=None,)
