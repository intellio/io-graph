...
class AndroidForWorkImportedPFXCertificateProfile(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.androidForWorkImportedPFXCertificateProfile"] = Field(alias="@odata.type", default="#microsoft.graph.androidForWorkImportedPFXCertificateProfile")
