...
class Windows10EasEmailProfileConfiguration(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.windows10EasEmailProfileConfiguration"] = Field(alias="@odata.type", default="#microsoft.graph.windows10EasEmailProfileConfiguration")
