...
class DefaultInvitationRedemptionIdentityProviderConfiguration(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.defaultInvitationRedemptionIdentityProviderConfiguration"] = Field(alias="@odata.type", default="#microsoft.graph.defaultInvitationRedemptionIdentityProviderConfiguration")
