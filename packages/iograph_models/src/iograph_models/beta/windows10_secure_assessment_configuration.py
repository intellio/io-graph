...
class Windows10SecureAssessmentConfiguration(BaseModel):
	...
	assessmentAppUserModelId: Optional[str] = Field(alias="assessmentAppUserModelId",default=None,)
	configurationAccount: Optional[str] = Field(alias="configurationAccount",default=None,)
	configurationAccountType: Optional[SecureAssessmentAccountType | str] = Field(alias="configurationAccountType",default=None,)
	launchUri: Optional[str] = Field(alias="launchUri",default=None,)
	localGuestAccountName: Optional[str] = Field(alias="localGuestAccountName",default=None,)
