...
class HealthMonitoringApplicationImpactSummary(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.healthMonitoring.applicationImpactSummary"] = Field(alias="@odata.type", default="#microsoft.graph.healthMonitoring.applicationImpactSummary")
