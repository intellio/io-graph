...
class PrivilegeEscalationAwsRoleFinding(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.privilegeEscalationAwsRoleFinding"] = Field(alias="@odata.type", default="#microsoft.graph.privilegeEscalationAwsRoleFinding")
