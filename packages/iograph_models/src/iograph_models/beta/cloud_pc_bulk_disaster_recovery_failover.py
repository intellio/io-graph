...
class CloudPcBulkDisasterRecoveryFailover(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.cloudPcBulkDisasterRecoveryFailover"] = Field(alias="@odata.type", default="#microsoft.graph.cloudPcBulkDisasterRecoveryFailover")
