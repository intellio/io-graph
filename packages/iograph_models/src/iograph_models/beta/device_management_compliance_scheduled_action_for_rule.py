...
class DeviceManagementComplianceScheduledActionForRule(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.deviceManagementComplianceScheduledActionForRule"] = Field(alias="@odata.type", default="#microsoft.graph.deviceManagementComplianceScheduledActionForRule")
