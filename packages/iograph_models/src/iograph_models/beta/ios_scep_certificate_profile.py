...
class IosScepCertificateProfile(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.iosScepCertificateProfile"] = Field(alias="@odata.type", default="#microsoft.graph.iosScepCertificateProfile")
	...
	rootCertificate: Optional[IosTrustedRootCertificate] = Field(alias="rootCertificate", default=None,)
