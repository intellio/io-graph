...
class IosDerivedCredentialAuthenticationConfiguration(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.iosDerivedCredentialAuthenticationConfiguration"] = Field(alias="@odata.type", default="#microsoft.graph.iosDerivedCredentialAuthenticationConfiguration")
