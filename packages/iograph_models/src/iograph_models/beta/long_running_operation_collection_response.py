...
class LongRunningOperationCollectionResponse(BaseModel):
	...
	value: Optional[list[Annotated[Union[AttackSimulationOperation, EngagementAsyncOperation, GoalsExportJob, RichLongRunningOperation, IndustryDataFileValidateOperation],Field(discriminator="odata_type")]]] = Field(alias="value", default=None,)
