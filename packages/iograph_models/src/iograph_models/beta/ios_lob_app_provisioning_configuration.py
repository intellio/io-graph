...
class IosLobAppProvisioningConfiguration(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.iosLobAppProvisioningConfiguration"] = Field(alias="@odata.type", default="#microsoft.graph.iosLobAppProvisioningConfiguration")
