...
class SharePointRestoreSession(BaseModel):
	...
	siteRestoreArtifactsBulkAdditionRequests: Optional[list[SiteRestoreArtifactsBulkAdditionRequest]] = Field(alias="siteRestoreArtifactsBulkAdditionRequests",default=None,)
