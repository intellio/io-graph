...
class MessageRulePredicates(BaseModel):
	...
	fromAddresses: Optional[list[Annotated[Union[Attendee],Field(discriminator="odata_type")]]] = Field(alias="fromAddresses", default=None,)
	...
	sentToAddresses: Optional[list[Annotated[Union[Attendee],Field(discriminator="odata_type")]]] = Field(alias="sentToAddresses", default=None,)
