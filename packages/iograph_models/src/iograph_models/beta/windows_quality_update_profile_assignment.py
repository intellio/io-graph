...
class WindowsQualityUpdateProfileAssignment(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.windowsQualityUpdateProfileAssignment"] = Field(alias="@odata.type", default="#microsoft.graph.windowsQualityUpdateProfileAssignment")
