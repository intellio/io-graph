...
class StopTranscriptionOperation(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.stopTranscriptionOperation"] = Field(alias="@odata.type", default="#microsoft.graph.stopTranscriptionOperation")
