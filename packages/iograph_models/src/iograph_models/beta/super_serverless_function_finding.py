...
class SuperServerlessFunctionFinding(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.superServerlessFunctionFinding"] = Field(alias="@odata.type", default="#microsoft.graph.superServerlessFunctionFinding")
