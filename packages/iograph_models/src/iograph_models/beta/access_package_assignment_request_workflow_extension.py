...
class AccessPackageAssignmentRequestWorkflowExtension(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.accessPackageAssignmentRequestWorkflowExtension"] = Field(alias="@odata.type", default="#microsoft.graph.accessPackageAssignmentRequestWorkflowExtension")
