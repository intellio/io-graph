...
class InactiveGcpServiceAccountFinding(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.inactiveGcpServiceAccountFinding"] = Field(alias="@odata.type", default="#microsoft.graph.inactiveGcpServiceAccountFinding")
