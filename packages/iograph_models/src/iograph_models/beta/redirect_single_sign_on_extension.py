...
class RedirectSingleSignOnExtension(BaseModel):
	odata_type: Literal["#microsoft.graph.redirectSingleSignOnExtension"] = Field(alias="@odata.type", default="#microsoft.graph.redirectSingleSignOnExtension")
