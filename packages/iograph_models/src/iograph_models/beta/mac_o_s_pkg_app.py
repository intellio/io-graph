...
class MacOSPkgApp(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.macOSPkgApp"] = Field(alias="@odata.type", default="#microsoft.graph.macOSPkgApp")
	...
	postInstallScript: Optional[MacOSAppScript] = Field(alias="postInstallScript", default=None,)
	preInstallScript: Optional[MacOSAppScript] = Field(alias="preInstallScript", default=None,)
