...
class MobileAppAssignmentSettings(BaseModel):
	...
	def convert_discriminator_class(cls, data: Any, handler: ModelWrapValidatorHandler[Self]) -> Self:
		try:
			...
			if mapping_key == "#microsoft.graph.androidManagedStoreAppAssignmentSettings":
				from .android_managed_store_app_assignment_settings import AndroidManagedStoreAppAssignmentSettings
				return AndroidManagedStoreAppAssignmentSettings.model_validate(data)
			...
			if mapping_key == "#microsoft.graph.macOsVppAppAssignmentSettings":
				from .mac_os_vpp_app_assignment_settings import MacOsVppAppAssignmentSettings
				return MacOsVppAppAssignmentSettings.model_validate(data)
			...
			if mapping_key == "#microsoft.graph.winGetAppAssignmentSettings":
				from .win_get_app_assignment_settings import WinGetAppAssignmentSettings
				return WinGetAppAssignmentSettings.model_validate(data)
