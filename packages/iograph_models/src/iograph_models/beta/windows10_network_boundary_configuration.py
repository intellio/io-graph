...
class Windows10NetworkBoundaryConfiguration(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.windows10NetworkBoundaryConfiguration"] = Field(alias="@odata.type", default="#microsoft.graph.windows10NetworkBoundaryConfiguration")
	...
	windowsNetworkIsolationPolicy: Optional[WindowsNetworkIsolationPolicy] = Field(alias="windowsNetworkIsolationPolicy", default=None,)
