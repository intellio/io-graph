...
class DepOnboardingSetting(BaseModel):
	...
	enrollmentProfiles: Optional[list[Annotated[Union[DepIOSEnrollmentProfile, DepMacOSEnrollmentProfile, DepEnrollmentProfile, DepTvOSEnrollmentProfile, DepVisionOSEnrollmentProfile],Field(discriminator="odata_type")]]] = Field(alias="enrollmentProfiles", default=None,)
