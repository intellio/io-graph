...
class AndroidDeviceOwnerEnterpriseWiFiConfiguration(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.androidDeviceOwnerEnterpriseWiFiConfiguration"] = Field(alias="@odata.type", default="#microsoft.graph.androidDeviceOwnerEnterpriseWiFiConfiguration")
	...
	macAddressRandomizationMode: Optional[MacAddressRandomizationMode | str] = Field(alias="macAddressRandomizationMode", default=None,)
	...
	proxyExclusionList: Optional[str] = Field(alias="proxyExclusionList", default=None,)
	...
	wiFiSecurityType: Optional[AndroidDeviceOwnerWiFiSecurityType | str] = Field(alias="wiFiSecurityType", default=None,)
	...
	identityCertificateForClientAuthentication: Optional[Union[AndroidDeviceOwnerImportedPFXCertificateProfile, AndroidDeviceOwnerPkcsCertificateProfile, AndroidDeviceOwnerScepCertificateProfile]] = Field(alias="identityCertificateForClientAuthentication", default=None,discriminator="odata_type", )
	rootCertificateForServerValidation: Optional[AndroidDeviceOwnerTrustedRootCertificate] = Field(alias="rootCertificateForServerValidation", default=None,)
	rootCertificatesForServerValidation: Optional[list[AndroidDeviceOwnerTrustedRootCertificate]] = Field(alias="rootCertificatesForServerValidation", default=None,)
