...
class AndroidDeviceOwnerEnterpriseWiFiConfiguration(BaseModel):
	...
	identityCertificateForClientAuthentication: SerializeAsAny[Optional[AndroidDeviceOwnerCertificateProfileBase]] = Field(alias="identityCertificateForClientAuthentication",default=None,)
