...
class AndroidWorkProfileScepCertificateProfile(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.androidWorkProfileScepCertificateProfile"] = Field(alias="@odata.type", default="#microsoft.graph.androidWorkProfileScepCertificateProfile")
