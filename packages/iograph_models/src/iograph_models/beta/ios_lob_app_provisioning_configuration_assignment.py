...
class IosLobAppProvisioningConfigurationAssignment(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.iosLobAppProvisioningConfigurationAssignment"] = Field(alias="@odata.type", default="#microsoft.graph.iosLobAppProvisioningConfigurationAssignment")
