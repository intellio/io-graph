...
class AndroidForWorkCertificateProfileBase(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.androidForWorkCertificateProfileBase"] = Field(alias="@odata.type", default="#microsoft.graph.androidForWorkCertificateProfileBase")
