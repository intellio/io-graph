...
class CloudPcBulkPowerOn(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.cloudPcBulkPowerOn"] = Field(alias="@odata.type", default="#microsoft.graph.cloudPcBulkPowerOn")
