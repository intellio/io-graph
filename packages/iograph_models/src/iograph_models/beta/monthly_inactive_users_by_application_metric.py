...
class MonthlyInactiveUsersByApplicationMetric(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.monthlyInactiveUsersByApplicationMetric"] = Field(alias="@odata.type", default="#microsoft.graph.monthlyInactiveUsersByApplicationMetric")
