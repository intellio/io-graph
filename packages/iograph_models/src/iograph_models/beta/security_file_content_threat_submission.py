...
class SecurityFileContentThreatSubmission(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.security.fileContentThreatSubmission"] = Field(alias="@odata.type", default="#microsoft.graph.security.fileContentThreatSubmission")
