...
class OverprovisionedUserFinding(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.overprovisionedUserFinding"] = Field(alias="@odata.type", default="#microsoft.graph.overprovisionedUserFinding")
