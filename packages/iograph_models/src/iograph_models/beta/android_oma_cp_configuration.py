...
class AndroidOmaCpConfiguration(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.androidOmaCpConfiguration"] = Field(alias="@odata.type", default="#microsoft.graph.androidOmaCpConfiguration")
