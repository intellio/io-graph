...
class AndroidWorkProfileGeneralDeviceConfiguration(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.androidWorkProfileGeneralDeviceConfiguration"] = Field(alias="@odata.type", default="#microsoft.graph.androidWorkProfileGeneralDeviceConfiguration")
	...
	workProfileAllowAppInstallsFromUnknownSources: Optional[bool] = Field(alias="workProfileAllowAppInstallsFromUnknownSources", default=None,)
