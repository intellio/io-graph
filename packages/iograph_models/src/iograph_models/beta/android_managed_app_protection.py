...
class AndroidManagedAppProtection(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.androidManagedAppProtection"] = Field(alias="@odata.type", default="#microsoft.graph.androidManagedAppProtection")
	...
	appActionIfSamsungKnoxAttestationRequired: Optional[ManagedAppRemediationAction | str] = Field(alias="appActionIfSamsungKnoxAttestationRequired", default=None,)
	approvedKeyboards: Optional[list[KeyValuePair]] = Field(alias="approvedKeyboards", default=None,)
	...
	keyboardsRestricted: Optional[bool] = Field(alias="keyboardsRestricted", default=None,)
