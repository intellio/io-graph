...
class MacOSImportedPFXCertificateProfile(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.macOSImportedPFXCertificateProfile"] = Field(alias="@odata.type", default="#microsoft.graph.macOSImportedPFXCertificateProfile")
