...
class ExternalUsersSelfServiceSignUpEventsFlow(BaseModel):
	...
	onAttributeCollectionStart: SerializeAsAny[Optional[OnAttributeCollectionStartHandler]] = Field(alias="onAttributeCollectionStart",default=None,)
	onAttributeCollectionSubmit: SerializeAsAny[Optional[OnAttributeCollectionSubmitHandler]] = Field(alias="onAttributeCollectionSubmit",default=None,)
