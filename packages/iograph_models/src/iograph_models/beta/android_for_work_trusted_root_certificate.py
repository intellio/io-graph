...
class AndroidForWorkTrustedRootCertificate(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.androidForWorkTrustedRootCertificate"] = Field(alias="@odata.type", default="#microsoft.graph.androidForWorkTrustedRootCertificate")
