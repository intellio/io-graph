...
class OnUserCreateStartHandler(BaseModel):
	...
	def convert_discriminator_class(cls, data: Any, handler: ModelWrapValidatorHandler[Self]) -> Self:
		try:
			...
			if mapping_key == "#microsoft.graph.onUserCreateStartExternalUsersSelfServiceSignUp":
				from .on_user_create_start_external_users_self_service_sign_up import OnUserCreateStartExternalUsersSelfServiceSignUp
				return OnUserCreateStartExternalUsersSelfServiceSignUp.model_validate(data)
