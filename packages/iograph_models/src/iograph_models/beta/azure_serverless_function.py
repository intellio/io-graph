...
class AzureServerlessFunction(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.azureServerlessFunction"] = Field(alias="@odata.type", default="#microsoft.graph.azureServerlessFunction")
	...
	resource: Optional[AzureAuthorizationSystemResource] = Field(alias="resource", default=None,)
