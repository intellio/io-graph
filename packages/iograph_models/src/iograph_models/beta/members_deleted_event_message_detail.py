...
class MembersDeletedEventMessageDetail(BaseModel):
	odata_type: Literal["#microsoft.graph.membersDeletedEventMessageDetail"] = Field(alias="@odata.type", default="#microsoft.graph.membersDeletedEventMessageDetail")
