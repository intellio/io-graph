...
class MacOSEndpointProtectionConfiguration(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.macOSEndpointProtectionConfiguration"] = Field(alias="@odata.type", default="#microsoft.graph.macOSEndpointProtectionConfiguration")
