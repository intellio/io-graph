...
class MacOSMicrosoftDefenderApp(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.macOSMicrosoftDefenderApp"] = Field(alias="@odata.type", default="#microsoft.graph.macOSMicrosoftDefenderApp")
