...
class PrivilegeEscalationUserFinding(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.privilegeEscalationUserFinding"] = Field(alias="@odata.type", default="#microsoft.graph.privilegeEscalationUserFinding")
