...
class WindowsWifiConfiguration(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.windowsWifiConfiguration"] = Field(alias="@odata.type", default="#microsoft.graph.windowsWifiConfiguration")
