...
class OverprovisionedAwsResourceFinding(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.overprovisionedAwsResourceFinding"] = Field(alias="@odata.type", default="#microsoft.graph.overprovisionedAwsResourceFinding")
