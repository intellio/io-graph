...
class DeviceManagementComplexSettingDefinition(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.deviceManagementComplexSettingDefinition"] = Field(alias="@odata.type", default="#microsoft.graph.deviceManagementComplexSettingDefinition")
