...
class IntuneBrandingProfileAssignment(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.intuneBrandingProfileAssignment"] = Field(alias="@odata.type", default="#microsoft.graph.intuneBrandingProfileAssignment")
