...
class Windows10PFXImportCertificateProfile(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.windows10PFXImportCertificateProfile"] = Field(alias="@odata.type", default="#microsoft.graph.windows10PFXImportCertificateProfile")
