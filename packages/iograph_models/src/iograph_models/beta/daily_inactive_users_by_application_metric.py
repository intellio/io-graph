...
class DailyInactiveUsersByApplicationMetric(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.dailyInactiveUsersByApplicationMetric"] = Field(alias="@odata.type", default="#microsoft.graph.dailyInactiveUsersByApplicationMetric")
