...
class AndroidEnterpriseWiFiConfiguration(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.androidEnterpriseWiFiConfiguration"] = Field(alias="@odata.type", default="#microsoft.graph.androidEnterpriseWiFiConfiguration")
	...
	identityCertificateForClientAuthentication: Optional[Union[AndroidForWorkImportedPFXCertificateProfile, AndroidImportedPFXCertificateProfile, AndroidPkcsCertificateProfile, AndroidScepCertificateProfile]] = Field(alias="identityCertificateForClientAuthentication", default=None,discriminator="odata_type", )
	rootCertificateForServerValidation: Optional[AndroidTrustedRootCertificate] = Field(alias="rootCertificateForServerValidation", default=None,)
