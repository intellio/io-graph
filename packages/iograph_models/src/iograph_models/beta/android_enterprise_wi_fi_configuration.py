...
class AndroidEnterpriseWiFiConfiguration(BaseModel):
	...
	identityCertificateForClientAuthentication: SerializeAsAny[Optional[AndroidCertificateProfileBase]] = Field(alias="identityCertificateForClientAuthentication",default=None,)
