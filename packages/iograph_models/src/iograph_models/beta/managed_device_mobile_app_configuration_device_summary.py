...
class ManagedDeviceMobileAppConfigurationDeviceSummary(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.managedDeviceMobileAppConfigurationDeviceSummary"] = Field(alias="@odata.type", default="#microsoft.graph.managedDeviceMobileAppConfigurationDeviceSummary")
