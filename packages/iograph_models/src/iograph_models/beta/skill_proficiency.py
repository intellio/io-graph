...
class SkillProficiency(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.skillProficiency"] = Field(alias="@odata.type", default="#microsoft.graph.skillProficiency")
	...
	proficiency: Optional[SkillProficiencyLevel | str] = Field(alias="proficiency", default=None,)
