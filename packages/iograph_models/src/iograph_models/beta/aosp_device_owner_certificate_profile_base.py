...
class AospDeviceOwnerCertificateProfileBase(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.aospDeviceOwnerCertificateProfileBase"] = Field(alias="@odata.type", default="#microsoft.graph.aospDeviceOwnerCertificateProfileBase")
