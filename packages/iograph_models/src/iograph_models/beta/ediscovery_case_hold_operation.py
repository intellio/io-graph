...
class EdiscoveryCaseHoldOperation(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.ediscovery.caseHoldOperation"] = Field(alias="@odata.type", default="#microsoft.graph.ediscovery.caseHoldOperation")
