...
class SecurityFileUrlThreatSubmission(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.security.fileUrlThreatSubmission"] = Field(alias="@odata.type", default="#microsoft.graph.security.fileUrlThreatSubmission")
