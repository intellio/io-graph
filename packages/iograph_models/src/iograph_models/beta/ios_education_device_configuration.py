...
class IosEducationDeviceConfiguration(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.iosEducationDeviceConfiguration"] = Field(alias="@odata.type", default="#microsoft.graph.iosEducationDeviceConfiguration")
