...
class HealthMonitoringUserImpactSummary(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.healthMonitoring.userImpactSummary"] = Field(alias="@odata.type", default="#microsoft.graph.healthMonitoring.userImpactSummary")
