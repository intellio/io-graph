...
class SalesQuote(BaseModel):
	acceptedDate: Optional[str] = Field(alias="acceptedDate", default=None,)
	...
	documentDate: Optional[str] = Field(alias="documentDate", default=None,)
	...
	sentDate: Optional[datetime] = Field(alias="sentDate", default=None,)
	shipmentMethodId: Optional[UUID] = Field(alias="shipmentMethodId", default=None,)
	...
	validUntilDate: Optional[str] = Field(alias="validUntilDate", default=None,)
	...
	shipmentMethod: Optional[ShipmentMethod] = Field(alias="shipmentMethod", default=None,)
