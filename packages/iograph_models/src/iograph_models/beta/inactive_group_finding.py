...
class InactiveGroupFinding(BaseModel):
	...
	group: Optional[Union[AwsAccessKey, AwsEc2Instance, AwsGroup, AwsLambda, AwsRole, AwsUser, AzureGroup, AzureManagedIdentity, AzureServerlessFunction, AzureServicePrincipal, AzureUser, GcpCloudFunction, GcpGroup, GcpServiceAccount, GcpUser]] = Field(alias="group", default=None,discriminator="odata_type", )
