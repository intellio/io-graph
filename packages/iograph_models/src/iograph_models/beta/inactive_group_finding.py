...
class InactiveGroupFinding(BaseModel):
	...
	group: Optional[Union[AwsIdentity, AwsAccessKey, AwsEc2Instance, AwsGroup, AwsLambda, AwsRole, AwsUser, AzureIdentity, AzureGroup, AzureManagedIdentity, AzureServerlessFunction, AzureServicePrincipal, AzureUser, GcpIdentity, GcpCloudFunction, GcpGroup, GcpServiceAccount, GcpUser]] = Field(alias="group", default=None,discriminator="odata_type", )
