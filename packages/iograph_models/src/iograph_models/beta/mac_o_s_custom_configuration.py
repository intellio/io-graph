...
class MacOSCustomConfiguration(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.macOSCustomConfiguration"] = Field(alias="@odata.type", default="#microsoft.graph.macOSCustomConfiguration")
