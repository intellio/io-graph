...
class AndroidWorkProfileGmailEasConfiguration(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.androidWorkProfileGmailEasConfiguration"] = Field(alias="@odata.type", default="#microsoft.graph.androidWorkProfileGmailEasConfiguration")
