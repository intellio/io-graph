...
class AndroidDeviceOwnerImportedPFXCertificateProfile(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.androidDeviceOwnerImportedPFXCertificateProfile"] = Field(alias="@odata.type", default="#microsoft.graph.androidDeviceOwnerImportedPFXCertificateProfile")
