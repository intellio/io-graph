...
class SecretInformationAccessAwsRoleFinding(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.secretInformationAccessAwsRoleFinding"] = Field(alias="@odata.type", default="#microsoft.graph.secretInformationAccessAwsRoleFinding")
