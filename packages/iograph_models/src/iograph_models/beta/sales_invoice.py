...
class SalesInvoice(BaseModel):
	...
	customerPurchaseOrderReference: Optional[str] = Field(alias="customerPurchaseOrderReference",default=None,)
	...
	orderId: Optional[UUID] = Field(alias="orderId",default=None,)
	orderNumber: Optional[str] = Field(alias="orderNumber",default=None,)
