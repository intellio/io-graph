...
class WindowsPhone81CustomConfiguration(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.windowsPhone81CustomConfiguration"] = Field(alias="@odata.type", default="#microsoft.graph.windowsPhone81CustomConfiguration")
