...
class RoleScopeTagAutoAssignment(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.roleScopeTagAutoAssignment"] = Field(alias="@odata.type", default="#microsoft.graph.roleScopeTagAutoAssignment")
