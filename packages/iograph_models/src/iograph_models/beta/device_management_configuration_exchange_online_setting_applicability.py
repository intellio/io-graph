...
class DeviceManagementConfigurationExchangeOnlineSettingApplicability(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.deviceManagementConfigurationExchangeOnlineSettingApplicability"] = Field(alias="@odata.type", default="#microsoft.graph.deviceManagementConfigurationExchangeOnlineSettingApplicability")
