...
class Win32CatalogApp(BaseModel):
	...
	latestUpgradeCatalogPackage: SerializeAsAny[Optional[MobileAppCatalogPackage]] = Field(alias="latestUpgradeCatalogPackage",default=None,)
	referencedCatalogPackage: SerializeAsAny[Optional[MobileAppCatalogPackage]] = Field(alias="referencedCatalogPackage",default=None,)
