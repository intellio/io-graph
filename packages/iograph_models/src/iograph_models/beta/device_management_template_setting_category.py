...
class DeviceManagementTemplateSettingCategory(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.deviceManagementTemplateSettingCategory"] = Field(alias="@odata.type", default="#microsoft.graph.deviceManagementTemplateSettingCategory")
	...
	recommendedSettings: Optional[list[Annotated[Union[DeviceManagementAbstractComplexSettingInstance, DeviceManagementBooleanSettingInstance, DeviceManagementCollectionSettingInstance, DeviceManagementComplexSettingInstance, DeviceManagementIntegerSettingInstance, DeviceManagementStringSettingInstance],Field(discriminator="odata_type")]]] = Field(alias="recommendedSettings", default=None,)
