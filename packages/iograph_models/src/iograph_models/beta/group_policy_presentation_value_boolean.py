...
class GroupPolicyPresentationValueBoolean(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.groupPolicyPresentationValueBoolean"] = Field(alias="@odata.type", default="#microsoft.graph.groupPolicyPresentationValueBoolean")
