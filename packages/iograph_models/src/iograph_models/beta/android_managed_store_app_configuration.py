...
class AndroidManagedStoreAppConfiguration(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.androidManagedStoreAppConfiguration"] = Field(alias="@odata.type", default="#microsoft.graph.androidManagedStoreAppConfiguration")
	...
	appSupportsOemConfig: Optional[bool] = Field(alias="appSupportsOemConfig", default=None,)
