...
class IosPkcsCertificateProfile(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.iosPkcsCertificateProfile"] = Field(alias="@odata.type", default="#microsoft.graph.iosPkcsCertificateProfile")
