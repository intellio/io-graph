...
class PrivilegedAccessGroupEligibilityScheduleInstance(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.privilegedAccessGroupEligibilityScheduleInstance"] = Field(alias="@odata.type", default="#microsoft.graph.privilegedAccessGroupEligibilityScheduleInstance")
