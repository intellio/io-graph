...
class Windows10EnrollmentCompletionPageConfigurationPolicySetItem(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.windows10EnrollmentCompletionPageConfigurationPolicySetItem"] = Field(alias="@odata.type", default="#microsoft.graph.windows10EnrollmentCompletionPageConfigurationPolicySetItem")
