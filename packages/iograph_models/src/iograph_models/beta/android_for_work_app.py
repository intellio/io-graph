...
class AndroidForWorkApp(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.androidForWorkApp"] = Field(alias="@odata.type", default="#microsoft.graph.androidForWorkApp")
