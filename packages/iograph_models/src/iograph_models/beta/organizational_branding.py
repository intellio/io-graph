...
class OrganizationalBranding(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.organizationalBranding"] = Field(alias="@odata.type", default="#microsoft.graph.organizationalBranding")
	...
	localizations: Optional[list[OrganizationalBrandingLocalization]] = Field(alias="localizations", default=None,)
