...
class ManagedDeviceMobileAppConfigurationPolicySetItem(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.managedDeviceMobileAppConfigurationPolicySetItem"] = Field(alias="@odata.type", default="#microsoft.graph.managedDeviceMobileAppConfigurationPolicySetItem")
