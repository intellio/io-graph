...
class PrivilegedAccessGroupEligibilityScheduleRequest(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.privilegedAccessGroupEligibilityScheduleRequest"] = Field(alias="@odata.type", default="#microsoft.graph.privilegedAccessGroupEligibilityScheduleRequest")
