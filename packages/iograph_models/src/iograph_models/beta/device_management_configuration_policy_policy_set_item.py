...
class DeviceManagementConfigurationPolicyPolicySetItem(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.deviceManagementConfigurationPolicyPolicySetItem"] = Field(alias="@odata.type", default="#microsoft.graph.deviceManagementConfigurationPolicyPolicySetItem")
