...
class DeviceManagementAbstractComplexSettingDefinition(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.deviceManagementAbstractComplexSettingDefinition"] = Field(alias="@odata.type", default="#microsoft.graph.deviceManagementAbstractComplexSettingDefinition")
