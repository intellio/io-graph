...
class AospDeviceOwnerTrustedRootCertificate(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.aospDeviceOwnerTrustedRootCertificate"] = Field(alias="@odata.type", default="#microsoft.graph.aospDeviceOwnerTrustedRootCertificate")
