...
class EdiscoveryAddToReviewSetOperation(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.ediscovery.addToReviewSetOperation"] = Field(alias="@odata.type", default="#microsoft.graph.ediscovery.addToReviewSetOperation")
