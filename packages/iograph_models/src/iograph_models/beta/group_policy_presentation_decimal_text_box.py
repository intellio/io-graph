...
class GroupPolicyPresentationDecimalTextBox(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.groupPolicyPresentationDecimalTextBox"] = Field(alias="@odata.type", default="#microsoft.graph.groupPolicyPresentationDecimalTextBox")
