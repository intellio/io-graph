...
class IosCertificateProfileCollectionResponse(BaseModel):
	...
	value: Optional[list[Annotated[Union[IosPkcsCertificateProfile, IosScepCertificateProfile, IosImportedPFXCertificateProfile],Field(discriminator="odata_type")]]] = Field(alias="value", default=None,)
