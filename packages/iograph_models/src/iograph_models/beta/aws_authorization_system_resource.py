...
class AwsAuthorizationSystemResource(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.awsAuthorizationSystemResource"] = Field(alias="@odata.type", default="#microsoft.graph.awsAuthorizationSystemResource")
