...
class WindowsAutopilotDeploymentProfilePolicySetItem(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.windowsAutopilotDeploymentProfilePolicySetItem"] = Field(alias="@odata.type", default="#microsoft.graph.windowsAutopilotDeploymentProfilePolicySetItem")
