...
class IosEasEmailProfileConfiguration(BaseModel):
	...
	identityCertificate: SerializeAsAny[Optional[IosCertificateProfileBase]] = Field(alias="identityCertificate",default=None,)
	smimeEncryptionCertificate: SerializeAsAny[Optional[IosCertificateProfile]] = Field(alias="smimeEncryptionCertificate",default=None,)
	smimeSigningCertificate: SerializeAsAny[Optional[IosCertificateProfile]] = Field(alias="smimeSigningCertificate",default=None,)
