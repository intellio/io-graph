...
class WindowsQualityUpdatePolicyAssignment(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.windowsQualityUpdatePolicyAssignment"] = Field(alias="@odata.type", default="#microsoft.graph.windowsQualityUpdatePolicyAssignment")
