...
class WindowsPhoneXAP(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.windowsPhoneXAP"] = Field(alias="@odata.type", default="#microsoft.graph.windowsPhoneXAP")
	...
	productIdentifier: Optional[str] = Field(alias="productIdentifier", default=None,)
