...
class AospDeviceOwnerPkcsCertificateProfile(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.aospDeviceOwnerPkcsCertificateProfile"] = Field(alias="@odata.type", default="#microsoft.graph.aospDeviceOwnerPkcsCertificateProfile")
