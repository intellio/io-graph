...
class Windows10PkcsCertificateProfile(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.windows10PkcsCertificateProfile"] = Field(alias="@odata.type", default="#microsoft.graph.windows10PkcsCertificateProfile")
