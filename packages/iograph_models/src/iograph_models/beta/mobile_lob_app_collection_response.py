...
class MobileLobAppCollectionResponse(BaseModel):
	...
	value: Optional[list[Annotated[Union[AndroidLobApp, IosLobApp, MacOSDmgApp, MacOSLobApp, MacOSPkgApp, Win32CatalogApp, WindowsAppX, WindowsMobileMSI, WindowsPhone81AppXBundle, WindowsPhoneXAP, WindowsUniversalAppX],Field(discriminator="odata_type")]]] = Field(alias="value", default=None,)
