...
class SecretInformationAccessAwsResourceFinding(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.secretInformationAccessAwsResourceFinding"] = Field(alias="@odata.type", default="#microsoft.graph.secretInformationAccessAwsResourceFinding")
