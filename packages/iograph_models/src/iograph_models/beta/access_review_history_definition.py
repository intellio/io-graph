...
class AccessReviewHistoryDefinition(BaseModel):
	...
	scopes: Optional[list[Annotated[Union[AccessReviewInactiveUsersQueryScope, AccessReviewReviewerScope, PrincipalResourceMembershipsScope],Field(discriminator="odata_type")]]] = Field(alias="scopes", default=None,)
