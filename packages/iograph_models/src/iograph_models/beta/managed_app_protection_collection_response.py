...
class ManagedAppProtectionCollectionResponse(BaseModel):
	...
	value: Optional[list[Annotated[Union[DefaultManagedAppProtection, AndroidManagedAppProtection, IosManagedAppProtection],Field(discriminator="odata_type")]]] = Field(alias="value", default=None,)
