...
class WindowsUpdatesQualityUpdateCatalogEntry(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.windowsUpdates.qualityUpdateCatalogEntry"] = Field(alias="@odata.type", default="#microsoft.graph.windowsUpdates.qualityUpdateCatalogEntry")
