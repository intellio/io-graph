...
class DeviceEnrollmentPlatformRestrictionConfiguration(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.deviceEnrollmentPlatformRestrictionConfiguration"] = Field(alias="@odata.type", default="#microsoft.graph.deviceEnrollmentPlatformRestrictionConfiguration")
