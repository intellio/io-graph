...
class SecurityRegistryKeyEvidence(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.security.registryKeyEvidence"] = Field(alias="@odata.type", default="#microsoft.graph.security.registryKeyEvidence")
