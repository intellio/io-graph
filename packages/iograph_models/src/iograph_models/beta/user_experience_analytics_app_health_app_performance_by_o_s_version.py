...
class UserExperienceAnalyticsAppHealthAppPerformanceByOSVersion(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.userExperienceAnalyticsAppHealthAppPerformanceByOSVersion"] = Field(alias="@odata.type", default="#microsoft.graph.userExperienceAnalyticsAppHealthAppPerformanceByOSVersion")
