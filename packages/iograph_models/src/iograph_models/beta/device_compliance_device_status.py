...
class DeviceComplianceDeviceStatus(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.deviceComplianceDeviceStatus"] = Field(alias="@odata.type", default="#microsoft.graph.deviceComplianceDeviceStatus")
