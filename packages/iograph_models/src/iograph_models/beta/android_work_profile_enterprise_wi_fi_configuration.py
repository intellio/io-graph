...
class AndroidWorkProfileEnterpriseWiFiConfiguration(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.androidWorkProfileEnterpriseWiFiConfiguration"] = Field(alias="@odata.type", default="#microsoft.graph.androidWorkProfileEnterpriseWiFiConfiguration")
	...
	identityCertificateForClientAuthentication: Optional[Union[AndroidWorkProfilePkcsCertificateProfile, AndroidWorkProfileScepCertificateProfile]] = Field(alias="identityCertificateForClientAuthentication", default=None,discriminator="odata_type", )
