...
class MdmWindowsInformationProtectionPolicyPolicySetItem(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.mdmWindowsInformationProtectionPolicyPolicySetItem"] = Field(alias="@odata.type", default="#microsoft.graph.mdmWindowsInformationProtectionPolicyPolicySetItem")
