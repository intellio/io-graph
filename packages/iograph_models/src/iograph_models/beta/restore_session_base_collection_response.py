...
class RestoreSessionBaseCollectionResponse(BaseModel):
	...
	value: Optional[list[Annotated[Union[ExchangeRestoreSession, OneDriveForBusinessRestoreSession, SharePointRestoreSession],Field(discriminator="odata_type")]]] = Field(alias="value", default=None,)
