...
class WindowsUpdatesContentApprovalRule(BaseModel):
	...
	contentFilter: Optional[Union[WindowsUpdatesDriverUpdateFilter, WindowsUpdatesQualityUpdateFilter]] = Field(alias="contentFilter", default=None,discriminator="odata_type", )
