...
class HealthMonitoringServicePrincipalImpactSummary(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.healthMonitoring.servicePrincipalImpactSummary"] = Field(alias="@odata.type", default="#microsoft.graph.healthMonitoring.servicePrincipalImpactSummary")
