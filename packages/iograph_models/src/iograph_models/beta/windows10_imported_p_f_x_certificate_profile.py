...
class Windows10ImportedPFXCertificateProfile(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.windows10ImportedPFXCertificateProfile"] = Field(alias="@odata.type", default="#microsoft.graph.windows10ImportedPFXCertificateProfile")
