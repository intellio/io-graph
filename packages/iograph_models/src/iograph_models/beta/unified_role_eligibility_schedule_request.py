...
class UnifiedRoleEligibilityScheduleRequest(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.unifiedRoleEligibilityScheduleRequest"] = Field(alias="@odata.type", default="#microsoft.graph.unifiedRoleEligibilityScheduleRequest")
