...
class StartTranscriptionOperation(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.startTranscriptionOperation"] = Field(alias="@odata.type", default="#microsoft.graph.startTranscriptionOperation")
