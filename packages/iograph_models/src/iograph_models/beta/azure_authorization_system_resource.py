...
class AzureAuthorizationSystemResource(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.azureAuthorizationSystemResource"] = Field(alias="@odata.type", default="#microsoft.graph.azureAuthorizationSystemResource")
