...
class IosExpeditedCheckinConfiguration(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.iosExpeditedCheckinConfiguration"] = Field(alias="@odata.type", default="#microsoft.graph.iosExpeditedCheckinConfiguration")
