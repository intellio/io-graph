...
class AppleExpeditedCheckinConfigurationBase(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.appleExpeditedCheckinConfigurationBase"] = Field(alias="@odata.type", default="#microsoft.graph.appleExpeditedCheckinConfigurationBase")
	...
	enableExpeditedCheckin: Optional[bool] = Field(alias="enableExpeditedCheckin", default=None,)
