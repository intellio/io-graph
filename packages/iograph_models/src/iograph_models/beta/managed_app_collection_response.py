...
class ManagedAppCollectionResponse(BaseModel):
	...
	value: Optional[list[Annotated[Union[ManagedAndroidStoreApp, ManagedIOSStoreApp, ManagedAndroidLobApp, ManagedIOSLobApp],Field(discriminator="odata_type")]]] = Field(alias="value", default=None,)
