...
class ManagedDeviceMobileAppConfigurationState(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.managedDeviceMobileAppConfigurationState"] = Field(alias="@odata.type", default="#microsoft.graph.managedDeviceMobileAppConfigurationState")
