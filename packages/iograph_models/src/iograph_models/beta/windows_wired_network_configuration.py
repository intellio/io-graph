...
class WindowsWiredNetworkConfiguration(BaseModel):
	...
	identityCertificateForClientAuthentication: SerializeAsAny[Optional[WindowsCertificateProfileBase]] = Field(alias="identityCertificateForClientAuthentication",default=None,)
	...
	secondaryIdentityCertificateForClientAuthentication: SerializeAsAny[Optional[WindowsCertificateProfileBase]] = Field(alias="secondaryIdentityCertificateForClientAuthentication",default=None,)
