...
class CloudPcOnPremisesConnection(BaseModel):
	...
	healthCheckPaused: Optional[bool] = Field(alias="healthCheckPaused", default=None,)
	...
	healthCheckStatusDetails: Optional[CloudPcOnPremisesConnectionStatusDetails] = Field(alias="healthCheckStatusDetails", default=None,)
	inUse: Optional[bool] = Field(alias="inUse", default=None,)
	inUseByCloudPc: Optional[bool] = Field(alias="inUseByCloudPc", default=None,)
	...
	type: Optional[CloudPcOnPremisesConnectionType | str] = Field(alias="type", default=None,)
