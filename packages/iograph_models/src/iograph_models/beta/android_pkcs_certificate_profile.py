...
class AndroidPkcsCertificateProfile(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.androidPkcsCertificateProfile"] = Field(alias="@odata.type", default="#microsoft.graph.androidPkcsCertificateProfile")
