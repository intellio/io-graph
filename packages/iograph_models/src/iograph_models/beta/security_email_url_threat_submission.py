...
class SecurityEmailUrlThreatSubmission(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.security.emailUrlThreatSubmission"] = Field(alias="@odata.type", default="#microsoft.graph.security.emailUrlThreatSubmission")
	...
	messageUrl: Optional[str] = Field(alias="messageUrl", default=None,)
