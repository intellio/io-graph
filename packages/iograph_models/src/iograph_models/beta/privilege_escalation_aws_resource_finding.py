...
class PrivilegeEscalationAwsResourceFinding(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.privilegeEscalationAwsResourceFinding"] = Field(alias="@odata.type", default="#microsoft.graph.privilegeEscalationAwsResourceFinding")
