...
class DeviceManagementIntentDeviceStateSummary(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.deviceManagementIntentDeviceStateSummary"] = Field(alias="@odata.type", default="#microsoft.graph.deviceManagementIntentDeviceStateSummary")
