...
class AndroidDeviceOwnerPkcsCertificateProfile(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.androidDeviceOwnerPkcsCertificateProfile"] = Field(alias="@odata.type", default="#microsoft.graph.androidDeviceOwnerPkcsCertificateProfile")
	...
	certificateAccessType: Optional[AndroidDeviceOwnerCertificateAccessType | str] = Field(alias="certificateAccessType", default=None,)
	...
	silentCertificateAccessDetails: Optional[list[AndroidDeviceOwnerSilentCertificateAccess]] = Field(alias="silentCertificateAccessDetails", default=None,)
