...
class Windows10XVpnConfiguration(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.windows10XVpnConfiguration"] = Field(alias="@odata.type", default="#microsoft.graph.windows10XVpnConfiguration")
