...
class AndroidTrustedRootCertificate(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.androidTrustedRootCertificate"] = Field(alias="@odata.type", default="#microsoft.graph.androidTrustedRootCertificate")
