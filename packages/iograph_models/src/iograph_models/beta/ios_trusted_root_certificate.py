...
class IosTrustedRootCertificate(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.iosTrustedRootCertificate"] = Field(alias="@odata.type", default="#microsoft.graph.iosTrustedRootCertificate")
