...
class AndroidForWorkPkcsCertificateProfile(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.androidForWorkPkcsCertificateProfile"] = Field(alias="@odata.type", default="#microsoft.graph.androidForWorkPkcsCertificateProfile")
	...
	rootCertificate: Optional[AndroidForWorkTrustedRootCertificate] = Field(alias="rootCertificate", default=None,)
