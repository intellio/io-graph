...
class ManagedDeviceMobileAppConfigurationUserStatus(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.managedDeviceMobileAppConfigurationUserStatus"] = Field(alias="@odata.type", default="#microsoft.graph.managedDeviceMobileAppConfigurationUserStatus")
