...
class DeviceManagementConfigurationPolicyAssignment(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.deviceManagementConfigurationPolicyAssignment"] = Field(alias="@odata.type", default="#microsoft.graph.deviceManagementConfigurationPolicyAssignment")
