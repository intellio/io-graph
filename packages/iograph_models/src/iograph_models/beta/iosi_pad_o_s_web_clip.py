...
class IosiPadOSWebClip(BaseModel):
	...
	fullScreenEnabled: Optional[bool] = Field(alias="fullScreenEnabled", default=None,)
	ignoreManifestScope: Optional[bool] = Field(alias="ignoreManifestScope", default=None,)
	preComposedIconEnabled: Optional[bool] = Field(alias="preComposedIconEnabled", default=None,)
	targetApplicationBundleIdentifier: Optional[str] = Field(alias="targetApplicationBundleIdentifier", default=None,)
