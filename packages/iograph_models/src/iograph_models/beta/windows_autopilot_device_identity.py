...
class WindowsAutopilotDeviceIdentity(BaseModel):
	...
	deploymentProfile: SerializeAsAny[Optional[WindowsAutopilotDeploymentProfile]] = Field(alias="deploymentProfile",default=None,)
	intendedDeploymentProfile: SerializeAsAny[Optional[WindowsAutopilotDeploymentProfile]] = Field(alias="intendedDeploymentProfile",default=None,)
