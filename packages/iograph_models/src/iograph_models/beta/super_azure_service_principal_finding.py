...
class SuperAzureServicePrincipalFinding(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.superAzureServicePrincipalFinding"] = Field(alias="@odata.type", default="#microsoft.graph.superAzureServicePrincipalFinding")
