...
class DriveProtectionUnitsBulkAdditionJob(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.driveProtectionUnitsBulkAdditionJob"] = Field(alias="@odata.type", default="#microsoft.graph.driveProtectionUnitsBulkAdditionJob")
