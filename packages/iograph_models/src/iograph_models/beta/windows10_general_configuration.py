...
class Windows10GeneralConfiguration(BaseModel):
	...
	edgeHomeButtonConfiguration: Optional[Union[EdgeHomeButtonHidden, EdgeHomeButtonLoadsStartPage, EdgeHomeButtonOpensCustomURL, EdgeHomeButtonOpensNewTab]] = Field(alias="edgeHomeButtonConfiguration", default=None,discriminator="odata_type", )
