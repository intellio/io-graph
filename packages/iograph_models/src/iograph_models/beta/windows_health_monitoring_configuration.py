...
class WindowsHealthMonitoringConfiguration(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.windowsHealthMonitoringConfiguration"] = Field(alias="@odata.type", default="#microsoft.graph.windowsHealthMonitoringConfiguration")
	...
	allowDeviceHealthMonitoring: Optional[Enablement | str] = Field(alias="allowDeviceHealthMonitoring", default=None,)
	configDeviceHealthMonitoringCustomScope: Optional[str] = Field(alias="configDeviceHealthMonitoringCustomScope", default=None,)
	configDeviceHealthMonitoringScope: Optional[WindowsHealthMonitoringScope | str] = Field(alias="configDeviceHealthMonitoringScope", default=None,)
