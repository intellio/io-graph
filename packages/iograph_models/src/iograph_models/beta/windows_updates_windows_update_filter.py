...
class WindowsUpdatesWindowsUpdateFilter(BaseModel):
	odata_type: Literal["#microsoft.graph.windowsUpdates.windowsUpdateFilter"] = Field(alias="@odata.type", default="#microsoft.graph.windowsUpdates.windowsUpdateFilter")
