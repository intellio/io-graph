...
class DeviceManagementConfigurationSimpleSettingValueCollectionResponse(BaseModel):
	...
	value: Optional[list[Annotated[Union[DeviceManagementConfigurationIntegerSettingValue, DeviceManagementConfigurationSecretSettingValue, DeviceManagementConfigurationStringSettingValue, DeviceManagementConfigurationReferenceSettingValue],Field(discriminator="odata_type")]]] = Field(alias="value", default=None,)
