...
class SecurityGitHubOrganizationEvidence(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.security.gitHubOrganizationEvidence"] = Field(alias="@odata.type", default="#microsoft.graph.security.gitHubOrganizationEvidence")
