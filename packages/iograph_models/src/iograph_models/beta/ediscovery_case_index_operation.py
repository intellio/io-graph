...
class EdiscoveryCaseIndexOperation(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.ediscovery.caseIndexOperation"] = Field(alias="@odata.type", default="#microsoft.graph.ediscovery.caseIndexOperation")
