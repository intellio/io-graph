...
class AndroidWorkProfileNineWorkEasConfiguration(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.androidWorkProfileNineWorkEasConfiguration"] = Field(alias="@odata.type", default="#microsoft.graph.androidWorkProfileNineWorkEasConfiguration")
