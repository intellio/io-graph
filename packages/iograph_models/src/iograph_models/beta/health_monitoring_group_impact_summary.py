...
class HealthMonitoringGroupImpactSummary(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.healthMonitoring.groupImpactSummary"] = Field(alias="@odata.type", default="#microsoft.graph.healthMonitoring.groupImpactSummary")
