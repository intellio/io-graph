...
class DeviceManagementScriptAssignment(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.deviceManagementScriptAssignment"] = Field(alias="@odata.type", default="#microsoft.graph.deviceManagementScriptAssignment")
