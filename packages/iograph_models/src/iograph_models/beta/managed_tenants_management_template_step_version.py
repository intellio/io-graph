...
class ManagedTenantsManagementTemplateStepVersion(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.managedTenants.managementTemplateStepVersion"] = Field(alias="@odata.type", default="#microsoft.graph.managedTenants.managementTemplateStepVersion")
