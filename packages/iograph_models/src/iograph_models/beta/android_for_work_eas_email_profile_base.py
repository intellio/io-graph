...
class AndroidForWorkEasEmailProfileBase(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.androidForWorkEasEmailProfileBase"] = Field(alias="@odata.type", default="#microsoft.graph.androidForWorkEasEmailProfileBase")
