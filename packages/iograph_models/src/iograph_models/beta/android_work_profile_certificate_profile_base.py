...
class AndroidWorkProfileCertificateProfileBase(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.androidWorkProfileCertificateProfileBase"] = Field(alias="@odata.type", default="#microsoft.graph.androidWorkProfileCertificateProfileBase")
