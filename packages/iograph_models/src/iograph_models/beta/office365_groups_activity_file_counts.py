...
class Office365GroupsActivityFileCounts(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.office365GroupsActivityFileCounts"] = Field(alias="@odata.type", default="#microsoft.graph.office365GroupsActivityFileCounts")
