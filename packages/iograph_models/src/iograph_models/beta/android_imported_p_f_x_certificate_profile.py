...
class AndroidImportedPFXCertificateProfile(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.androidImportedPFXCertificateProfile"] = Field(alias="@odata.type", default="#microsoft.graph.androidImportedPFXCertificateProfile")
