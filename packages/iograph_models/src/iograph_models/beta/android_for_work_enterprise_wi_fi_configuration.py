...
class AndroidForWorkEnterpriseWiFiConfiguration(BaseModel):
	...
	identityCertificateForClientAuthentication: SerializeAsAny[Optional[AndroidForWorkCertificateProfileBase]] = Field(alias="identityCertificateForClientAuthentication",default=None,)
