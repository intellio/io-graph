...
class AndroidForWorkEnterpriseWiFiConfiguration(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.androidForWorkEnterpriseWiFiConfiguration"] = Field(alias="@odata.type", default="#microsoft.graph.androidForWorkEnterpriseWiFiConfiguration")
	...
	identityCertificateForClientAuthentication: Optional[Union[AndroidForWorkPkcsCertificateProfile, AndroidForWorkScepCertificateProfile]] = Field(alias="identityCertificateForClientAuthentication", default=None,discriminator="odata_type", )
	rootCertificateForServerValidation: Optional[AndroidForWorkTrustedRootCertificate] = Field(alias="rootCertificateForServerValidation", default=None,)
