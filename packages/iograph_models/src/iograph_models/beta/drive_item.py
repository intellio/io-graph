...
class DriveItem(BaseModel):
	...
	contentStream: Optional[str] = Field(alias="contentStream", default=None,)
	...
	media: Optional[Media] = Field(alias="media", default=None,)
	...
	source: Optional[DriveItemSource] = Field(alias="source", default=None,)
	...
	viewpoint: Optional[DriveItemViewpoint] = Field(alias="viewpoint", default=None,)
