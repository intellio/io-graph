...
class AndroidDeviceOwnerWiFiConfiguration(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.androidDeviceOwnerWiFiConfiguration"] = Field(alias="@odata.type", default="#microsoft.graph.androidDeviceOwnerWiFiConfiguration")
