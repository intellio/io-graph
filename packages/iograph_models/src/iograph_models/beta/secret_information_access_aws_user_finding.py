...
class SecretInformationAccessAwsUserFinding(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.secretInformationAccessAwsUserFinding"] = Field(alias="@odata.type", default="#microsoft.graph.secretInformationAccessAwsUserFinding")
