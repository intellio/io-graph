...
class DeviceConfigurationDeviceStateSummary(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.deviceConfigurationDeviceStateSummary"] = Field(alias="@odata.type", default="#microsoft.graph.deviceConfigurationDeviceStateSummary")
