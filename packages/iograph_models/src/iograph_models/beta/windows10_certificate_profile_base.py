...
class Windows10CertificateProfileBase(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.windows10CertificateProfileBase"] = Field(alias="@odata.type", default="#microsoft.graph.windows10CertificateProfileBase")
