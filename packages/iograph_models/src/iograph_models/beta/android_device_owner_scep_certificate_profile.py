...
class AndroidDeviceOwnerScepCertificateProfile(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.androidDeviceOwnerScepCertificateProfile"] = Field(alias="@odata.type", default="#microsoft.graph.androidDeviceOwnerScepCertificateProfile")
