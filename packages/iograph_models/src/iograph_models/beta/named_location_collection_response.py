...
class NamedLocationCollectionResponse(BaseModel):
	...
	value: Optional[list[Annotated[Union[CompliantNetworkNamedLocation, CountryNamedLocation, IpNamedLocation]],Field(discriminator="odata_type")]]] = Field(alias="value", default=None,)
