...
class AndroidForWorkWiFiConfiguration(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.androidForWorkWiFiConfiguration"] = Field(alias="@odata.type", default="#microsoft.graph.androidForWorkWiFiConfiguration")
