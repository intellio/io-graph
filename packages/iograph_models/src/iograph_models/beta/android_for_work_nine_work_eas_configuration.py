...
class AndroidForWorkNineWorkEasConfiguration(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.androidForWorkNineWorkEasConfiguration"] = Field(alias="@odata.type", default="#microsoft.graph.androidForWorkNineWorkEasConfiguration")
