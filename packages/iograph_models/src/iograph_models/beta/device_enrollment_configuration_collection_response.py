...
class DeviceEnrollmentConfigurationCollectionResponse(BaseModel):
	...
	value: Optional[list[Annotated[Union[DeviceComanagementAuthorityConfiguration, DeviceEnrollmentLimitConfiguration, DeviceEnrollmentNotificationConfiguration, DeviceEnrollmentPlatformRestrictionConfiguration, DeviceEnrollmentPlatformRestrictionsConfiguration, DeviceEnrollmentWindowsHelloForBusinessConfiguration, Windows10EnrollmentCompletionPageConfiguration],Field(discriminator="odata_type")]]] = Field(alias="value", default=None,)
