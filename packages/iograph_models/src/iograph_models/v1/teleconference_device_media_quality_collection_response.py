...
class TeleconferenceDeviceMediaQualityCollectionResponse(BaseModel):
	...
	value: Optional[list[Annotated[Union[TeleconferenceDeviceAudioQuality, TeleconferenceDeviceScreenSharingQuality],Field(discriminator="odata_type")]]] = Field(alias="value", default=None,)
