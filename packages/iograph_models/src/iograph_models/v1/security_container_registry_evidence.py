...
class SecurityContainerRegistryEvidence(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.security.containerRegistryEvidence"] = Field(alias="@odata.type", default="#microsoft.graph.security.containerRegistryEvidence")
