...
class AccessReviewScopeCollectionResponse(BaseModel):
	...
	value: Optional[list[Annotated[Union[AccessReviewQueryScope, AccessReviewInactiveUsersQueryScope, PrincipalResourceMembershipsScope],Field(discriminator="odata_type")]]] = Field(alias="value", default=None,)
