...
class TeamsAppInstalledEventMessageDetail(BaseModel):
	odata_type: Literal["#microsoft.graph.teamsAppInstalledEventMessageDetail"] = Field(alias="@odata.type", default="#microsoft.graph.teamsAppInstalledEventMessageDetail")
