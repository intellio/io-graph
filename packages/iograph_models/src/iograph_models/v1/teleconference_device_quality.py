...
class TeleconferenceDeviceQuality(BaseModel):
	...
	mediaQualityList: Optional[list[Annotated[Union[TeleconferenceDeviceAudioQuality, TeleconferenceDeviceScreenSharingQuality],Field(discriminator="odata_type")]]] = Field(alias="mediaQualityList", default=None,)
