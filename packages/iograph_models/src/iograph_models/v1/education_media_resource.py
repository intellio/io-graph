...
class EducationMediaResource(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.educationMediaResource"] = Field(alias="@odata.type", default="#microsoft.graph.educationMediaResource")
