...
class ChannelUnsetAsFavoriteByDefaultEventMessageDetail(BaseModel):
	odata_type: Literal["#microsoft.graph.channelUnsetAsFavoriteByDefaultEventMessageDetail"] = Field(alias="@odata.type", default="#microsoft.graph.channelUnsetAsFavoriteByDefaultEventMessageDetail")
