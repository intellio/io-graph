...
class SecurityKubernetesServiceAccountEvidence(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.security.kubernetesServiceAccountEvidence"] = Field(alias="@odata.type", default="#microsoft.graph.security.kubernetesServiceAccountEvidence")
