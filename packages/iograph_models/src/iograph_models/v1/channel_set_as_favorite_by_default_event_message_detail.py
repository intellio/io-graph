...
class ChannelSetAsFavoriteByDefaultEventMessageDetail(BaseModel):
	odata_type: Literal["#microsoft.graph.channelSetAsFavoriteByDefaultEventMessageDetail"] = Field(alias="@odata.type", default="#microsoft.graph.channelSetAsFavoriteByDefaultEventMessageDetail")
