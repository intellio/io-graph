...
class EducationSubmission(BaseModel):
	...
	returnedBy: Optional[Union[ChatMessageFromIdentitySet, ChatMessageMentionedIdentitySet, ChatMessageReactionIdentitySet, CommunicationsIdentitySet, SharePointIdentitySet]] = Field(alias="returnedBy", default=None,discriminator="odata_type", )
	...
	submittedBy: Optional[Union[ChatMessageFromIdentitySet, ChatMessageMentionedIdentitySet, ChatMessageReactionIdentitySet, CommunicationsIdentitySet, SharePointIdentitySet]] = Field(alias="submittedBy", default=None,discriminator="odata_type", )
	submittedDateTime: Optional[datetime] = Field(alias="submittedDateTime", default=None,)
	unsubmittedBy: Optional[Union[ChatMessageFromIdentitySet, ChatMessageMentionedIdentitySet, ChatMessageReactionIdentitySet, CommunicationsIdentitySet, SharePointIdentitySet]] = Field(alias="unsubmittedBy", default=None,discriminator="odata_type", )
