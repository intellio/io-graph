...
class AndroidManagedAppRegistration(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.androidManagedAppRegistration"] = Field(alias="@odata.type", default="#microsoft.graph.androidManagedAppRegistration")
	...
	appliedPolicies: Optional[list[Annotated[Union[TargetedManagedAppConfiguration, DefaultManagedAppProtection, AndroidManagedAppProtection, IosManagedAppProtection, MdmWindowsInformationProtectionPolicy, WindowsInformationProtectionPolicy],Field(discriminator="odata_type")]]] = Field(alias="appliedPolicies", default=None,)
	intendedPolicies: Optional[list[Annotated[Union[TargetedManagedAppConfiguration, DefaultManagedAppProtection, AndroidManagedAppProtection, IosManagedAppProtection, MdmWindowsInformationProtectionPolicy, WindowsInformationProtectionPolicy],Field(discriminator="odata_type")]]] = Field(alias="intendedPolicies", default=None,)
