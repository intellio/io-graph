...
class StopHoldMusicOperation(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.stopHoldMusicOperation"] = Field(alias="@odata.type", default="#microsoft.graph.stopHoldMusicOperation")
