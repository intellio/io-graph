...
class ManagedDeviceMobileAppConfigurationAssignment(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.managedDeviceMobileAppConfigurationAssignment"] = Field(alias="@odata.type", default="#microsoft.graph.managedDeviceMobileAppConfigurationAssignment")
