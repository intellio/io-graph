...
class WindowsPhone81GeneralConfiguration(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.windowsPhone81GeneralConfiguration"] = Field(alias="@odata.type", default="#microsoft.graph.windowsPhone81GeneralConfiguration")
