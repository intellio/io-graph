...
class SecurityAuthorityTemplate(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.security.authorityTemplate"] = Field(alias="@odata.type", default="#microsoft.graph.security.authorityTemplate")
