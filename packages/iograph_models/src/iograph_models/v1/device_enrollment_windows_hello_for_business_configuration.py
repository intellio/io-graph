...
class DeviceEnrollmentWindowsHelloForBusinessConfiguration(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.deviceEnrollmentWindowsHelloForBusinessConfiguration"] = Field(alias="@odata.type", default="#microsoft.graph.deviceEnrollmentWindowsHelloForBusinessConfiguration")
