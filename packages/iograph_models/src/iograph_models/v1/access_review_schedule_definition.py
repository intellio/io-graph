...
class AccessReviewScheduleDefinition(BaseModel):
	...
	instanceEnumerationScope: Optional[Union[AccessReviewQueryScope, AccessReviewInactiveUsersQueryScope, PrincipalResourceMembershipsScope]] = Field(alias="instanceEnumerationScope", default=None,discriminator="odata_type", )
