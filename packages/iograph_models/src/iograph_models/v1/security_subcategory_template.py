...
class SecuritySubcategoryTemplate(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.security.subcategoryTemplate"] = Field(alias="@odata.type", default="#microsoft.graph.security.subcategoryTemplate")
