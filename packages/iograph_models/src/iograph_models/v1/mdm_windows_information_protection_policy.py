...
class MdmWindowsInformationProtectionPolicy(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.mdmWindowsInformationProtectionPolicy"] = Field(alias="@odata.type", default="#microsoft.graph.mdmWindowsInformationProtectionPolicy")
