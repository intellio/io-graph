...
class TeamJoiningDisabledEventMessageDetail(BaseModel):
	odata_type: Literal["#microsoft.graph.teamJoiningDisabledEventMessageDetail"] = Field(alias="@odata.type", default="#microsoft.graph.teamJoiningDisabledEventMessageDetail")
