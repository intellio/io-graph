...
class BookingBusiness(BaseModel):
	...
	customers: SerializeAsAny[Optional[list[BookingCustomerBase]]] = Field(alias="customers",default=None,)
	...
	staffMembers: SerializeAsAny[Optional[list[BookingStaffMemberBase]]] = Field(alias="staffMembers",default=None,)
