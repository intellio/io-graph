...
class SecurityBlobContainerEvidence(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.security.blobContainerEvidence"] = Field(alias="@odata.type", default="#microsoft.graph.security.blobContainerEvidence")
