...
class MacOSOfficeSuiteApp(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.macOSOfficeSuiteApp"] = Field(alias="@odata.type", default="#microsoft.graph.macOSOfficeSuiteApp")
