...
class ManagedAppRegistrationCollectionResponse(BaseModel):
	...
	value: Optional[list[Annotated[Union[AndroidManagedAppRegistration, IosManagedAppRegistration],Field(discriminator="odata_type")]]] = Field(alias="value", default=None,)
