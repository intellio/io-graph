...
class SecurityEdiscoveryPurgeDataOperation(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.security.ediscoveryPurgeDataOperation"] = Field(alias="@odata.type", default="#microsoft.graph.security.ediscoveryPurgeDataOperation")
