...
class DeleteUserFromSharedAppleDeviceActionResult(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.deleteUserFromSharedAppleDeviceActionResult"] = Field(alias="@odata.type", default="#microsoft.graph.deleteUserFromSharedAppleDeviceActionResult")
