...
class AccessReviewHistoryDefinition(BaseModel):
	...
	scopes: Optional[list[Annotated[Union[AccessReviewInactiveUsersQueryScope, PrincipalResourceMembershipsScope],Field(discriminator="odata_type")]]] = Field(alias="scopes", default=None,)
