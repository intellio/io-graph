...
class ClaimsMappingPolicy(BaseModel):
	id: Optional[str] = Field(alias="id", default=None,)
	odata_type: Literal["#microsoft.graph.claimsMappingPolicy"] = Field(alias="@odata.type", default="#microsoft.graph.claimsMappingPolicy")
