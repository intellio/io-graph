...
class SecurityCloudLogonRequestEvidence(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.security.cloudLogonRequestEvidence"] = Field(alias="@odata.type", default="#microsoft.graph.security.cloudLogonRequestEvidence")
