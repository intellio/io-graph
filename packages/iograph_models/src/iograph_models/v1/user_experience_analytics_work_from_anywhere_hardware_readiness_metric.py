...
class UserExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetric(BaseModel):
	...
	odata_type: Literal["#microsoft.graph.userExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetric"] = Field(alias="@odata.type", default="#microsoft.graph.userExperienceAnalyticsWorkFromAnywhereHardwareReadinessMetric")
