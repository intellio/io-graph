...
class MessageRuleActions(BaseModel):
	...
	forwardAsAttachmentTo: Optional[list[Annotated[Union[Attendee],Field(discriminator="odata_type")]]] = Field(alias="forwardAsAttachmentTo", default=None,)
	forwardTo: Optional[list[Annotated[Union[Attendee],Field(discriminator="odata_type")]]] = Field(alias="forwardTo", default=None,)
	...
	redirectTo: Optional[list[Annotated[Union[Attendee],Field(discriminator="odata_type")]]] = Field(alias="redirectTo", default=None,)
